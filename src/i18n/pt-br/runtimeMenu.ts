 ...
 */
 export default[
	...
	{ text: 'Referências de API', header: true, type: 'learn',  key: 'apiReference', items: [
		{ text: 'Handlers', slug: '/documentacao/produtos/applications/functions/runtime/api-reference/handlers/', key: 'runtime/handlers' },
		{ text: 'Variáveis de Ambiente', slug: '/documentacao/produtos/applications/functions/runtime/api-reference/environment-variables/', key: 'runtime/variables' },
		{ text: 'Metadados', slug: '/documentacao/produtos/applications/functions/runtime/api-reference/metadata/', key: 'runtime/metadata' },
		{ text: 'Cache', slug: '/documentacao/runtime/api-reference/cache/', key: 'runtime/cache-api' },
		{ text: 'Network List', slug: '/documentacao/produtos/applications/functions/runtime/api-reference/network-list/', key: 'runtime/network-list' },
		{ text: 'Object Storage', slug: '/documentacao/runtime/api-reference/storage/', key: 'runtime/storage-api' },
		{ text: 'SQL Database', slug: '/documentacao/runtime/api-reference/sql-database/', key: 'runtime/storage-api' },
	...
	{ text: 'Desenvolvimento', header: true, type: 'learn',  key: 'development', items: [
		{ text: 'Editor de Código', slug: '/documentacao/produtos/applications/functions/runtime-api/code-editor/', key: 'runtime/code-editor' },
		{ text: 'Preview Deployment', slug: '/documentacao/produtos/applications/functions/runtime-api/preview-deployment/', key: 'runtime/preview-deployment' },
	] },
