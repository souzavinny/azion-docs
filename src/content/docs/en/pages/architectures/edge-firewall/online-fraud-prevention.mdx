...
permalink: /documentation/architectures/firewall/online-fraud-prevention/
meta_tags: >-
...
- [Applications](/en/documentation/build/applications/): allows you to build applications that run in Azion Global Infrastructure.
  - [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/): used to customize cache optimization rules, cache keys, and cookies based on established patterns.
  - [Cache](/en/documentation/build/applications/reference/cache/): global add-on to cache content at the edge.
  - [Functions for Applications](/en/documentation/build/applications/reference/functions/): allows you to create event-driven, serverless applications, at the edge of the network, closer to users.
  - [Rules Engine for Applications](/en/documentation/build/applications/reference/rules-engine/): allows you to configure scenarios where specific policies are enforced, providing granular control over delivery.
- [Firewall](/en/documentation/secure/firewall/): provides main settings to set up your instance, enabling you to associate it with domains and activate modules to protect users, applications, and networks.
  - [DDoS Protection](/en/documentation/secure/ddos-protection/): detects and mitigates DDoS and DoS attacks.
  ...
  - [Functions for Firewall](/en/documentation/secure/firewall/reference/functions/): build event-driven, serverless web applications including functions with your own security source code.
  - [Rules Engine for Firewall](/en/documentation/secure/firewall/reference/rules-engine/): allows you to configure scenarios where specific policies are enforced, providing granular control over delivery.
- [Azion Marketplace](/en/documentation/marketplace/reference/marketplace/) and Custom Integrations:
  - Bot protection.
...
- [Observe suite](/en/documentation/observe/overview/): monitor and track traffic through [Real-Time Metrics](/en/documentation/observe/real-time-metrics/), [Real-Time Events](/en/documentation/observe/real-time-events/), and [Data Stream](/en/documentation/observe/data-stream/).

---

## Implementation

1. [Create an application](/en/documentation/get-started/journeys/launch/) and deploy it to the edge.
2. Configure your custom integrations with Azion's platform.
- For example, IdP for user management via [SAML](/en/documentation/account/guides/sso-google-saml/) or [SCIM](/en/documentation/account/guides/microsoft-entra-automated-user-provisioning/) protocol.
3. [Configure the application](/en/documentation/build/applications/guides/configure-main-settings/), including main settings such as origins, cache settings, etc.
- [Configure a custom domain](/en/documentation/build/applications/reference/domains/) for your application.
- [Set the criteria and behaviors](/en/documentation/build/applications/reference/rules-engine/) for the Rules Engine rules. For example:
  ...
  - Redirects.
  - Rewrite the request.
4. [Create and configure a firewall](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/).
- [Set the criteria and behaviors](/en/documentation/secure/firewall/reference/rules-engine/) for the Rules Engine rules. For example:
  - Deny or drop requests.
  - Block malicious IPs.
  - Filter specific HTTP requests.
  - Enforce rate limits.
  - Run functions with custom logic.
- [Instantiate functions](/en/documentation/secure/firewall/guides/instantiate-functions/) and [integrations](/en/documentation/marketplace/reference/integrations/#edge-firewall-functions).
...
6. [Monitor your application](/en/documentation/observe/data-stream/guides/monitor-applications/) and refine rules.

---

## Related docs

- [Enhance Cybersecurity with Azion's Advanced WAAP Solution](/en/documentation/architectures/firewall/web-application-and-api-protection-waap/)
...
- [Secure an application](/en/documentation/get-started/journeys/protect/)
- [Secure an infrastructure](/en/documentation/get-started/journeys/protect/infrastructure/)
- [Secure a DNS](/en/documentation/get-started/journeys/protect/dns/)
...
- [Strengthen Governance, Risk, and Compliance in Your Organization](/en/documentation/platform/compliance/governance-risk-compliance/)
