...
- [Applications](/en/documentation/build/applications/): allows you to build applications that run in Azion Global Infrastructure.
  - [Application Accelerator](/en/documentation/build/applications/application-accelerator/): used to customize cache optimization rules, cache keys, and cookies based on established patterns.
  - [Cache](/en/documentation/build/applications/cache/): global add-on to cache content at the edge.
  - [Functions for Applications](/en/documentation/build/applications/functions/): allows you to create event-driven, serverless applications, at the edge of the network, closer to users.
...
- [Observe suite](/en/documentation/): monitor and track traffic through [Real-Time Metrics](/en/documentation/observe/real-time-metrics/), [Real-Time Events](/en/documentation/observe/real-time-events/), and [Data Stream](/en/documentation/observe/data-stream/).
