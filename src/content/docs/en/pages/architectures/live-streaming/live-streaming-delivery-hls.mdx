...
- [Applications](/en/documentation/build/applications/) allows you to build applications on top of the Azion Web Platform and deliver your content.
  - [Cache](/en/documentation/build/applications/reference/cache/) enables you to configure how your application caches content to reduce latency and increase transfer rates.
...
2. [Create a domain](https://www.azion.com/en/documentation/build/workloads/guides/configure-a-domain/#create-a-domain-with-azion) and [associate it with the application](/en/documentation/build/workloads/guides/configure-a-domain/#link-a-custom-domain-to-your-application).
3. Set up and [enforce cache policies for HLS](/en/documentation/build/applications/guides/enforce-hls-cache/) in the application.
