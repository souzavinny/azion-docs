...
- **[Firewall](/en/documentation/secure/firewall/)**  
...
- **[Functions](/en/documentation/secure/firewall/reference/functions/)**  
...
- **[Applications](/en/documentation/build/applications/)**  (Optional)
...
```
**Note:** Make sure the selected model is available and properly configured in the Azion environment. Check the [available models](/en/documentation/build/ai-inference/reference/models/).
...
- [Protect web applications and APIs with WAAP](/en/documentation/architectures/firewall/web-application-and-api-protection-waap/)  
- [Azion Observe products](/en/documentation/observe/overview/)