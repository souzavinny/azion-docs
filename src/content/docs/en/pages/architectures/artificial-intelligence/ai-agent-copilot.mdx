...
- [Applications](/en/documentation/build/applications/): allows you to build applications that run in Azion Global Infrastructure.
  - [Functions for Applications](/en/documentation/build/applications/reference/functions/): executes code closer to the end user, enhancing performance and enabling custom logic for handling requests and responses.- [SQL Database](/en/documentation/store/sql-database/): an edge-native SQL solution designed for serverless applications.
  - [Vector Search](/en/documentation/store/sql-database/reference/vector-search/): enables customers to implement semantic search engines.
...
2. Create the [SQL database](/en/documentation/store/sql-database/guides/create-database/) that will be consulted.
3. [Create a function](/en/documentation/build/applications/reference/functions/#implementation) with your AI Agent's logic and [instantiate](/en/documentation/build/applications/guides/instantiate-functions/) it in the application.
4. Implement [Vector Search](/en/documentation/store/sql-database/guides/sql-database-vector-search/).
5. You can monitor your AI Agent through [Azion Observe products](/en/documentation/observe/overview/) and specialized tools such as LangGraph.

---

## Related docs

- [Store journey](/en/documentation/store/overview/)
