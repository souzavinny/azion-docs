...
3. [Create a function](/en/documentation/build/applications/functions/#implementation) with your AI Agent's logic and [instantiate](/en/documentation/build/functions/guides/instantiate-functions/) it in the application.
