...
- **[Applications](https://www.azion.com/en/documentation/build/applications/)**: an application on Azion that hosts the AI agent.
- **[Functions](https://www.azion.com/en/documentation/build/applications/functions/)**: a serverless function that contains the AI agent logic.
...
Use the [LangGraph AI Agent Boilerplate](/en/documentation/marketplace/integrations/langgraph-ai-agent-boilerplate/) to quickly set up a LangGraph backend and SQL base that ensures reliable persistence of state and documents.
...
:::note
This template uses [Application Accelerator](/en/documentation/build/applications/application-accelerator/), [Functions](/en/documentation/build/applications/functions/), and [SQL Database](/en/documentation/store/sql-database/), and may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
:::
---

## Reference Guide

- [Reference Guide - How to integrate an AI agent with Third Party LLM](/en/documentation/marketplace/integrations/langgraph-ai-agent-boilerplate/)

## Related Documentation

- [Object Storage](/en/documentation/store/object-storage/)
- [SQL Database](/en/documentation/store/sql-database/)
- [Azion GitHub App](/en/documentation/get-started/first-deploy/github/azion-github-app/)
- [Vector Search with SQL Database](/en/documentation/store/sql-database/guides/sql-database-vector-search/)
