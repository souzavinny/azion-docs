...
- **[Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/)**: a serverless function that contains the AI agent logic.
