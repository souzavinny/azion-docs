...
Use the [AI Inference Starter Kit](/en/documentation/marketplace/integrations/ai-inference-starter-kit/) template to accelerate your journey and have a ready-to-use application with OpenAI-compatible APIs running at the edge.
...
Notes:
- Access the [Azion AI Inference Models](/en/documentation/build/ai-inference/reference/models/) page to see more available models.
...
- **[Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/)**: analyze events and gain insights into your applications' performance.
...
- [AI Inference Starter Kit guide](/en/documentation/marketplace/integrations/ai-inference-starter-kit/)
- [Available models](/en/documentation/build/ai-inference/reference/models/)
