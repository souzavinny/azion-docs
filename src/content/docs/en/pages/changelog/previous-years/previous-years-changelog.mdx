...
permalink: /documentation/changelog/archive/
meta_tags: >-
...
* **Digital Certificates:** we are now supporting **CSR generation** on our platform. A Certificate Signing Request (CSR) is one of the first steps to obtaining your own TLS certificate with the CA (Certificate Authority) of your choice. Learn more about this feature [here](/en/documentation/secure/certificate-manager/).

**Edge Firewall**

* **WAF Self-Calibration:**  with the new **Tuning** option, you can view insights and customize which rules will be allowed quickly and easily, with just a few clicks. Read the [documentation](/en/documentation/secure/waf/) for more information.
...
* **Web Application Firewall** has a new feature: _Custom Allowed Rules_, which allows you to select specific Rules IDs, improving the creation and editing of [WAF](/en/documentation/secure/waf/) rules. In addition, Firewall gained two fields: _last editor_ and _last modified_. Respectively, they display who created or edited a rule and when this has occurred.
...
* We've added a functionality for [multiport](/en/documentation/build/applications/reference/v3/main-settings/#ports) access to Edge Application, making your implementation more flexible.
...
* We have also improved security issues when creating rules in [Rules Engine](/en/documentation/secure/firewall/reference/rules-engine/).
...
* A new feature, [Slice configuration](/en/documentation/build/applications/reference/cache-settings/#large-file-optimization), is available on Edge Application.
...
* Added support for ECC - _Elliptic Curve Cryptography_ in [Digital Certificates](/en/documentation/secure/certificate-manager/).
...
* Bug fix on the _subdomain_ purge when using [Wildcard Purge](/en/documentation/build/applications/reference/real-time-purge/).
...
* New Bot Management solution integrated to the Azion platform, using [Functions](/en/documentation/build/applications/reference/functions/) in [Firewall](/en/documentation/secure/firewall/).
* Added [TLS Minimum Version](/en/documentation/build/applications/reference/v3/main-settings/#minimum-tls-version) selection component to the Application interface.
...
* New [types of purge](/en/documentation/build/applications/reference/real-time-purge/): purges can now be done via URL, CacheKey or Wildcard.
...
* Implementation of [Multi-Factor Authentication](/en/documentation/account/reference/multi-factor-authentication/).
...
* [Edge Firewall's](/en/documentation/secure/firewall/) IP Blocking functionality is integrated into Real-Time Manager.
* [Edge Firewall](/en/documentation/secure/firewall/) IP Blocking integrated in to the API.
...
* Evolution of the Learning Tool of the [Web Application Firewall](/en/documentation/secure/waf/) product.
...
* Improvements to the texts of the [Advanced Cache Key](/en/documentation/build/applications/reference/application-accelerator/#advanced-cache-key) options.
...
* Renewal of the Azion [Shared Certificate](/en/documentation/secure/certificate-manager/) with CA, for all customers of the product.
...
* Integration of the Advanced Cache Key functionalities (cache key by cookie and cache key by query string) of the [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/) product with Real-Time Manager.
...
* Launch of new Image Optimization graphics in [Analytics](/en/documentation/observe/real-time-metrics/).
...
* HTTP/2 support.
* Update of the Origins tab in Real-Time Manager to integrate the [Load Balancer](/en/documentation/build/connectors/reference/load-balancer/) product functionalities.
* Update of Real-Time Manager to include the new interface for creating [Web Application Firewall](/en/documentation/secure/waf/) rule sets.
...
* Update of the [Image Optimization](/en/documentation/build/applications/reference/image-processor/) platform, with good gains in image optimization.

---

**may/2016**

* Launch of the new interface for uploading [Digital Certificates](/en/documentation/secure/certificate-manager/) to Real-Time Manager.
...
* Update of the [Edge Firewall](/en/documentation/secure/firewall/) interface to support the reuse of rule sets.
