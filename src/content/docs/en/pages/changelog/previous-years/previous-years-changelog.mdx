...
* A new feature, [Slice configuration](/en/documentation/build/cache/reference/cache-settings/#large-file-optimization), is available on Edge Application.
...
* Bug fix on the _subdomain_ purge when using [Wildcard Purge](/en/documentation/build/cache/reference/real-time-purge/).
...
* New Bot Management solution integrated to the Azion platform, using [Functions](/en/documentation/build/functions/) in [Firewall](/en/documentation/secure/firewall/).
...
* New [types of purge](/en/documentation/build/cache/reference/real-time-purge/): purges can now be done via URL, CacheKey or Wildcard.
...
* Improvements to the texts of the [Advanced Cache Key](/en/documentation/build/application-accelerator/#advanced-cache-key) options.
...
* Integration of the Advanced Cache Key functionalities (cache key by cookie and cache key by query string) of the [Application Accelerator](/en/documentation/build/application-accelerator/) product with Real-Time Manager.
...
* Update of the [Image Optimization](/en/documentation/build/image-processor/) platform, with good gains in image optimization.
