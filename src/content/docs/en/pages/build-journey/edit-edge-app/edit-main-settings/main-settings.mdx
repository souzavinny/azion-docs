...
permalink: /documentation/build/applications/guides/configure-main-settings/
...
In this guide, you'll modify some configurations of your application. You can see if the changes ocurred by [accessing your Azion domain](/en/documentation/secure/workloads/guides/configure-a-domain/).

:::note
Don't have an application? [Start with a template](/en/documentation/get-started/start-with-a-template/).
:::
...
<Fragment slot="panel.console">
        ...
        **Delivery protocols**
        ...
        Modify your application to support the available [delivery protocols](/en/documentation/build/applications/reference/main-settings/#delivery-protocols).
...
```
        ...
        **Delivery ports**
        ...
        Choose between the supported [delivery ports](/en/documentation/build/applications/reference/main-settings/#ports) for each protocol selected.
...
```
        ...
        **Modules**
        ...
        [Modules](/en/documentation/build/applications/#modules) can unlock additional functionalities and features for your applications. See the [Pricing page](/en/documentation/platform/pricing/) for more details.

        For now, you'll enable two modules. The **Application Accelerator** and **Functions** modules will be used for when you [tune your cache settings](/en/documentation/build/applications/cache/guides/tune-cache-settings/), [instantiate a function](/en/documentation/build/functions/guides/instantiate-functions/), and [work with Rules Engine](/en/documentation/build/applications/guides/work-with-rules-engine/). 

        If you're an [Account owner](/en/documentation/account/guides/users-management/), start by enabling the following modules for your account:
...
```
        ...
        7.  Check the supported cipher suite by inspecting the page or [running the DIG command](/en/documentation/secure/edge-dns/guides/run-the-dig-command/).
