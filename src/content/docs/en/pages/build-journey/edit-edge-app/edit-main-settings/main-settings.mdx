...
In this guide, you'll modify some configurations of your application. You can see if the changes ocurred by [accessing your Azion domain](/en/documentation/build/workloads/guides/configure-a-domain/).
