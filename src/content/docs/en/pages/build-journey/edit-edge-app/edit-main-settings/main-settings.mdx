...
```
        ...
        **Modules**
        ...
        For now, you'll enable two modules. The **Application Accelerator** and **Functions** modules will be used for when you [tune your cache settings](/en/documentation/build/cache/guides/tune-cache-settings/), [instantiate a function](/en/documentation/build/functions/guides/instantiate-functions/), and [work with Rules Engine](/en/documentation/build/applications/guides/work-with-rules-engine/). 
