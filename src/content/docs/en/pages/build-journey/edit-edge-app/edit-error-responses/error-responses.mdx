...
5. In the **Connector** field, select the [Connector](/en/documentation/build/connectors/) that is fetching the data from your origin. 
...
Now let's bind the Custom Page to your [Workload](/en/documentation/build/workloads/).
