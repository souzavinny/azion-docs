...
permalink: /documentation/build/applications/guides/set-error-pages/
...
There are separate instructions for API v3 using [legacy Error Responses](/en/documentation/build/applications/reference/error-responses/) settings and API v4 using the new [Custom Pages](/en/documentation/secure/custom-pages/) product.
