...
permalink: /documentation/secure/custom-pages/guides/set-error-pages/
menu_namespace: customPagesMenu
---
...
There are separate instructions for API v3 using [legacy Error Responses](/en/documentation/secure/custom-pages/reference/error-responses/) settings and API v4 using the new [Custom Pages](/en/documentation/secure/custom-pages/) product.
...
Configure your application to handle error responses from the origin using [Custom Pages](/en/documentation/secure/custom-pages/). Azion allows you to set a cache TTL for error pages, a custom path, or deliver another HTTP code in the response without needing to change the source code of your application.

---

1. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Custom Pages**.
2. Click **+ Custom Page**.
...
5. In the **Connector** field, select the [Connector](/en/documentation/secure/connectors/) that is fetching the data from your origin. 
...
Now let's bind the Custom Page to your [Workload](/en/documentation/secure/workloads/).
