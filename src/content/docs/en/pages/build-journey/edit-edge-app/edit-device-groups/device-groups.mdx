...
If your current browser sends a `User-Agent` header similar to the example, you can test whether the request went through by [accessing your application](/en/documentation/build/workloads/guides/configure-a-domain/) from a mobile device or artificially adding the header and its value to the request using the following command:
