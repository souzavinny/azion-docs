...
permalink: /documentation/build/applications/guides/create-device-groups/
...
Group end-users based on their devices, operating systems, or browsers with information provided by the `User-Agent` HTTP request header. By using [Device Groups](/en/documentation/build/applications/reference/device-groups/) to categorize requests, you can make your application more responsive.
...
You may now deactivate the rule or [create a different rule](/en/documentation/build/applications/guides/work-with-rules-engine/) to fit the application's settings to your needs.
