...
permalink: /documentation/build/functions/guides/instantiate-functions/
...
:::caution[warning]
You must activate the [Functions](/en/documentation/build/applications/functions/) module to implement functions in your application. If **Functions** is activated, computing time and invocations could generate usage-related costs. Check the [pricing page](/en/documentation/platform/pricing/) for more information.
:::
...
:::note
The `${uri}` variable may already be selected by default if you didn't activate the [Application Accelerator](/en/documentation/build/applications/application-accelerator/) module.
:::
...
To see your function running, access your application [using its domain](/en/documentation/secure/workloads/guides/configure-a-domain/) and the URI set in the rule, which is in the format `xxxxxxxxx.map.azionedge.net/hello-world`.
</Fragment>
