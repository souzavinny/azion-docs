...
Instantiate [serverless functions](/en/documentation/build/functions/reference/functions-instances/) directly within your application.
...
:::caution[warning]
You must activate the [Functions](/en/documentation/build/functions/) module to implement functions in your application. If **Functions** is activated, computing time and invocations could generate usage-related costs. Check the [pricing page](/en/documentation/platform/pricing/) for more information.
:::
