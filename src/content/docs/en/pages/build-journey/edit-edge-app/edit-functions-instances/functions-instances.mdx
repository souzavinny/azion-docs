...
permalink: /documentation/build/applications/guides/instantiate-functions/
meta_tags: >-
...
Instantiate [serverless functions](/en/documentation/build/applications/reference/functions-instances/) directly within your application.

This guide uses the pre-configured *Azion - Hello World* function, which is linked to your account. You can repeat this process using any function already available on [Azion Marketplace](/en/documentation/marketplace/reference/marketplace/) or [develop your own function](/en/documentation/build/functions/guides/api-builder/).

:::caution[warning]
You must activate the [Functions](/en/documentation/build/applications/reference/functions/) module to implement functions in your application. If **Functions** is activated, computing time and invocations could generate usage-related costs. Check the [pricing page](/en/documentation/platform/pricing/) for more information.
:::
...
:::note
The `${uri}` variable may already be selected by default if you didn't activate the [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/) module.
:::
...
To see your function running, access your application [using its domain](/en/documentation/build/workloads/guides/configure-a-domain/) and the URI set in the rule, which is in the format `xxxxxxxxx.map.azionedge.net/hello-world`.
</Fragment>

<Fragment slot="panel.api">
1. Run the following `PATCH` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and the `<application_id>` variable with [your application ID](/en/documentation/build/applications/guides/configure-main-settings/) to activate the [Functions](/en/documentation/build/applications/reference/functions/) module:
