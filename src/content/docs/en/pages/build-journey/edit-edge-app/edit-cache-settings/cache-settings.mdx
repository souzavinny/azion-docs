...
permalink: /documentation/build/applications/cache/guides/tune-cache-settings/
...
:::caution[warning]
To enable all Application Accelerator functionalities, you must activate the [Application Accelerator](/en/documentation/build/applications/application-accelerator/) module.
:::
...
To verify how your content is being cached, you can [verify application cache indicators using Modheader for Google Chrome](/en/documentation/build/applications/cache/guides/check-page-cache-time/).
</Fragment>
