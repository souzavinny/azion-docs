...
There are separate instructions for API v3 using [legacy Origin](/en/documentation/build/applications/reference/domains/) settings and API v4 using the new [Connectors](/en/documentation/products/secure/connectors) product.
