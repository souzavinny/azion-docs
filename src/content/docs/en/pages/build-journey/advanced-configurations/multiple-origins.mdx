...
description: >-
  ...
  Robin algorithm.
permalink: /documentation/build/applications/guides/multiple-origins/
...
There are separate instructions for API v3 using [legacy Origin](/en/documentation/build/applications/reference/origins/) settings and API v4 using the new [Connectors](/en/documentation/secure/connectors/) product.
...
:::caution[warning]
In this section, you'll modify your default origin, which is of the Single Origin-type, into a Load Balancer-type origin. Editing your default origin will override the origin you configured when creating the application. To create a different origin, see [how to work with origins](/en/documentation/build/applications/guides/work-with-origins/).
:::
