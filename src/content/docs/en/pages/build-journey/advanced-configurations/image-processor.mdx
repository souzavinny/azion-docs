...
permalink: /documentation/build/image-processor/guides/process-images/
menu_namespace: imageProcessorMenu
---
...
7. In the **Cache Expiration Policies** section, configure the [expiration policy](/en/documentation/build/cache/reference/cache-settings/#browser-cache-settings) for your images.
...
:::note
For more information on the cache settings endpoint, see how to [Tune your cache settings](/en/documentation/build/cache/guides/tune-cache-settings/).
:::
...
:::note
For more information on the cache settings endpoint, see [Tune your cache settings](/en/documentation/build/cache/guides/tune-cache-settings/).
:::
