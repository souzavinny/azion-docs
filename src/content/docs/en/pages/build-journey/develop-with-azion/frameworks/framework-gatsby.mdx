...
permalink: /documentation/get-started/frameworks/gatsby/
meta_tags: >-
...
- [If you chose to have a local development server running](/en/documentation/get-started/frameworks/gatsby/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/get-started/frameworks/gatsby/#answering-no-to-local-dev).
