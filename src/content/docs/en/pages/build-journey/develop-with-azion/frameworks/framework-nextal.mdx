...
permalink: /documentation/get-started/frameworks/nextal/
meta_tags: >-
...
- A valid [Azion personal token](/en/documentation/account/reference/personal-tokens/) configured in your terminal environment.
- Code editor.
...
- [If you chose to have a local development server running](/en/documentation/get-started/frameworks/nextal/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/get-started/frameworks/nextal/#answering-no-to-local-dev).
...
For more information about Next.js compatibility on the Azion Web Platform, visit the [Next.js frameworks compatibility page](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/nextjs/).
