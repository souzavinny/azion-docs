...
permalink: /documentation/get-started/frameworks/eleventy/
meta_tags: >-
...
- [If you chose to have a local development server running](/en/documentation/get-started/frameworks/eleventy/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/get-started/frameworks/eleventy/#answering-no-to-local-dev).
