...
description: >-
  ...
  skills.
permalink: /documentation/get-started/frameworks/vite/
meta_tags: >-
...
- [If you chose to have a local development server running](/en/documentation/get-started/frameworks/vite/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/get-started/frameworks/vite/#answering-no-to-local-dev).
