...
description: >-
  ...
  Platform.
permalink: /documentation/get-started/frameworks/vue/
meta_tags: >-
...
- [If you chose to have a local development server running](/en/documentation/get-started/frameworks/vue/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/get-started/frameworks/vue/#answering-no-to-local-dev).
