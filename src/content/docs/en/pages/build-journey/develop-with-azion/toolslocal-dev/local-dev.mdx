...
permalink: /documentation/get-started/frameworks/local-dev/
meta_tags: >-
...
<LinkButton link="/en/documentation/devtools/cli/reference/dev-command/" label="Go to local dev command reference" severity="secondary" />
