...
permalink: /documentation/get-started/frameworks/wasm/
meta_tags: >-
...
Learn about the required process to create a [function](/en/documentation/get-started/frameworks/javascript/) that uses a [WebAssembly](https://webassembly.org/getting-started/developers-guide/) originated function.
