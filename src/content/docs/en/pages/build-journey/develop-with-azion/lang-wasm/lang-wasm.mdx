...
Now, the function is ready to be instantiated in an application. Check how to [instantiate and execute the functions in your application](/en/documentation/build/functions/reference/functions-instances/) and try it out.
