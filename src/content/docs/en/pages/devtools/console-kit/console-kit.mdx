...
For a faster setup, generate a [personal token](/en/documentation/account/guides/personal-tokens/) in [Azion Console](https://console.azion.com) and save it in a `.env.development` file:
...
2. Configure your [personal token](/en/documentation/account/guides/personal-tokens/) on the CLI:
