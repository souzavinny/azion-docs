...
1. Go to [**Functions**](/en/documentation/build/applications/reference/functions/) → **+ Function**.
...
Application and Firewall [Functions Instances](/en/documentation/build/applications/reference/functions-instances/) render using the configured Form Builder from the created function.

When a Form Builder is configured during function creation/editing, the visual form loads with a `Form/JSON` selector panel when loading instances in [Applications](/en/documentation/build/applications/) or Firewalls.
