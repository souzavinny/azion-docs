...
permalink: /documentation/devtools/cli/reference/reset/
---
...
- [azion unlink](/en/documentation/devtools/cli/reference/unlink-command/): detaches a local project from its linked Azion resources.
- [azion logout](/en/documentation/devtools/cli/reference/logout/): signs out and removes the personal token saved locally.
