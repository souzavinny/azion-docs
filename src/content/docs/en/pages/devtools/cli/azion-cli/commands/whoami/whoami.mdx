...
permalink: /documentation/devtools/cli/reference/whoami/
---
...
- [azion login](/en/documentation/devtools/cli/reference/login/): authenticates the CLI with your Azion account.
- [azion logout](/en/documentation/devtools/cli/reference/logout/): signs out and removes the locally stored personal token.
