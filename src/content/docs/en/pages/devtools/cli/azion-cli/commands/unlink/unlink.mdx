...
permalink: /documentation/devtools/cli/reference/unlink-command/
---
...
- [azion reset](/en/documentation/devtools/cli/reference/reset/): restores the CLI's stored settings to a clean state.
- [azion login](/en/documentation/devtools/cli/reference/login/): authenticates the CLI before you link or work with a project.
