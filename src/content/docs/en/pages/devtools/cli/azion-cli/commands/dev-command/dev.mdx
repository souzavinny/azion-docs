...
permalink: /documentation/devtools/cli/reference/dev-command/
meta_tags: >-
...
<LinkButton link="/en/documentation/devtools/cli/reference/link-command/" label="Link an Existing Project to Azion" severity="secondary" /> 
...
<LinkButton link="/en/documentation/build/functions/guides/first-steps/" label="Functions for Applications" severity="secondary" /> 

<br />

<LinkButton link="/en/documentation/secure/firewall/reference/functions/" label="Functions for Firewall" severity="secondary" /> 
