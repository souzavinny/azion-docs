...
permalink: /documentation/devtools/cli/reference/update/
---
...
The `--application-acceleration` flag specifies if the application has the [Application Acceleration](/en/documentation/build/applications/reference/application-accelerator/) module active.

##### delivery-protocol

The `--delivery-protocol` flag specifies the application's [delivery protocol](/en/documentation/build/applications/reference/main-settings/).
...
The `--edge-functions` flag specifies if the application has the [Functions](/en/documentation/build/applications/reference/functions/) module active.
...
The `--image-optimization` flag specifies if the application has the [Image Processor](/en/documentation/build/applications/reference/image-processor/) module active.
...
The `--l2-caching` flag specifies if the application has the [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/) module active.

##### load-balancer

The `--load-balancer` flag specifies if the application has the [Load Balancer](/en/documentation/build/connectors/reference/load-balancer/) module active.
