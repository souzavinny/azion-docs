...
The `--application-acceleration` flag specifies if the application has the [Application Acceleration](/en/documentation/build/applications/application-accelerator/) module active.
...
The `--edge-functions` flag specifies if the application has the [Functions](/en/documentation/build/applications/functions/) module active.
...
The `--image-optimization` flag specifies if the application has the [Image Processor](/en/documentation/build/applications/image-processor/) module active.
...
The `--l2-caching` flag specifies if the application has the [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/) module active.

##### load-balancer

The `--load-balancer` flag specifies if the application has the [Load Balancer](/en/documentation/secure/connectors/reference/load-balancer/) module active.
