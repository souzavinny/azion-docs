...
permalink: /documentation/devtools/cli/reference/logout/
---
...
- [azion login](/en/documentation/devtools/cli/reference/login/): authenticates the CLI and stores a personal token locally.
- [azion whoami](/en/documentation/devtools/cli/reference/whoami/): shows the email of the account currently signed in.
