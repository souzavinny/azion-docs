...
permalink: /documentation/devtools/cli/reference/login/
---
...
- [azion logout](/en/documentation/devtools/cli/reference/logout/): logs out and removes the personal token stored locally.
- [azion whoami](/en/documentation/devtools/cli/reference/whoami/): confirms which authenticated account the CLI is currently using.
