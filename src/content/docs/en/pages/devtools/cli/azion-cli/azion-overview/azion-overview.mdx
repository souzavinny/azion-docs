...
The Azion CLI is built in Go and interacts with Azion products through the [Azion Go SDK](/en/documentation/products/azion-lib/overview/). You can also interact with Azion using the [Terraform Provider](/en/documentation/products/terraform-provider/) or the [Azion API](https://api.azion.com/).
