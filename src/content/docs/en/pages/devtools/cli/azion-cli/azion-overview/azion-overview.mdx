...
The Azion CLI is built in Go and interacts with Azion products through the [Azion Go SDK](/en/documentation/devtools/lib/). You can also interact with Azion using the [Terraform Provider](/en/documentation/devtools/terraform/) or the [Azion API](https://api.azion.com/).
...
<LinkButton link="/en/documentation/get-started/frameworks/overview/" label="View supported frameworks" severity="secondary" target="_blank" />
<LinkButton link="/en/documentation/build/functions/runtime-apis/frameworks-compatibility/" label="Framework compatibility reference" severity="secondary" target="_blank" />
