...
permalink: /documentation/devtools/mcp/reference/how-it-works/
---
...
- [Configuration Guide](/en/documentation/devtools/mcp/reference/configuration/) - Set up your environment
- [Practical Examples](/en/documentation/devtools/mcp/reference/examples/) - Real-world use cases
