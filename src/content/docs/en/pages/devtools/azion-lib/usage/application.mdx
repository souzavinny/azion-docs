...
permalink: /documentation/devtools/lib/reference/application/
meta_tags: >-
...
<LinkButton link="/en/documentation/devtools/lib/" label="Go to Azion Libraries Overview" severity="secondary" target="_blank" />
