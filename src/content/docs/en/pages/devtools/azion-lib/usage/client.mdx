...
permalink: /documentation/devtools/lib/reference/client/
meta_tags: >-
...
For more details on KV operations, see the [KV library documentation](/en/documentation/devtools/lib/reference/kv/).
