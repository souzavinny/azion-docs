...
:::warning
**API Version Notice:** Terraform Provider v2.0 requires API v4. This version is compatible only with Azion API v4. If you're using API v3, see the [Terraform Provider v1.x documentation](/en/documentation/devtools/terraform/v1/).
:::
...
If you're upgrading from Terraform Provider v1.x (API v3), see the [Terraform Provider Migration Guide](/en/documentation/devtools/terraform/reference/terraform-migration-v3-to-v4/) for detailed instructions on migrating your configurations to v2.0.
