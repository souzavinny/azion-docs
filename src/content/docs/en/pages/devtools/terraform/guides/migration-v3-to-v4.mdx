...
permalink: /documentation/devtools/terraform/reference/terraform-migration-v3-to-v4/
---
...
- **Personal Token**: A valid [personal token](/en/documentation/account/reference/personal-tokens/) with appropriate permissions
...
- [Terraform Provider v1.x Documentation](/en/documentation/devtools/terraform/v1/) (Deprecated)
