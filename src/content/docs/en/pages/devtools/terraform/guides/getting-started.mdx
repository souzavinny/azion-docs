...
permalink: /documentation/devtools/terraform/reference/getting-started/
---
...
- A [Personal Token](/en/documentation/account/reference/personal-tokens/) with appropriate permissions
...
- [Workloads](/en/documentation/devtools/terraform/reference/workloads/) - Learn about workloads
- [Applications](/en/documentation/devtools/terraform/reference/applications/) - Configure applications
- [Security](/en/documentation/devtools/terraform/reference/security/) - Configure firewall and WAF
...
**Solution**: Verify that the resource exists in API v4. Some v3 resources were removed or renamed. See the [Migration Guide](/en/documentation/devtools/terraform/reference/terraform-migration-v3-to-v4/).
