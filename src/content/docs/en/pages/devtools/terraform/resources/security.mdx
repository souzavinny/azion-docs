...
permalink: /documentation/devtools/terraform/reference/security/
---
...
- [Applications](/en/documentation/devtools/terraform/reference/applications/) - Manage applications
- [DNS](/en/documentation/devtools/terraform/reference/dns/) - Manage DNS
