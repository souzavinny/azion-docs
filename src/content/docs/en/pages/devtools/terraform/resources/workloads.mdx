...
permalink: /documentation/devtools/terraform/reference/workloads/
---
...
See the [Migration Guide](/en/documentation/devtools/terraform/reference/terraform-migration-v3-to-v4/) for more details.

---

## Next Steps

- [Connectors](/en/documentation/devtools/terraform/reference/connectors/) - Manage origin connectors
