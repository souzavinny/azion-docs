...
permalink: /documentation/devtools/terraform/v1/
---
...
See the [Migration Guide](/en/documentation/devtools/terraform/reference/terraform-migration-v3-to-v4/) for upgrading from v1.x to v2.0.
:::
...
With the provider configured, it's recommended to configure a [personal token](/en/documentation/account/reference/personal-tokens/):
...
To migrate your Terraform configurations to v2.0 (API v4), see the [Terraform Provider Migration Guide](/en/documentation/devtools/terraform/reference/terraform-migration-v3-to-v4/).
