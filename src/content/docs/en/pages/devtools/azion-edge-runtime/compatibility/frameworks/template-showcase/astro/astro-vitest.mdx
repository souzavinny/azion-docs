...
permalink: /documentation/marketplace/templates/astro-vitest/
...
This template is built with [Astro](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/astro/) and wires up Vitest, a fast unit test runner powered by Vite. It includes a working test setup so you can validate components and logic from day one and keep your project reliable as it grows. Deployed on Azion, it's served via a distributed architecture for fast, globally distributed delivery.
