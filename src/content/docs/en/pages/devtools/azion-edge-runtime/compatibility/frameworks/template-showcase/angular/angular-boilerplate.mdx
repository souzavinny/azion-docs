...
permalink: /documentation/marketplace/templates/angular-boilerplate/
meta_tags: >-
...
>
  <Fragment slot="content">
    <div style="flex: 1; min-width: 300px;">
      ...
      | Framework | [Angular](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/angular/) |
      | Use Case | General |
    </div>
...
This template is a minimal starter for applications built with [Angular](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/angular/), a TypeScript-based framework for building structured, dynamic web interfaces. It comes with a clean baseline project and deployment steps already configured, so you can start developing right away. Once deployed on Azion, the app is delivered via a distributed architecture for low-latency access worldwide.
...
For more information about deploying this template visit the [template guide](/en/documentation/marketplace/integrations/angular-boilerplate/).