...
permalink: /documentation/build/functions/runtime-apis/frameworks-compatibility/react/
meta_tags: >-
...
|:-------------|:---------|:-----|
| ButterCMS + React Starter Project | Starter | <LinkButton link="/en/documentation/marketplace/templates/react-buttercms/" label="Learn more" severity="secondary" /> |
| React Boilerplate | Starter project | <LinkButton link="/en/documentation/marketplace/templates/react-boilerplate/" label="Learn more" severity="secondary" /> |
...
| Cosmic Agency | Starter | <LinkButton link="/en/documentation/marketplace/templates/cosmic-agency/" label="Learn more" severity="secondary" /> |
| Astro With Multiple Frameworks | Starter | <LinkButton link="/en/documentation/marketplace/templates/astro-multiple-frameworks/" label="Learn more" severity="secondary" /> |
...
- [If you chose to have a local development server running](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/react/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/react/#answering-no-to-local-dev).
