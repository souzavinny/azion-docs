...
permalink: /documentation/build/functions/runtime-apis/frameworks-compatibility/gatsby/
meta_tags: >-
...
|:-------------|:---------|:-----|
| ButterCMS + Gatsby Starter Project | E-commerce | <LinkButton link="/en/documentation/marketplace/templates/gatsby-butter-starter/" label="Learn more" severity="secondary" /> |
| Gatsby Blog Starter Kit| Starter project | <LinkButton link="/en/documentation/marketplace/templates/gatsby-blog/" label="Learn more" severity="secondary" /> |
| Gatsby Ecommerce Theme | Blog creation | <LinkButton link="/en/documentation/marketplace/templates/gatsby-ecommerce/" label="Learn more" severity="secondary" /> |
| Gatsby Boilerplate| E-commerce platform | <LinkButton link="/en/documentation/marketplace/templates/gatsby-boilerplate/" label="Learn more" severity="secondary" /> |
...
- [If you chose to have a local development server running](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/gatsby/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/gatsby/#answering-no-to-local-dev).
