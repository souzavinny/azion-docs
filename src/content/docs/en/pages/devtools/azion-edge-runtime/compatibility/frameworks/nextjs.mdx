...
permalink: /documentation/build/functions/runtime-apis/frameworks-compatibility/nextjs/
meta_tags: >-
...
Next.js also allows for Server Side Rendering (SSR) on the Azion Web Platform. For more information about Next.js compatibility [visit our documentation](/en/documentation/build/functions/runtime-apis/compatibility/nextjs/).

## Available Templates

| Template name | Use case | Details |
|:-------------|:---------|:-----|
| Next.js Static Boilerplate | Static/SPA | <LinkButton link="/en/documentation/marketplace/templates/nextjs-static-boilerplate/" label="Learn more" severity="secondary" /> |
| Cosmic Next Blog | Blog | <LinkButton link="/en/documentation/marketplace/templates/cosmic-nextjs-blog/" label="Learn more" severity="secondary" /> |
| Cosmic Agency | Agency/Starter | <LinkButton link="/en/documentation/marketplace/templates/cosmic-agency/" label="Learn more" severity="secondary" /> |
| Space Jelly Shop | E-commerce | <LinkButton link="/en/documentation/marketplace/templates/space-jelly-shop/" label="Learn more" severity="secondary" /> |
| Nextal | Starter | <LinkButton link="/en/documentation/marketplace/templates/nextal/" label="Learn more" severity="secondary" /> |
...
- [If you chose to have a local development server running](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/nextjs/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/nextjs/#answering-no-to-local-dev).
...
You can use the Azion CLI to deploy a project compatible with our [available frameworks](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/).
