...
permalink: /documentation/marketplace/templates/gatsby-ecommerce/
meta_tags: >-
...
>
  <Fragment slot="content">
    <div style="flex: 1; min-width: 300px;">
      ...
      | Framework | [Gatsby](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/gatsby/) |
      | Use Case | E-commerce |
    </div>
...
This template is an online store theme built with [Gatsby](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/gatsby/), a React-based static site generator. It ships with styled product and category components plus the structure needed to wire in a commerce backend, so you can shape a storefront quickly. Deployed on Azion, the catalog pages are served via a distributed architecture for fast, globally distributed shopping experiences.
...
For more information about deploying this template visit the [template guide](/en/documentation/marketplace/integrations/gatsby-ecommerce-theme/).