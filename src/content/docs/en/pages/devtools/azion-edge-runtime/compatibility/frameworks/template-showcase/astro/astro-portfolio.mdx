...
permalink: /documentation/marketplace/templates/astro-portfolio/
...
This template is built with [Astro](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/astro/) and provides a polished personal portfolio with sections for projects, skills, and contact details. The responsive layout is designed to put your work front and center, and the content is easy to swap for your own. Deployed on Azion, it's served via a distributed architecture for fast, globally distributed delivery.
