...
permalink: /documentation/marketplace/templates/astro-boilerplate/
meta_tags: >-
...
For more information about deploying this template visit the [template guide](/en/documentation/marketplace/integrations/astro-boilerplate/).
