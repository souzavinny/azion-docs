...
permalink: /documentation/marketplace/templates/astro-mdx/
...
This template is built with [Astro](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/astro/) and the @astrojs/mdx integration, which lets you author content in MDX. MDX blends Markdown with JSX, so you can drop interactive components straight into your prose while keeping the simplicity of Markdown for everyday writing. Running on Azion, the compiled pages are delivered via a distributed architecture for fast, globally distributed access.
