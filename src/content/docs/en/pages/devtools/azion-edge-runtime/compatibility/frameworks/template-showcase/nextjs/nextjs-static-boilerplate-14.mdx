...
permalink: /documentation/marketplace/templates/nextjs-static-boilerplate/
meta_tags: >-
...
>
  <Fragment slot="content">
    <div style="flex: 1; min-width: 300px;">
      ...
      | Framework | [Next.js](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/nextjs/) |
      | Use Case | General |
    </div>
...
This boilerplate is a clean starting point built on [Next.js](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/nextjs/) 14, the popular React framework for production-grade web apps, set up to produce a fully static build. Instead of wiring up the export configuration yourself, you get a project that compiles to static HTML, CSS, and JavaScript ready to ship. Deployed on Azion, those assets are distributed across the global network for fast, reliable loads anywhere.
...
For more information about deploying this template visit the [template guide](/en/documentation/marketplace/integrations/nextjs-static-boilerplate/).