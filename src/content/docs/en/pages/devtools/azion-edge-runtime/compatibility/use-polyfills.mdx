...
:::note
For more information about configuring your project, check the [azion.config.js file reference](/en/documentation/devtools/cli/reference/azion-config-js/).
:::
...
:::tip
You can access a list of APIs resolved through polyfills by Azion Bundler build on [its repository](https://github.com/aziontech/bundler) and on [Azion's compatibility documentation](/en/documentation/build/functions/runtime-apis/compatibility/node/). Azion Bundler's an **open-source** project and you can propose new presets and implementations.
:::
