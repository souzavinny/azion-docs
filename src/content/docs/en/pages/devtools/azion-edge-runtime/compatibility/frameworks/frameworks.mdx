...
permalink: /documentation/build/functions/runtime-apis/frameworks-compatibility/
meta_tags: >-
...
- [Azion Console](/en/documentation/get-started/start-with-a-template/)
...
Implementation:
- [Azion CLI how to build with Angular](/en/documentation/get-started/frameworks/angular/)
- [Angular Boilerplate on Azion Console](/en/documentation/marketplace/integrations/angular-boilerplate/)
...
Implementation:
- [Azion CLI how to build with Astro](/en/documentation/get-started/frameworks/astro/)
- [Astro Boilerplate on Azion Console](/en/documentation/marketplace/integrations/astro-boilerplate/)
...
Implementation:
- [Docusaurus with JavaScript Boilerplate on Azion Console](/en/documentation/marketplace/integrations/docusaurus-javascript-boilerplate/)
- [Docusaurus with TypeScript Boilerplate on Azion Console](/en/documentation/marketplace/integrations/docusaurus-typescript-boilerplate/)
...
Implementation:
- [Gatsby Boilerplate on Azion Console](/en/documentation/marketplace/integrations/gatsby-boilerplate/)
...
- [Hexo Boilerplate on Azion Console](/en/documentation/marketplace/integrations/hexo-boilerplate/)
...
Implementation:
- [Hugo Boilerplate on Azion Console](/en/documentation/marketplace/integrations/hugo-boilerplate/)
...
Implementation:
- [Jekyll Boilerplate on Azion Console](/en/documentation/marketplace/integrations/jekyll-boilerplate/)
...
Implementation:
- [How to build with Next.js on Azion CLI](/en/documentation/get-started/frameworks/next/)
- [Next.js Static Boilerplate on Azion Console](/en/documentation/marketplace/integrations/nextjs-static-boilerplate/)
<Tag severity="info" client:only="vue" value="Compute" />
<br />
<br />
<LinkButton link="/en/documentation/build/functions/runtime-apis/compatibility/nextjs/" label="Go to Azion and Next.js compatibility docs" severity="secondary"  target="_blank" />
---
...
- [Nuxt Static Boilerplate on Azion Console](/en/documentation/marketplace/integrations/nuxt-static-boilerplate/)
- [Nuxt Notes template on Azion Console](/en/documentation/marketplace/integrations/nuxt-notes/)
- [Nuxt Content template on Azion Console](/en/documentation/marketplace/integrations/nuxt-content/)
...
- [Qwik Minimal template](/en/documentation/marketplace/integrations/qwik-minimal/)
- [Qwik Boilerplate](/en/documentation/marketplace/integrations/qwik-boilerplate/)
...
Implementation:
- [How to build with React on Azion CLI](/en/documentation/get-started/frameworks/react/)
...
- [How to build with VitePress using Azion CLI](/en/documentation/get-started/frameworks/vite/)
- [VitePress with JavaScript Boilerplate on Azion Console](/en/documentation/marketplace/integrations/vitepress-javascript-boilerplate/)
- [VitePress with TypeScript Boilerplate on Azion Console](/en/documentation/marketplace/integrations/vitepress-typescript-boilerplate/)
...
Implementation:
- [How to build with Vue and Azion CLI](/en/documentation/get-started/frameworks/vue/)
- [Vue Boilerplate on Azion Console](/en/documentation/marketplace/integrations/vue-boilerplate/)
