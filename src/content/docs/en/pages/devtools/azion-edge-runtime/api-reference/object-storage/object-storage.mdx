...
permalink: /documentation/build/functions/runtime-apis/storage/
menu_namespace: runtimeMenu
---

The [Functions](/en/documentation/build/applications/reference/functions/) Storage API is an interface that allows access to the Object Storage. Through this interface, it's possible to read and write data in the storage and its buckets.
