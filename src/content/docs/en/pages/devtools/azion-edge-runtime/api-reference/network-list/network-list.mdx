...
permalink: /documentation/build/functions/runtime-apis/functions/runtime/api-reference/network-list/
...
Find out more about [Network Lists on the Azion Platform](/en/documentation/secure/firewall/reference/network-shield/network-lists/).
