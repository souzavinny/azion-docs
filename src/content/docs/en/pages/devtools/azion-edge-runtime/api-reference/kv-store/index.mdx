...
permalink: /documentation/build/functions/runtime-apis/kv-store/
...
|--------|-------------|-----------|
| `put(key, value, options?)` | Store a key-value pair | [Write key-value pairs](/en/documentation/build/functions/runtime-apis/kv-store/write/) |
| `get(key, type?, options?)` | Retrieve a value by key | [Read key-value pairs](/en/documentation/build/functions/runtime-apis/kv-store/read/) |
| `getWithMetadata(key, type?, options?)` | Retrieve a value with its metadata | [Read key-value pairs](/en/documentation/build/functions/runtime-apis/kv-store/read/) |
| `delete(key)` | Delete a key-value pair | [Delete key-value pairs](/en/documentation/build/functions/runtime-apis/kv-store/delete/) |
...
- [How to manage KV Store with Functions](/en/documentation/store/kv-store/guides/manage-with-functions/)
