...
permalink: /documentation/build/functions/runtime-apis/functions/runtime/api-reference/environment-variables/
...
Find out more about [Environment variables](/en/documentation/build/functions/runtime-apis/functions/environment-variables/).
