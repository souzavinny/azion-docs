...
permalink: /documentation/build/functions/runtime-apis/compatibility/nextjs/
meta_tags: >-
...
[Follow the guide here](/en/documentation/build/functions/guides/get-started/) to use [@aziontech/opennextjs-azion](https://www.npmjs.com/package/@aziontech/opennextjs-azion) with an existing Next.js app.
...
For more details, see the [documentation on Function size limits](/en/documentation/build/applications/reference/functions/#limits).
:::
