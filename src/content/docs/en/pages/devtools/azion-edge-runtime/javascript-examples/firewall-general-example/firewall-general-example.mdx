...
permalink: /documentation/build/functions/runtime-apis/functions/javascript-examples/general-firewall-example/
meta_tags: >-
...
- [JavaScript examples](/en/documentation/build/functions/runtime-apis/javascript-examples/)
- [Runtime APIs](/en/documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch-event/)
