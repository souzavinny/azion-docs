...
The **Azion Runtime** is a set of tools for developing applications at the **Edge**. The Azion Runtime allows you to write JavaScript [functions](/en/documentation/build/applications/functions/) built on Web standards.
