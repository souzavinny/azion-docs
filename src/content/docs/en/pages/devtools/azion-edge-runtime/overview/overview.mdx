...
permalink: /documentation/build/functions/runtime-apis/overview/
...
The **Azion Runtime** is a set of tools for developing applications at the **Edge**. The Azion Runtime allows you to write JavaScript [functions](/en/documentation/build/applications/reference/functions/) built on Web standards.
...
<LinkButton link="/en/documentation/build/functions/runtime-apis/javascript/" label="See all Web APIs supported" severity="secondary" target="_blank" />
