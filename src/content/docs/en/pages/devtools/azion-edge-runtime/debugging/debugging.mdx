...
description: >-
  ...
  platform.
permalink: /documentation/build/functions/runtime-apis/debugging/
meta_tags: >-
...
To debug codes, you must create a new [function](/en/documentation/build/applications/reference/functions/) that will use the **log** method. This method prints to the console a message previously sent by a parameter to the function.
...
2. Click on the application where you want to add the function or [create a new one](/en/documentation/build/applications/quickstart/).
...
Now your function is instantiated and ready to be used in your application. You can configure the execution conditions and behaviors using the [Rules Engine](/en/documentation/build/applications/reference/rules-engine/):
