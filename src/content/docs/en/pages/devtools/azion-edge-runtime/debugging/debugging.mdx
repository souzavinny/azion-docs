...
To debug codes, you must create a new [function](/en/documentation/build/applications/functions/) that will use the **log** method. This method prints to the console a message previously sent by a parameter to the function.
