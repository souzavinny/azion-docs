...
permalink: /documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/add-eventlistener/
menu_namespace: runtimeMenu
---

## How it works

The *addEventListener* function defines the trigger for the execution of JavaScript code to receive the request data. The event listener type is `fetch` and gets the [fetchEvent](/en/documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch-event/)
...
- [Runtime APIs](/en/documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch/)
