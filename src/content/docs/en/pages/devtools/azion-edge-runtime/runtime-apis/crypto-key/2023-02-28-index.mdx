...
permalink: /documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/crypto-key/
menu_namespace: runtimeMenu
---

## How it works

The `CryptoKey` interface represents a cryptographic key obtained from one of the [SubtleCrypto methods](/en/documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/subtle-crypto/).
