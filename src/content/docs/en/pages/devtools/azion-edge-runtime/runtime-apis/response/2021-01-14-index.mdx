...
permalink: /documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/response/
menu_namespace: runtimeMenu
---

The `Response` interface represents an HTTP response and integrates the [Fetch API](/en/documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch/).
