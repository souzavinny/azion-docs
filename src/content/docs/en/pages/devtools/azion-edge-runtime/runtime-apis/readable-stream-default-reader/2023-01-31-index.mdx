...
permalink: /documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/readable-default-reader/
...
Unlike a [ReadableStreamBYOBReader](/en/documentation/build/functions/runtime-apis/functions/runtime-apis/javascript/readable-default-reader/), which only works with streams that have a byte source, the ReadableStreamDefaultReader can be used to read from any type of ReadableStream source.
