...
description: >-
  ...
  techniques.
permalink: /documentation/devtools/graphql/reference/queries/
meta_tags: >-
...
For each type of data, you'll query with different [GraphQL datasets](/en/documentation/devtools/graphql/reference/features/#datasets).

:::tip
See all [GraphQL API limits](/en/documentation/devtools/graphql/reference/limits/) to make sure your query is valid.
:::
...
Find out more on [How to select Top X queries with GraphQL API](/en/documentation/devtools/graphql/guides/graphql-top-x-query/).
:::
...
Find more information and examples in the [How to query aggregated data with GraphQL API](/en/documentation/devtools/graphql/guides/graphql-aggregated-data/) guide.
...
Depending on the [type of field of a dataset](/en/documentation/devtools/graphql/reference/features/#datasets) you're querying for, you'll get to use different operators:
