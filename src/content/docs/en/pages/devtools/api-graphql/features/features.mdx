...
permalink: /documentation/devtools/graphql/reference/features/
meta_tags: >-
...
| edgeFunctionsMetrics | Events executed by [Functions](/en/documentation/build/applications/reference/functions/) |
| httpMetrics | Request events registered by [Applications](/en/documentation/build/applications/) and [Firewall](/en/documentation/secure/firewall/) |
| httpBreakdownMetrics | Query real-time, detailed, aggregated data on [HTTP request events blocked](/en/documentation/devtools/graphql/guides/query-httpbreakdownmetrics-data-with-graphql/) |
| edgeDnsQueriesMetrics | Query events performed on [Edge DNS](/en/documentation/secure/edge-dns/) |
| imagesProcessedMetrics | Image processing events by [Image Processor](/en/documentation/build/applications/reference/image-processor/) |
| tieredCacheMetrics | Request events registered by [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/) |
| connectedUsersMetrics | Query the number of users connected to your applications, using [Live Ingest](/en/documentation/devtools/graphql/guides/query-connected-users-data-with-graphql/) |
| botManagerMetrics | Query the number of requests evaluated and the actions performed by [Azion Bot Manager](/en/documentation/devtools/graphql/guides/query-bot-manager-data-with-graphql/) (if subscribed) |
| botManagerBreakdownMetrics | Query the URLs most impacted by bad bots, according to [Azion Bot Manager](/en/documentation/devtools/graphql/guides/query-bot-manager-breakdown-data-with-graphql/) data (if subscribed) |

<LinkButton link="/en/documentation/devtools/graphql/reference/gql-real-time-metrics-fields/" label="Go to Real-Time Metrics GraphQL API fields descriptions" severity="secondary" />

### Real-Time Events GraphQL API

| Dataset | Description |
| ------- | ----------- |
| activityHistoryEvents | Events logs from an account on Azion Console regarding activities registered on [Activity History](/en/documentation/account/reference/activity-history/). It stores data for *2 years* and exhibits data starting from *September 22nd, 2023*. |
| functionConsoleEvents |  Events logs from applications using [Azion Runtime](/en/documentation/build/functions/runtime-apis/overview/) returned by the Cells Console. |
| dataStreamedEvents | Sent events of data by [Data Stream](/en/documentation/observe/data-stream/) to the clients' endpoint. |
| functionEvents | Events executed by [Functions](/en/documentation/build/applications/reference/functions/). |
| workloadEvents | Request events registered by [Applications](/en/documentation/build/applications/) and [Firewall](/en/documentation/secure/firewall/). |
| edgeDnsQueriesEvents | Query events performed on [Edge DNS](/en/documentation/secure/edge-dns/). |
| imagesProcessedEvents |  Image processing events by [Image Processor](/en/documentation/build/applications/reference/image-processor/). |
| tieredCacheEvents | Request events registered by [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/). |
...
<LinkButton link="/en/documentation/devtools/graphql/reference/gql-real-time-events-fields/" label="Go to Real-Time Events GraphQL API fields descriptions" severity="secondary" />
...
<LinkButton link="/en/documentation/devtools/graphql/reference/gql-billing-fields/" label="Go to Billing GraphQL API fields descriptions" severity="secondary" />
...
<LinkButton link="/en/documentation/devtools/graphql/reference/gql-accounting-fields/" label="Go to Accounting GraphQL API fields descriptions" severity="secondary" />
...
<LinkButton link="/en/documentation/devtools/graphql/reference/gql-consumption-fields/" label="Go to Consumption GraphQL API fields descriptions" severity="secondary" />

---

:::tip
You can also run an **Introspection Query** to consult metadata on the Metrics and Events datasets. Metadata provide what each dataset of the GraphQL APIs supports and specific information: name, description, and format. Find out more on the [How to query metadata with GraphQL API](/en/documentation/devtools/graphql/guides/graphql-metadata/) guide.
:::

You can request both the *raw* model, using the **Events** datasets, and the *aggregated* model, using the **Metrics** datasets.

<LinkButton link="/en/documentation/devtools/graphql/reference/queries/#raw-data" label="go to raw queries reference" severity="secondary" /> <br></br>

<LinkButton link="/en/documentation/devtools/graphql/reference/queries/#aggregated-data" label="go to aggregated queries reference" severity="secondary" /> <br></br>

<LinkButton link="/en/documentation/devtools/graphql/guides/graphql-aggregated-data/" label="go to How to query aggregated data guide" severity="secondary" />
