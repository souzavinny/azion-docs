...
| edgeFunctionsMetrics | Events executed by [Functions](/en/documentation/build/applications/functions/) |
...
| imagesProcessedMetrics | Image processing events by [Image Processor](/en/documentation/build/applications/image-processor/) |
| tieredCacheMetrics | Request events registered by [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/) |
...
| functionEvents | Events executed by [Functions](/en/documentation/build/applications/functions/). |
...
| imagesProcessedEvents |  Image processing events by [Image Processor](/en/documentation/build/applications/image-processor/). |
| tieredCacheEvents | Request events registered by [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/). |
