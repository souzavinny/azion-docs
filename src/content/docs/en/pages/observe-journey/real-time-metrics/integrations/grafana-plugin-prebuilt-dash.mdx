...
permalink: /documentation/observe/real-time-metrics/guides/azion-plugin-grafana-pre-built-dash/
...
<LinkButton link="/en/documentation/observe/real-time-metrics/guides/integrate-grafana/" label="go to integrate with grafana guide" severity="secondary" target="_blank" />
...
2. On **Personal Token**, add the token you've created on the [Personal Tokens page on Azion Console](/en/documentation/account/reference/personal-tokens/).
