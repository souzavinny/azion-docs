...
permalink: /documentation/observe/data-stream/guides/analyze-metrics/
menu_namespace: dataStreamMenu
---

import LinkButton from 'azion-webkit/linkbutton'

Your analysis using **Real-Time Metrics** depends on the [product you choose](/en/documentation/observe/real-time-metrics/#product-choice-to-view-metrics) to use and its available fields. Each product has specific fields that generate the charts providing information on access, behavior, and performance of your applications and related products.
...
<LinkButton link="/en/documentation/observe/data-stream/guides/add-filters-metrics/" label="go to add filters guide" severity="secondary" target="_blank" />
