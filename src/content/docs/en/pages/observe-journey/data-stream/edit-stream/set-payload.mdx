...
permalink: /documentation/observe/data-stream/guides/data-stream-set-payload/
...
While configuring a stream with a [Standard HTTP/HTTPS POST](/en/documentation/observe/data-stream/guides/connector-standard-https-post/) connector, you can set a payload to customize the data and how it'll be streamed.
...
2. Follow the steps described on the [How to use Standard HTTP/HTTPS POST to receive data](/en/documentation/observe/data-stream/guides/connector-standard-https-post/) guide for the **Destination** section.
