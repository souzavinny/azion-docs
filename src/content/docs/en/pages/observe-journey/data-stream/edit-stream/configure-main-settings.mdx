...
permalink: /documentation/observe/data-stream/guides/use-data-stream/
...
By accessing Data Stream through [Azion Console](https://console.azion.com/data-stream) or [Azion API](https://api.azion.com/#04257075-3691-4b5f-b22b-22a5b6653f3f), you can perform a variety of actions to manage your data flows, including [create a new data streams](/en/documentation/observe/data-stream/guides/use-data-stream/), connect them to [endpoints](/en/documentation/guides/#observe), [edit data streams settings](/en/documentation/observe/data-stream/guides/use-data-stream/), [view detailed information](/en/documentation/observe/data-stream/guides/data-stream-understand-metrics/) about each stream and [delete or stop data streams](/en/documentation/observe/data-stream/guides/delete-data-stream/) that are no longer needed.
...
1. [Access Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Data Stream**.
...
4. On the **Source** dropdown menu, select the one you want to use: **Activity History**, **Applications**, **Functions**, or **WAF Events**.
    - For **Functions** and **WAF Events**, you must be [subscribed to the products](/en/documentation/observe/data-stream/quickstart/).
5. On the **Template** dropdown menu, select the one you want to use.
    - You can modify the presented JSON in the **Data Set** code box, adding the variables you want to use in your logs' analysis. See more on [How to create a custom template on Data Stream](/en/documentation/observe/data-stream/guides/data-stream-custom-template/).
6. On **Workloads** > **Options**, select between ****All Curent and Future Domains** or **Filter Domains**.
    - See more about each option on [How to associate domains on Data Stream](/en/documentation/observe/data-stream/guides/data-stream-associate-domains/).
...
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) to retrieve your `<data_streaming_id>`:
