...
permalink: /documentation/observe/data-stream/guides/endpoint-amazon-s3/
...
You can find detailed steps for the entire configuration on the [How to use Data Stream guide](/en/documentation/observe/data-stream/guides/use-data-stream/).
