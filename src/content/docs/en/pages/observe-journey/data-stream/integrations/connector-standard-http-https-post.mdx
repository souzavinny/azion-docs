...
permalink: /documentation/observe/data-stream/guides/connector-standard-https-post/
...
You can find detailed steps for the entire configuration on the [How to configure Data Stream main settings](/en/documentation/observe/data-stream/guides/use-data-stream/) guide.
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) to create your data stream.
...
:::tip
With this type of connector, you can also [set up a payload](/en/documentation/observe/data-stream/guides/data-stream-set-payload/).
:::
