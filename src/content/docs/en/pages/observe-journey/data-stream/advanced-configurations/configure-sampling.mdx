...
permalink: /documentation/observe/data-stream/guides/configure-sampling/
...
When you [configure a stream](/en/documentation/observe/data-stream/guides/use-data-stream/) and choose to associate all of your domains, you can configure the **Sampling** option to filter the percentage of data you'll be streaming. It's a viable option to reduce the costs of data collection and analysis.
...
2. To configure the stream, follow the steps in [How to configure Data Stream main settings](/en/documentation/observe/data-stream/guides/use-data-stream/).
