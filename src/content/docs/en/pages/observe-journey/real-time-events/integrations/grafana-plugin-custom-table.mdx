...
permalink: /documentation/observe/real-time-metrics/guides/azion-plugin-grafana-customize-log-table/
...
5. On the code box, add the query you want to use.
    - See the [GraphQL API guides](/en/documentation/devtools/graphql/reference/overview/) for a few examples of queries.
