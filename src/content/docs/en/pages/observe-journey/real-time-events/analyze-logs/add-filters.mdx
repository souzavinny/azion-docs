...
permalink: /documentation/observe/data-stream/guides/add-filters-events/
...
Once you [understand Real-Time Events logs](/en/documentation/observe/data-stream/guides/understand-logs/) and decide the variables you want to query, you can use the filter and query for more accurate results.
