...
permalink: /documentation/observe/data-stream/guides/understand-logs/
...
<LinkButton link="/en/documentation/observe/data-stream/guides/add-filters-events/" label="go to add filters guide" severity="secondary" target="_blank" />
