...
<div class="grid gap-3 my-6 grid-cols-[repeat(auto-fill,minmax(280px,1fr))]">
    <DocsCard link="/en/documentation/store/object-storage/" title="Object Storage" icon="ai ai-edge-storage" description="Store and access files with scalable, S3-compatible object storage." />
    <DocsCard link="/en/documentation/store/sql-database/" title="SQL Database" icon="ai ai-edge-sql" description="Run SQL queries on an edge-native relational database." />
    <DocsCard link="/en/documentation/store/kv-store/" title="KV Store" icon="ai ai-edge-kv" description="Manage key-value data for your applications and functions." />
</div>
