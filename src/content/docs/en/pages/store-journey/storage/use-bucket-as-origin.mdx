...
There are separate instructions for API v3 using [legacy Origin](/en/documentation/build/applications/reference/domains/) settings and API v4 using the new [Connector](/en/documentation/build/connectors/) product.
