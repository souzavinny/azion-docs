...
There are separate instructions for API v3 using [legacy Origin](/en/documentation/secure/workloads/reference/domains/) settings and API v4 using the new [Connector](/en/documentation/secure/connectors/) product.
...
:::tip
After creating your application with an Object Storage bucket as the origin, you can manage and configure settings, such as [cache settings](/en/documentation/build/cache/guides/cache-settings/).
:::
