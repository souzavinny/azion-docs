...
This guide walks you through uploading an object to an Object Storage bucket using the [Azion Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/runtime/api-reference/storage/).
