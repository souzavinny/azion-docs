...
permalink: /documentation/store/object-storage/guides/upload-object/
menu_namespace: storeMenu
---

This guide walks you through uploading an object to an Object Storage bucket using the [Azion Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/build/functions/runtime-apis/storage/).
