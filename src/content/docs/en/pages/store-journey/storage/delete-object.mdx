...
This guide walks you through deleting an Object Storage bucket's object using the [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/runtime/api-reference/storage/).
