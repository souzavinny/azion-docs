...
permalink: /documentation/store/object-storage/guides/list-objects/
menu_namespace: storeMenu
---

This guide walks you through listing the objects in an Object Storage bucket using the [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/build/functions/runtime-apis/storage/).
...
To list the objects in a bucket, run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and `<bucket_name>` with the name of your bucket:
...
<LinkButton link="/en/documentation/build/applications/guides/instantiate-functions/" label="Go to how to instantiate a function" severity="secondary" target="_blank" />
