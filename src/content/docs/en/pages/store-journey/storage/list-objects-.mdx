...
This guide walks you through listing the objects in an Object Storage bucket using the [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/runtime/api-reference/storage/).
...
<LinkButton link="/en/documentation/build/functions/guides/instantiate-functions/" label="Go to how to instantiate a function" severity="secondary" target="_blank" />
