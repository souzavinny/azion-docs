...
description: >-
  ...
  CLI.
permalink: /documentation/store/object-storage/guides/delete-buckets/
meta_tags: >-
...
Run the following `DELETE` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and `bucket_name` with the name of the bucket you want to delete:
