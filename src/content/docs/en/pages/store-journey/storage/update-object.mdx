...
This guide walks you through updating an object from an Object Storage bucket using the [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/runtime/api-reference/storage/).
...
<LinkButton link="/en/documentation/build/functions/guides/instantiate-functions/" label="Go to how to instantiate an function" severity="secondary" target="_blank" />
