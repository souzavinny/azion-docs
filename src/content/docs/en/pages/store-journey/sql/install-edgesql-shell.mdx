...
permalink: /documentation/store/sql-database/guides/install-edge-sql-shell/
...
You'll also need an Azion [personal token](/en/documentation/account/guides/personal-tokens/).
