...
The sentence rules serve the pair. Short sentences with simple tenses translate without restructuring, and a sentence that needs no restructuring is a sentence where meaning does not get lost. The vocabulary side is a substitution table: which terms stay in English, and which Portuguese words are avoided.

## Related resources

- [Bilingual pages](/en/documentation/style-guide/conventions/bilingual/) - the full contract for a translation pair.
- [Documentation terminology](/en/documentation/style-guide/writing/terminology/) - the terms that stay in English and the substitution table.
