...
Documentation pages are MDX, and this page is the whole component vocabulary. A component absent from this page is not available: an invented import fails the build, and the legacy components that do resolve are banned below, with the reasons.
