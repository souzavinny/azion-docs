...
description: >-
  Write a product glossary: a filterable table of terms and definitions,
  alphabetical, with each definition linking its canonical page.
...
It is not a naming-rules page. Which names are current and which are banned belongs to [Documentation terminology](/en/documentation/style-guide/writing/terminology/); the glossary defines what terms mean for the reader.
...
Do not write an entry for a term no page uses. Do not use the glossary to explain at length. A term that needs more than three sentences needs a [concept page](/en/documentation/style-guide/content/concept/), and its definition links to it.
...
- **Every definition traces to a page or a source you can name.** The glossary records how the documentation uses a term; it never introduces one.
