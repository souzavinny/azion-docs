...
The title names the design as a noun phrase: `Content delivery at the edge`. The opening paragraph states what problem the design solves and for whom.
...
- **The diagram never stands alone.** The numbered dataflow carries the meaning, because an agent fetching the markdown twin gets the list, not the image.
- **Write alt text that describes what the diagram shows**, and never rely on color alone.
...
- **Mark a gap instead of inventing.** A required section whose content you do not have gets a gap marker, never an invented fill.
