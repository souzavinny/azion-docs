...
- **Keep the contract.** You choose every option: no branching, no "depending on your needs". Every step shows a visible result, and every command was run.
...
This excerpt of a tutorial that builds a user list API shows the opening move, the prerequisites, and the first stage:
