...
A slot is a position in a product section; a kind is the shape of a page. The [information architecture](/en/documentation/style-guide/content/information-architecture/) lists twelve slots, and this catalog holds twelve kinds. Equal length is a coincidence: the two lists do not map onto each other.
