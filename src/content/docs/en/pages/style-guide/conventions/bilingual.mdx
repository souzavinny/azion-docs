...
- Do not translate product names: **Applications**, **Functions**, **Firewall**, **Azion Web Platform**, **Azion Marketplace**.
- Apply the substitutions: `aplicação`, not `aplicativo`; `edge`, not `borda`; `performance`, not `desempenho`.
...
The full lists are in [Terminology](/en/documentation/style-guide/writing/terminology/).
