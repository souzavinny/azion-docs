...
description: >-
  How the English and Portuguese versions of a page pair by namespace, with
...
When a task hands you the Portuguese page alone, open the English page before you write. If it does not exist, stop and say so: a Portuguese page written first has no source, and the English page that follows becomes a translation of a translation.
...
- Do not translate generic technical terms: `data center`, `serverless`, `template`, `compliance`, `on-premise`. The strings `edge`, `edge computing`, and `edge location` stay untranslated where they already appear, but new text does not introduce them.
...
The full lists are in [Documentation terminology](/en/documentation/style-guide/writing/terminology/).
