...
title: Headings
description: >-
  How to write headings: sentence case, imperative verbs instead of gerunds,
  correct heading levels, and headings that work as search queries.
...
Section size follows the same retrieval logic. See [Page size](/en/documentation/style-guide/content/page-size/).
