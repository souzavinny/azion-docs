...
title: Punctuation
description: >-
  Punctuation rules for Azion documentation: the Oxford comma, dashes and
  hyphens, heading and list punctuation, spacing, and the symbols to avoid.
...
Dashes used for emphasis are the pattern to avoid. Prose that leans on them reads as machine-generated, which [Word choice](/en/documentation/style-guide/writing/word-choice/) covers in full. This is a rule for writing, not a defect for review: nobody flags a single em dash.
...
An exclamation point adds volume, not information. It also reads as promotional, which [Voice](/en/documentation/style-guide/writing/voice/) rules out.
...
Portuguese takes a space on each side of a dash that separates a clause. The rest of this page holds in both languages.
