...
- Incorrect: `Refer to [**Cache settings**](/en/documentation/build/applications/reference/cache-settings/).`
- Correct: `Refer to [Cache settings](/en/documentation/build/applications/reference/cache-settings/).`
