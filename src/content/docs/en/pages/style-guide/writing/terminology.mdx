...
Every product has one documentation name, and every page uses that name. The canonical list of names lives in the company knowledge base, the single source for product naming. This guide does not restate the list, because a copy is wrong the day a name changes.
