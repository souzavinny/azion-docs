...
- "Currently", "at the time of writing", "will soon", "now available", "recently", and "new" as a modifier: all age badly, and nobody returns to fix them. No month or year appears outside a changelog. Say what is true and let the changelog carry the timeline.
