...
Some words appear in drafts as decoration and carry no technical meaning. They also appear far more often in machine-generated text than in human writing, so they make a page read as generated. Delete the padding and keep the sentence: "it is important to note that" and "note that" add nothing. Prefer the short form: "to" instead of "in order to", "because" instead of "due to the fact that", and "can" instead of "has the ability to".
...
- After: `To cache content, configure the three settings below.`
