...
:::note
Ensure that the subject name and the subject alternate names (SAN) listed are the same as the [domains you configure with Azion](/en/documentation/build/workloads/guides/configure-a-domain/). This will avoid errors from occurring when you associate the certificate with the domain.
:::
...
Once you receive a certificate issued by your CA, you must associate it with the CSR entry you created. After your certificate is active with Azion, you may [associate the certificate to a domain](/en/documentation/build/workloads/guides/create-a-digital-certificate/#associate-certificate-to-domain).
