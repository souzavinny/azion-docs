...
There are separate instructions for API v3 using [legacy Domains](/en/documentation/build/applications/reference/domains/) settings and API v4 using the new [Workloads](/en/documentation/build/workloads/) product.
