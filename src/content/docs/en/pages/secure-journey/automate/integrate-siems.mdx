...
permalink: /documentation/secure/firewall/guides/integrate-siems/
...
- Find more information on each option on [How to associate domains on Data Stream](/en/documentation/observe/data-stream/guides/data-stream-associate-domains/).
...
1. Run the following `POST` request, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/): 
