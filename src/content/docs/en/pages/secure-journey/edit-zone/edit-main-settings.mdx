...
permalink: /documentation/secure/firewall/guides/edge-dns-configure-main-settings/
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) to create a new zone:
