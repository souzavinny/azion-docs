...
permalink: /documentation/secure/firewall/guides/add-records/
...
After defining your [Edge DNS main settings](/en/documentation/secure/firewall/guides/edge-dns-configure-main-settings/), you can add records to specify which IPs are associated with the domain and how **Edge DNS** should handle requests for the domain.
...
2. Run the following `POST` request, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and the `<zone_id>` value you copied:
