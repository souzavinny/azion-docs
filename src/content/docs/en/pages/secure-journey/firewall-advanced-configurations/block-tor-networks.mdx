...
permalink: /documentation/secure/firewall/guides/block-tor-networks/
...
3. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/), the `<edge_firewall_id>` variable with your [firewall ID](https://api.azion.com/#58376993-e0dd-4b51-9cd3-41d86122728f), and the `<network_list_id>` value with the IP Tor Exit Nodes list ID:
