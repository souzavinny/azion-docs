...
permalink: /documentation/secure/firewall/guides/tune-waf/
...
- <Tag severity="info" client:only="vue">[Configured firewall](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/)</Tag><br></br>

- <Tag severity="info" client:only="vue">[Activated WAF in the firewall](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/#modules)</Tag>
...
2. Select the WAF Rule Set you want to tune or [create a new one](/en/documentation/secure/firewall/guides/create-waf-rule-set/).
...
Once you filter a query with WAF Tuning, you can create an [allowed rule](/en/documentation/secure/waf/reference/custom-allowed-rules/) from the presented results. To do so:
