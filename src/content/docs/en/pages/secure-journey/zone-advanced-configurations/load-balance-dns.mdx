...
permalink: /documentation/secure/firewall/guides/load-balance-dns/
...
2. Choose the zone in which you want to add records from the list or [create a zone](/en/documentation/secure/firewall/guides/edge-dns-configure-main-settings/#creating-a-new-zone).
...
3. Run the following `POST` request, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and the `<hosted_zone_id>` value you copied:
