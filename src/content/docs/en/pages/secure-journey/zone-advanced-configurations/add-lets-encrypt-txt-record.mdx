...
If you've chosen Azion's **Domain** feature to create a Let's Encrypt certificate directly from Azion's platform for a zone that is fully configured in Edge DNS, the entire process is automated, including the handling of the TXT record. Find out more in the [Let's Encrypt guide](/en/documentation/build/applications/guides/how-to-generate-a-lets-encrypt-certificate/).
:::
