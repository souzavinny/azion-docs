...
permalink: /documentation/get-started/journeys/protect/infrastructure/
---
...
Once you've [created an firewall and secured your application](/en/documentation/get-started/journeys/protect/), you can use **Origin Shield** to secure your infrastructure by blocking threats.
...
- The [Network Shield module](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/#modules) enabled.
...
1. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > select **Network Lists**.
2. Select **Azion Origin Shield**.
3. On the **List** field, you can copy the IP addresses list.
</Fragment>

<Fragment slot="panel.api">
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/)
