...
permalink: /documentation/secure/firewall/guides/test-zone/
menu_namespace: firewallMenu
---

import LinkButton from 'azion-webkit/linkbutton'

Once you've set up your [Edge DNS zone](/en/documentation/secure/firewall/guides/edge-dns-configure-main-settings/), you can test it to see if it's properly processing your information.
