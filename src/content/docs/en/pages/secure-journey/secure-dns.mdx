...
permalink: /documentation/get-started/journeys/protect/dns/
---
...
<LinkButton link="/en/documentation/secure/edge-dns/" label="go to Edge DNS reference" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/firewall/guides/edge-dns-configure-main-settings/" label="go to configure Edge DNS guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/workloads/guides/migrate-ns-to-azion/" label="go to migrate a NS guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/firewall/guides/activate-dnssec/" label="go to activate DNSSEC guide" severity="secondary" />
