...
permalink: /documentation/devtools/graphql/reference/playground/
...
<LinkButton link="/en/documentation/devtools/graphql/reference/first-steps/#accessing-graphql-playground" label="Access GraphiQL Playground" severity="secondary" />
...
:::tip
For more details, check the [How to identify the Top IPs generating attack traffic using GraphQL API](/en/documentation/devtools/graphql/guides/query-top-ips-attack-traffic-with-graphql/) guide.
:::
