...
permalink: /documentation/get-started/first-deploy/template/
---
...
:::tip
To know more on how to edit and customize your application's main settings, go to the [Configuring main settings](/en/documentation/build/applications/guides/configure-main-settings/) guide. You can also [Go live with Azion](/en/documentation/get-started/production-checklist/), adding a custom domain and poiting your traffic.
:::
