...
permalink: /documentation/marketplace/guides/install-an-integration/
...
:::tip
To build a new application, go to the [Build](/en/documentation/get-started/journeys/launch/) journey for more details on this topic.
:::
...
<LinkButton link="/en/documentation/marketplace/guides/update-an-integration/" label="Go to How to update an integration guide" severity="secondary" /> 
