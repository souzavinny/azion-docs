...
permalink: /documentation/store/sql-database/reference/vector-search/
---
...
| Scope | Resource |
|---|---|
| Implement Vector Search | Guide explaining the basics of [implementing Vector Search](/en/documentation/store/sql-database/guides/sql-database-vector-search/) |
