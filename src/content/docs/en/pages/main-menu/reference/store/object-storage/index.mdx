...
:::note
This product is available through [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com), [Azion Runtime](/en/documentation/runtime/overview/), and [Azion CLI](/en/documentation/devtools/cli/).
:::
...
The recommended way to deliver objects stored in **Object Storage** to end users is through [Applications](/en/documentation/build/applications/) connected to your buckets using [Connectors](/en/documentation/secure/connectors/). This approach:
...
With **Object Storage**, you can use buckets as an [origin](/en/documentation/secure/connectors/#connector-type) in Azion **Connectors** to retrieve the content of an application.
