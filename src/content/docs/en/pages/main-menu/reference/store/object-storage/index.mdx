...
The recommended way to deliver objects stored in **Object Storage** to end users is through [Applications](/en/documentation/build/applications/) connected to your buckets using [Connectors](/en/documentation/build/connectors/). This approach:
