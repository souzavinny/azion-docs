...
:::note
This product is available through [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com), [Azion Runtime](/en/documentation/build/functions/runtime-apis/overview/), and [Azion CLI](/en/documentation/devtools/cli/).
:::
...
The recommended way to deliver objects stored in **Object Storage** to end users is through [Applications](/en/documentation/products/edge-application/) connected to your buckets using [Connectors](/en/documentation/build/connectors/). This approach:
...
| Scope | Resource |
| --- | --- |
| Manage a bucket | [How to create and modify an Object Storage bucket](/en/documentation/store/object-storage/guides/create-and-modify-bucket/) |
| Upload and download objects | [How to upload and download objects from an Object Storage bucket](/en/documentation/store/object-storage/guides/bucket-actions/) |
| Use bucket as origin | [How to use an Object Storage bucket as the origin of a static application](/en/documentation/store/object-storage/guides/use-bucket-as-origin/) |
| Set up S3 credentials | [Set up S3 credentials for Object Storage](/en/documentation/store/object-storage/guides/s3-protocol-for-object-storage/) |
| Runtime API | [Object Storage API](/en/documentation/build/functions/runtime-apis/storage/) |
...
Objects, or files, can be uploaded, modified, downloaded, and removed from buckets using the [Azion API](https://api.azion.com), [Azion Runtime](/en/documentation/build/functions/runtime-apis/overview/), and the [S3 protocol](#s3-protocol-compatibility).
...
With **Object Storage**, you can use buckets as an [origin](/en/documentation/build/connectors/#connector-type) in Azion **Connectors** to retrieve the content of an application.
...
:::note
Class C operations are free. If an operation falls out of the scope of class C operations, it'll be billed to your account according to the established costs. For more operation and class charges information, see the [Pricing](/en/documentation/platform/pricing/) page.
:::
...
Read more on [Set up S3 credentials for Object Storage](/en/documentation/store/object-storage/guides/s3-protocol-for-object-storage/).
...
- **Azion Teams Permissions**: operations involving buckets, such as uploading, listing, and deleting objects, always require authentication through the Azion account. Go to [Teams Permissions](/en/documentation/account/reference/teams-permissions/) to know more about the available Object Storage account permissions.
...
To [create a S3 credential](/en/documentation/store/object-storage/guides/s3-protocol-for-object-storage/), you must use an Azion personal token and run a `POST` request via API. However, after the credential is created, it works independently from your Azion token. This way, even if the token expires, the credential remains valid.
...
<LinkButton link="/en/documentation/store/object-storage/guides/s3-protocol-for-object-storage/" label="learn how to set up S3 credentials for Object Storage" severity="secondary"/>
