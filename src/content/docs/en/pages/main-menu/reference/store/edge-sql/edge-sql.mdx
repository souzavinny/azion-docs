...
| Scope | Resource |
| ----- | -------- |
| Manage databases with REST API | [How to create an SQL Database database](/en/documentation/store/sql-database/guides/manage-sql-database/) |
| Create queries with REST API | [How to create and query data on SQL Database](/en/documentation/store/sql-database/guides/create-tables-sql-database/) |
| Retrieve data from a database | [How to retrieve data from a database with SQL Database and Functions](/en/documentation/store/sql-database/guides/retrieve-data-with-functions/) |
| Get to know SQL Database Vector Search | [SQL Database Vector Search reference](/en/documentation/store/sql-database/reference/vector-search/) |
| Import data to SQL Database | [How to import data guide ](/en/documentation/store/sql-database/guides/import-data-sql-database/) |
...
[Creating a database](/en/documentation/store/sql-database/guides/manage-sql-database/) is the first step to use SQL Database and add data:
...
<LinkButton link="/en/documentation/store/sql-database/guides/install-edge-sql-shell/" label="Go to SQL Database Shell installation guide" severity="secondary" /> 
<LinkButton link="/en/documentation/store/sql-database/guides/sql-database-shell-commands/" label="Go to SQL Database Shell commands reference" severity="secondary" />
...
To view the databases associated with your acount visit this [guide](/en/documentation/store/sql-database/guides/list-databases/).
