...
permalink: /documentation/account/reference/billing-and-subscriptions/
...
<LinkButton link="/en/documentation/account/guides/billing-and-subscriptions/" label="Go to How to access the Billing page guide" severity="secondary" target="_blank" />
