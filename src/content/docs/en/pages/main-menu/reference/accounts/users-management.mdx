...
permalink: /documentation/account/reference/users-management/
...
You can also allocate non-owners to more than one team, which expands the permission possibilities for the same user. See [Team Permissions](/en/documentation/account/reference/teams-permissions/) for more details.
