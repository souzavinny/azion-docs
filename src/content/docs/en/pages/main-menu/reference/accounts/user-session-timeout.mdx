...
permalink: /documentation/account/reference/user-session-timeout/
...
| Scope | Resource |
| --- | --- |
| Configure User Session Timeout | [How to configure User Session Timeout](/en/documentation/account/guides/configure-user-session-timeout/) |
...
<LinkButton link="/en/documentation/account/guides/configure-user-session-timeout/" label="Go to Configuring User Session Timeout guide" severity="secondary" target="_blank" />
