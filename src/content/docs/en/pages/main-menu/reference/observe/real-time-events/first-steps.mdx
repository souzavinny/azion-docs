...
permalink: /documentation/observe/real-time-events/quickstart/
---

Before using [Real-Time Events](/en/documentation/observe/real-time-events/), make sure you have a [Azion Console](https://console.azion.com) account. You can find more information on creating one on the [documentation page](/en/documentation/account/reference/creating-account/).
