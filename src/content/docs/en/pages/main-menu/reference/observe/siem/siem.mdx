...
permalink: /documentation/observe/siem/
---

**Azion SIEM** allows you to expand visibility into accesses to your applications. By correlating data available on [Real-Time Metrics](/en/documentation/observe/real-time-metrics/) and [Real-Time Events](/en/documentation/observe/real-time-events/), you can amplify your analysis of security, access volume, health, and degradation.
