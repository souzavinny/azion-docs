...
**Data Stream** is an [Observe](/en/documentation/observe/) product that allows you to feed your stream processing, SIEM, and big data platforms with the event logs from your applications on Azion in real time. To keep an enhanced performance, it uses ASCII encoding to avoid parser issues and problems in data interpretation.
...
- [Create a new data stream](/en/documentation/observe/data-stream/guides/use-data-stream/).
- Connect your Data Streams to [endpoints](/en/documentation/guides/#observe).
- [Edit data stream settings](/en/documentation/observe/data-stream/guides/use-data-stream/) directly from the list by selecting the stream you want to update.
- [View detailed information](/en/documentation/observe/data-stream/guides/data-stream-understand-metrics/) about each stream to ensure everything is running smoothly.
- [Delete or stop data streams](/en/documentation/observe/data-stream/guides/delete-data-stream/) that are no longer needed to optimize your system.
...
| Task | Guide |
| ---- | ----- |
| Accessing Data Stream | [Data Stream first steps](/en/documentation/observe/data-stream/quickstart/) |
| Configure Data Stream | [How to configure Data Stream main settings](/en/documentation/observe/data-stream/guides/use-data-stream/) |
| Stop or delete a data stream| [How to stop or delete a data stream](/en/documentation/observe/data-stream/guides/delete-data-stream/) |
| Associate domains | [How to associate domains on Data Stream](/en/documentation/observe/data-stream/guides/data-stream-associate-domains/) |
| Create customize template | [How to create a custom template on Data Stream](/en/documentation/observe/data-stream/guides/data-stream-custom-template/) |
...
You can [create a new data stream](/en/documentation/observe/data-stream/guides/use-data-stream/) through [Azion Console](https://console.azion.com/data-stream):
...
To [edit](/en/documentation/observe/data-stream/guides/use-data-stream/) any stream, go to the **Data Stream** page and select the stream you want to work with. Edit the configurations as desired and save the changes.

If you want to [stop a data stream](/en/documentation/observe/data-stream/guides/delete-data-stream/) in your Azion account, follow these steps: 
...
To [delete](/en/documentation/observe/data-stream/guides/delete-data-stream/) a stream: go to the **Data Stream** page, navigate to the right side of the row, and click the **trash icon** for the stream you want to delete. 
...
The **Activity History** data source displays the data for [logs activity](/en/documentation/account/reference/activity-history/) regarding your account on Azion Console. The following variables are available for this option:
...
Learn more about [Applications](/en/documentation/build/applications/).
...
| $upstream_addr | Client IP address and port. Can also store multiple servers or server groups. Example: 192.168.1.1:80. When the response is `127.0.0.1:1666`, the upstream is Azion [Cells Runtime](/en/documentation/build/functions/runtime-apis/overview/). |
...
:::note
You can add the `$traceback` variable when using a custom template for the Applications data source if you have the *Debug rules* option activated in your application. See more on [Debugging rules on Application](/en/documentation/build/applications/reference/rules-engine/#debugging-rules).
:::

The variables: `$upstream_bytes_received`, `$upstream_cache_status`, `$upstream_connect_time`, `$upstream_header_time`, `$upstream_response_time`, and `$upstream_status` can have *more than one comma-separated element*. When a connection is triggered, either by internal redirection or choice of source with [Load Balancer](/en/documentation/build/connectors/reference/load-balancer/), for example, each value contained in the field represents the respective initiated connection. The field can be separated by:
...
The **Functions** data source provides the data from requests made to your [Functions](/en/documentation/build/applications/reference/functions/) at Azion.
...
<LinkButton link="/en/documentation/observe/data-stream/guides/data-stream-custom-template/" label="How to create a custom template on Data Stream" severity="secondary"/>

---

## Domains

You can associate your [existing domains](/en/documentation/build/applications/reference/domains/) registered on Azion to your stream. If you haven't registered any domains to your account yet, see the [Creating a new domain associated with your Application](/en/documentation/build/workloads/guides/configure-a-domain/) documentation.
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/data-stream-associate-domains/" label="How to associate domains on Data Stream" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-amazon-kinesis/" label="How to use Amazon Kinesis Data Firehose to receive data" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-azure-blob/" label="How to use Azure Blob Storage to receive data" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-azure-monitor/" label="How to use Azure Monitor to receive data" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-datadog/" label="How to use Datadog to receive data" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-elasticsearch/" label="How to use Elasticsearch to receive data" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-google-bigquery/" label="How to use Google BigQuery to receive data" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-amazon-s3/" label="How to use Amazon S3 to receive data" />
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/connector-azion-object-storage/" label="How to use Azion Object Storage to receive data" />
...
<LinkButton severity="secondary" link="/en/documentation/observe/data-stream/guides/endpoint-splunk/" label="How to use Splunk to receive data" />
