...
**Edge Pulse** is an [Observe](/en/documentation/observe/overview/) product based on the market-leading *Real User Monitoring (RUM)* solution. With it, you can, in real time:
...
| Scope | Source |
| ----- | ------ |
| First steps | [Edge Pulse first steps](/en/documentation/observe/edge-pulse/quickstart/) |
...
<LinkButton link="/en/documentation/observe/real-time-events/" label="explore via Real-Time Events" />
