...
**Real-Time Events** is an [Observe](/en/documentation/observe/overview/) product that provides raw data, *logs*, from other Azion products in real time.
...
| Task | Guide |
| ---- | ----- |
| See first steps | [Real-Time Events first steps](/en/documentation/observe/real-time-events/quickstart/) |
...
Displays the event records from requests made to your [Applications](/en/documentation/build/applications/) and [Firewall instances](/en/documentation/secure/firewall/).
...
| Upstream Addr | Client’s IP address and port. Can also store multiple servers or server groups. Example: `192.168.1.1:80`. When the response is `127.0.0.1:1666`, the upstream is [Azion Cells Runtime](/en/documentation/build/functions/runtime-apis/overview/). |
...
The `Stack Trace` variable can be used if you have the **Debug Rules** feature activated in your application. Find out more on [How to debug rules created with Rules Engine](/en/documentation/build/applications/guides/debug-rules/).
...
Displays the event records of requests made to your [Functions](/en/documentation/build/applications/reference/functions/).
...
:::note
See the [Debbuging documentation](/en/documentation/build/functions/runtime-apis/debugging/) for more options on viewing function's logs.
:::
...
Displays the event records from applications using [Azion Runtime](/en/documentation/build/functions/runtime-apis/overview/) returned by Cells Console.
...
Displays the event records of requests made to applications using [Image Processor](/en/documentation/build/applications/reference/image-processor/).
...
Displays the event records of requests made to applications using [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/).
...
Displays the event records of activies performed on an account on Azion Console registered by [Activity History](/en/documentation/account/reference/activity-history/). Use the [Real-Time Events GraphQL API](/en/documentation/devtools/graphql/reference/overview/) to query up to *2 years* of logs.
