...
Displays the event records of requests made to your [Functions](/en/documentation/build/applications/functions/).
...
Displays the event records of requests made to applications using [Image Processor](/en/documentation/build/applications/image-processor/).
...
Displays the event records of requests made to applications using [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/).
