...
Displays the event records of activies performed on an account on Azion Console registered by [Activity History](/en/documentation/account/reference/activity-history/). Use the [Real-Time Events GraphQL API](/en/documentation/devtools/graphql-api/overview/) to query up to *2 years* of logs.
