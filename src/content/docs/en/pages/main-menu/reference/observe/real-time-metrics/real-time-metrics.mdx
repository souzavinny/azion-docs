...
- [Define cache policies](/en/documentation/build/cache/guides/cache-settings/) and [Advanced Cache Key](/en/documentation/build/application-accelerator/guides/advanced-cache-key/).
- [Configure multiple origins with load balancing algorithms](/en/documentation/secure/connectors/guides/multiple-origins/).
