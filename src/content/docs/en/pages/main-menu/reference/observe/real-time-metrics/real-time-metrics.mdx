...
If you have [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/) enabled, your Cache graph will exhibit:
...
- [Define cache policies](/en/documentation/build/applications/cache/guides/cache-settings/) and [Advanced Cache Key](/en/documentation/build/applications/cache/guides/advanced-cache-key/).
...
The Tiered Cache tab displays metrics related to the data of your applications using [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/) configured in your account.
...
The **Functions** tab displays metrics related to the invocations of the [Functions](/en/documentation/build/applications/functions/) configured in your account.
...
The **Image Processor** tab displays metrics related to the requests made to your images processed through [Image Processor](/en/documentation/build/applications/image-processor/) configured in your account.
