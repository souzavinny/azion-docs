...
See the [first steps for Real-Time Metrics](/en/documentation/observe/real-time-metrics/quickstart/).
...
- [Customize your own dashboard](/en/documentation/observe/real-time-metrics/guides/azion-plugin-grafana-custom-dash/)
- [Use use a pre-built dashboard to view Data Transferred graphs](/en/documentation/observe/real-time-metrics/guides/azion-plugin-grafana-pre-built-dash/)
...
<LinkButton link="/en/documentation/observe/real-time-metrics/reference/historical-real-time-metrics/" label="Use the Historical Real-Time Metrics" severity="secondary" />
...
On average, the difference between the two is smaller than 1%. See [Azion Pricing](/en/documentation/platform/pricing/) and the [Billing documentation](/en/documentation/account/reference/billing-and-subscriptions/) for more information.
...
<LinkButton link="/en/documentation/observe/real-time-metrics/guides/use-real-time-metrics/" label="How to use Real-Time Metrics" severity="secondary" />
...
<LinkButton link="/en/documentation/observe/data-stream/guides/add-filters-metrics/" label="Go to add filters guide" severity="secondary" />
...
If you have [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/) enabled, your Cache graph will exhibit:
...
- [Improve your database queries](/en/documentation/devtools/graphql/reference/queries/) for optimal performance.
- [Define cache policies](/en/documentation/build/applications/guides/cache-settings/) and [Advanced Cache Key](/en/documentation/build/applications/guides/advanced-cache-key/).
- [Configure multiple origins with load balancing algorithms](/en/documentation/build/applications/guides/multiple-origins/).
...
With this information, you can analyze how requests are being handled and identify trends in secure (encrypted) versus non-secure traffic. Read more on [How to configure HTTP and HTTPS ports for origins and delivery address](/en/documentation/build/applications/guides/configure-ports/).
...
By examining this data, you can identify regional traffic patterns, detect unusual activity from specific countries or networks, and take targeted security actions. For example, you can create a [network list based on user’s IP addresses or geolocation](/en/documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/) to block these requests.
...
The Tiered Cache tab displays metrics related to the data of your applications using [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/) configured in your account.
...
The **Functions** tab displays metrics related to the invocations of the [Functions](/en/documentation/build/applications/reference/functions/) configured in your account.
...
The **Image Processor** tab displays metrics related to the requests made to your images processed through [Image Processor](/en/documentation/build/applications/reference/image-processor/) configured in your account.
...
With this information, you can set up security policies. For example, you can create a [network list based on the user's geolocation](/en/documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/) to block these requests.
...
This graph helps you quickly identify which attack families are generating the most flagged requests, allowing for a clearer analysis of threat patterns and setting up policies to contain these threats. For example, by [creating a WAF Rules Set](/en/documentation/secure/firewall/guides/create-waf-rule-set/), you can protect your Applications against specific threat families.
...
>
> After creating a rule set, you must [create a Rules Engine rule](/en/documentation/secure/firewall/guides/create-waf-rule-set/) to execute the criteria and behavior. For example, if a request has a high SQL score (criteria), it'll be dropped (behavior).
...
- [Analyze flagged request logs](/en/documentation/secure/firewall/guides/firewall-understand-metrics/) to identify patterns or potential vulnerabilities that need addressing.
- [Adjust WAF Rules Sets](/en/documentation/secure/firewall/guides/create-waf-rule-set/) to strengthen filtering policies to block or challenge suspicious requests from high-risk hosts.
- [Implement rate limiting](/en/documentation/secure/firewall/reference/rules-engine/#set-rate-limit) and restrict the number of requests from specific hosts to prevent abuse.
- [Define blocklists](/en/documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/) with identified threat sources to prevent repeated attacks.
...
With this information, you can quickly identify your traffic and focus on creating policies to stop the biggest threats. For example, you can create a [network list based on user's IP addresses](/en/documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/) to block these requests.
