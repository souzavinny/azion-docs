...
permalink: /documentation/observe/real-time-metrics/reference/historical-real-time-metrics/
---
...
You can already use the [New Real-Time Metrics](/en/documentation/observe/real-time-metrics/) and will be able to continue using it.

**Historical Real-Time Metrics** is an [Observe](/en/documentation/observe/) product that provides you with real-time access to metrics, through graphs, so you can analyze the events of your applications and products configured on Azion. It also helps you optimize the use of Azion products and how your content is delivered.
...
You can find detailed information about each tab and subtabs and about each of the graphs available on the [New Real-Time Metrics documentation](/en/documentation/observe/real-time-metrics/).
