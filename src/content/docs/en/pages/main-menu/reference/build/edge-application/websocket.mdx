...
permalink: /documentation/build/applications/reference/websocket/
---
...
:::caution  
Due to their nature as a bidirectional open connection, WebSocket Proxy is incompatible with the use of the [Image Processor](/en/documentation/build/applications/reference/image-processor/), [Cache](/en/documentation/build/applications/reference/cache/) or [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/) modules.
:::
...
| Functions WebSocket API| [WebSocket API](/en/documentation/build/functions/runtime-apis/websocket/)  |
| Debug Rules| [Debug Rules](/en/documentation/build/applications/guides/debug-rules/)  |
...
<LinkButton link="/en/documentation/build/functions/runtime-apis/websocket/" label="Go to WebSocket API reference" severity="secondary" target="_blank" />
