...
permalink: /documentation/build/applications/reference/rules-engine/
---
...
:::caution
Before you create a rule, you should enable the [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/) module, which extends the usability of **Rules Engine** by applying serverless computing features to **Applications**. If the module is disabled, only some variables and behaviors will be available for your rule.
:::
...
| Creating a rule | [Creating rules using Rules Engine for Applications](/en/documentation/build/applications/guides/rules-engine/) |
| Creating a cache setting | [How to configure cache policies for Applications](/en/documentation/build/applications/guides/cache-settings/) |
| Mitigating HTTPoxy using rules | [How to mitigate the HTTPOxy vulnerability](/en/documentation/build/applications/guides/mitigating-a-vulnerability-httpoxy/) |
...
| `${device_group}` | Device group name. You can customize your [device groups](/en/documentation/build/applications/reference/device-groups/) in the **Device Groups** tab of your application | `Mobile` | Request <br />Response |
...
<LinkButton link="/en/documentation/build/applications/reference/domains/mtls/" label="Learn more about support for mTLS" severity="secondary" />
...
[<Tag severity="info" client:only="vue">Requires Application Accelerator</Tag>](/en/documentation/build/applications/reference/application-accelerator/)
...
:::tip
See the guide on [How to configure cache policies for Applications](/en/documentation/build/applications/guides/cache-settings/#bypass-cache) for more information on Bypass Cache.
:::
...
Enables Gzip data compression, if supported by the user's browser. See the guide on [How to enable gzip compression](/en/documentation/build/applications/guides/gzip-compression/) for more information.
...
<LinkButton link="/en/documentation/build/applications/guides/enforce-hls-cache/" label="go to enforce HLS cache guide" severity="secondary" />
...
To prevent a user from receiving the `Set-Cookie` header from another user's session, see the [guide on cache policies](/en/documentation/build/applications/guides/cache-settings/#creating-a-rule-to-forward-cookies-from-the-origin-to-the-user).
...
### Optimize Images
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requires Image Processor</Tag>](/en/documentation/build/applications/reference/image-processor/)

Enables [Image Processor](/en/documentation/build/applications/reference/image-processor/).

### Redirect HTTP to HTTPS
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requires HTTPS application</Tag>](/en/documentation/build/applications/reference/main-settings/)
...
<Tag severity="info" client:only="vue">Request Phase</Tag> <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="info" client:only="vue">Requires Application Accelerator</Tag>](/en/documentation/build/applications/reference/application-accelerator/)
[<Tag severity="info" client:only="vue">Requires Functions</Tag>](/en/documentation/build/applications/reference/functions/)

Runs a function created using **Functions** and instantiated in the **Functions** tab for the application. See the guide on [How to run serverless functions](/en/documentation/build/functions/guides/serverless-functions/) for more information.

### Set Cache Policy 
<Tag severity="info" client:only="vue">Request Phase</Tag>

Assigns the cache policy that should be used for the request. You must first set up the cache policies in [Cache Settings](/en/documentation/build/applications/reference/cache-settings/).

You can set up the time that an object will be stored in cache and the rules for the variation of objects in cache with the [Advanced Cache Key](/en/documentation/build/applications/reference/cache-settings/#advanced-cache-key). 
...
Before configuring this behavior, you must set up your origins using [Origins](/en/documentation/build/applications/reference/origins/).
...
You can [debug rules created with Rules Engine](/en/documentation/build/applications/guides/debug-rules/) created in **Rules Engine for Applications** through the **GraphQL API**, **Data Stream**, or **Real-Time Events**.
