...
| Creating a cache setting | [How to configure cache policies for Applications](/en/documentation/build/cache/guides/cache-settings/) |
...
<LinkButton link="/en/documentation/secure/certificate-manager/reference/mtls-for-build/" label="Learn more about support for mTLS" severity="secondary" />
...
[<Tag severity="info" client:only="vue">Requires Application Accelerator</Tag>](/en/documentation/build/application-accelerator/)
...
:::tip
See the guide on [How to configure cache policies for Applications](/en/documentation/build/cache/guides/cache-settings/#bypass-cache) for more information on Bypass Cache.
:::
...
<LinkButton link="/en/documentation/build/cache/guides/enforce-hls-cache/" label="go to enforce HLS cache guide" severity="secondary" />
...
To prevent a user from receiving the `Set-Cookie` header from another user's session, see the [guide on cache policies](/en/documentation/build/cache/guides/cache-settings/#creating-a-rule-to-forward-cookies-from-the-origin-to-the-user).
...
### Optimize Images
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requires Image Processor</Tag>](/en/documentation/build/image-processor/)
...
<Tag severity="info" client:only="vue">Request Phase</Tag> <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="info" client:only="vue">Requires Application Accelerator</Tag>](/en/documentation/build/application-accelerator/)
[<Tag severity="info" client:only="vue">Requires Functions</Tag>](/en/documentation/build/functions/)
...
Assigns the cache policy that should be used for the request. You must first set up the cache policies in [Cache Settings](/en/documentation/build/cache/reference/cache-settings/).

You can set up the time that an object will be stored in cache and the rules for the variation of objects in cache with the [Advanced Cache Key](/en/documentation/build/cache/reference/cache-settings/#advanced-cache-key). 
...
Before configuring this behavior, you must set up your origins using [Origins](/en/documentation/secure/connectors/reference/origins/).
