...
permalink: /documentation/build/applications/reference/origins/
---
...
For more information about the new product, visit the [Connectors reference](/en/documentation/secure/connectors/).
:::
...
| Scope | Resource |
| --- | --- |
| Applications first steps | [First steps](/en/documentation/build/applications/quickstart/#origins) |
...
The bucket name is defined when you [create or modify an Object Storage bucket](/en/documentation/store/object-storage/guides/create-and-modify-bucket/).
