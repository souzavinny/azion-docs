...
For more information about the new product, visit the [Workloads Reference](/en/documentation/build/workloads/).
:::
...
If you already own a domain, you can [redirect your traffic to Azion](/en/documentation/build/workloads/guides/point-domain-to-azion/) by configuring the records in your DNS provider and listing your **custom domains**.
