...
permalink: /documentation/build/applications/reference/domains/
---
...
For more information about the new product, visit the [Workloads Reference](/en/documentation/secure/workloads/).
:::


**Domains** is an [Azion Console](https://console.azion.com) tool that provides a domain generation and management service.

When you [build an application](/en/documentation/get-started/journeys/launch/), your application is given an automatically generated **Azion domain**, in the format `xxxx.map.azionedge.net`. You can create multiple domains for your applications.

If you already own a domain, you can [redirect your traffic to Azion](/en/documentation/secure/workloads/guides/point-domain-to-azion/) by configuring the records in your DNS provider and listing your **custom domains**.
