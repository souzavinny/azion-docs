...
permalink: /documentation/build/applications/reference/cache/
---
...
| Tiered Cache module | [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/) |
| Configuring a cache policy | [How to configure cache policies for Applications](/en/documentation/build/applications/guides/cache-settings/) |
...
:::note
Find out more about how to automate your browser to obtain other cache data in the [How to verify application cache indicators using Modheader for Google Chrome](/en/documentation/build/applications/guides/check-page-cache-time/) guide.
:::
...
When [Image Processor](/en/documentation/build/applications/reference/image-processor/) is activated, in addition to the `ims` query string, variations with converted format contain the file format after the separator.
...
When the [Advanced Cache Key](/en/documentation/build/applications/reference/application-accelerator/#advanced-cache-key) feature is configured, the formation of cache keys is also affected. 
