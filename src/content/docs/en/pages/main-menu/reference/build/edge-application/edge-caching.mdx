...
| Configuring a cache policy | [How to configure cache policies for Applications](/en/documentation/build/cache/guides/cache-settings/) |
...
:::note
Find out more about how to automate your browser to obtain other cache data in the [How to verify application cache indicators using Modheader for Google Chrome](/en/documentation/build/cache/guides/check-page-cache-time/) guide.
:::
...
<LinkButton link="/en/documentation/build/cache/reference/cache-settings/#browser-cache-settings" label="go to expiration settings documentation" />
...
<LinkButton link="/en/documentation/build/cache/reference/cache-settings/#stale-cache" label="go to stale cache documentation" />
