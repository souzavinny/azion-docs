...
permalink: /documentation/secure/custom-pages/reference/error-responses/
...
<LinkButton link="/en/documentation/secure/connectors/reference/origins/" label="Learn more about Origins" />
