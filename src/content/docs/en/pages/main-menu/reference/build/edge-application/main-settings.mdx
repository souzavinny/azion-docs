...
:::note
With the release of API v4, delivery settings were moved to [Workloads](/en/documentation/secure/workloads/). For more details about the changes [visit the migration documentation.](/en/documentation/devtools/api/v4-migration/#workloads) 
:::
...
<LinkButton link="/en/documentation/build/applications/cache/" label="Learn more about Cache" />
...
<LinkButton link="/en/documentation/build/applications/functions/" label="Learn more about Functions" />
...
<LinkButton link="/en/documentation/build/applications/image-processor/" label="Learn more about Image Processor" />
...
<LinkButton link="/en/documentation/build/applications/cache/tiered-cache/" label="Learn more about Tiered Cache" />
