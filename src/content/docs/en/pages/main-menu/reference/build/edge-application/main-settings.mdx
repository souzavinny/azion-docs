...
permalink: /documentation/build/applications/reference/main-settings/
---
...
:::caution[important]
You're viewing the latest version of this documentation. If your account hasn't been migrated yet, refer to the [legacy Applications main settings reference](/en/documentation/build/applications/reference/main-settings/).
:::

With [Applications](/en/documentation/build/applications/), you can manage your application's modules and status.

:::note
With the release of API v4, delivery settings were moved to [Workloads](/en/documentation/build/workloads/). For more details about the changes [visit the migration documentation.](/en/documentation/devtools/api/v4-migration/#workloads) 
:::
...
<LinkButton link="/en/documentation/build/applications/reference/cache/" label="Learn more about Cache" />
...
<LinkButton link="/en/documentation/build/applications/reference/functions/" label="Learn more about Functions" />
...
<LinkButton link="/en/documentation/build/applications/reference/image-processor/" label="Learn more about Image Processor" />
...
<LinkButton link="/en/documentation/build/applications/reference/cache/tiered-cache/" label="Learn more about Tiered Cache" />
