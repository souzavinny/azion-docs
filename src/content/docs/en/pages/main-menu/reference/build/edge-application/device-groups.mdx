...
permalink: /documentation/build/applications/reference/device-groups/
---
...
| About Rules Engine | [Rules Engine](/en/documentation/build/applications/reference/rules-engine/) |
| About Adaptive Delivery | [Adaptive Delivery](/en/documentation/build/applications/reference/cache-settings/#adaptive-delivery) |
...
> To use this variable, you must enable [Application Accelerator](/en/documentation/build/applications/application-accelerator/).
...
<LinkButton link="/en/documentation/build/applications/reference/cache-settings/#adaptive-delivery" label="Learn more about Adaptive Delivery" />
