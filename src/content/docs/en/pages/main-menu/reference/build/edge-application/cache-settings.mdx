...
| Cache module | [Cache](/en/documentation/build/applications/cache/)  |
...
- **Override Cache Settings**: overrides the cache setting of your origin server with the desired TTL. To set the TTL of CDN cache to values under 60 seconds, you must enable the [Application Accelerator](/en/documentation/build/applications/application-accelerator/) module.
...
<LinkButton link="/en/documentation/build/applications/cache/#large-file-optimization" label="go to Large File Optimization documentation" />
...
<LinkButton link="/en/documentation/build/applications/cache/tiered-cache/" label="go to Tiered Cache documentation" />
...
<LinkButton link="/en/documentation/build/applications/cache/#stale-cache" label="go to stale cache documentation" />
