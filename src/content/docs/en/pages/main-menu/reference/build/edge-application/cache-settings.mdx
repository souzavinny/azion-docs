...
**CDN Cache Settings** configures how Azion caches the content on its distributed network. You can select from the following options:
...
**Large File Optimization** works with a default fragment size of *1,024 kB*. If you want to modify the fragmentation range, [contact the Sales team](https://www.azion.com/en/contact-sales/).

<LinkButton link="/en/documentation/build/cache/#large-file-optimization" label="go to Large File Optimization documentation" />
...
<LinkButton link="/en/documentation/build/cache/#stale-cache" label="go to stale cache documentation" />
