...
permalink: /documentation/build/applications/reference/cache-settings/
---
...
| Cache module | [Cache](/en/documentation/build/applications/reference/cache/)  |
...
- **Override Cache Settings**: overrides the cache setting of your origin server with the desired TTL. To set the TTL of CDN cache to values under 60 seconds, you must enable the [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/) module.
...
<LinkButton link="/en/documentation/build/applications/reference/cache/#large-file-optimization" label="go to Large File Optimization documentation" />
...
<LinkButton link="/en/documentation/build/applications/reference/cache/tiered-cache/" label="go to Tiered Cache documentation" />
...
<LinkButton link="/en/documentation/build/applications/reference/cache/#stale-cache" label="go to stale cache documentation" />
...
<LinkButton link="/en/documentation/build/applications/reference/device-groups/" label="go to Device Groups documentation" />
