...
**Functions** is a serverless product that runs your JavaScript code on Azion's distributed network. Use Functions to build APIs, manipulate request and response headers, apply logic from request metadata, or block traffic before it reaches your application.
