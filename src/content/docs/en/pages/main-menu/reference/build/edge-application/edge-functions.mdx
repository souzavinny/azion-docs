...
permalink: /documentation/build/applications/functions/
---
...
- **Debugging**: Use [Preview Deployment](/en/documentation/products/applications/functions/runtime-api/preview-deployment/), [Data Stream](/en/documentation/observe/data-stream/guides/debugging-functions-data-stream/), or [GraphQL API](/en/documentation/build/functions/guides/debugging-functions-graphql/) to debug framework-generated Functions.
