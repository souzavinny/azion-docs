...
permalink: /documentation/build/applications/reference/functions/
---
...
| Scope | Guide |
| - | - | 
| API Builder | [How to build an API with Functions and ChatGPT](/en/documentation/build/functions/guides/api-builder/) |
| Examples | [Examples](/en/documentation/build/functions/runtime-apis/javascript-examples/) |
...
By using the [Azion Runtime](/en/documentation/build/functions/runtime-apis/overview/) to develop your functions, you have a set of tools that help you implement your logic.

<LinkButton link="/en/documentation/build/functions/runtime-apis/overview/" label="go to azion runtime" severity="secondary" target="_blank" />
<br /><LinkButton link="/en/documentation/build/functions/runtime-apis/frameworks-compatibility/" label="go to supported Web Frameworks" severity="secondary" target="_blank" />
<br /><LinkButton link="/en/documentation/build/functions/runtime-apis/javascript/" label="go to supported Web APIs" severity="secondary" target="_blank" />
<br /><LinkButton link="/en/documentation/build/functions/runtime-apis/compatibility/node/" label="go to node.js support reference" severity="secondary" target="_blank" />
...
For the complete list of supported frameworks and detailed compatibility information, see [Frameworks compatibility](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/).

### Practical implications

When you deploy a framework project, keep in mind:

- **Compute costs**: Framework deployments generate Functions, which incur compute time and invocation charges. See [Pricing](/en/documentation/platform/pricing/) for details.
- **Debugging**: Use [Preview Deployment](/en/documentation/build/functions/runtime-apis/functions/runtime-api/preview-deployment/), [Data Stream](/en/documentation/observe/data-stream/guides/debugging-functions-data-stream/), or [GraphQL API](/en/documentation/build/functions/guides/debugging-functions-graphql/) to debug framework-generated Functions.
- **Environment variables**: Access environment variables in your framework code using [Azion's environment variables API](/en/documentation/build/functions/runtime-apis/functions/environment-variables/).

<LinkButton link="/en/documentation/build/functions/runtime-apis/frameworks-compatibility/" label="View all supported frameworks" severity="secondary" target="_blank" />
...
<LinkButton link="/en/documentation/build/ai-inference/" label="Learn more about AI Inference" severity="secondary" target="_blank" />
...
Learn more on [How to create an function using WebAssembly on the Azion Web Platform](/en/documentation/build/functions/guides/webassembly-on-azion-platform/).
...
Learn more about [Functions Instances](/en/documentation/build/applications/reference/functions-instances/).
...
Learn more about [Rules Engine](/en/documentation/build/applications/reference/rules-engine/).
...
Learn more about the [Functions Code Editor](/en/documentation/build/functions/runtime-apis/functions/runtime-api/code-editor/).
...
Learn more about the [AI Assistant](/en/documentation/build/functions/runtime-apis/functions/runtime-api/ai-integration/).
...
Learn more about [Preview Deployment](/en/documentation/build/functions/runtime-apis/functions/runtime-api/preview-deployment/).

---

## Debug

You can debug your functions in real time using the `inspect` tool inside the [Preview Deployment](/en/documentation/build/functions/runtime-apis/functions/runtime-api/preview-deployment/) section.

You can also debug using:

- [Data Stream](/en/documentation/observe/data-stream/guides/debugging-functions-data-stream/)
- [GraphQL API](/en/documentation/build/functions/guides/debugging-functions-graphql/)
...
Learn more about [Environment Variables](/en/documentation/build/functions/runtime-apis/functions/environment-variables/).
