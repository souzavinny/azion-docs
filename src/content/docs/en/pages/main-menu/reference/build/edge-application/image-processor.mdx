...
permalink: /documentation/build/applications/reference/image-processor/
---
...
| Scope | Resource |
| --- | --- |
| Image processor first steps | [Image Processor first steps](/en/documentation/build/applications/guides/image-processor/) |
