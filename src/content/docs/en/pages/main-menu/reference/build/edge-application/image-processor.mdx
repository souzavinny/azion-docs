...
permalink: /documentation/build/applications/image-processor/
---
...
:::tip
You can follow the **Bandwidth Saving** graph through [Real-Time Metrics](/en/documentation/observe/real-time-metrics/) to monitor the traffic savings resulting from the processed images.
:::
...
| Scope | Resource |
| --- | --- |
| Image processor first steps | [Image Processor first steps](/en/documentation/build/applications/image-processor/first-steps/) |
