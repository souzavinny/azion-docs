...
permalink: /documentation/build/applications/quickstart/
---

Before using **Applications**, make sure you have:

- An Azion Console account. You can find more information about how to create your account on the [documentation page](/en/documentation/account/reference/creating-account/).
- An application. If you haven't created an application yet, check the [build an application](/en/documentation/get-started/journeys/launch/) page.

> See also the guides on [how to clone](/en/documentation/build/applications/guides/clone-applications/) and [how to delete](/en/documentation/build/applications/guides/delete-applications/) an application.
...
- [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/)
- [Cache](/en/documentation/build/applications/reference/cache/)
- [Functions](/en/documentation/build/applications/reference/functions/)
- [Image Processor](/en/documentation/build/applications/reference/image-processor/)
- [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/)

Some **Applications modules** are billed products and it may generate usage-related costs. Check the [Applications modules pricing](/en/documentation/platform/pricing/) for more information.
...
- [Device Groups](/en/documentation/build/applications/reference/device-groups/)
- [Cache Settings](/en/documentation/build/applications/reference/cache-settings/)
- [Functions](/en/documentation/build/applications/reference/functions-instances/)
- [Rules Engine](/en/documentation/build/applications/reference/rules-engine/)
...
To configure your application's origin you'll use [Connectors](/en/documentation/build/connectors/).
...
:::note
For more details on Connector Types, please visit the [Connectors reference](/en/documentation/build/connectors/).
:::
...
**Connector** enables you to configure multiple origins and distribute traffic among them by using [Load Balancer](/en/documentation/build/connectors/reference/load-balancer/).

:::tip
You can use [Custom Pages](/en/documentation/secure/custom-pages/) to configure custom error pages that are displayed when **Connector** receives specific error responses (such as HTTP 4xx or 5xx status codes) from your origin.
:::

### Device Groups

Manage devices using [Device Groups](/en/documentation/build/applications/reference/device-groups/):
...
Edit your cache configuration in [Cache Settings](/en/documentation/build/applications/reference/cache-settings/):
...
5. If you've chosen to override cache settings, add the desired **Maximum TTL** in seconds.
    - At this point, you may also customize other cache settings for dynamic content provided by the [Advanced Cache Key](/en/documentation/build/applications/reference/cache-settings/#advanced-cache-key) feature.
6. Click the **Save** button.

#### Tiered Cache

To use the [Tiered Cache](/en/documentation/build/applications/reference/cache/tiered-cache/) module:
...
Instantiate your functions using [Functions](/en/documentation/build/applications/reference/functions-instances/):
...
Create conditional business rules for your application using [Rules Engine](/en/documentation/build/applications/reference/rules-engine/).
...
To access [Real-Time Purge](/en/documentation/build/applications/reference/real-time-purge/), proceed as follows:
