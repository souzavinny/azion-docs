...
- [Cache Settings](/en/documentation/build/cache/reference/cache-settings/)
- [Functions](/en/documentation/build/functions/reference/functions-instances/)
...
Edit your cache configuration in [Cache Settings](/en/documentation/build/cache/reference/cache-settings/):
...
5. If you've chosen to override cache settings, add the desired **Maximum TTL** in seconds.
    - At this point, you may also customize other cache settings for dynamic content provided by the [Advanced Cache Key](/en/documentation/build/cache/reference/cache-settings/#advanced-cache-key) feature.
6. Click the **Save** button.
...
Instantiate your functions using [Functions](/en/documentation/build/functions/reference/functions-instances/):
...
To access [Real-Time Purge](/en/documentation/build/cache/reference/real-time-purge/), proceed as follows:
