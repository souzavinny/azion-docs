...
- [Application Accelerator](/en/documentation/build/applications/application-accelerator/)
- [Cache](/en/documentation/build/applications/cache/)
- [Functions](/en/documentation/build/applications/functions/)
- [Image Processor](/en/documentation/build/applications/image-processor/)
- [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/)
...
To configure your application's origin you'll use [Connectors](/en/documentation/secure/connectors/).
...
:::note
For more details on Connector Types, please visit the [Connectors reference](/en/documentation/secure/connectors/).
:::
...
**Connector** enables you to configure multiple origins and distribute traffic among them by using [Load Balancer](/en/documentation/secure/connectors/reference/load-balancer/).
...
To use the [Tiered Cache](/en/documentation/build/applications/cache/tiered-cache/) module:
