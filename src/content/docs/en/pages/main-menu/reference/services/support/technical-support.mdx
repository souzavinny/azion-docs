...
:::tip
If you want to open a ticket, see the guide on [How to open a Support Ticket](/en/documentation/services/support/guides/open-ticket/).
:::
...
<Tabs client:visible>
  ...
  | **CNAMEs already in use** | You have encountered the error *CNAMEs already in use* when listing a CNAME in one of your [Azion domains](/en/documentation/build/applications/reference/domains/). |
  ...
  | **Template (Preview)** | You need a new [Template](/en/documentation/marketplace/reference/templates/) to be added to the Azion Marketplace. |
  ...
  | **Rules Engine** | You have questions about how to set up a behavior using [Rules Engine for Applications](/en/documentation/build/applications/reference/rules-engine/) or [Rules Engine for Firewall](/en/documentation/secure/firewall/reference/rules-engine/). |
