...
<Tabs client:visible>
  ...
  | **CNAMEs already in use** | You have encountered the error *CNAMEs already in use* when listing a CNAME in one of your [Azion domains](/en/documentation/secure/workloads/reference/domains/). |
