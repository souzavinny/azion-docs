...
<LinkButton link="/en/documentation/build/ai-inference/reference/models/" label="See Available Models" severity="secondary" />
...
- [Applications](/en/documentation/build/applications/): build applications that run directly on Azion's distributed network, delivering exceptional performance and customization options.
- [Functions](/en/documentation/build/applications/reference/functions/): execute code closer to end users, enhancing performance and enabling custom logic for handling requests and responses.
...
- [Vector Search](/en/documentation/store/sql-database/reference/vector-search/): enable semantic search engines and AI-powered recommendations through vector embeddings at the edge.
...
<LinkButton link="/en/documentation/marketplace/integrations/langgraph-ai-agent-boilerplate/" label="Go to the LangGraph AI Agent template guide" severity="secondary" />
