...
permalink: /documentation/deploy/orchestrator/reference/edge-node/
---
...
| Scope | Guide |
| - | - | 
| Edge Node | [ Edge Node first steps](/en/documentation/deploy/orchestrator/guides/edge-node-first-steps/) |
