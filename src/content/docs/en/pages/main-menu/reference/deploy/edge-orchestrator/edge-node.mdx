...
permalink: /documentation/build/orchestrator/reference/edge-node/
---
...
| Scope | Guide |
| - | - | 
| Edge Node | [ Edge Node first steps](/en/documentation/build/orchestrator/guides/edge-node-first-steps/) |
