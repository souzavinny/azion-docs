...
permalink: /documentation/deploy/orchestrator/
---
...
Orchestrator deploys workloads on Azion's distributed network, on multi-cloud platforms, on-premises, or on remote devices. It can run natively on the operating system, within containers, or on top of the [Azion Runtime](/en/documentation/runtime/overview/).
...
| Scope | Guide |
| - | - | 
| Node | [Node first steps](/en/documentation/deploy/orchestrator/guides/edge-node-first-steps/) |
| Services| [Creating an Edge Service](/en/documentation/deploy/orchestrator/guides/edge-services-first-steps/) |
...
All services linked to Nodes will be orchestrated and configured from the moment the device is authorized via the control panel. A service can be linked to many Nodes: when a service is updated, it's automatically deployed to the Nodes it's related to.
...
Learn more about the [Azion Orchestrator agent installation](/en/documentation/deploy/orchestrator/guides/edge-node-first-steps/#installing).
...
[Learn more about Node](/en/documentation/deploy/orchestrator/reference/edge-node/).

---

## Services

**Services** enables you to create your own services. You can use your customized services and ensure your device is managed and orchestrated by [Azion Console](https://console.azion.com). You can configure install, uninstall, and reload triggers and define resource dependencies for service execution.

[Learn more about Services](/en/documentation/deploy/orchestrator/reference/edge-services/).
