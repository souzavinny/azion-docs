...
| Scope | Guide |
| - | - | 
| Node | [Node first steps](/en/documentation/build/orchestrator/guides/edge-node-first-steps/) |
| Services| [Creating an Edge Service](/en/documentation/build/orchestrator/guides/edge-services-first-steps/) |
...
Learn more about the [Azion Orchestrator agent installation](/en/documentation/build/orchestrator/guides/edge-node-first-steps/#installing).
...
[Learn more about Node](/en/documentation/build/orchestrator/reference/edge-node/).
...
[Learn more about Services](/en/documentation/build/orchestrator/reference/edge-services/).
