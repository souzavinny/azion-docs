...
[Let's Encrypt](https://letsencrypt.org/)™ is a nonprofit global CA that allows people and organizations to obtain, renew, and manage TLS certificates for free. When [creating a Domain](/en/documentation/secure/workloads/reference/domains/) with Azion, you may choose to obtain a TLS certificate signed by Let's Encrypt. You can request Let's Encrypt certificates for domains hosted in [Edge DNS](/en/documentation/secure/edge-dns/) or in a third-party DNS provider.
...
:::tip
See [how to add a TXT record for a Let's Encrypt certificate](/en/documentation/secure/firewall/guides/lets-encrypt-record/) and [how to generate a Let's Encrypt certificate for your domain](/en/documentation/secure/certificate-manager/guides/lets-encrypt/).
:::
...
If any of the CNAMEs hosted in external providers fail the [DNS-01 challenge](/en/documentation/secure/certificate-manager/guides/lets-encrypt/#option-2-preparing-dns-entry-with-an-external-dns-provider), the certificate won't be generated and will remain with the *Pending* status.
...
- **For users of Let's Encrypt Certificates with IdenTrust**: you must migrate to the new Let's Encrypt signing technology or an [Azion edge certificate](/en/documentation/secure/certificate-manager/reference/mtls-for-build/#edge-certificate).
