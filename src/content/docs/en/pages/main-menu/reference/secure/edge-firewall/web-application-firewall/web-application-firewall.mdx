...
WAF can operate in two modes: **Learning** or **Blocking**. You can set the mode in a rule in [Rules Engine](/en/documentation/secure/firewall/reference/rules-engine/) with the **Set WAF Rule Set** behavior or via [Azion API](https://api.azion.com/#ace1b2f6-253a-48a1-bf58-4c5381e22c21).
...
| Scope | Source |
| ----- | ------ |
| Create WAF rule set | [How to create a WAF rule set](/en/documentation/secure/firewall/guides/create-waf-rule-set/) |
| WAF mode | [How to check your WAF mode](/en/documentation/secure/waf/guides/how-to-check-your-waf-mode/) |
| WAF score | [How to find information about WAF blocked requests](/en/documentation/secure/waf/guides/how-to-find-waf-score/) |
| Integrate WAF with SIEMs | [How to integrate WAF with SIEMs](/en/documentation/secure/firewall/guides/integrate-siems/) |
...
:::tip
Learn more about [Firewall modules](/en/documentation/secure/firewall/) and the [Rules Engine for Firewall](/en/documentation/secure/firewall/reference/rules-engine/).
:::


<LinkButton link="/en/documentation/secure/firewall/guides/firewall-configure-main-settings/" label="go to configure firewall guide" severity="secondary" /> 
...
<LinkButton link="/en/documentation/secure/waf/reference/rules-set/#threat-types" label="go to types of threats reference" severity="secondary" /> <br></br>

<LinkButton link="/en/documentation/secure/firewall/guides/create-waf-rule-set/" label="go to create a rule set guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/waf/reference/rules-set/#sensitivity-levels" label="go to sensitivity levels reference" severity="secondary" />
...
- **Full list:** see the description of rule families and their `Rule IDs` in [WAF Rule Sets](/en/documentation/secure/waf/reference/rules-set/).
...
You can find the detailed description of Rule 13 and its parameters on the [WAF Rule Sets](/en/documentation/secure/waf/reference/rules-set/) page.
...
<LinkButton link="/en/documentation/secure/firewall/guides/tune-waf/" label="go to tune WAF guide" severity="secondary" /> 
...
<LinkButton link="/en/documentation/secure/waf/reference/custom-allowed-rules/" label="go to WAF Custom Allowed Rules reference" severity="secondary" />
...
| Field | Description |
| ----- | ----------- |
| `Rule ID` | Unique numeric ID of a WAF Rule. See the list of rules in [WAF Rule Sets](/en/documentation/secure/waf/reference/rules-set/). |
...
For complete API specifications and examples, see the [WAF Exceptions documentation](/en/documentation/secure/waf/reference/custom-allowed-rules/#managing-exceptions-via-api) and the [Azion API reference](https://api.azion.com/v4#/operations/list_waf_exceptions).
