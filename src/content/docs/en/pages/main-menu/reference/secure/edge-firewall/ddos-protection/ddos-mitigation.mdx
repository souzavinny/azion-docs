...
permalink: /documentation/secure/ddos-protection/reference/ddos-mitigation/
---
...
<LinkButton link="/en/documentation/secure/ddos-protection/" label="Go to DDoS Protection" severity="secondary" target="_blank" />
...
:::tip
You can implement custom rules to mitigate specific attacks, using [Firewall](/en/documentation/secure/firewall/), a programmable firewall at the edge equipped with Network Shield, Rate Limiting, WAF, and Bot Manager.
:::
