...
permalink: /documentation/secure/bot-manager/reference/lite/
---
...
<LinkButton link="/en/documentation/marketplace/integrations/bot-manager-lite/" label="Go to How to install Azion Bot Manager Lite from Azion Marketplace guide" severity="secondary" /> 

<LinkButton link="/en/documentation/marketplace/integrations/bot-manager-lite-starter-kit/" label="Go to the How to test Bot Manager Lite using a template guide" severity="secondary" /> 

<LinkButton link="/en/documentation/marketplace/integrations/bot-manager-lite-integration-kit/" label="Go to the How to add Bot Manager Lite to an existent firewall with a template guide" severity="secondary" /> 
