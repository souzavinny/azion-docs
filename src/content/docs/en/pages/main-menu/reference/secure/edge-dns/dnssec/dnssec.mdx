...
permalink: /documentation/secure/edge-dns/reference/dnssec-compatibility/
---
...
<LinkButton link="/en/documentation/secure/firewall/guides/activate-dnssec/" label="activate DNSSEC" severity="secondary" /> 
