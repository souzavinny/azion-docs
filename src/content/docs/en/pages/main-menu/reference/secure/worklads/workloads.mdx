...
:::note
This page documents the new Workloads product. If your account hasn't been migrated yet, refer to the [legacy Domains reference](/en/documentation/secure/workloads/reference/domains/).
:::
