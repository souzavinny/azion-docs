...
permalink: /documentation/secure/certificate-manager/guides/wildcard-lets-encrypt/
...
<LinkButton link="/en/documentation/secure/firewall/guides/certificate-manager/" label="consult the guide on obtaining and registering a digital certificate" severity="secondary" />
