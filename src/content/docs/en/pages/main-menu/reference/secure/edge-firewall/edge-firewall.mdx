...
| Scope | Source |
| ----- | ------ |
| Main settings | [How to configure main settings](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/) |
| Update Firewall | [How to update your Firewall](/en/documentation/secure/firewall/guides/how-to-update-your-firewall/) |
| Get to know Network Lists | [Network Lists](/en/documentation/secure/firewall/reference/network-shield/network-lists/) |
| Get to know WAF Rule Sets | [WAF Rule Sets](/en/documentation/secure/waf/reference/rules-set/) |
| Get to know WAF Custom Allowed Rules | [WAF Custom Allowed Rules](/en/documentation/secure/waf/reference/custom-allowed-rules/) |
| Get to know Functions | [Functions Instances for Firewall](/en/documentation/secure/firewall/reference/functions-instances/) |
| Get to know Rules Engine | [Rules Engine for Firewall](/en/documentation/secure/firewall/reference/rules-engine/) |
| Get to know Certificate Manager | [Certificate Manager for Secure](/en/documentation/secure/certificate-manager/) |
| DNSSEC Compatibility | [DNSSEC Compatibility](/en/documentation/secure/edge-dns/reference/dnssec-compatibility/) |
| Create network lists | [How to create IP blocklists with Network Shield](/en/documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/) |
| WAF Mode | [How to check your WAF mode](/en/documentation/secure/waf/guides/how-to-check-your-waf-mode/) |
...
<LinkButton link="/en/documentation/secure/firewall/guides/firewall-configure-main-settings/" label="go to configure main settings guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/firewall/reference/rules-engine/" label="go to Rules Engine reference" severity="secondary" />

<LinkButton link="/en/documentation/secure/firewall/guides/work-with-rules-engine/" label="go to work with rules engine guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/ddos-protection/" label="go to DDoS Protection reference" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/firewall/reference/functions/" label="go to Functions for Firewall reference" severity="secondary" />

<LinkButton link="/en/documentation/secure/firewall/guides/instantiate-functions/" label="go to instantiate functions guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/network-shield/" label="go to Network Shield reference" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/waf/" label="go to Web Application Firewall reference" severity="secondary" />

<LinkButton link="/en/documentation/secure/firewall/guides/create-waf-rule-set/" label="go to create waf rule set guide" severity="secondary" />
