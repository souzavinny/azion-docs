...
permalink: /documentation/secure/connectors/reference/origin-shield/
---
...
| Scope | Resource |
| --- | --- |
| Secure an application | [Secure an application](/en/documentation/get-started/journeys/protect/infrastructure/) |
...
To activate it, enable Origin IP ACL for at least one [connector](/en/documentation/secure/connectors/) in your account.
