...
permalink: /documentation/build/connectors/reference/origin-shield/
---
...
To activate it, enable Origin IP ACL for at least one [connector](/en/documentation/build/connectors/) in your account.
