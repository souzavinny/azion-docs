...
permalink: /documentation/secure/firewall/reference/rules-engine/
---
...
<LinkButton link="/en/documentation/secure/firewall/" label="Go to Firewall Reference" outlined />

<LinkButton link="/en/documentation/secure/firewall/guides/work-with-rules-engine/" label="Go to Work With Rules Engine Guide" outlined />

## Implementation

| Scope | Resource |
| --- | --- |
| Secure an application | [How to secure an application](/en/documentation/get-started/journeys/protect/) |
| Configuring main settings | [How to configure Firewall main settings](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/) |
| Creating a WAF rule set | [How to create a WAF rule set](/en/documentation/secure/firewall/guides/create-waf-rule-set/) |
| Blocking Tor exit node IP addresses | [How to block Tor exit node IP addresses](/en/documentation/secure/firewall/guides/block-tor-networks/) |
...
After that, you'll be able to add [Functions Instances](/en/documentation/secure/firewall/reference/functions-instances/) and **Rules Engine** rules. The fields and requirements to use **Rules Engine for Firewall** are explained in the sections below.
:::
...
:::note 
The availability of certain criteria depends on the enabled modules of your Firewall. Go to the [Firewall concepts page](/en/documentation/secure/firewall/concepts/#how-modules-unlock-criteria-and-behaviors) for more details.
:::
...
It associates the WAF Rule Set to be used in the request. WAF policies must be previously configured in **Edge Libraries** > **WAF Rules**. You must also define the **WAF mode**: **Learning** or **Blocking**. Read more on [WAF Rule Sets](/en/documentation/secure/waf/reference/rules-set/). 
...
It runs a function specified as a parameter. The function must have been previously [instantiated and parameterized](/en/documentation/secure/firewall/guides/instantiate-functions/) in the Functions tab in order to be used.
...
You can [debug rules created with Rules Engine for Firewall](/en/documentation/build/applications/guides/debug-rules/) through the GraphQL API, Data Stream, or Real-Time Events.
