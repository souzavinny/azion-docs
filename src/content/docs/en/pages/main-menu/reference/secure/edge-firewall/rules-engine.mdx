...
:::note 
The availability of certain criteria depends on the enabled modules of your Firewall. Go to the [Firewall modules reference](/en/documentation/secure/firewall/#about-edge-firewall-modules) for more details.
:::
