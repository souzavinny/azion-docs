---
title: Azion Bot Manager reference
description: >-
  Complete reference for Bot Manager: features, bot classification, report log
  fields, JSON Args setup options, engine versions, and additional resources.
meta_tags: 'bot, protection, cybersecurity, edge computing, reference, json args, report log'
namespace: documentation_secure_bot_manager_reference
permalink: /documentation/secure/bot-manager/reference/
---

import LinkButton from 'azion-webkit/linkbutton';

This page documents every configuration section of [Bot Manager](/en/documentation/secure/bot-manager/): features, bot classification, report log fields, JSON Args setup options, engine versions, and additional resources.
...
<LinkButton link="/en/documentation/secure/firewall/reference/network-shield/network-lists/" label="go to network lists reference" severity="secondary" /> 
...
The following table describes the possible classification values and categories (attack types) of Bot Manager and how they are identified, as they can be seen in [Real Time Metrics](/en/documentation/observe/real-time-metrics/#bot-manager):
...
<LinkButton link="/en/documentation/observe/data-stream/" label="Go to Data Stream Reference" severity="secondary" /> 
<br />
<LinkButton link="/en/documentation/observe/real-time-events/" label="Go to Real-Time Events Reference" severity="secondary" /> 

You can also check the Bot Manager graphs in [Real-Time Metrics](/en/documentation/observe/real-time-metrics/). The Bot Manager tab displays metrics related to Bot Manager activity, being generated almost in real time, with an aggregation interval of up to *60 seconds*. Depending on the chart, the data can be stored for up to *2 years*. 
...
<LinkButton link="/en/documentation/observe/real-time-metrics/" label="Go to Real-Time Metrics Reference" severity="secondary"/>
<br />
<LinkButton link="/en/documentation/observe/real-time-metrics/#bot-manager" label="Go to Bot Manager Graphs" severity="secondary"/>

#### GraphiQL Playground

Use the GraphiQL Playground to access detailed information about Bot Manager's performance and operations. For example, you can [query Bot Manager data](/en/documentation/devtools/graphql/guides/query-bot-manager-data-with-graphql/) or [query the top URLs impacted by bots](/en/documentation/devtools/graphql/guides/query-bot-manager-breakdown-data-with-graphql/) to analyze bot activity, and retrieve data to optimize your configurations.

<LinkButton link="/en/documentation/devtools/graphql/reference/playground/" label="Go to GraphiQL Playground" severity="secondary"/>
<br />
<LinkButton link="/en/documentation/devtools/graphql/reference/gql-real-time-metrics-fields/#botmanagermetrics" label="Go to Bot Manager Fields" severity="secondary"/>
...
- Read the [How to use the ALTCHA Function through Azion Marketplace](https://www.azion.com/en/documentation/build/functions/guides/altcha/) for more information.
:::
...
For more information about how to install the Javascript Tag (JS TAG) through Azion, [read our documentation](/en/documentation/marketplace/integrations/javascript-tag-js-tag/).
...
- **You must run ALTCHA before Bot Manager in the Firewall Rules Engine for the challenge to work correctly.** This creates complementary defense layers and prevents redirect loops, ensuring the best experience for legitimate users. 
- Alternatively, you can use the ALTCHA Function independently—only with Firewall—to protect specific areas of your application by requiring the challenge. 
- Read the guide [How to use the ALTCHA Function through Azion Marketplace](/en/documentation/build/functions/guides/altcha/) to know more.
:::
...
Azion will provide you with easy-to-go configurations, that should be enough for most of the cases. If you need a more detailed configuration, you can add new custom rules based on your business needs. It's also possible to add more criteria and behaviors to be executed by the [Rules Engine](/en/documentation/secure/firewall/reference/rules-engine/), building more comprehensive responses to possible attacks. 
