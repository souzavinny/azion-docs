...
permalink: /documentation/secure/firewall/reference/functions/
---

[Functions](/en/documentation/build/applications/reference/functions/) are functions that run on the Azion Web Platform with low latency, bringing the operational power closer to the end user.

[Firewall](/en/documentation/secure/firewall/) supports functions. Through them you can write your own security source code in JavaScript and deploy it to run at the edge of the network.
...
| Scope | Guide |
| - | - | 
| Function for Firewall | [How to create and configure an function on your Firewall](/en/documentation/build/functions/guides/firewall/) |
...
Find out more about the [GeoIP metadata list](/en/documentation/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#geo-ip).

### Remote

You're able to check the IP address and the TCP port used.

Find out more about the [Remote metadata list](/en/documentation/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#remote).

### Server

You're able to check the protocol being used in the request.

Find out more about the [Server metadata list](/en/documentation/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#server).

### TLS

The TLS-related metadata is available when the request is made over a secure TLS connection.

Find out more about the [TLS metadata list](/en/documentation/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#tls).
