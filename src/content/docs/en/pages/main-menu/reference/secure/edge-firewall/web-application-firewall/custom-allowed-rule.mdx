...
permalink: /documentation/secure/waf/reference/custom-allowed-rules/
...
:::tip
Learn more about [Firewall modules](/en/documentation/secure/firewall/) and [Web Application Firewall](/en/documentation/secure/waf/).
:::
...
For more information on how WAF tuning works in practice, [check our guide on how to configure it](https://www.azion.com/en/documentation/secure/firewall/guides/tune-waf/).
...
| 13      | Invalid POST format. <br/> **Note**: requests that fall under rule 13 will be blocked in some cases, even if the WAF is operating in *learning* mode. Read the [Rules Engine for Firewall](/en/documentation/secure/firewall/reference/rules-engine/) documentation for the definition of learning/blocking modes. Read this guide [how to check your WAF mode](/en/documentation/secure/waf/guides/how-to-check-your-waf-mode/).                                                                                                                      |
...
## Allowed Rules fields

The Allowed Rules are composed of the fields:

| Field | Description |
| ----- | ----------- |
| `Rule ID` | Unique numeric ID of a WAF Rule. See the [list of internal rules](#waf-internal-rules). |
...
| `match_zone` | string | The part of the request to match against. See [Match Zone options](#match-zone-dropdown-options) |
