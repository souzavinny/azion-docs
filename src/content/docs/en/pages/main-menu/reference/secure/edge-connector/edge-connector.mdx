...
:::note
This page documents the new Connectors product. If your account hasn't been migrated yet, refer to the [legacy Origins reference](/en/documentation/secure/connectors/reference/origins/).
:::
