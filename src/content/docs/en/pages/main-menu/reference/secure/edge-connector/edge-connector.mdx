...
permalink: /documentation/secure/connectors/
---
...
:::note
This page documents the new Connectors product. If your account hasn't been migrated yet, refer to the [legacy Origins reference](/en/documentation/build/applications/reference/origins/).
:::
...
| Load Balancer module | [Load Balancer](/en/documentation/secure/connectors/reference/load-balancer/) |
...
<LinkButton link="/en/documentation/secure/connectors/reference/load-balancer/" label="Learn more about Load Balancer" />
...
The bucket name is defined when you [create or modify an Object Storage bucket](/en/documentation/store/object-storage/guides/create-and-modify-bucket/). When creating a connector, the bucket selector automatically lists your existing buckets and provides a search field to help you find the desired bucket.
...
<LinkButton link="/en/documentation/store/object-storage/" label="Go to Object Storage reference" />
