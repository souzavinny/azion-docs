...
permalink: /documentation/secure/firewall/reference/network-shield/network-lists/
---
...
:::tip
Learn more about [Firewall modules](/en/documentation/secure/firewall/), [Network Shield](/en/documentation/secure/network-shield/), and the [Rules Engine for Firewall](/en/documentation/secure/firewall/reference/rules-engine/).
:::
...
| Scope | Source |
| ----- | ------ |
| Network Lists | [How to create IP, ASN, and geolocation block/allow lists with Network Lists](/en/documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/) |
...
<LinkButton link="/en/documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/" label="create network lists" severity="secondary" /> 
...
<LinkButton link="/en/documentation/secure/firewall/guides/block-tor-networks/" label="go to block Tor networks guide" severity="secondary" />
<LinkButton link="/en/documentation/secure/connectors/reference/origin-shield/" label="go to Origin Shield reference" severity="secondary" />
