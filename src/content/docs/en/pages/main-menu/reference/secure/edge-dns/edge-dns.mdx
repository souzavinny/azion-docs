...
| Scope | Source |
|-------|--------|
| Main settings | [How to configure Edge DNS main settings](/en/documentation/secure/firewall/guides/edge-dns-configure-main-settings/) |
| Dig command | [How to look up DNS servers with the dig command](/en/documentation/secure/edge-dns/guides/run-the-dig-command/) |
| Traceroute command | [How to diagnose performance and delivery issues with the traceroute command](/en/documentation/secure/edge-dns/guides/run-the-traceroute-command/) |
...
<LinkButton link="/en/documentation/secure/firewall/guides/test-zone/" label="go to test zone guide" severity="secondary" /> 

---

## Edge DNS Records

<LinkButton link="/en/documentation/secure/firewall/guides/add-records/" label="go to add records guide" severity="secondary" />
...
Your domain is now set up and ready to be served by Azion **Edge DNS**. To make sure everything is working well, run some of the tests described in the [test zone guide](/en/documentation/secure/firewall/guides/test-zone/).
...
<LinkButton link="/en/documentation/secure/firewall/guides/load-balance-dns/" label="go to load balance DNS records guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/edge-dns/reference/dnssec-compatibility/" label="go to DNSSEC compatibility reference" severity="secondary" /> 
...
<LinkButton link="/en/documentation/secure/edge-dns/guides/run-the-dig-command/" label="go to dig command guide" severity="secondary" />
