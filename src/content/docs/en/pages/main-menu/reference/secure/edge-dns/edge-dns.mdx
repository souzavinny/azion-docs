...
<LinkButton link="/en/documentation/secure/firewall/guides/add-records/" label="go add records guide" severity="secondary" />
...
<LinkButton link="/en/documentation/secure/firewall/guides/load-balance-dns/" label="go load balance DNS records guide" severity="secondary" />
