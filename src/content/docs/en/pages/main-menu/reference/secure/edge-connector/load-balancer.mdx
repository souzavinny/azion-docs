...
permalink: /documentation/secure/connectors/reference/load-balancer/
---
...
For more options on how to direct traffic to **Load Balancer** based on other criteria, see the [Rules Engine for Application](/en/documentation/build/applications/reference/rules-engine/) page.

## Implementation

| Scope | Resource |
| --- | --- |
| Connectors | [Connectors](/en/documentation/secure/connectors/) |
...
<LinkButton link="/en/documentation/build/applications/reference/origins/#address" label="Learn more about origin addresses" />
