...
<LinkButton link="/en/documentation/secure/firewall/guides/certificate-manager/" label="go to acquire and register a digital certificate guide" severity="secondary" /> 
...
| Scope | Resource |
| --- | --- |
| About Domains | [Domains](/en/documentation/build/applications/reference/domains/) |
| About mTLS | [mTLS](/en/documentation/secure/certificate-manager/reference/mtls/) |
...
> See [How to generate a Let's Encrypt for your domain](/en/documentation/build/applications/guides/how-to-generate-a-lets-encrypt-certificate/) to know how to validate this type of certificate.
...
<LinkButton link="/en/documentation/secure/firewall/guides/lets-encrypt-record/" label="go to add TXT record for Let's Encrypt certificate guide" severity="secondary" /> 
...
1. Acesss [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Certificate Manager**.
