...
| Scope | Resource |
| --- | --- |
| About Domains | [Domains](/en/documentation/secure/workloads/reference/domains/) |
...
> See [How to generate a Let's Encrypt for your domain](/en/documentation/secure/certificate-manager/guides/lets-encrypt/) to know how to validate this type of certificate.
