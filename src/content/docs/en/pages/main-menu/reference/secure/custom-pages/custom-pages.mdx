...
permalink: /documentation/secure/custom-pages/
---
...
:::note
This page documents the new Custom Pages product. If your account hasn't been migrated yet, refer to the [legacy Error Responses documentation](/en/documentation/build/applications/reference/error-responses/).
:::

**Custom Pages** is an Azion feature that allows you to customize error pages for users based on the status code received from an [Connector](/en/documentation/secure/connectors/).
...
| Scope | Resource |
| --- | --- |
| Application first steps | [First steps](/en/documentation/build/applications/quickstart/) |
| Customizing error page | [How to customize an error response page](/en/documentation/build/applications/guides/customizing-error-response-page/) |
| Connectors | [Connectors reference](/en/documentation/secure/connectors/) |
| Workloads | [Workloads reference](/en/documentation/secure/workloads/) |
...
<LinkButton link="/en/documentation/build/applications/reference/cache-settings/#browser-cache-settings" label="Learn more about cache expiration settings" />
...
supersedes: Error Responses (legacy; still available for non-migrated accounts)
api_base: https://api.azion.com/v4
auth_header: Authorization: Token [TOKEN]
scope: HTTP 4xx (Client) and 5xx (Server) error responses
