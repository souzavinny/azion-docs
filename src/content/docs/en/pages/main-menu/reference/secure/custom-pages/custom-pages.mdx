...
**Custom Pages** is an Azion feature that allows you to customize error pages for users based on the status code received from an [Connector](/en/documentation/build/connectors/).
...
| Connectors | [Connectors reference](/en/documentation/build/connectors/) |
| Workloads | [Workloads reference](/en/documentation/build/workloads/) |
