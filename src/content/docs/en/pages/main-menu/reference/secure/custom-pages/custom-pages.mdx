...
:::note
This page documents the new Custom Pages product. If your account hasn't been migrated yet, refer to the [legacy Error Responses documentation](/en/documentation/secure/custom-pages/reference/error-responses/).
:::
...
| Customizing error page | [How to customize an error response page](/en/documentation/secure/custom-pages/guides/customizing-error-response-page/) |
...
<LinkButton link="/en/documentation/build/cache/reference/cache-settings/#browser-cache-settings" label="Learn more about cache expiration settings" />
