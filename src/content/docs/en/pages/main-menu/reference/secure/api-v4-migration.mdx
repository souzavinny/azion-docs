...
**Custom Pages** is an Azion feature that allows you to customize error pages for users based on the status code received from an [Connectors](/en/documentation/build/connectors/) when fetching the content from your origin.
