...
permalink: /documentation/devtools/api/v4-migration/
...
**Custom Pages** is an Azion feature that allows you to customize error pages for users based on the status code received from an [Connectors](/en/documentation/secure/connectors/) when fetching the content from your origin.
