...
permalink: /documentation/marketplace/reference/marketplace-seller-guide/
---
...
| [How to become an Independent Software Vendor](/en/documentation/marketplace/reference/isv-signup/) | Guide on how to apply to be a Marketplace's vendor. |
...
<LinkButton link="/en/documentation/marketplace/reference/isv-signup/" label="go to Become an ISV guide" severity="secondary" /> 
...
<LinkButton link="/en/documentation/platform/pricing/" label="go to Pricing page" severity="secondary" /> 
