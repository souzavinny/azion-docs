...
permalink: /documentation/account/guides/multi-factor-authentication/
menu_namespace: fundamentalsMenu
---

[Multi-Factor Authentication (MFA)](/en/documentation/account/reference/multi-factor-authentication/) allows you to secure logins by requiring an extra layer to authentication.
