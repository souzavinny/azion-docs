...
permalink: /documentation/account/guides/users-management/
menu_namespace: fundamentalsMenu
---

import LinkButton from 'azion-webkit/linkbutton'

[Users Management](/en/documentation/account/reference/users-management/) allows you to add, modify, and delete users to your account.
...
You can add users before or after [creating teams](/en/documentation/account/reference/teams-permissions/).
