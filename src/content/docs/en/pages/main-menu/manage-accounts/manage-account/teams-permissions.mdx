...
permalink: /documentation/account/guides/teams-permissions/
menu_namespace: fundamentalsMenu
---

With [Teams Permissions](/en/documentation/account/reference/teams-permissions/), you can create and manage teams, as well as control and configure access rights for distinct teams within your organization.
