...
permalink: /documentation/account/reference/creating-account/
...
You're now able to access **Azion Console** and start building your applications. Check the [build an application](/en/documentation/get-started/journeys/launch/) page to continue your onboarding journey.
...
You're now able to access **Console** and start building your applications. Check [build an application](/en/documentation/get-started/journeys/launch/) page to continue your onboarding journey.
