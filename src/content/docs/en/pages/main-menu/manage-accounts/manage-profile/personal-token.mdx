...
permalink: /documentation/account/guides/personal-tokens/
...
[Personal Tokens](/en/documentation/account/reference/personal-tokens/) allow you to authenticate your access to interfaces and tools such as the [Azion CLI](/en/documentation/get-started/frameworks/cli/) and [Azion API](/en/documentation/devtools/api/). 
