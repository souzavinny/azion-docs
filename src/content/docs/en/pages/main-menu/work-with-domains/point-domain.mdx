...
There are separate instructions for the [legacy Domains](/en/documentation/build/applications/reference/domains/) settings and the new [Workloads](/en/documentation/build/workloads/) product.
