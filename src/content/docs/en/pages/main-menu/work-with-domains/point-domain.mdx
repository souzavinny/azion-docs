...
permalink: /documentation/build/workloads/guides/point-domain-to-azion/
---
...
There are separate instructions for the [legacy Domains](/en/documentation/build/applications/reference/domains/) settings and the new [Workloads](/en/documentation/products/secure/workloads) product.
...
:::note
This process will require you to associate a CNAME record to your domain. To associate an ANAME record to your application, [migrate your nameservers to Azion](/en/documentation/build/workloads/guides/migrate-ns-to-azion/).
:::
...
:::tip
If your application uses HTTPS, you might want to combine this process with the [association of a digital certificate](/en/documentation/build/workloads/guides/create-a-digital-certificate/) to your custom domain.
:::
...
:::note
Some services don't allow you to change your ANAME resolution directly. You can point your custom ANAME record to your application by [migrating your nameservers to Azion](/en/documentation/build/workloads/guides/migrate-ns-to-azion/).
:::
