...
There are separate instructions for the [legacy Domains](/en/documentation/secure/workloads/reference/domains/) settings and the new [Workloads](/en/documentation/secure/workloads/) product.
