...
permalink: /documentation/build/workloads/guides/create-a-digital-certificate/
---
...
:::note[Optional]
As shown in the example below, if you didn't update the Domain and Subdomain fields with your custom domain yet, make sure to add the host and any common names for the application that are protected by the certificate. This will be useful when you later [point your domain](/en/documentation/build/workloads/guides/point-domain-to-azion/) or [migrate your NS resolution](/en/documentation/build/workloads/guides/migrate-ns-to-azion/) to Azion.
:::
