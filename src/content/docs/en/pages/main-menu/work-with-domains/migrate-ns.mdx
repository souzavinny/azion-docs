...
permalink: /documentation/secure/workloads/guides/migrate-ns-to-azion/
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and adding your domain address in the `domain` field:
...
Repeat the process described above for every CNAME listed for your application. Wait a couple of minutes for the changes to propagate. You can [run the DIG command](/en/documentation/secure/edge-dns/guides/run-the-dig-command/) in your terminal to check whether your domain points to the Azion address.
...
1. Run the following `GET` request to retrieve your workloads's ID, replacing `TOKEN VALUE` with your [personal token](/en/documentation/account/guides/personal-tokens/):
...
6. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/), `hosted_zone_id` with the value from the previous response and the answer's list with the Azion domain address as a string:
...
8. Wait a couple of minutes for the changes to propagate. You can [run the DIG command](/en/documentation/secure/edge-dns/guides/run-the-dig-command/) in your terminal to check whether your domain points to the Azion address.
...
6. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/), `hosted_zone_id` with the value from the previous response and the answers list with the Azion domain address as a string:
...
- [Access root domain](/en/documentation/secure/firewall/guides/access-root-domain/)
- [Activate DNSSEC](/en/documentation/secure/firewall/guides/activate-dnssec/)
- [Authenticate Let\'s Encrypt](/en/documentation/secure/firewall/guides/lets-encrypt-record/)
- [Perform DNS load balance](/en/documentation/secure/firewall/guides/load-balance-dns/)
