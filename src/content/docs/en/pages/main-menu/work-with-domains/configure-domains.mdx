...
permalink: /documentation/build/workloads/guides/configure-a-domain/
---
...
| `digital_certificate_id` | When `null`, selects the **Azion SAN** certificate. You can also [associate a digital certificate](/en/documentation/build/workloads/guides/create-a-digital-certificate/#via-api) to your Workload. |
...
--data '{
  ...
  | `digital_certificate_id` | When `null`, selects the **Azion SAN** certificate. You can also [associate a digital certificate](/en/documentation/build/workloads/guides/create-a-digital-certificate/#via-api) to your domain. |
...
You can choose to customize your domain by [associating a domain record](/en/documentation/build/workloads/guides/point-domain-to-azion/) or [migrating your name resolution to Azion](/en/documentation/build/workloads/guides/migrate-ns-to-azion/).
