...
permalink: /documentation/secure/workloads/guides/configure-a-domain/
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) to create a new Workload.
...
| `digital_certificate_id` | When `null`, selects the **Azion SAN** certificate. You can also [associate a digital certificate](/en/documentation/secure/workloads/guides/create-a-digital-certificate/#via-api) to your Workload. |
...
4. Now you must bind the created **Workload** to an **Application**. This is done by creating a Workload Deployment. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/), `<edge_application_id>` with the ID of the desired Application and `<workload_id>` with the ID of the Workload you created on the previous step.
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/), the `<edge_application_id>` variable with the [ID of your application](/en/documentation/build/applications/guides/configure-main-settings/):
...
--data '{
  ...
  | `digital_certificate_id` | When `null`, selects the **Azion SAN** certificate. You can also [associate a digital certificate](/en/documentation/secure/workloads/guides/create-a-digital-certificate/#via-api) to your domain. |
  | `edge_application_id` | The [ID of the application](/en/documentation/get-started/journeys/launch/#via-api) linked to the domain. |
...
You can choose to customize your domain by [associating a domain record](/en/documentation/secure/workloads/guides/point-domain-to-azion/) or [migrating your name resolution to Azion](/en/documentation/secure/workloads/guides/migrate-ns-to-azion/).
