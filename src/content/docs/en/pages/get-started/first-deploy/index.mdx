...
description: >-
  Put an application live on the Azion Web Platform in about 5 minutes,
...
By the end of this tutorial, an application will be live on the Azion Web Platform, answering HTTP 200 on its own Azion domain. It takes about 5 minutes.
...
**Before you start:** you need a GitHub account and a repository using one of the [supported frameworks](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/).
...
**Before you start:** you need the Azion CLI (installed below) and a local project using one of the [supported frameworks](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/), with its dependencies installed.

:::tip
Starting from scratch instead? Run `azion init` to create a new project from a framework template, then deploy it the same way. See the [CLI overview](/en/documentation/devtools/cli/) and the [link command reference](/en/documentation/devtools/cli/reference/link-command/) for details.
:::
