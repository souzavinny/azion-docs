...
permalink: /documentation/deploy/orchestrator/guides/install-orchestrator-agent/
...
<LinkButton link="/en/documentation/account/guides/personal-tokens/" label="go to how to generate a personal token" severity="secondary" />
<LinkButton link="/en/documentation/account/reference/personal-tokens/" label="go to Personal Token reference documentation" severity="secondary" target="_blank" />
