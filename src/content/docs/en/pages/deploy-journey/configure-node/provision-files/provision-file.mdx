...
permalink: /documentation/build/orchestrator/guides/provision-files/
...
<LinkButton link="/en/documentation/build/orchestrator/guides/work-with-variables/" label="Go to Work with Variables Guide" severity="secondary" target="_blank" />