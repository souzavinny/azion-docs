...
permalink: /documentation/deploy/orchestrator/guides/provision-files/
...
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and retrieve the edge service ID:
...
<LinkButton link="/en/documentation/deploy/orchestrator/guides/work-with-variables/" label="Go to Work with Variables Guide" severity="secondary" target="_blank" />