...
permalink: /documentation/build/orchestrator/guides/work-with-variables/
...
3. Select the [edge service](/en/documentation/build/orchestrator/guides/create-edge-service/) to which you want to add a variable.
...
5. Choose the [service](/en/documentation/build/orchestrator/guides/create-edge-service/) to which you want to apply the variable.
