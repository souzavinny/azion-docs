...
permalink: /documentation/build/orchestrator/guides/watch-logs/
...
1. Access your [edge node](/en/documentation/build/orchestrator/guides/install-orchestrator-agent/).
2. Open the terminal. 
...
<LinkButton link="/en/documentation/build/orchestrator/guides/run-scripts/" label="go to how to run scripts" severity="secondary" target="_blank" />
