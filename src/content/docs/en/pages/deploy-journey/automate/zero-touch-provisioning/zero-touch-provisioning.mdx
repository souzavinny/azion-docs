...
permalink: /documentation/build/orchestrator/guides/zero-touch-provisioning/
...
1. [Install the Orchestrator Agent](/en/documentation/build/orchestrator/guides/install-orchestrator-agent/) on your device. This device now represents an edge node.
2. [Authorize the node](/en/documentation/build/orchestrator/guides/authorize-an-edge-node/) on the Azion platform.
