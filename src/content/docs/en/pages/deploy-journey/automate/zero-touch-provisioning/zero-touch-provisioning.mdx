...
permalink: /documentation/deploy/orchestrator/guides/zero-touch-provisioning/
...
[Azion Orchestrator](/en/documentation/deploy/orchestrator/) is a programmable and extensible cloud-management and *zero-touch provisioning* orchestration service purposely built for edge infrastructures and applications.
...
1. [Install the Orchestrator Agent](/en/documentation/deploy/orchestrator/guides/install-orchestrator-agent/) on your device. This device now represents an edge node.
2. [Authorize the node](/en/documentation/deploy/orchestrator/guides/authorize-an-edge-node/) on the Azion platform.
