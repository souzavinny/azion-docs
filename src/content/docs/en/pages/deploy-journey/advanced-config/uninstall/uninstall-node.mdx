...
permalink: /documentation/deploy/orchestrator/guides/uninstall-agent/
...
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and retrieve the edge node ID you wish to delete:
...
2. Run the following `DELETE` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and `:id` with the edge node ID:
