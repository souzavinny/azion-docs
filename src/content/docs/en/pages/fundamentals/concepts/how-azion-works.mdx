...
description: >-
  How the Azion Web Platform unifies app development, security, and
  observability on a global infrastructure so you can ship faster with
...
permalink: /documentation/fundamentals/concepts/how-azion-works/
...
Products are organized around the developer workflow—build, store, secure, deploy, and observe. Each product carries its own documentation in the [main navigation](/en/documentation/).

Common use cases:

- Build and deploy [applications](/en/documentation/build/applications/) on Azion’s global infrastructure.
- Speed up delivery with [templates and integrations](/en/documentation/marketplace/reference/templates-and-integrations-overview/).
...
- Configure [caching rules](/en/documentation/build/applications/cache/) and advanced optimizations.
- Monitor performance with [real-time metrics](/en/documentation/observe/real-time-metrics/).
- Improve [performance](/en/documentation/architectures/applications/content-delivery/) and reduce bandwidth and operational costs.
- Develop with [supported frameworks and languages](/en/documentation/get-started/frameworks/overview/).
- [Migrate your architecture and content](/en/documentation/get-started/migrate/).
...
- [Azion Console](/en/documentation/account/guides/getting-to-know-azion-console/): configure products, provisioning, billing, and permissions
