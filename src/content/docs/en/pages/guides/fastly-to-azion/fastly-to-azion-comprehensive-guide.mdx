...
| **Compute packages** | Packaged application code deployed to Fastly Compute. | [Functions](https://www.azion.com/en/documentation/build/applications/functions/) + [Azion CLI](https://www.azion.com/en/documentation/products/azion-cli/overview/) |
