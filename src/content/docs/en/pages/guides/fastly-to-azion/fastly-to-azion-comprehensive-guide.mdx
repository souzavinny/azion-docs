...
permalink: /documentation/get-started/migrate/fastly/
---
...
| :------------------------ | :---------- | :--------------- |
| **Full-Site Delivery** | Website, application, API, and mobile delivery through Fastly services. | [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **Fastly services** | Main delivery resource for domains, origins, caching, request handling, and service versions. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Workloads](https://www.azion.com/en/documentation/build/workloads/) |
| **Domains** | Hostnames associated with Fastly services. | [Workloads](https://www.azion.com/en/documentation/build/workloads/) |
| **Hosts and origins** | Backend origin configuration for Fastly delivery services. | [Connectors](https://www.azion.com/en/documentation/build/connectors/) |
| **Origin Shield / shielding patterns** | Reduce origin traffic by routing cache misses through an intermediate shield location. | [Origin Shield](https://www.azion.com/en/documentation/build/connectors/reference/origin-shield/) + [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/) |
| **Conditions** | Request, cache, and response conditions in Fastly service configuration. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **Request settings** | Request manipulation, forwarding, and handling behavior. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Response settings** | Response header and delivery behavior. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **VCL snippets / custom VCL** | Custom delivery logic for redirects, headers, cache keys, origin selection, and request control. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Compute** | Serverless compute platform that runs custom code on Fastly's network. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Compute packages** | Packaged application code deployed to Fastly Compute. | [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) + [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
...
| **Cache Reservation** | Reserved cache capacity for content on Fastly. | [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/) |
| **Cache APIs** | Programmatic cache interaction patterns for Compute applications. | [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Real-Time Purge](https://www.azion.com/en/documentation/build/applications/reference/real-time-purge/) |
| **Streaming Delivery** | Delivery of live and video-on-demand streaming content. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Media Shield for Live** | Reduces origin traffic for live video workflows. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/build/connectors/reference/origin-shield/) |
| **Media Shield for VOD** | Reduces origin traffic for video-on-demand workflows. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/build/connectors/reference/origin-shield/) |
| **Image Optimizer** | Real-time image transformation and optimization service. | [Image Processor](https://www.azion.com/en/documentation/build/applications/reference/image-processor/) |
| **WebSockets** | Long-lived, bidirectional communication for real-time applications. | [WebSocket Proxy](https://www.azion.com/en/documentation/build/applications/reference/websocket/) + [WebSocket API](https://www.azion.com/en/documentation/build/functions/runtime-apis/websocket/) |
| **Fanout** | Publish-subscribe messaging patterns on Fastly. | [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) + [WebSocket Proxy](https://www.azion.com/en/documentation/build/applications/reference/websocket/) |
| **AI Accelerator** | Semantic caching and traffic acceleration for generative AI APIs. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) |
...
| **Edge Rate Limiting** | Count requests and apply actions when limits are exceeded. | [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/) + [Functions for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/functions/) |
| **Fastly DDoS Protection** | DDoS visibility and mitigation. | [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **Bot Management** | Detect and respond to automated traffic. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) + [Bot Manager Lite](https://www.azion.com/en/documentation/secure/bot-manager/reference/lite/) |
| **Certainly** | Fastly certificate authority for TLS certificates. | [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/) |
| **Platform TLS** | API-driven TLS certificate and key management. | [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/) + [Azion API](https://www.azion.com/en/documentation/devtools/api/) |
| **TLS Service Options** | TLS configuration for serving sites and applications over HTTPS. | [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/) + [Workloads](https://www.azion.com/en/documentation/build/workloads/) |
...
| **Domain Inspector** | Domain-level traffic visibility and reporting. | [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) |
| **Origin Inspector** | Origin response visibility and reporting. | [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) |
| **Observability features** | Traffic, security, performance, and origin visibility. | [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) + [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
...
* [WebSocket Proxy](https://www.azion.com/en/documentation/build/applications/reference/websocket/)
* [WebSocket API](https://www.azion.com/en/documentation/build/functions/runtime-apis/websocket/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/)
* [Origin Shield](https://www.azion.com/en/documentation/build/connectors/reference/origin-shield/)
