...
| **Fastly services** | Main delivery resource for domains, origins, caching, request handling, and service versions. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Workloads](https://www.azion.com/en/documentation/secure/workloads/) |
| **Domains** | Hostnames associated with Fastly services. | [Workloads](https://www.azion.com/en/documentation/secure/workloads/) |
| **Hosts and origins** | Backend origin configuration for Fastly delivery services. | [Connectors](https://www.azion.com/en/documentation/secure/connectors/) |
| **Origin Shield / shielding patterns** | Reduce origin traffic by routing cache misses through an intermediate shield location. | [Origin Shield](https://www.azion.com/en/documentation/secure/connectors/reference/origin-shield/) + [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/) |
...
| **Request settings** | Request manipulation, forwarding, and handling behavior. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
...
| **VCL snippets / custom VCL** | Custom delivery logic for redirects, headers, cache keys, origin selection, and request control. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
| **Compute** | Serverless compute platform that runs custom code on Fastly's network. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/functions/) |
| **Compute packages** | Packaged application code deployed to Fastly Compute. | [Functions](https://www.azion.com/en/documentation/build/applications/functions/) + [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
...
| **Cache Reservation** | Reserved cache capacity for content on Fastly. | [Cache](https://www.azion.com/en/documentation/build/applications/cache/) + [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/) |
| **Cache APIs** | Programmatic cache interaction patterns for Compute applications. | [Functions](https://www.azion.com/en/documentation/build/applications/functions/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) + [Real-Time Purge](https://www.azion.com/en/documentation/build/applications/reference/real-time-purge/) |
| **Streaming Delivery** | Delivery of live and video-on-demand streaming content. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Media Shield for Live** | Reduces origin traffic for live video workflows. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/secure/connectors/reference/origin-shield/) |
| **Media Shield for VOD** | Reduces origin traffic for video-on-demand workflows. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/secure/connectors/reference/origin-shield/) |
| **Image Optimizer** | Real-time image transformation and optimization service. | [Image Processor](https://www.azion.com/en/documentation/build/applications/image-processor/) |
| **WebSockets** | Long-lived, bidirectional communication for real-time applications. | [WebSocket Proxy](https://www.azion.com/en/documentation/build/applications/reference/websocket/) + [WebSocket API](https://www.azion.com/en/documentation/runtime/api-reference/websocket/) |
| **Fanout** | Publish-subscribe messaging patterns on Fastly. | [Functions](https://www.azion.com/en/documentation/build/applications/functions/) + [WebSocket Proxy](https://www.azion.com/en/documentation/build/applications/reference/websocket/) |
| **AI Accelerator** | Semantic caching and traffic acceleration for generative AI APIs. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) |
...
| **TLS Service Options** | TLS configuration for serving sites and applications over HTTPS. | [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/) + [Workloads](https://www.azion.com/en/documentation/secure/workloads/) |
