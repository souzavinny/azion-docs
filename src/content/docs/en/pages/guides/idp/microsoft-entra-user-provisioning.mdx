...
permalink: /documentation/account/guides/microsoft-entra-automated-user-provisioning/
...
:::note
You need an Azion personal token to execute the following tasks. Read the documentation to [create a new personal token](/en/documentation/account/guides/personal-tokens/).

You also need to previously [configure Microsoft Entra as an Identity Provider (IdP) for Azion](/en/documentation/account/guides/sso-microsoft-entra-saml/).
:::
...
:::note 
The IdP must be active and linked with the right SAML Application in the Microsoft Entra console. Check the guide on using [Microsoft Entra custom SAML app as an IdP for Azion](/en/documentation/account/guides/sso-microsoft-entra-saml/) for more details on this configuration.
:::
