...
permalink: /documentation/account/guides/sso-microsoft-entra-saml/
...
Alternatively, you can enable Automated User Provisioning, using the SCIM protocol. Check the [how-to guide](/en/documentation/account/guides/microsoft-entra-automated-user-provisioning/) to get more information.
