...
permalink: /documentation/build/applications/guides/live-ingest-best-practices/
...
- Basic knowledge of [Applications](/en/documentation/build/applications/) and [Cache Settings](/en/documentation/build/applications/reference/cache-settings/).
- Familiarity with the [Rules Engine](/en/documentation/build/applications/reference/rules-engine/) for Applications.
...
See the documentation on [how to query connected users data with GraphQL API](/en/documentation/devtools/graphql/guides/query-connected-users-data-with-graphql/) to implement custom monitoring dashboards.
...
See the guide [Implement HLS cache](/en/documentation/build/applications/cache/guides/enforce-hls-cache/) for detailed instructions.
...
- [Implement HLS cache](/en/documentation/build/applications/cache/guides/enforce-hls-cache/)
- [Applications](/en/documentation/build/applications/)
...
- [Real-Time Metrics](/en/documentation/observe/real-time-metrics/)
- [Query connected users data with GraphQL API](/en/documentation/devtools/graphql/guides/query-connected-users-data-with-graphql/)