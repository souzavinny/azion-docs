...
- Basic knowledge of [Applications](/en/documentation/build/applications/) and [Cache Settings](/en/documentation/build/cache/reference/cache-settings/).
...
See the guide [Implement HLS cache](/en/documentation/build/cache/guides/enforce-hls-cache/) for detailed instructions.
...
- [Implement HLS cache](/en/documentation/build/cache/guides/enforce-hls-cache/)
