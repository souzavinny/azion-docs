...
See the guide [Implement HLS cache](/en/documentation/build/applications/guides/enforce-hls-cache/) for detailed instructions.
...
- [Implement HLS cache](/en/documentation/build/applications/guides/enforce-hls-cache/)
