...
permalink: /documentation/store/sql-database/guides/sql-database-vector-search/
...
<LinkButton link="/en/documentation/store/sql-database/reference/vector-search/" label="Go to Vector Search Reference" severity="secondary" target="_blank" />
...
- Generate an [Azion personal token](/en/documentation/account/guides/personal-tokens/).
...
- Create a typescript application. 
    - As in the example, you can use the [Azion CLI](/en/documentation/devtools/cli/reference/init/) to create a Simple Typescript Router application.
