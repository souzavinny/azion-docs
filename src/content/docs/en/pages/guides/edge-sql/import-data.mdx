...
permalink: /documentation/store/sql-database/guides/import-data-sql-database/
...
- **SQL Database Shell Installed**: Ensure that you have the SQL Database shell properly [installed on your system](/en/documentation/store/sql-database/guides/install-edge-sql-shell/).
