...
permalink: /documentation/store/sql-database/guides/retrieve-data-with-functions/
...
- [Azion Functions enabled](/en/documentation/build/applications/functions/).
- An active [Azion Personal Token](/en/documentation/account/guides/personal-tokens/).
...
<LinkButton link="/en/documentation/build/functions/guides/instantiate-functions/" label="go to How to instantiate functions in your application" severity="secondary" />
