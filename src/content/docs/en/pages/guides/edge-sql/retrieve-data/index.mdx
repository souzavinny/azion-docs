...
- [Azion Functions enabled](/en/documentation/build/applications/reference/functions/).
...
<LinkButton link="/en/documentation/build/applications/guides/instantiate-functions/" label="go to How to instantiate functions in your application" severity="secondary" />
