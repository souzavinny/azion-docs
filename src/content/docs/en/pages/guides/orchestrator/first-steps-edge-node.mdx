...
permalink: /documentation/deploy/orchestrator/guides/edge-node-first-steps/
...
:::tip
To generate the personal token required to authenticate your edge nodes, follow the steps in the [Personal Token documentation](/en/documentation/account/guides/personal-tokens/).
:::
