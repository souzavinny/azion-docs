...
permalink: /documentation/observe/real-time-metrics/guides/metrics-dash/
menu_namespace: realTimeMetricsMenu
---

Follow the steps described in [How to use a pre-built dashboard with the Azion plugin on Grafana](/en/documentation/observe/real-time-metrics/guides/azion-plugin-grafana-pre-built-dash/) and then use the following JSON with the `https://api.azionapi.net/metrics/graphql` URL to create a dashboard on Grafana with data from the Real-Time Metrics GraphQL API such as:
