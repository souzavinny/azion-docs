...
permalink: /documentation/build/functions/guides/get-started/
meta_tags: >-
...
export default defineAzionConfig({
  // See https://www.azion.com/en/documentation/build/applications/reference/cache/ for advanced options
});
```
...
See [Known Issues](/en/documentation/build/functions/runtime-apis/compatibility/nextjs/#known-issues) for more details.
...
This runs your Application locally, simulating the Azion platform. [See Troubleshooting](/en/documentation/build/functions/guides/troubleshooting/) for tips on debugging and log monitoring.
...
- See [Known Issues](/en/documentation/build/functions/runtime-apis/compatibility/nextjs/#known-issues) for important config notes.
- See [Troubleshooting](/en/documentation/build/functions/guides/troubleshooting/) for local dev, logging, and debugging tips.
- Explore [Examples](/en/documentation/build/functions/runtime-apis/compatibility/nextjs/#examples) for starter projects and templates.
- For advanced caching, see [Caching](/en/documentation/build/applications/reference/cache/).
