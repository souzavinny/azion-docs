...
export default defineAzionConfig({
  // See https://www.azion.com/en/documentation/build/applications/cache/ for advanced options
});
```
...
- For advanced caching, see [Caching](/en/documentation/build/applications/cache/).
