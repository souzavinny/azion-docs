...
permalink: /documentation/secure/network-shield/guides/blocklists-ip-addresses-edge/
...
1. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Network Lists**, from the **Edge Libraries** section.
