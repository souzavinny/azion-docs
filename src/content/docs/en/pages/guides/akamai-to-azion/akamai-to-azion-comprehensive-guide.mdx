...
permalink: /documentation/get-started/migrate/akamai/
---
...
| :------------------------ | :---------- | :--------------- |
| **Ion** | Web performance, reliability, and user experience optimization at scale. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Application Accelerator](https://www.azion.com/en/documentation/build/applications/reference/application-accelerator/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) |
| **API Acceleration** | API performance and reliability optimization. | [Application Accelerator](https://www.azion.com/en/documentation/build/applications/reference/application-accelerator/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) |
| **Adaptive Media Delivery** | Large-scale online video delivery. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Download Delivery** | Optimized delivery for large files, software, games, and media assets. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Dedicated Delivery** | High-volume media delivery with origin offload requirements. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/) |
| **Image & Video Manager** | Image and video optimization for devices and network conditions. | [Image Processor](https://www.azion.com/en/documentation/build/applications/reference/image-processor/) |
| **Media Services Live** | Live video ingest and delivery workflows. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Live ingest best practices](https://www.azion.com/en/documentation/build/applications/guides/live-ingest-best-practices/) |
| **Cloudlets** | Predefined policy applications for redirects, load balancing, traffic control, phased releases, and request handling. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) + [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) + [Firewall](https://www.azion.com/en/documentation/secure/firewall/) |
| **Cloud Wrapper** | Private caching layer for origin offload and reduced egress. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/build/connectors/reference/origin-shield/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) |
| **EdgeWorkers** | JavaScript functions that customize request and response behavior. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Akamai Functions** | Distributed serverless execution for application and AI workloads. | [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
...
| **API Gateway** | API registration, routing, delivery, and protection. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) + [Firewall](https://www.azion.com/en/documentation/secure/firewall/) |
| **App Platform** | Managed containerized application deployment. | [Orchestrator](https://www.azion.com/en/documentation/deploy/orchestrator/) |
...
| **App & API Protector** | Application and API protection against vulnerabilities, abuse, and distributed threats. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [Web Application Firewall](https://www.azion.com/en/documentation/secure/waf/) + [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/) + [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) |
| **Firewall for AI** | Protection for LLM and AI-driven applications. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) |
| **API Security** | API discovery, monitoring, and protection workflows. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [Web Application Firewall](https://www.azion.com/en/documentation/secure/waf/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
...
| **Account Protector** | Protection for account abuse and credential attacks. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) + [Firewall](https://www.azion.com/en/documentation/secure/firewall/) |
| **Content Protector** | Protection against content scraping and abusive automated access. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) + [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **Input Validation Cloudlet** | Form and request validation controls. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/) |
| **Request Control Cloudlet** | Fast access control and request filtering. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/) |
| **Cloud Firewall** | Network security controls for cloud workloads. | [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) + [Firewall](https://www.azion.com/en/documentation/secure/firewall/) |
| **Prolexic Solutions** | DDoS protection for infrastructure, cloud, hybrid, and on-premises environments. | [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **Forward Rewrite Cloudlet** | URL rewrite logic for clean and semantic URLs. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Phased Release Cloudlet** | Gradual release and rollback control. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **API Prioritization Cloudlet** | API traffic prioritization. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Application Accelerator](https://www.azion.com/en/documentation/build/applications/reference/application-accelerator/) |
| **Application Load Balancer Cloudlet** | Application load balancing for performance and availability. | [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) |
| **Audience Segmentation Cloudlet** | Cookie-based segmentation, A/B testing, and session affinity patterns. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **Edge Redirector Cloudlet** | Centralized redirect management. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **NodeBalancers** | Layer 4 and Layer 7 load balancing for compute instances. | [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) |
...
| **Global Traffic Management** | Traffic steering for performance optimization and outage avoidance. | [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) + [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) |
...
| **Akamai TrafficPeak** | Observability for operations and security visibility. | [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) + [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
...
| **mPulse** | Real-user monitoring and digital experience analytics. | [Edge Pulse](https://www.azion.com/en/documentation/observe/edge-pulse/) + [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) |
...
* [Origin Shield](https://www.azion.com/en/documentation/build/connectors/reference/origin-shield/)
...
* [Advanced Cache Key](https://www.azion.com/en/documentation/build/applications/guides/advanced-cache-key/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/)
...
* [How to enforce HLS cache for live streaming delivery](https://www.azion.com/en/documentation/build/applications/guides/enforce-hls-cache/)
...
* [Application Accelerator](https://www.azion.com/en/documentation/build/applications/reference/application-accelerator/)
...
* [Certificate Manager](/en/documentation/secure/certificate-manager/)
...
* [WAF Rule Sets](https://www.azion.com/en/documentation/secure/waf/reference/rules-set/)
...
* [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/)
* [How to configure Edge DNS main settings](https://www.azion.com/en/documentation/secure/firewall/guides/edge-dns-configure-main-settings/)
* [How to add DNS records](https://www.azion.com/en/documentation/secure/firewall/guides/add-records/)
* [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/)
...
* [How to manage KV Store with Functions](https://www.azion.com/en/documentation/store/kv-store/guides/manage-with-functions/)
* [KV Store API](https://www.azion.com/en/documentation/build/functions/runtime-apis/kv-store/)
* [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/)
...
* [How to create and query data on SQL Database](https://www.azion.com/en/documentation/store/sql-database/guides/create-tables-sql-database/)
* [How to import data to SQL Database](https://www.azion.com/en/documentation/store/sql-database/guides/import-data-sql-database/)
* [How to retrieve data from a database with SQL Database and Functions](https://www.azion.com/en/documentation/store/sql-database/guides/retrieve-data-with-functions/)
...
* [How to configure sampling on Data Stream](https://www.azion.com/en/documentation/observe/data-stream/guides/configure-sampling/)
* [How to select variables on Data Stream](https://www.azion.com/en/documentation/observe/data-stream/guides/data-stream-select-variables/)
...
* [Edge Pulse first steps](https://www.azion.com/en/documentation/observe/edge-pulse/quickstart/)
* [How to analyze navigation data from Edge Pulse](https://www.azion.com/en/documentation/observe/data-stream/guides/analyze-navigation-data/)
...
* [Understand Real-Time Events logs](https://www.azion.com/en/documentation/observe/data-stream/guides/understand-logs/)
