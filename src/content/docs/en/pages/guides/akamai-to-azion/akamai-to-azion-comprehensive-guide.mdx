...
| :------------------------ | :---------- | :--------------- |
| **Ion** | Web performance, reliability, and user experience optimization at scale. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Application Accelerator](https://www.azion.com/en/documentation/build/applications/application-accelerator/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) |
| **API Acceleration** | API performance and reliability optimization. | [Application Accelerator](https://www.azion.com/en/documentation/build/applications/application-accelerator/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) |
| **Adaptive Media Delivery** | Large-scale online video delivery. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Download Delivery** | Optimized delivery for large files, software, games, and media assets. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Dedicated Delivery** | High-volume media delivery with origin offload requirements. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) + [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/) |
| **Image & Video Manager** | Image and video optimization for devices and network conditions. | [Image Processor](https://www.azion.com/en/documentation/build/applications/image-processor/) |
...
| **Cloudlets** | Predefined policy applications for redirects, load balancing, traffic control, phased releases, and request handling. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) + [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) + [Firewall](https://www.azion.com/en/documentation/secure/firewall/) |
| **Cloud Wrapper** | Private caching layer for origin offload and reduced egress. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/secure/connectors/reference/origin-shield/) + [Cache](https://www.azion.com/en/documentation/build/applications/cache/) |
| **EdgeWorkers** | JavaScript functions that customize request and response behavior. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/functions/) |
| **Akamai Functions** | Distributed serverless execution for application and AI workloads. | [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
...
| **Forward Rewrite Cloudlet** | URL rewrite logic for clean and semantic URLs. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
...
| **API Prioritization Cloudlet** | API traffic prioritization. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Application Accelerator](https://www.azion.com/en/documentation/build/applications/application-accelerator/) |
| **Application Load Balancer Cloudlet** | Application load balancing for performance and availability. | [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) |
...
| **NodeBalancers** | Layer 4 and Layer 7 load balancing for compute instances. | [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) |
...
| **Global Traffic Management** | Traffic steering for performance optimization and outage avoidance. | [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) + [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) |
...
* [Origin Shield](https://www.azion.com/en/documentation/secure/connectors/reference/origin-shield/)
...
* [Advanced Cache Key](https://www.azion.com/en/documentation/build/applications/cache/guides/advanced-cache-key/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/)
...
* [How to enforce HLS cache for live streaming delivery](https://www.azion.com/en/documentation/build/applications/cache/guides/enforce-hls-cache/)
...
* [Application Accelerator](https://www.azion.com/en/documentation/build/applications/application-accelerator/)
