...
You can use the [debugging process](/en/documentation/devtools/debugging/) to identify errors in your functions. One of the options for debugging is using the [GraphQL API](/en/documentation/devtools/graphql/reference/overview/).
