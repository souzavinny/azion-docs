...
permalink: /documentation/build/functions/guides/debugging-functions-graphql/
---

You can use the [debugging process](/en/documentation/build/functions/runtime-apis/debugging/) to identify errors in your functions. One of the options for debugging is using the [GraphQL API](/en/documentation/devtools/graphql/reference/overview/).

To do so, follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/devtools/graphql/guides/query-graphql-postman/) using the `https://api.azionapi.net/events/graphql` URL.
