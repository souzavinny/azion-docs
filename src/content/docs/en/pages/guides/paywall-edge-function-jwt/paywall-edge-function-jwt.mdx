...
permalink: /documentation/build/functions/guides/paywall-function-jwt/
...
To create a JWT function, you can refer to the guide on [How to install the JWT solution from Azion Marketplace](/en/documentation/marketplace/integrations/jwt/)
