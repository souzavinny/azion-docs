...
There are separate instructions using [legacy Domains](/en/documentation/build/applications/reference/domains/) settings and using the new [Workloads](/en/documentation/secure/workloads/) product.
