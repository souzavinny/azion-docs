...
There are separate instructions using [legacy Domains](/en/documentation/secure/workloads/reference/domains/) settings and using the new [Workloads](/en/documentation/secure/workloads/) product.
