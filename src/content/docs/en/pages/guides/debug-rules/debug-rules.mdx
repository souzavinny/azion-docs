...
permalink: /documentation/build/applications/guides/debug-rules/
---
...
<LinkButton link="/en/documentation/build/applications/reference/rules-engine/" label="Learn more about Rules Engine" severity="secondary" />

There are separate instructions using [legacy Domains](/en/documentation/build/applications/reference/domains/) settings and using the new [Workloads](/en/documentation/products/secure/workloads) product.
...
:::tip
Check the [GraphQL API documentation](/en/documentation/devtools/graphql/reference/overview/) for more information.
:::

To query the available rules data in the **GraphQL API**, follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/devtools/graphql/guides/query-graphql-postman/) using the `https://api.azionapi.net/events/graphql` URL.
...
For more information on the **GraphQL API**, visit the [datasets documentation page](/en/documentation/devtools/graphql/reference/features/#datasets).
...
8. On **Workloads**, select between **Filter Workloads** or **All Current and Future Workloads**. See more about each option on [How to associate domains on Data Stream](/en/documentation/observe/data-stream/guides/data-stream-associate-workloads/).
...
8. On **Domains**, select between **Filter Domains** or **All Current and Future Domains**. See more about each option on [How to associate domains on Data Stream](/en/documentation/observe/data-stream/guides/data-stream-associate-domains/).
