...
permalink: /documentation/store/kv-store/guides/manage-with-functions/
...
<LinkButton link="/en/documentation/store/kv-store/" label="Go to KV Store reference" severity="secondary" />
...
- [Functions enabled](/en/documentation/build/applications/functions/) in your application.
...
- Explore [Functions](/en/documentation/build/applications/functions/)
