...
permalink: /documentation/build/functions/guides/serverless-functions/
menu_namespace: applicationsMenu
---
import LinkButton from 'azion-webkit/linkbutton'

[Functions](/en/documentation/build/applications/functions/) is a module of the Azion Web Platform that allows you to program and execute serverless functions.

<LinkButton link="/en/documentation/build/applications/reference/functions-instances/" label="Go to Functions for Applications reference" severity="secondary" />
...
- Define activation triggers within [Rules Engine](/en/documentation/build/applications/reference/rules-engine/).
...
:::tip
Check the guide on [How to build an API with Functions and ChatGPT](/en/documentation/build/functions/guides/api-builder/) for an example of a function you can run in your application. 
:::
