...
[Functions](/en/documentation/build/applications/reference/functions/) is a module of the Azion Web Platform that allows you to program and execute serverless functions.
