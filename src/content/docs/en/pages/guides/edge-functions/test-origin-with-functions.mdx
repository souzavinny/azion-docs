...
- A [domain](/en/documentation/build/workloads/guides/configure-a-domain/) associated with your application
...
:::note
The following steps describe configuration in Azion Console. For detailed information about these interfaces, see the [Functions reference](/en/documentation/build/applications/reference/functions/) and [Firewall documentation](/en/documentation/secure/firewall/).
:::
...
- [Functions reference](/en/documentation/build/applications/reference/functions/)
