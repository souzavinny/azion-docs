...
permalink: /documentation/build/functions/guides/test-origin-with-functions/
...
- An [application](/en/documentation/get-started/journeys/launch/) with production traffic
- A [domain](/en/documentation/secure/workloads/guides/configure-a-domain/) associated with your application
- A test origin (your new software) accessible via HTTPS
- A [Firewall](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/) associated with your domain
...
:::note
The following steps describe configuration in Azion Console. For detailed information about these interfaces, see the [Functions reference](/en/documentation/build/applications/functions/) and [Firewall documentation](/en/documentation/secure/firewall/).
:::
...
1. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Real-Time Events**.
...
- [Functions reference](/en/documentation/build/applications/functions/)
- [Rules Engine for Firewall](/en/documentation/secure/firewall/reference/rules-engine/)
