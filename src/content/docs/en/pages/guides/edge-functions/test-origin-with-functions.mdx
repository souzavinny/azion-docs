...
:::note
The following steps describe configuration in Azion Console. For detailed information about these interfaces, see the [Functions reference](/en/documentation/build/functions/) and [Firewall documentation](/en/documentation/secure/firewall/).
:::
