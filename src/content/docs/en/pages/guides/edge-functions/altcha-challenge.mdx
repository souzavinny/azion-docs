...
permalink: /documentation/build/functions/guides/altcha/
...
To finish, you have to set up the [Rules Engine](/en/documentation/secure/firewall/reference/rules-engine/) to configure the behavior and the criteria to run ALTCHA. To do this:
...
For the ALTCHA flow to work correctly, you also need to create a rule in the [Application Rules Engine](/en/documentation/build/applications/reference/rules-engine/) to redirect users to the verification endpoint when the challenge hasn't been solved yet.
