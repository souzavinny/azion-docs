...
Learn about the required process to create a [function](/en/documentation/build/applications/reference/functions/) that uses a [WebAssembly](https://webassembly.org/getting-started/developers-guide/) originated function.
