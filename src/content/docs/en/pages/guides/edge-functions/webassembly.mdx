...
permalink: /documentation/build/functions/guides/webassembly-on-azion-platform/
menu_namespace: applicationsMenu
og_image: >-
  “/assets/docs/images/uploads/use-case_-creating-a-function-using-webassembly.png”
---

Learn about the required process to create a [function](/en/documentation/build/applications/functions/) that uses a [WebAssembly](https://webassembly.org/getting-started/developers-guide/) originated function.
...
Now, the function is ready to be instantiated in an application. Check how to [instantiate and execute the functions in your application](/en/documentation/build/applications/reference/functions-instances/) and try it out.
