...
permalink: /documentation/build/functions/guides/browserless-functions/
...
<LinkButton link="/en/documentation/get-started/journeys/launch/" text="Build an application" />
