...
permalink: /documentation/build/functions/guides/file-upload-functions/
...
<LinkButton link="/en/documentation/store/object-storage/" text="Learn more about Object Storage" />
