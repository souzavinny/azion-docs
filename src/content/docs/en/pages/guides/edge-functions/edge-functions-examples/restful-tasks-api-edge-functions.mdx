...
permalink: /documentation/build/functions/guides/restful-tasks-api-functions/
...
For more details, see [SQL Database documentation](https://www.azion.com/en/documentation/store/sql-database/).
...
<LinkButton link="/en/documentation/store/sql-database/" text="Learn more about SQL Database" />
<LinkButton link="/en/documentation/build/applications/functions/" text="Learn more about Functions" />
