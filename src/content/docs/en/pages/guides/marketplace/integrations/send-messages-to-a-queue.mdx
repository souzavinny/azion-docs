...
permalink: /documentation/marketplace/integrations/send-messages-to-a-queue/
---
...
Being an [Application function](/en/documentation/marketplace/reference/integrations/#edge-application-functions), **Send messages to a queue** runs on the edge *employing* an existing application.

:::tip
Go to the [building section](/en/documentation/get-started/journeys/launch/) for more details on how to build an application.
:::
