...
permalink: /documentation/marketplace/integrations/jwt/
---
...
To finish, you have to set up the [Rules Engine](/en/documentation/secure/firewall/reference/rules-engine/) to configure the behavior and the criteria to run the JWT.
...
:::tip
You can see a use case by visiting the [Setting up a paywall with Function JWT](/en/documentation/build/functions/guides/paywall-function-jwt/) page.
:::
