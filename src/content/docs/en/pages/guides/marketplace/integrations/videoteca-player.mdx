...
permalink: /documentation/marketplace/integrations/videofront-player/
---
...
2. Select the application from the list to which you want to add the integration or [create a new application](/en/documentation/build/applications/quickstart/).
