...
permalink: /documentation/marketplace/integrations/massive-redirect-integration/
---
...
:::tip
To create an applications, go to the [building](/en/documentation/get-started/journeys/launch/) section.
:::
