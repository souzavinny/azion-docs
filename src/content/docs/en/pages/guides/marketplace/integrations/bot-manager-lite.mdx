...
permalink: /documentation/marketplace/integrations/bot-manager-lite/
...
1. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Marketplace**.
...
:::caution[Warning]
If a product or module is activated, it could generate usage-related costs. Check the [pricing page](/en/documentation/platform/pricing/) for more details.
:::
...
:::caution[Warning]
If a product or module is activated, it could generate usage-related costs. Check the [pricing page](/en/documentation/platform/pricing/) for more information.
:::
...
:::tip
Check [Data Stream First Steps](/en/documentation/observe/data-stream/quickstart/) and [How to configure Data Stream main settings](/en/documentation/observe/data-stream/guides/use-data-stream/) for more details.
:::
...
:::tip
Check [Real⁠-⁠Time Events first steps](/en/documentation/observe/real-time-events/quickstart/) and [How to understand Real⁠-⁠Time Events logs](/en/documentation/observe/data-stream/guides/understand-logs/) for more details.
:::
...
:::tip
Check [How to debug rules created with Rules Engine](/en/documentation/build/applications/guides/debug-rules/) for step-by-step instructions on querying `traceback` via Data Stream, Real-Time Events, and the GraphQL API.
:::

<LinkButton link="/en/documentation/secure/firewall/guides/manage-bots/" label="Go to the Manage Bots Guide" outlined />
