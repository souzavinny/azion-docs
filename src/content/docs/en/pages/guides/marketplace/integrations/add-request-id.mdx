...
permalink: /documentation/marketplace/integrations/add-request-id-header/
---
...
:::caution[Warning]
If a product or module is activated, it could generate usage-related costs, such as function execution. Check the [pricing page](/en/documentation/platform/pricing/) for more information.
:::
