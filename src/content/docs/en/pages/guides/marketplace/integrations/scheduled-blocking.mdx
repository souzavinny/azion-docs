...
permalink: /documentation/marketplace/integrations/scheduled-blocking/
---
...
Finally, you must set up the [Rules Engine](/en/documentation/secure/firewall/reference/rules-engine/) to configure the *behavior* and the *criteria* to run the function.
