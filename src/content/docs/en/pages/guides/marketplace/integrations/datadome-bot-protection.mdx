...
permalink: /documentation/marketplace/integrations/datadome-bot-protection/
---
...
:::caution[Warning]
Activating modules may generate usage-related costs. Check the [pricing page](/en/documentation/platform/pricing/) for more details.
:::
