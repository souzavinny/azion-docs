...
permalink: /documentation/marketplace/integrations/langgraph-ai-agent-boilerplate/
---
...
2.  You must have a **`.env` file** with your environment variables in it. If you want to create a new one, it must follow the structure below:
    ...
    :::tip
    You can use the [Azion EdgeSQL Shell](/en/documentation/store/sql-database/guides/sql-database-shell-commands/) to interact with your databases. This shell provides a command-line interface that allows you to better visualize your databases and tables and execute SQL commands directly from the terminal.
