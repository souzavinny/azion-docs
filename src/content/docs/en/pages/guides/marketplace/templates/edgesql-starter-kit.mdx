...
permalink: /documentation/marketplace/integrations/sqldatabase-starter-kit/
---
...
:::tip
Read the documentation for more details about [managing applications](/en/documentation/build/applications/quickstart/) and [managing EdgeSQL databases](/en/documentation/store/sql-database/guides/manage-sql-database/).
:::
