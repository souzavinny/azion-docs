...
:::tip
Read the documentation about [managing applications](/en/documentation/build/applications/quickstart/) and [Azion Image Processor](/en/documentation/build/image-processor/) for more details.
:::
