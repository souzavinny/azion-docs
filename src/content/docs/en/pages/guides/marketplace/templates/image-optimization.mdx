...
permalink: /documentation/marketplace/integrations/image-optimization-template/
---
...
:::tip
Read the documentation about [managing applications](/en/documentation/build/applications/quickstart/) and [Azion Image Processor](/en/documentation/build/applications/reference/image-processor/) for more details.
:::
