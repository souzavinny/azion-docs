...
:::tip
Read the documentation about [managing applications](/en/documentation/build/applications/quickstart/) and [how to configure cache policies for Applications](/en/documentation/build/cache/guides/cache-settings/) for more details.
:::
