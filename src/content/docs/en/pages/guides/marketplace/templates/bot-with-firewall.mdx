...
permalink: /documentation/marketplace/integrations/bot-manager-lite-integration-kit/
---
...
- Have an [Firewall](/en/documentation/secure/firewall/) created in your account.
    - During the setup of the template, you must inform the ID of your existing Firewall to add the Bot Manager Lite instance. If the ID doesn't exist, the execution will fail. Check [how to configure and edit an Firewall](/en/documentation/get-started/journeys/protect/#step-1-configure-main-settings).
...
You can calibrate and edit the arguments to better adjust the integration to your needs. Read more on [How to manage bots](/en/documentation/secure/firewall/guides/manage-bots/).
...
Read more on [How to observe and calibrate rules](/en/documentation/secure/firewall/guides/manage-bots/).
...
:::tip
Read the documentation about [managing applications](/en/documentation/build/applications/quickstart/) and [how to configure cache policies for Applications](/en/documentation/build/applications/guides/cache-settings/) for more details.
:::
...
<LinkButton link="/en/documentation/build/workloads/guides/configure-a-domain/" label="go to configuring a domain guide reference" severity="secondary" /> 
