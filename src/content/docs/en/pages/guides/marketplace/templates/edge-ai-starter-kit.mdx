...
:::tip
Read the documentation about [managing functions](/en/documentation/build/applications/reference/functions/) for more details.
:::
...
<LinkButton link="/en/documentation/build/workloads/guides/configure-a-domain/" label="Go to the domain configuration guide" severity="secondary" />
