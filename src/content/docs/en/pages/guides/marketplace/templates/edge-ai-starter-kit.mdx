...
- The template uses [Application Accelerator](/en/documentation/build/application-accelerator/), [Functions](/en/documentation/build/functions/), and [AI Inference](/en/documentation/build/ai-inference/). This may generate usage-related costs. Check the [pricing page](/en/documentation/platform/pricing/) for more information.
