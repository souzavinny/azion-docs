...
permalink: /documentation/marketplace/integrations/edge-application-proxy-template/
---
...
- **Behavior**: then [Set Origin](/en/documentation/build/applications/reference/rules-engine/#set-origin) `Default Origin`, [Bypass Cache](/en/documentation/build/applications/reference/rules-engine/#bypass-cache), and [Forward Cookies](/en/documentation/build/applications/reference/rules-engine/#forward-cookies).
...
- This template uses [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/) and [Functions](/en/documentation/build/applications/reference/functions/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
...
- **Custom Host Header**: in some cases, it may be necessary to add host information in the header request to retrieve information from the origin. This variable is used for that purpose.
    - Example: `${host}`. Read more about the host header and how to customize it on the [Origins documentation](/en/documentation/build/applications/reference/origins/#host-header).
