...
- This template uses [Application Accelerator](/en/documentation/build/applications/application-accelerator/), [Functions](/en/documentation/build/applications/functions/), [Image processor](/en/documentation/build/applications/image-processor/), and [Network Shield](/en/documentation/secure/network-shield/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
...
<LinkButton link="/en/documentation/secure/workloads/guides/configure-a-domain/" label="go to configuring a domain guide" severity="secondary" /> 
