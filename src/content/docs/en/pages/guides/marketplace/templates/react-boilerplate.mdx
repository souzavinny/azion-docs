...
permalink: /documentation/marketplace/integrations/react-boilerplate/
---
...
- This template uses [Functions](/en/documentation/build/applications/reference/functions/) and [Cache](/en/documentation/build/applications/reference/cache/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
...
- A pop-up window will open to confirm the installation of the [Azion GitHub App](https://www.azion.com/en/documentation/get-started/first-deploy/github/azion-github-app/), a tool that connects your GitHub account with Azion's platform.
...
With the integration of the [Azion Bundler framework adapter](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/), the application undergoes an optimized build process, emphasizing optimal performance and efficiency.
...
<LinkButton link="/en/documentation/build/applications/reference/domains/" label="go to Workloads reference" severity="secondary" /> 
