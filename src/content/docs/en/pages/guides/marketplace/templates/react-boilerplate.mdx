...
- This template uses [Functions](/en/documentation/build/applications/functions/) and [Cache](/en/documentation/build/applications/cache/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
