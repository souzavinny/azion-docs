...
permalink: /documentation/marketplace/integrations/bot-manager-lite-and-tor-block-starter-kit/
---
...
- This template uses [Functions](/en/documentation/build/applications/reference/functions/) and [Network Shield](/en/documentation/secure/network-shield/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
...
You can calibrate and edit the arguments to better adjust the integration to your needs. To read more about the Bot Manager Lite variables, check the [How to install Azion Bot Manager Lite](https://www.azion.com/en/documentation/marketplace/integrations/bot-manager-lite/) and [How to manage bots guides](https://www.azion.com/en/documentation/secure/firewall/guides/manage-bots/).
...
Read more on [How to observe and calibrate rules](/en/documentation/secure/firewall/guides/manage-bots/#use-real-time-events-to-observe-and-calibrate-rules).
