...
permalink: /documentation/account/guides/conditional-access-by-ip-address/
...
1. Run the following `POST` request in your terminal, replacing `[Token]` with your [personal token](/en/documentation/account/guides/personal-tokens/) to configure your policy.
...
1. Run the following `GET` request in your terminal, replacing `[Token]` with your [personal token](/en/documentation/account/guides/personal-tokens/) to list all your configured account policies.
...
4. Run the following `PUT` request in your terminal, replacing `[Token]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and `<id>` with the identifier you copied in the previous step, to update the status of your policy. 
...
3. Copy the `id` of the policy you want to update. 
4. Run the following `DELETE` request in your terminal, replacing `[Token]` with your [personal token](/en/documentation/account/guides/personal-tokens/) and `<id>` with the identifier you copied in the previous step, to delete the policy. 
