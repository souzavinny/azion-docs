...
permalink: /documentation/account/guides/configure-user-session-timeout/
...
<LinkButton link="/en/documentation/account/reference/user-session-timeout/" label="Go to User Session Timeout reference" severity="secondary" target="_blank" />
