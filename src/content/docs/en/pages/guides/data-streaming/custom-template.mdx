...
permalink: /documentation/observe/data-stream/guides/data-stream-custom-template/
...
While [configuring a stream](/en/documentation/observe/data-stream/guides/use-data-stream/) on **Azion Console**, after choosing a data source on Data Stream, you have two options:
