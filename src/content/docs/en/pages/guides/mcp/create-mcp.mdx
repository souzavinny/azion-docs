...
permalink: /documentation/devtools/mcp/guides/run-mcp-server/
---
...
In this guide we will create an [Function](/en/documentation/build/applications/reference/functions/) to run a MCP server.
