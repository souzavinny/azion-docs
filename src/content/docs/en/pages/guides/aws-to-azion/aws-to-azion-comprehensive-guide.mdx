...
| **CloudFront Invalidation** | Remove content from CloudFront edge caches before expiration. | [Real-Time Purge](https://www.azion.com/en/documentation/build/cache/reference/real-time-purge/) |
...
| **Amazon API Gateway** | Create and manage REST, HTTP, and WebSocket APIs with backend integrations. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
...
| **CloudFront Signed URLs / Signed Cookies** | Restrict access to private content using signed URLs or cookies. | [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
...
`} />
:::note
Azion manages environment variables at the Function instance level, not through a standalone variables API. Variables are configured as key-value pairs in the `vars` field when creating or updating a function instance. See the [Functions Instances documentation](https://www.azion.com/en/documentation/build/functions/reference/functions-instances/) for details.
:::
</Fragment>
</Tabs>
...
* [Working with variables](https://www.azion.com/en/documentation/build/orchestrator/guides/work-with-variables/)
...
* [Functions Instances](https://www.azion.com/en/documentation/build/functions/reference/functions-instances/)
* [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/)
...
* [Cache Settings](https://www.azion.com/en/documentation/build/cache/reference/cache-settings/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/)
* [Real-Time Purge](https://www.azion.com/en/documentation/build/cache/reference/real-time-purge/)
...
* [How to process images](https://www.azion.com/en/documentation/build/image-processor/guides/process-images/)
