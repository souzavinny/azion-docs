...
| **CloudFront Alternate Domain Names** | Configure custom domains for CloudFront distributions. | [Workloads](https://www.azion.com/en/documentation/secure/workloads/) |
...
| **CloudFront Cache Policies** | Control cache keys, TTLs, headers, cookies, query strings, and compression. | [Cache](https://www.azion.com/en/documentation/build/applications/cache/) |
...
| **CloudFront Origin Shield** | Additional centralized caching layer to reduce origin load and improve cache hit ratio. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/) |
...
| **CloudFront Functions** | Lightweight JavaScript execution at the edge for redirects, rewrites, headers, and cache-key normalization. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/functions/) |
| **Lambda@Edge** | Node.js or Python functions triggered by CloudFront events to customize delivery. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/functions/) |
...
| **AWS Lambda** | General-purpose serverless compute for event-driven code execution. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/functions/) |
| **Amazon API Gateway** | Create and manage REST, HTTP, and WebSocket APIs with backend integrations. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
...
| **S3 Object Lambda** | Transform S3 objects with Lambda before returning them to the requester. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
| **S3 Object Lambda for image transformation** | Resize, watermark, redact, or transform content retrieved from S3. | [Image Processor](https://www.azion.com/en/documentation/build/applications/image-processor/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
...
| **Elastic Load Balancing** | Distributes traffic across multiple targets and availability zones. | [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) |
| **Application Load Balancer** | Layer 7 HTTP/HTTPS load balancing with application-level routing. | [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) |
| **Network Load Balancer** | Layer 4 TCP/UDP/TLS load balancing. | [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) |
| **AWS Global Accelerator** | Global Anycast IPs and optimized routing over the AWS global network. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/) |
| **CloudFront Origin Access Control** | Secure S3 origins so users access content through CloudFront instead of directly from S3. | [Connectors](https://www.azion.com/en/documentation/secure/connectors/) + [Origin Shield](https://www.azion.com/en/documentation/secure/connectors/reference/origin-shield/) |
| **CloudFront Signed URLs / Signed Cookies** | Restrict access to private content using signed URLs or cookies. | [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
...
* [Connectors](https://www.azion.com/en/documentation/secure/connectors/)
...
* [Functions](https://www.azion.com/en/documentation/build/applications/functions/)
...
* [Load Balancer](https://www.azion.com/en/documentation/secure/connectors/reference/load-balancer/)
* [Connectors](https://www.azion.com/en/documentation/secure/connectors/)
...
* [Cache](https://www.azion.com/en/documentation/build/applications/cache/)
* [Cache Settings](https://www.azion.com/en/documentation/build/applications/reference/cache-settings/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/applications/cache/tiered-cache/)
...
* [Image Processor](https://www.azion.com/en/documentation/build/applications/image-processor/)
* [How to process images](https://www.azion.com/en/documentation/build/applications/image-processor/guides/process-images/)
...
Create a workload in Azion Console and associate your custom domain. See [Workloads Documentation](https://www.azion.com/en/documentation/secure/workloads/).
...
* [Workloads](https://www.azion.com/en/documentation/secure/workloads/)
* [Create an Azion custom domain](https://www.azion.com/en/documentation/secure/workloads/guides/create-azion-custom-domain/)
...
* [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/)
* [Create a digital certificate](https://www.azion.com/en/documentation/secure/workloads/guides/create-a-digital-certificate/)
