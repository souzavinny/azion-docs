...
permalink: /documentation/get-started/migrate/aws/
---
...
| :---------- | :---------- | :--------------- |
| **Amazon CloudFront** | AWS CDN for delivering static content, dynamic content, APIs, applications, and video globally. | [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **CloudFront Distributions** | Main CloudFront delivery resource for domains, origins, cache behavior, certificates, security, and edge delivery settings. | [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **CloudFront Alternate Domain Names** | Configure custom domains for CloudFront distributions. | [Workloads](https://www.azion.com/en/documentation/build/workloads/) |
| **CloudFront Cache Behaviors** | Path-based delivery behavior, cache policy, origin request policy, allowed methods, and edge function associations. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **CloudFront Cache Policies** | Control cache keys, TTLs, headers, cookies, query strings, and compression. | [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) |
| **CloudFront Origin Request Policies** | Control which request values CloudFront forwards to origin. | [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **CloudFront Response Headers Policies** | Add or modify response headers such as security headers and CORS headers. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **CloudFront Origin Shield** | Additional centralized caching layer to reduce origin load and improve cache hit ratio. | [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/) |
| **CloudFront Invalidation** | Remove content from CloudFront edge caches before expiration. | [Real-Time Purge](https://www.azion.com/en/documentation/build/applications/reference/real-time-purge/) |
| **CloudFront Functions** | Lightweight JavaScript execution at the edge for redirects, rewrites, headers, and cache-key normalization. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Lambda@Edge** | Node.js or Python functions triggered by CloudFront events to customize delivery. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Lambda@Edge for security logic** | Use CloudFront-triggered functions for request validation, authentication, or blocking logic. | [Functions for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/functions/) |
| **CloudFront Device Detection** | Detect device type and pass device metadata to the origin. | [Device Groups](https://www.azion.com/en/documentation/build/applications/reference/device-groups/) |
| **AWS Elemental MediaLive** | Real-time live video encoding. | [Live Ingest](https://www.azion.com/en/documentation/build/applications/guides/live-ingest-best-practices/) |
| **AWS Elemental MediaPackage** | Package and originate live video streams for HLS, DASH, and related formats. | [Live Ingest](https://www.azion.com/en/documentation/build/applications/guides/live-ingest-best-practices/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **CloudFront for live streaming** | Deliver live video globally using CloudFront with AWS Media Services. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Live Ingest](https://www.azion.com/en/documentation/build/applications/guides/live-ingest-best-practices/) |
| **AWS Lambda** | General-purpose serverless compute for event-driven code execution. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Amazon API Gateway** | Create and manage REST, HTTP, and WebSocket APIs with backend integrations. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **API Gateway request validation / throttling** | Apply API request controls, throttling, and validation rules. | [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Firewall](https://www.azion.com/en/documentation/secure/firewall/) |
| **AWS Amplify Hosting** | Git-based CI/CD and hosting for static and server-side rendered web apps. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
| **AWS App Runner** | Deploy source code or container images to managed web applications. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Orchestrator](https://www.azion.com/en/products/orchestrator/) |
...
| **Amazon S3 Static Website Hosting** | Host static websites from S3 buckets. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **S3 Object Lambda** | Transform S3 objects with Lambda before returning them to the requester. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **S3 Object Lambda for image transformation** | Resize, watermark, redact, or transform content retrieved from S3. | [Image Processor](https://www.azion.com/en/documentation/build/applications/reference/image-processor/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
...
| **AWS WAF** | Web application firewall for protecting applications and APIs. | [WAF](https://www.azion.com/en/documentation/secure/waf/) / [Firewall](https://www.azion.com/en/documentation/secure/firewall/) |
| **AWS Managed Rules for AWS WAF** | Managed rule groups for common vulnerabilities and unwanted traffic. | [WAF Rule Sets](https://www.azion.com/en/documentation/secure/waf/reference/rules-set/) |
| **AWS WAF custom rules** | Create custom match conditions and actions for web requests. | [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/) |
...
| **AWS WAF Rate-Based Rules** | Rate limit requests based on IP, headers, URI, method, or other keys. | [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **AWS WAF IP Sets** | Reusable IP/CIDR lists for allow or block rules. | [Network Lists](https://www.azion.com/en/documentation/secure/firewall/reference/network-shield/network-lists/) |
| **AWS Shield Standard** | Standard DDoS protection for AWS resources. | [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/) |
| **AWS Shield Advanced** | Advanced DDoS protection with additional visibility and mitigation options. | [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/) |
| **Shield Advanced automatic DDoS mitigation** | Automatically creates or updates WAF protections during application-layer attacks. | [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/) + [WAF](https://www.azion.com/en/documentation/secure/waf/) |
...
| **Elastic Load Balancing** | Distributes traffic across multiple targets and availability zones. | [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) |
| **Application Load Balancer** | Layer 7 HTTP/HTTPS load balancing with application-level routing. | [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) |
| **Network Load Balancer** | Layer 4 TCP/UDP/TLS load balancing. | [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) |
| **AWS Global Accelerator** | Global Anycast IPs and optimized routing over the AWS global network. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/) |
| **CloudFront Origin Access Control** | Secure S3 origins so users access content through CloudFront instead of directly from S3. | [Connectors](https://www.azion.com/en/documentation/build/connectors/) + [Origin Shield](https://www.azion.com/en/documentation/build/connectors/reference/origin-shield/) |
| **CloudFront Signed URLs / Signed Cookies** | Restrict access to private content using signed URLs or cookies. | [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **CloudFront Geographic Restrictions** | Allow or block content access by country. | [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
...
| **AWS Certificate Manager** | Provision, import, manage, deploy, and renew SSL/TLS certificates. | [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/) |
| **AWS Private CA** | Create and operate private certificate authorities. | [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/) |
| **AWS Private CA for client authentication** | Private PKI patterns for certificate-based client authentication. | [mTLS](https://www.azion.com/en/documentation/secure/certificate-manager/reference/mtls/) |
...
| **Amazon CloudWatch Metrics** | Collect, query, visualize, and alarm on service and application metrics. | [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) |
...
| **AWS Marketplace** | Discover, buy, deploy, and manage third-party software, data, and services. | [Marketplace](https://www.azion.com/en/documentation/marketplace/reference/marketplace/) |
...
| **AWS SDKs** | Language-specific SDKs for building integrations with AWS services. | [SDK](https://www.azion.com/en/documentation/devtools/lib/) |
| **AWS SDK for JavaScript** | JavaScript libraries for interacting with AWS services. | [Azion Lib](https://www.azion.com/en/documentation/devtools/lib/) |
...
| **Lambda runtime environment** | Runtime layer used by Lambda functions. | [Azion Runtime](https://www.azion.com/en/documentation/build/functions/runtime-apis/overview/) |
| **CloudFront edge runtime** | Runtime environment for CloudFront Functions and Lambda@Edge. | [Azion Runtime](https://www.azion.com/en/documentation/build/functions/runtime-apis/overview/) |
...
* [Applications](https://www.azion.com/en/documentation/build/applications/)
* [Applications first steps](https://www.azion.com/en/documentation/build/applications/quickstart/)
* [Azion CLI overview](https://www.azion.com/en/documentation/devtools/cli/)
* [Import an existing project from GitHub](https://www.azion.com/en/documentation/get-started/first-deploy/github/import-an-existing-project-from-github/)
...
* [Azion CLI overview](https://www.azion.com/en/documentation/devtools/cli/)
* [azion.config.js reference](https://www.azion.com/en/documentation/devtools/cli/reference/azion-config-js/)
* [azion deploy command](https://www.azion.com/en/documentation/devtools/cli/reference/deploy/)
...
`} />
:::note
Azion manages environment variables at the Function instance level, not through a standalone variables API. Variables are configured as key-value pairs in the `vars` field when creating or updating a function instance. See the [Functions Instances documentation](https://www.azion.com/en/documentation/build/applications/reference/functions-instances/) for details.
:::
</Fragment>
</Tabs>
...
* [Environment Variables](https://www.azion.com/en/documentation/get-started/frameworks/environment-variables/)
* [Working with variables](https://www.azion.com/en/documentation/deploy/orchestrator/guides/work-with-variables/)
* [Azion runtime environment variables reference](https://www.azion.com/en/documentation/build/functions/runtime-apis/functions/environment-variables/)
...
* [Applications](https://www.azion.com/en/documentation/build/applications/)
* [Applications Main Settings](https://www.azion.com/en/documentation/build/applications/reference/main-settings/)
* [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/)
* [Connectors](https://www.azion.com/en/documentation/build/connectors/)
...
* [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/)
* [Functions Instances](https://www.azion.com/en/documentation/build/applications/reference/functions-instances/)
* [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/)
...
* [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/)
* [Functions Instances](https://www.azion.com/en/documentation/build/applications/reference/functions-instances/)
* [Runtime APIs](https://www.azion.com/en/documentation/get-started/frameworks/runtime-apis/)
* [JavaScript Runtime APIs reference](https://www.azion.com/en/documentation/build/functions/runtime-apis/javascript/)
...
* [Load Balancer](https://www.azion.com/en/documentation/build/connectors/reference/load-balancer/)
* [Connectors](https://www.azion.com/en/documentation/build/connectors/)
* [Application Main Settings](https://www.azion.com/en/documentation/build/applications/reference/main-settings/)
...
* [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/)
* [Cache Settings](https://www.azion.com/en/documentation/build/applications/reference/cache-settings/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/tiered-cache/)
* [Real-Time Purge](https://www.azion.com/en/documentation/build/applications/reference/real-time-purge/)
...
* [Image Processor](https://www.azion.com/en/documentation/build/applications/reference/image-processor/)
* [How to process images](https://www.azion.com/en/documentation/build/applications/guides/process-images/)
...
* [AI Inference models](https://www.azion.com/en/documentation/build/ai-inference/reference/models/)
* [AI Inference Starter Kit](https://www.azion.com/en/documentation/marketplace/integrations/ai-inference-starter-kit/)
...
Create a workload in Azion Console and associate your custom domain. See [Workloads Documentation](https://www.azion.com/en/documentation/build/workloads/).
...
* [Workloads](https://www.azion.com/en/documentation/build/workloads/)
* [Create an Azion custom domain](https://www.azion.com/en/documentation/build/workloads/guides/create-azion-custom-domain/)
* [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/)
* [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/)
...
* [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/)
* [DNSSEC compatibility](https://www.azion.com/en/documentation/secure/edge-dns/reference/dnssec-compatibility/)
* [Run the dig command](https://www.azion.com/en/documentation/secure/edge-dns/guides/run-the-dig-command/)
* [Run the traceroute command](https://www.azion.com/en/documentation/secure/edge-dns/guides/run-the-traceroute-command/)
...
4. See the [mTLS configuration guide](/en/documentation/secure/certificate-manager/guides/mtls/) for detailed steps.
...
* [Certificate Manager](https://www.azion.com/en/documentation/secure/certificate-manager/)
* [Create a digital certificate](https://www.azion.com/en/documentation/build/workloads/guides/create-a-digital-certificate/)
* [mTLS](https://www.azion.com/en/documentation/secure/certificate-manager/reference/mtls/)
...
* [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/)
* [Functions for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/functions/)
...
* [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/)
* [DDoS Mitigation](https://www.azion.com/en/documentation/secure/ddos-protection/reference/ddos-mitigation/)
...
* [Bot Manager Lite](https://www.azion.com/en/documentation/secure/bot-manager/reference/lite/)
* [Bot Manager Lite integration kit](https://www.azion.com/en/documentation/marketplace/integrations/bot-manager-lite-integration-kit/)
* [Radware Bot Manager](https://www.azion.com/en/documentation/marketplace/integrations/radware-bot-manager/)
...
* [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/)
* [Functions for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/functions/)
* [Functions Instances for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/functions-instances/)
...
* [Network Lists](https://www.azion.com/en/documentation/secure/firewall/reference/network-shield/network-lists/)
...
* [Object Storage](https://www.azion.com/en/documentation/store/object-storage/)
* [Use S3-compatible tools with Object Storage](https://www.azion.com/en/documentation/store/object-storage/guides/use-s3-compatible-tools-with-object-storage/)
* [Create and modify a bucket](https://www.azion.com/en/documentation/store/object-storage/guides/create-and-modify-bucket/)
* [Upload and download objects](https://www.azion.com/en/documentation/store/object-storage/guides/bucket-actions/)
* [Use a bucket as origin](https://www.azion.com/en/documentation/store/object-storage/guides/use-bucket-as-origin/)
* [Storage library reference](https://www.azion.com/en/documentation/devtools/lib/reference/storage/)
...
* [KV library (azion/kv)](https://www.azion.com/en/documentation/devtools/lib/reference/kv/)
* [SQL Database](https://www.azion.com/en/documentation/store/sql-database/)
* [Create a database](https://www.azion.com/en/documentation/store/sql-database/guides/create-database/)
* [Install SQL Shell](https://www.azion.com/en/documentation/store/sql-database/guides/install-edge-sql-shell/)
* [Import data into SQL Database](https://www.azion.com/en/documentation/store/sql-database/guides/import-data-sql-database/)
...
* [SQL Database](https://www.azion.com/en/documentation/store/sql-database/)
* [Vector Search](https://www.azion.com/en/documentation/store/sql-database/reference/vector-search/)
* [Create a database](https://www.azion.com/en/documentation/store/sql-database/guides/create-database/)
* [Install SQL Shell](https://www.azion.com/en/documentation/store/sql-database/guides/install-edge-sql-shell/)
* [SQL Database Shell commands](https://www.azion.com/en/documentation/store/sql-database/guides/sql-database-shell-commands/)
* [Import data into SQL Database](https://www.azion.com/en/documentation/store/sql-database/guides/import-data-sql-database/)
* [SQL Database API reference](https://www.azion.com/en/documentation/build/functions/runtime-apis/sql-database/)
...
* [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/)
* [Real-Time Metrics first steps](https://www.azion.com/en/documentation/observe/real-time-metrics/quickstart/)
* [Historical Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/reference/historical-real-time-metrics/)
* [Analyze metrics](https://www.azion.com/en/documentation/observe/data-stream/guides/analyze-metrics/)
* [Grafana plugin custom dashboards](https://www.azion.com/en/documentation/observe/real-time-metrics/guides/azion-plugin-grafana-custom-dash/)
* [Grafana plugin pre-built dashboards](https://www.azion.com/en/documentation/observe/real-time-metrics/guides/azion-plugin-grafana-pre-built-dash/)
...
* [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/)
* [Real-Time Events first steps](https://www.azion.com/en/documentation/observe/real-time-events/quickstart/)
* [Investigate requests with the GraphQL API](https://www.azion.com/en/documentation/observe/data-stream/guides/investigate-requests-graphql-api/)
* [Configure sampling](https://www.azion.com/en/documentation/observe/data-stream/guides/configure-sampling/)
...
* [Data Stream first steps](https://www.azion.com/en/documentation/observe/data-stream/quickstart/)
* [Use Data Stream](https://www.azion.com/en/documentation/observe/data-stream/guides/use-data-stream/)
* Connectors: [Amazon S3](https://www.azion.com/en/documentation/observe/data-stream/guides/endpoint-amazon-s3/), [Azion Object Storage](https://www.azion.com/en/documentation/observe/data-stream/guides/connector-azion-object-storage/), [Datadog](https://www.azion.com/en/documentation/observe/data-stream/guides/endpoint-datadog/), [Splunk](https://www.azion.com/en/documentation/observe/data-stream/guides/endpoint-splunk/), [Elasticsearch](https://www.azion.com/en/documentation/observe/data-stream/guides/endpoint-elasticsearch/), [Kinesis](https://www.azion.com/en/documentation/observe/data-stream/guides/endpoint-amazon-kinesis/), [BigQuery](https://www.azion.com/en/documentation/observe/data-stream/guides/endpoint-google-bigquery/)
...
* Review [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) to monitor application performance
...
* [Read the Applications documentation](https://www.azion.com/en/documentation/build/applications/)
