...
permalink: /documentation/secure/waf/guides/how-to-check-your-waf-mode/
...
- A [firewall](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/) associated with the domains of your applications.
- This firewall should have at least one [WAF Rule Set](/en/documentation/secure/waf/reference/rules-set/). 

If you don't have a configured WAF Rule Set, check [this guide](/en/documentation/secure/firewall/guides/create-waf-rule-set/) for more details.
...
1. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Firewall**, in the **Secure** section.
