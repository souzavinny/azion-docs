...
permalink: /documentation/secure/waf/guides/waf-rules-for-specific-cookie/
...
- An [existent firewall](/en/documentation/secure/firewall/guides/firewall-configure-main-settings/) with the WAF add-on activated.
...
Still on the **WAF Rules** page, you must create a secondary **WAF Rule Set** including a [Custom Allowed Rule](/en/documentation/secure/waf/reference/custom-allowed-rules/). To do so:
...
3. In the **Rule ID** dropdown menu, select a rule.
    ...
    - Read more about all the [available internal rules](/en/documentation/secure/waf/reference/custom-allowed-rules/). 
...
:::tip
You can use [Azion Observe products](/en/documentation/observe/overview/) to monitor your application delivery, incoming traffic, and how your security logics are being applied and with which requests.
:::