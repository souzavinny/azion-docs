...
There are separate instructions using [legacy Domains](/en/documentation/secure/workloads/reference/domains/) settings using the new [Workloads](/en/documentation/secure/workloads/) product.
