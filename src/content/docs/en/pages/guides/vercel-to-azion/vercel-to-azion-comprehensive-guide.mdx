...
permalink: /documentation/get-started/migrate/vercel/
---
...
| :------------------------ | :---------- | :--------------- |
| **Projects** | Main application resource for build, deployment, environment, domains, and runtime settings. | [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **Production Deployments** | Production builds promoted to customer-facing domains. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
| **CI/CD and Preview Deployments** | Git-integrated build and deployment platform with automatic preview environments. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) + [Preview Deployment](https://www.azion.com/en/documentation/build/functions/runtime-apis/functions/runtime-api/preview-deployment/) |
| **Content Delivery Network** | Global delivery for caching, routing, compression, TLS, redirects, and rewrites. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Cache](https://www.azion.com/en/documentation/build/applications/reference/cache/) + [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **Redirects and rewrites** | Path and host routing configured in project settings, framework config, or `vercel.json`. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **Headers** | Custom request or response headers configured for routes. | [Rules Engine for Applications](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **Image Optimization** | On-demand image transformation and delivery. | [Image Processor](https://www.azion.com/en/documentation/build/applications/reference/image-processor/) |
| **Microfrontends** | Compose independently deployed frontend projects under centralized routing. | [Applications](https://www.azion.com/en/documentation/build/applications/) + [Rules Engine](https://www.azion.com/en/documentation/build/applications/reference/rules-engine/) |
| **Vercel Functions** | Managed server-side functions for APIs, dynamic pages, and backend integrations. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Fluid Compute** | Server-side compute model designed to improve concurrency and reduce cold starts for dynamic workloads. | [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) |
| **Environment Variables** | Project-level values for production, preview, and development environments. | [Environment Variables](https://www.azion.com/en/documentation/get-started/frameworks/environment-variables/) + [Functions Instances](https://www.azion.com/en/documentation/build/applications/reference/functions-instances/) |
| **AI Cloud** | Platform for building and operating AI applications. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
| **AI SDK** | TypeScript toolkit for building AI-powered applications, agents, streaming interfaces, and tool-calling experiences. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Azion AI Client](https://www.azion.com/en/documentation/devtools/lib/reference/ai-client/) + [Azion Lib](https://www.azion.com/en/documentation/devtools/lib/) |
| **AI Gateway** | Unified endpoint for model access, routing, fallbacks, retries, usage monitoring, and observability. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) |
...
| **Platform Security** | DDoS mitigation, TLS, platform firewalling, access controls, and security monitoring. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [DDoS Protection](https://www.azion.com/en/documentation/secure/ddos-protection/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **Vercel Firewall** | Traffic rules, IP blocks, rate limits, redirects, challenges, Attack Mode, and exceptions. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/) + [Network Lists](https://www.azion.com/en/documentation/secure/firewall/reference/network-shield/network-lists/) |
...
| **Bot Management** | Automated traffic detection, mitigation, challenge, allow, and block controls. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) + [Bot Manager Lite](https://www.azion.com/en/documentation/secure/bot-manager/reference/lite/) |
...
| **Advanced Deployment Protection** | Access controls for deployment URLs using authentication, trusted IPs, passwords, or bypasses. | [Firewall](https://www.azion.com/en/documentation/secure/firewall/) + [Rules Engine for Firewall](https://www.azion.com/en/documentation/secure/firewall/reference/rules-engine/) + [Network Lists](https://www.azion.com/en/documentation/secure/firewall/reference/network-shield/network-lists/) |
| **SAML Single Sign-On** | Centralized workforce authentication through a SAML-compatible identity provider. | [Single Sign-On](https://www.azion.com/en/documentation/account/reference/single-sign-on/) |
| **Domains and DNS** | Custom domains, DNS records, nameservers, and SSL certificate automation. | [Workloads](https://www.azion.com/en/documentation/build/workloads/) + [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) + [Certificate Manager](https://www.azion.com/en/documentation/build/applications/reference/certificate-manager/) |
| **Observability** | Monitoring for traffic, builds, functions, external API calls, performance, errors, and usage. | [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) + [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
| **Speed Insights** | Real-user performance monitoring based on Core Web Vitals. | [Edge Pulse](https://www.azion.com/en/documentation/observe/edge-pulse/) + [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) |
| **Web Analytics** | Website analytics for page views, visitors, referrers, demographics, custom events, and feature usage. | [Edge Pulse](https://www.azion.com/en/documentation/observe/edge-pulse/) + [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) |
| **Observability Plus** | Extended observability retention, metrics, request data, queries, notebooks, monitoring, and alerts. | [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) + [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
| **Web Analytics Plus** | Longer analytics reporting windows and additional attribution data. | [Edge Pulse](https://www.azion.com/en/documentation/observe/edge-pulse/) + [Real-Time Metrics](https://www.azion.com/en/documentation/observe/real-time-metrics/) |
| **Vercel Marketplace** | Integration catalog for databases, storage, auth, AI, observability, CMS, commerce, messaging, and security. | [Marketplace](https://www.azion.com/en/documentation/marketplace/reference/marketplace/) |
...
* [Azion Preview Deployment](https://www.azion.com/en/documentation/build/functions/runtime-apis/functions/runtime-api/preview-deployment/)
...
* [Azion AI Client](https://www.azion.com/en/documentation/devtools/lib/reference/ai-client/)
* [Functions](https://www.azion.com/en/documentation/build/applications/reference/functions/)
...
* [Certificate Manager](https://www.azion.com/en/documentation/build/applications/reference/certificate-manager/)
...
* [Firewall](https://www.azion.com/en/documentation/secure/firewall/)
...
* [Single Sign-On](https://www.azion.com/en/documentation/account/reference/single-sign-on/)
* [Teams Permissions](https://www.azion.com/en/documentation/account/reference/teams-permissions/)
* [Multi-Factor Authentication](https://www.azion.com/en/documentation/account/reference/multi-factor-authentication/)
...
* [Marketplace](https://www.azion.com/en/documentation/marketplace/reference/marketplace/)
