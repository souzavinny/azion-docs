...
| **Image Optimization** | On-demand image transformation and delivery. | [Image Processor](https://www.azion.com/en/documentation/build/applications/image-processor/) |
...
| **Vercel Functions** | Managed server-side functions for APIs, dynamic pages, and backend integrations. | [Functions for Applications](https://www.azion.com/en/documentation/build/applications/functions/) |
| **Fluid Compute** | Server-side compute model designed to improve concurrency and reduce cold starts for dynamic workloads. | [Functions](https://www.azion.com/en/documentation/build/applications/functions/) |
...
| **AI Cloud** | Platform for building and operating AI applications. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Functions](https://www.azion.com/en/documentation/build/applications/functions/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
...
| **Domains and DNS** | Custom domains, DNS records, nameservers, and SSL certificate automation. | [Workloads](https://www.azion.com/en/documentation/secure/workloads/) + [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) + [Certificate Manager](https://www.azion.com/en/documentation/build/applications/reference/certificate-manager/) |
