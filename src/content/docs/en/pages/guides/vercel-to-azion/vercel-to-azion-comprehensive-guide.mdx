...
| **Environment Variables** | Project-level values for production, preview, and development environments. | [Environment Variables](https://www.azion.com/en/documentation/get-started/frameworks/environment-variables/) + [Functions Instances](https://www.azion.com/en/documentation/build/functions/reference/functions-instances/) |
| **AI Cloud** | Platform for building and operating AI applications. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Functions](https://www.azion.com/en/documentation/build/functions/) + [Applications](https://www.azion.com/en/documentation/build/applications/) |
