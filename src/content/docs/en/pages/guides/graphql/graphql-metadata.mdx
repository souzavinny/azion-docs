...
permalink: /documentation/devtools/graphql/guides/graphql-metadata/
menu_namespace: graphqlMenu
---

Metadata are relevant information regarding the scope of data in the [GraphQL API](/en/documentation/devtools/graphql/reference/overview/). They can help you understand the relationship and the utility of the request processes.

To check GraphQL API's metadata, follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/devtools/graphql/guides/query-graphql-postman/) using the `https://api.azionapi.net/metrics/graphql` URL.
...
For more information on the available datasets with the GraphQL API, visit the [datasets documentation page](/en/documentation/devtools/graphql/reference/features/#datasets).
