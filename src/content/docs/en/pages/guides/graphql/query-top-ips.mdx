...
permalink: /documentation/devtools/graphql/guides/query-top-ips-attack-traffic-with-graphql/
...
:::tip
To know more about the available fields, check the [Real-Time Events GraphQL API Fields documentation](/en/documentation/devtools/graphql/reference/gql-real-time-events-fields/#httpevents-edge-applications-waf).
:::
