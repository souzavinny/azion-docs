...
permalink: /documentation/devtools/graphql/guides/query-httpbreakdownmetrics-data-with-graphql/
...
This example queries the top 20 blocked `remoteAddress` entries. To know more about the available fields, check the [Real-Time Metrics GraphQL API Fields](/en/documentation/devtools/graphql/reference/gql-real-time-metrics-fields/) documentation.
