...
permalink: /documentation/devtools/graphql/guides/graphql-aggregated-data/
...
To query the available aggregated data in the [GraphQL API](/en/documentation/devtools/graphql/reference/overview/), follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/devtools/graphql/guides/query-graphql-postman/) using the `https://api.azionapi.net/metrics/graphql` URL.
...
For more information on aggregating data with the GraphQL API, visit the [datasets documentation page](/en/documentation/devtools/graphql/reference/features/#datasets).
