...
permalink: /documentation/devtools/graphql/guides/query-data-stream-usage-data-with-graphql/
...
This guide explains how to query the total data streamed by Data Stream using the [GraphiQL Playground](/en/documentation/devtools/graphql/reference/playground/).
