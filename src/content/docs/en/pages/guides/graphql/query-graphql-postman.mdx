...
permalink: /documentation/devtools/graphql/guides/query-graphql-postman/
menu_namespace: graphqlMenu
---

You can query [GraphQL API](/en/documentation/devtools/graphql/reference/overview/) requests [on Postman](https://www.postman.com/) or other API platforms. To use Postman, you need to go through two steps: create a personal token and run your request on Postman. See the next sections and follow the presented steps.
...
See the [Personal Tokens documentation](/en/documentation/account/reference/personal-tokens/) for more information on how to create one.
