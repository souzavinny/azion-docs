...
permalink: /documentation/devtools/graphql/guides/query-connected-users-data-with-graphql/
...
:::note
To retrieve this data, you must be subscribed to [Azion Live Ingest](https://www.azion.com/en/solutions/live-streaming-delivery/) and use the [GraphQL API](/en/documentation/devtools/graphql/reference/overview/).
:::
