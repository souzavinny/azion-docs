...
permalink: /documentation/devtools/graphql/guides/query-functions-usage-data-with-graphql/
...
This guide explains how to query Functions' compute time and invocations metrics using the [GraphiQL Playground](/en/documentation/devtools/graphql/reference/playground/).
