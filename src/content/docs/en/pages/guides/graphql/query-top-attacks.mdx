...
permalink: /documentation/devtools/graphql/guides/query-top-attacks-with-graphql/
...
:::tip
To know more about the available fields, check the [Real-Time Metrics GraphQL API Fields documentation](/en/documentation/devtools/graphql/reference/gql-real-time-metrics-fields/#httpmetrics-edge-applications-waf).
:::
