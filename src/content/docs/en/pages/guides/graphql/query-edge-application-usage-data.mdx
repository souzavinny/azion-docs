...
permalink: /documentation/devtools/graphql/guides/query-applications-usage-data-with-graphql/
...
Using the [GraphiQL Playground](/en/documentation/devtools/graphql/reference/playground/), you can query data related to:
...
:::note
This example retrieves data for the total number of requests inspected by WAF. The results are grouped by `clientId` and `workloadId`. To learn more about the available fields, check the [Consumption GraphQL API Fields](/en/documentation/devtools/graphql/reference/gql-consumption-fields/) documentation.
:::
...
:::tip
To know more about the available fields, check the [Consumption GraphQL API Fields](/en/documentation/devtools/graphql/reference/gql-consumption-fields/) documentation.
:::
