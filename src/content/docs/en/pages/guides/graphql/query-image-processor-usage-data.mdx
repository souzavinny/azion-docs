...
permalink: /documentation/devtools/graphql/guides/query-image-processor-usage-data-with-graphql/
...
This guide explains how to query images processed by Image Processor using the [GraphiQL Playground](/en/documentation/devtools/graphql/reference/playground/).
