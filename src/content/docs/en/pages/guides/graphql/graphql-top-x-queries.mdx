...
permalink: /documentation/devtools/graphql/guides/graphql-top-x-query/
...
To query Top X queries through the [GraphQL API](/en/documentation/devtools/graphql/reference/overview/), follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/devtools/graphql/guides/query-graphql-postman/) using the `https://api.azionapi.net/events/graphql` URL.
