...
permalink: /documentation/devtools/graphql/guides/query-tiered-cache-usage-data-with-graphql/
...
This guide explains how to query the total data transferred by Tiered Cache using the [GraphiQL Playground](/en/documentation/devtools/graphql/reference/playground/).
