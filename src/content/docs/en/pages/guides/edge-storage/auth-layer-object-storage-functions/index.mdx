...
permalink: /documentation/store/object-storage/guides/auth-layer-object-storage-functions/
---
...
- [Object Storage API Reference](/en/documentation/build/functions/runtime-apis/storage/)
- [Functions Overview](/en/documentation/build/applications/reference/functions/)
- [JWT Integration](/en/documentation/marketplace/integrations/jwt/)
- [How to create and modify an Object Storage bucket](/en/documentation/store/object-storage/guides/create-and-modify-bucket/)

<LinkButton link="/en/documentation/build/functions/runtime-apis/storage/" label="Object Storage API Reference" severity="secondary" />
