...
permalink: /documentation/store/object-storage/guides/create-and-modify-bucket/
...
<LinkButton link="/en/documentation/store/object-storage/" label="learn more about Object Storage" severity="secondary" />

Refer to the guide [How to upload and download objects from a bucket](/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/) to perform object operations.
...
Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/pt-br/documentacao/account/guides/personal-tokens/) and the `name` value with the bucket name to create a new read-only bucket:
...
Now you can use the bucket to [upload and download objects](/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/).

---

## Grant read-write permission to a bucket

Run the following `PATCH` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/pt-br/documentacao/account/guides/personal-tokens/) and `bucket_name` with the bucket name to grant read and write permissions:
...
Run the following `DELETE` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/pt-br/documentacao/account/guides/personal-tokens/) and `bucket_name` with the name of the bucket you want to delete:
