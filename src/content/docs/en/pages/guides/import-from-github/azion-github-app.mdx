...
permalink: /documentation/get-started/first-deploy/github/azion-github-app/
---
...
- When [deploying a template](/en/documentation/marketplace/reference/templates/) or [importing a project for GitHub](/en/documentation/get-started/first-deploy/github/import-an-existing-project-from-github/).
...
:::tip
For more details, check the [How to import an existing project to build an application](/en/documentation/get-started/first-deploy/github/import-an-existing-project-from-github/) and [How to create an account on Azion](/en/documentation/account/reference/creating-account/) guides.
:::
