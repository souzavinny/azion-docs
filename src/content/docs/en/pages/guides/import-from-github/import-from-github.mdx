...
permalink: /documentation/get-started/first-deploy/github/import-an-existing-project-from-github/
---
...
- An Azion account.
    - Check the [How to create an account on Azion](/en/documentation/account/reference/creating-account/) guide for more information.
...
Check [some code samples](https://github.com/aziontech/azion-samples/tree/dev/templates) to fork and use as boilerplate, if desired. Read more about [Frameworks compatibility](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/) in the documentation.
...
- A pop-up window will open to confirm the installation of the [Azion GitHub App](/en/documentation/get-started/first-deploy/github/azion-github-app/), a tool that connects your GitHub account with Azion's platform.
...
- You can use them as global variables and edit or turn them into secrets on the **Variables** page. Read the [Variables](/en/documentation/get-started/frameworks/environment-variables/) documentation for more details.
