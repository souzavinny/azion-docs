...
permalink: /documentation/build/applications/guides/enforce-hls-cache/
---
...
- [A domain associated with the application](/en/documentation/build/workloads/guides/configure-a-domain/).
