...
permalink: /documentation/build/applications/cache/guides/enforce-hls-cache/
---
...
2. Get the details of an existing application using the [list command](/en/documentation/devtools/cli/reference/list/): `azion list edge-application --details`
...
- Define **Advanced Cache Key** behaviors according to your needs. Check the optional flags for the [create command](/en/documentation/devtools/cli/reference/create/#optional-flags-3).
...
:::tip
Read more about setting up [cache settings](/en/documentation/build/applications/reference/cache-settings/) for your applications.
:::
