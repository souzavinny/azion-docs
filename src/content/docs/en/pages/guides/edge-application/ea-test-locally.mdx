...
- An application and a [configured domain](/en/documentation/build/workloads/guides/configure-a-domain/).
...
:::caution[warning]
For the association to take place, you must first [configure your domain](/en/documentation/build/workloads/guides/configure-a-domain/) and add at least one custom domain CNAME to the domain's CNAME list.
:::
...
In the absence of cache, if your original application is already served on the CNAME you assigned but hasn't undergone [domain record modifications](/en/documentation/build/workloads/guides/point-domain-to-azion/#step-2-modify-domain-records) in the DNS provider, the `hosts` file will serve the application using the custom host.
...
You should now see your Azion domain as if it was in production and perform any necessary tests before [pointing your DNS resolution from your provider](/en/documentation/build/workloads/guides/point-domain-to-azion/) or [migrating your authoritative nameservers](/en/documentation/build/workloads/guides/migrate-ns-to-azion/) to Azion.