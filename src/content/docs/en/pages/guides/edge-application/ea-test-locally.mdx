...
- An application and a [configured domain](/en/documentation/secure/workloads/guides/configure-a-domain/).
...
:::caution[warning]
For the association to take place, you must first [configure your domain](/en/documentation/secure/workloads/guides/configure-a-domain/) and add at least one custom domain CNAME to the domain's CNAME list.
:::
...
You should now see your Azion domain as if it was in production and perform any necessary tests before [pointing your DNS resolution from your provider](/en/documentation/secure/workloads/guides/point-domain-to-azion/) or [migrating your authoritative nameservers](/en/documentation/secure/workloads/guides/migrate-ns-to-azion/) to Azion.