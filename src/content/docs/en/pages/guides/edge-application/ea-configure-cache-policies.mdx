...
permalink: /documentation/build/applications/guides/cache-settings/
...
:::tip
To configure cache settings for dynamic content, see the guide on [How to configure Advanced Cache Key for Applications](/en/documentation/build/applications/guides/advanced-cache-key/).
:::
