...
permalink: /documentation/build/applications/guides/cors-errors/
...
To solve this type of error, configure your browser on [Azion Console](https://console.azion.com) using [Rules Engine](/en/documentation/build/applications/reference/rules-engine/).
...
1. Access [Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Applications**.
