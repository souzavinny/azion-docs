...
permalink: /documentation/build/applications/guides/cross-origin-resource-sharing-cors/
...
The first step in allowing CORS access is to create a rule in [Rules Engine](/en/documentation/build/applications/reference/rules-engine/):
...
To enable CORS within a configuration for specific origin servers, you'll need to enable the [Application Accelerator](/en/documentation/build/applications/application-accelerator/) module:
