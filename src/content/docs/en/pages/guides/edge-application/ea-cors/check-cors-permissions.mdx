...
To enable CORS within a configuration for specific origin servers, you'll need to enable the [Application Accelerator](/en/documentation/build/applications/reference/application-accelerator/) module:
