...
There are separate instructions for API v3 using [legacy Origins](/en/documentation/secure/connectors/reference/origins/) settings and API v4 using the new [Connectors](/en/documentation/secure/connectors/) product.
