...
permalink: /documentation/build/applications/guides/configure-ports/
...
There are separate instructions for API v3 using [legacy Origins](/en/documentation/build/applications/reference/origins/) settings and API v4 using the new [Connectors](/en/documentation/secure/connectors/) product.
...
6. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Workloads**.
...
:::tip
You can also use **Rules Engine** and [create a rule](/en/documentation/build/applications/guides/work-with-rules-engine/) using the behavior **Redirect HTTP to HTTPS** to prevent your users from accessing application through the HTTP protocol given a specific scenario.
:::
...
5. In **Address**, type the hostname of your origin. Example: `yourorigin.com`.
6. Click the **Save** button.
7. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Workloads**.
...
2. Access [Azion Console](/en/documentation/account/guides/how-to-access-azion-console/) > **Connectors**.
