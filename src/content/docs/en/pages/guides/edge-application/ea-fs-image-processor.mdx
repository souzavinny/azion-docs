...
permalink: /documentation/build/image-processor/first-steps/
---
...
4. In the **Cache Expiration Policies** section, configure the [expiration policy](/en/documentation/build/cache/reference/cache-settings/#browser-cache-settings) for your images.
