...
permalink: /documentation/build/applications/guides/image-processor/
---

To configure [Image Processor](/en/documentation/build/applications/reference/image-processor/), follow the steps below:
