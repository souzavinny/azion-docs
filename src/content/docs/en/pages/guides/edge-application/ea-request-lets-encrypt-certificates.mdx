...
Below are steps for adding a certificate to your application. There are separate instructions for the [legacy Domains](/en/documentation/build/applications/reference/domains/) settings and the new [Workloads](/en/documentation/build/workloads/) product.
...
Once you have an application, you need to [create a Workload](/en/documentation/build/workloads/) and list the CNAMEs that you want to secure with the Let's Encrypt certificate. To do so, follow these steps:
...
Below are steps for pointing your traffic to Azion. There are separate instructions for the [legacy Domains](/en/documentation/build/applications/reference/domains/) settings and the new [Workloads](/en/documentation/build/workloads/) product.
