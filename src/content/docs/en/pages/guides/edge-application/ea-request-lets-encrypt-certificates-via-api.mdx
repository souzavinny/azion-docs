...
permalink: /documentation/build/applications/guides/how-to-generate-a-lets-encrypt-certificate-via-api/
...
For more information on these updates, [visit the Certificate Manager documentation](/en/documentation/secure/certificate-manager/#lets-encrypt-certificate).
...
2. Ensure that the DNS for this hostname is pointed to Azion (see [How to point your domain to Azion](/en/documentation/secure/workloads/guides/point-domain-to-azion/)). This must be done in your DNS provider service.
