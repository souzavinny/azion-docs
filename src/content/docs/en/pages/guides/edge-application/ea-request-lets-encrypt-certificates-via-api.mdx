...
2. Ensure that the DNS for this hostname is pointed to Azion (see [How to point your domain to Azion](/en/documentation/build/workloads/guides/point-domain-to-azion/)). This must be done in your DNS provider service.
