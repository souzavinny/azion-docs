...
permalink: /documentation/build/applications/guides/gzip-compression/
...
You can enable gzip compression for any application using the [Rules Engine for Applications](/en/documentation/build/applications/reference/rules-engine/).
