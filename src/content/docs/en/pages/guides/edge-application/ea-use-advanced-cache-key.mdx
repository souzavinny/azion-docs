...
:::tip
If you want to configure cache settings for static content, see the guide on [How to configure cache policies for Applications](/en/documentation/build/cache/guides/cache-settings/).
:::
