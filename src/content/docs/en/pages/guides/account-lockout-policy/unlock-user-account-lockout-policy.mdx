...
permalink: /documentation/account/guides/unlock-account-lockout-policy/
...
<LinkButton link="/en/documentation/account/reference/account-lockout-policy/" label="Go to Account Lockout Policy reference" severity="secondary" target="_blank" />
...
To manually unlock a user, you need to [get the logs](/en/documentation/account/guides/account-lockout-policy-logs/) and confirm the data about the user. Then, execute the unlocking. To do so:
