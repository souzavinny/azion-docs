...
<div class="grid gap-3 my-6 grid-cols-[repeat(auto-fill,minmax(280px,1fr))]">
    <DocsCard link="#faça-deploy-de-um-template-via-console" title="Deploy de template" icon="pi pi-th-large" description="Você está começando do zero e quer um projeto pronto." />
    <DocsCard link="#importe-um-projeto-do-github" title="Importe do GitHub" icon="pi pi-github" description="Seu projeto já vive em um repositório do GitHub." />
    <DocsCard link="#faça-deploy-com-a-azion-cli" title="Deploy pela CLI" icon="pi pi-wrench" description="Seu projeto está na sua máquina e você prefere o terminal." />
</div>
