...
description: >-
  Coloque uma aplicação no ar na Azion Web Platform em cerca de 5 minutos,
...
Ao final deste tutorial, uma aplicação estará no ar na Azion Web Platform, respondendo HTTP 200 no seu próprio domínio Azion. Leva cerca de 5 minutos.
...
**Antes de começar:** você precisa de uma conta no GitHub e de um repositório usando um dos [frameworks compatíveis](/pt-br/documentacao/build/functions/runtime-apis/compatibility/).
...
**Antes de começar:** você precisa da Azion CLI (instalada abaixo) e de um projeto local usando um dos [frameworks compatíveis](/pt-br/documentacao/build/functions/runtime-apis/compatibility/), com as dependências instaladas.

:::tip
Começando do zero? Rode `azion init` para criar um projeto novo a partir de um template de framework e faça o deploy da mesma forma. Veja a [visão geral da CLI](/pt-br/documentacao/devtools/cli/) e a [referência do comando link](/pt-br/documentacao/devtools/cli/reference/link-comando/) para mais detalhes.
:::
