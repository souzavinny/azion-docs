...
<div class="grid gap-3 my-6 grid-cols-[repeat(auto-fill,minmax(280px,1fr))]">
    ...
    <DocsCard link="/pt-br/documentacao/secure/firewall/" title="Proteja a sua aplicação" icon="ai ai-secure-pillar" description="Ative a proteção do Firewall e do WAF." />
    <DocsCard link="/pt-br/documentacao/" title="Observe a sua aplicação" icon="ai ai-observe-pillar" description="Acompanhe métricas e eventos em tempo real." />
</div>
