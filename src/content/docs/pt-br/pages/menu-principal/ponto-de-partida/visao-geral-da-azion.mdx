...
permalink: /documentacao/platform/overview/
---
...
- [Build](/pt-br/documentacao/build/overview/)
- [Store](/pt-br/documentacao/store/overview/)
- [Secure](/pt-br/documentacao/secure/overview/)
- [Deploy](/pt-br/documentacao/deploy/overview/)
- [Observe](/pt-br/documentacao/observe/overview/)
...
- Definição de [regras de cache](/pt-br/documentacao/build/applications/reference/cache/), otimizações personalizadas e configurações avançadas.
