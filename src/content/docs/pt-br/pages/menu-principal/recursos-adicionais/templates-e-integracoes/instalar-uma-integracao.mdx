...
permalink: /documentacao/marketplace/reference/instalar-uma-integracao/
...
:::tip
Para criar uma nova application, acesse a jornada de [Build](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/) para obter mais detalhes sobre este tópico.
:::
...
:::tip
Vá para a [página de guias da Azion](/pt-br/documentacao/guides/#marketplace) para ler as especificações de cada integração.
:::
...
<LinkButton link="/pt-br/documentacao/marketplace/reference/atualizar-uma-integracao/" label="consulte o guia Como atualizar uma integração" severity="secondary" />
