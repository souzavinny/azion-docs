...
permalink: /documentacao/devtools/graphql/reference/playground/
...
<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/first-steps/#acessar-o-playground-graphql" label="Como acessar o playground" severity="secondary" />
...
:::tip
Para mais detalhes, consulte o guia [Como identificar os principais IPs gerando tráfego de ataque com a API GraphQL](/pt-br/documentacao/devtools/graphql/guides/consultar-top-ips-gerando-trafego-de-ataque-com-graphql/).
:::
...
:::tip
Visite a [página de Guias](/pt-br/documentacao/guides/#graphql-api) e a [documentação da GraphQL API](/pt-br/documentacao/devtools/graphql/) para explorar mais opções de consulta de dados.
:::
