...
:::tip
Visite a [página de Guias](/pt-br/documentacao/guides/#graphql-api) e a [documentação da GraphQL API](/pt-br/documentacao/devtools/graphql-api/) para explorar mais opções de consulta de dados.
:::
