...
permalink: /documentacao/account/guides/users-management/
menu_namespace: fundamentalsMenu
---

import LinkButton from 'azion-webkit/linkbutton'

[Users Management](/pt-br/documentacao/account/reference/users-management/) permite que você adicione, modifique, e remova usuários de sua conta.
...
Você pode adicionar usuários antes ou depois de [criar equipes](/pt-br/documentacao/account/guides/teams-permissions/#adicionando-equipes).
