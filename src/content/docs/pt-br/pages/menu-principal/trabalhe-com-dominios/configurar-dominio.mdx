...
permalink: /documentacao/build/workloads/guides/configurar-dominio/
---
...
`digital_certificate_id` | Quando `null`, seleciona o certificado Azion SAN. Você também pode [associar um certificado digital](/pt-br/documentacao/build/workloads/guides/criar-certificado-digital/) a seu Workload. |
...
--data '{
    ...
    | `digital_certificate_id` | Quando `null`, seleciona o certificado Azion SAN. Você também pode [associar um certificado digital](/pt-br/documentacao/build/workloads/guides/criar-certificado-digital/) a seu domínio. |
...
Para personalizar o domínio de sua application, você pode optar por [associar um registro de domínio](/pt-br/documentacao/build/workloads/guides/apontar-dominio-para-a-azion/) ou [migrar nameservers para a Azion](/pt-br/documentacao/build/workloads/guides/migrar-ns-para-a-azion/).
