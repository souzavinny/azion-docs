...
permalink: /documentacao/secure/workloads/guides/configurar-dominio/
...
Para criar um endereço de domínio gratuito para sua aplicação no formato `xxxxxxxxxx.map.azionedge.net`, siga os passos na aba apropriada abaixo. Há instruções separadas para as configurações do [Domains legado](/pt-br/documentacao/secure/workloads/reference/domains/) e para o novo produto [Workloads](/pt-br/documentacao/secure/workloads/).

:::tip[Dica]
Se você não tem certeza de quais passos se aplicam à sua conta, consulte [este guia](/pt-br/documentacao/account/guides/verificar-migracao-conta/) para determinar se sua conta já foi migrada.
:::
...
1. Execute a seguinte requisição `POST`, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) para criar um novo Workload.
...
`digital_certificate_id` | Quando `null`, seleciona o certificado Azion SAN. Você também pode [associar um certificado digital](/pt-br/documentacao/secure/workloads/guides/criar-certificado-digital/) a seu Workload. |
...
1. Execute a seguinte requisição `POST`, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/), a variável `<edge_application_id>` pelo [ID da sua application](/pt-br/documentacao/build/applications/guides/definir-configuracoes-principais/):
...
--data '{
    ...
    | `digital_certificate_id` | Quando `null`, seleciona o certificado Azion SAN. Você também pode [associar um certificado digital](/pt-br/documentacao/secure/workloads/guides/criar-certificado-digital/) a seu domínio. |
    | `edge_application_id` | O [ID da application](/pt-br/documentacao/build/applications/guides/definir-configuracoes-principais/#via-api) vinculada ao domínio. |
...
Para personalizar o domínio de sua application, você pode optar por [associar um registro de domínio](/pt-br/documentacao/secure/workloads/guides/apontar-dominio-para-a-azion/) ou [migrar nameservers para a Azion](/pt-br/documentacao/secure/workloads/guides/migrar-ns-para-a-azion/).
