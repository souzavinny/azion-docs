...
Há instruções separadas para as configurações do [Domains legado](/pt-br/documentacao/build/applications/reference/domains/) e para o novo produto [Workloads](/pt-br/documentacao/secure/workloads/).
