...
permalink: /documentacao/secure/workloads/guides/criar-certificado-digital/
...
Se sua aplicação roda em HTTPS, você precisa cadastrar um certificado digital com Azion [Certificate Manager](/pt-br/documentacao/secure/certificate-manager/). Um certificado digital TLS confirma a identidade de um site e protege as transferências de dados. Ele garante transações financeiras e qualquer troca de informações sensíveis, desde credenciais de login até dados pessoais.
...
:::note
- A Azion agora oferece a flexibilidade de emitir e renovar [certificados Let’s Encrypt](/pt-br/documentacao/secure/certificate-manager/) via API utilizando tanto o desafio DNS-01 quanto o HTTP-01, permitindo que você escolha o método que melhor atenda às suas necessidades.
- Não possui um certificado digital? Consulte o guia sobre [Como obter e registrar um certificado digital com a Azion](/pt-br/documentacao/secure/firewall/guides/certificado-digital/).
:::

Há instruções separadas para as configurações do [Domains legado](/pt-br/documentacao/secure/workloads/reference/domains/) e para o novo produto [Workloads](/pt-br/documentacao/secure/workloads/).
...
4. Execute o seguinte comando cURL no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e adicionando seu certificado e chave privada aos campos:
...
3. Execute o seguinte comando cURL no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e adicionando seu certificado aos campos:
...
:::note[Opcional]
Como mostrado no exemplo abaixo, se você ainda não atualizou o campo CNAME com seu domínio personalizado, certifique-se de adicionar o host e quaisquer CNAMEs para a aplicação que são protegidos pelo certificado. Isso será útil para quando você [apontar seu domínio](/pt-br/documentacao/secure/workloads/guides/apontar-dominio-para-a-azion/) ou [migrar sua resolução NS](/pt-br/documentacao/secure/workloads/guides/migrar-ns-para-a-azion/) para Azion.
:::
