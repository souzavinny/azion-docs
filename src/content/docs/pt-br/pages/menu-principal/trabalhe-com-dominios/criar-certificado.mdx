...
permalink: /documentacao/build/workloads/guides/criar-certificado-digital/
---
...
Há instruções separadas para as configurações do [Domains legado](/pt-br/documentacao/build/applications/reference/domains/) e para o novo produto [Workloads](/pt-br/documentacao/produtos/secure/workloads).
...
:::note[Opcional]
Como mostrado no exemplo abaixo, se você ainda não atualizou o campo CNAME com seu domínio personalizado, certifique-se de adicionar o host e quaisquer CNAMEs para a aplicação que são protegidos pelo certificado. Isso será útil para quando você [apontar seu domínio](/pt-br/documentacao/build/workloads/guides/apontar-dominio-para-a-azion/) ou [migrar sua resolução NS](/pt-br/documentacao/build/workloads/guides/migrar-ns-para-a-azion/) para Azion.
:::
