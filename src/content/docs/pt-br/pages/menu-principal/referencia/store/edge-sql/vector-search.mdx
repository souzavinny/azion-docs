...
permalink: /documentacao/store/sql-database/reference/vector-search/
---
...
| Escopo | Recurso |
|---|---|
| Implemente o Vector Search| Guia explicando os fundamentos da [implementação do Vector Search](/pt-br/documentacao/store/sql-database/guides/edge-sql-vector-search/) |
