...
:::note
Esse produto está disponível via [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com), [Azion Runtime](/pt-br/documentacao/build/functions/runtime-apis/overview/) e [Azion CLI](/pt-br/documentacao/devtools/cli/).
:::
...
A forma recomendada de entregar objetos armazenados no **Object Storage** aos usuários finais é através de [Applications](/pt-br/documentacao/build/applications/) conectadas aos seus buckets usando [Connectors](/pt-br/documentacao/build/connectors/). Esta abordagem:
...
| Escopo | Recursos |
| --- | --- |
| Criar e modificar um bucket | [Como criar e modificar um bucket do Object Storage](/pt-br/documentacao/store/object-storage/guides/criar-e-modificar-um-bucket/) |
| Upload e download de objetos | [Como fazer o upload e download de objetos de um bucket do Object Storage](/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/) |
| Configurar o protocolo S3 | [Como acessar um bucket do Object Storage usando o protocolo S3](/pt-br/documentacao/store/object-storage/guides/s3-protocol-para-object-storage/) |
| Runtime API | [Object Storage API](/pt-br/documentacao/build/functions/runtime-apis/storage/) |
...
Objetos, ou arquivos, podem ser enviados, modificados, baixados e removidos dos buckets por meio da [Azion REST API](https://api.azion.com), do [Azion Runtime](/pt-br/documentacao/build/functions/runtime-apis/overview/) e do [protocolo S3](#compatiblidade-com-protocolo-s3).
...
Com **Object Storage**, você pode usar buckets como uma [origin](/pt-br/documentacao/build/connectors/#object-storage) no **Connector** da Azion para buscar o conteúdo de uma application.
...
:::note
As operações da classe C são gratuitas. Se uma operação estiver fora do escopo das operações da classe C, será cobrada na sua conta de acordo com os custos estabelecidos. Para mais informações sobre cobranças de operações e classes, consulte a página de [Preços](/en/documentation/platform/pricing/).
:::
...
Leia mais sobre [Como acessar o Object Storage usando o protocolo S3](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/s3-protocol-para-object-storage/).
...
- **Teams Permissions na Azion**: operações envolvendo buckets, como upload, listagem e exclusão de objetos, sempre requerem autenticação através da conta Azion. Vá para [Teams Permissions](/pt-br/documentacao/account/reference/teams-permissions/) para saber mais sobre as permissões disponíveis no Object Storage.
...
<LinkButton link="/pt-br/documentacao/store/object-storage/guides/protocolo-s3-para-object-storage/" label="saiba Como acessar o Object Storage usando o protocolo S3" severity="secondary"/>
