...
:::note
Esse produto está disponível via [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com), [Azion Runtime](/pt-br/documentacao/runtime/visao-geral/) e [Azion CLI](/pt-br/documentacao/devtools/cli/).
:::
...
A forma recomendada de entregar objetos armazenados no **Object Storage** aos usuários finais é através de [Applications](/pt-br/documentacao/build/applications/) conectadas aos seus buckets usando [Connectors](/pt-br/documentacao/secure/connectors/). Esta abordagem:
...
Com **Object Storage**, você pode usar buckets como uma [origin](/pt-br/documentacao/secure/connectors/#object-storage) no **Connector** da Azion para buscar o conteúdo de uma application.
