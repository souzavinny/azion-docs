...
permalink: /documentacao/secure/edge-dns/reference/compatibilidade-dnssec/
---
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/ativar-dnssec/" label="ative DNSSEC" severity="secondary" /> 
