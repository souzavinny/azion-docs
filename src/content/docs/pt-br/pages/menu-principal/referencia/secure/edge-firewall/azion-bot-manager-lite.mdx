...
permalink: /documentacao/secure/bot-manager/reference/lite/
---
...
<LinkButton link="/pt-br/documentacao/marketplace/integrations/bot-manager-lite-integration-kit/" label="Vá para o guia Como adicionar o Bot Manager Lite em um firewall existente usando um template" severity="secondary" /> 

<LinkButton link="/pt-br/documentacao/marketplace/integrations/bot-manager-lite-starter-kit/" label="Vá para o guia Como testar o Bot Manager Lite usando um template" severity="secondary" /> 

<LinkButton link="/pt-br/documentacao/marketplace/integrations/bot-manager-lite/" label="Vá para o guia Como instalar o Bot Manager Lite através do Marketplace da Azion" severity="secondary" /> 
