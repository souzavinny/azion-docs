...
[Functions](/pt-br/documentacao/build/applications/functions/) são funções executadas na Azion Web Platform, com a latência baixa, levando a capacidade operacional para mais perto do usuário final.
