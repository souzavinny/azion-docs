...
permalink: /documentacao/secure/firewall/reference/functions/
---

[Functions](/pt-br/documentacao/build/applications/reference/functions/) são funções executadas na Azion Web Platform, com a latência baixa, levando a capacidade operacional para mais perto do usuário final.

[Firewall](/pt-br/documentacao/secure/firewall/) suporta functions. Através delas, você pode escrever seu próprio código de segurança em JavaScript e realizar deploy no edge.
...
| Escopo | Guia |
| - | - |
| Como criar e configurar uma function em seu Firewall| [Como criar e configurar uma function no seu Firewall](/pt-br/documentacao/build/functions/guides/firewall/) |
| Exemplos | [Exemplos de functions para firewall](/pt-br/documentacao/build/functions/runtime-apis/javascript-examples/#edge-functions---edge-firewall) |
...
Leia mais sobre [a lista de metadados de GeoIP](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#geo-ip).

### Remote

Você pode verificar o endereço de IP e a porta TCP utilizada.

Leia mais sobre [a lista de metadados de Remote](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#remote).

### Server

Você pode verificar o protocolo sendo usado na requisição.

Leia mais sobre [a lista de metadados de Server](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#server).

### TLS

Os metadados relacionados a TLS estarão disponíveis quando a requisição for feita de uma conexão segura.

Leia mais sobre [a lista de metadados de TLS](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime/api-reference/metadata/#tls).
...
Você pode solicitar o aumento dos limites de acordo com o seu plano. Entre em contato com a [equipe de suporte técnico](/pt-br/documentacao/services/support/) para solicitar.
:::
