---
title: Referência do Azion Bot Manager
description: >-
  Referência completa do Bot Manager: recursos, classificação de bots, campos do
  report log, opções de configuração JSON Args, versões de engine e recursos adicionais.
meta_tags: 'bot, proteção, cybersegurança, edge computing, referência, json args, report log'
namespace: documentation_secure_bot_manager_reference
permalink: /documentacao/secure/bot-manager/reference/
---

import LinkButton from 'azion-webkit/linkbutton';

Esta página documenta cada seção de configuração do [Bot Manager](/pt-br/documentacao/secure/bot-manager/): recursos, classificação de bots, campos do report log, opções de configuração JSON Args, versões de engine e recursos adicionais.
...
<LinkButton link="/pt-br/documentacao/secure/firewall/reference/network-shield/network-lists/" label="saiba mais sobre network lists" severity="secondary" /> 
...
A tabela a seguir descreve os possíveis valores de classificação e categorias (tipos de ataque) do Bot Manager e como eles são identificados, conforme podem ser vistos no [Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/#bot-manager):
...
<LinkButton link="/pt-br/documentacao/observe/data-stream/" label="Saiba mais sobre o Data Stream" severity="secondary" /> 
<br />
<LinkButton link="/pt-br/documentacao/observe/real-time-events/" label="Saiba mais sobre o Real-Time Events" severity="secondary" /> 

Você também pode consultar os gráficos do Bot Manager no [Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/). A aba do Bot Manager exibe métricas relacionadas à atividade do Bot Manager, geradas quase em tempo real, com um intervalo de agregação de até *60 segundos*. Dependendo do gráfico, os dados podem ser armazenados por até *2 anos*.
...
<LinkButton link="/pt-br/documentacao/observe/real-time-metrics/" label="Saiba mais sobre o Real-Time Metrics" severity="secondary"/>
<br />
<LinkButton link="/pt-br/documentacao/observe/real-time-metrics/#bot-manager" label="Saiba mais sobre os gráficos do Bot Manager" severity="secondary"/>

#### GraphiQL Playground

Use o GraphiQL Playground para acessar informações detalhadas sobre o desempenho e as operações do Bot Manager. 

Por exemplo, você pode [consultar dados do Bot Manager](/pt-br/documentacao/devtools/graphql/guides/consultar-dados-bot-manager-com-graphql/) ou [consultar as principais URLs impactadas por bots](/pt-br/documentacao/devtools/graphql/guides/consultar-dados-bot-manager-breakdown-com-graphql/) para analisar a atividade de bots e recuperar dados para otimizar suas configurações.

<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/playground/" label="Saiba mais sobre o GraphiQL Playground" severity="secondary" />  
<br />
<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/campos-gql-real-time-metrics/#botmanagermetrics" label="Saiba mais sobre os campos do Bot Manager" severity="secondary" />  
...
Para mais informações sobre como instalar o Javascript Tag (JS TAG) na Azion, [consulte nossa documentação](/pt-br/documentacao/marketplace/integrations/javascript-tag-js-tag/).
...
- Leia o guia [Como utilizar a Function ALTCHA através do Marketplace da Azion](https://www.azion.com/pt-br/documentacao/build/functions/guides/altcha/) para saber mais.
:::
