...
- **[GraphQL API](/pt-br/documentacao/devtools/graphql-api/recursos/#conjuntos-de-dados)**: consulte dados brutos e agregados de DNS para análise personalizada e integração com ferramentas de monitoramento.
