...
| Escopo | Fonte |
| ------ | ----- |
| Main settings | [Como definir as main settings de uma zona](/pt-br/documentacao/secure/firewall/guides/edge-dns-definir-main-settings/) |
| Comando dig | [Como procurar servidores DNS com o comando dig](/pt-br/documentacao/secure/edge-dns/guides/executar-o-comando-dig/) |
| Comando traceroute | [Como diagnosticar problemas de desempenho e entrega com o comando traceroute](/pt-br/documentacao/secure/edge-dns/guides/executar-o-comando-traceroute/) |
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/testar-zona/" label="consulte o guia sobre testar zonas" severity="secondary" /> 

---

## Registros do Edge DNS

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/adicionar-registros/" label="consulte o guia sobre adicionar registros" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/balanceamento-de-carga-dns/" label="consulte o guia balancear carga entre registros DNS" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/edge-dns/reference/compatibilidade-dnssec/" label="saiba mais sobre compatibilidade DNSSEC" severity="secondary" />
...
3. **Entre em contato com o Suporte Azion** através do [Suporte Azion](/pt-br/documentacao/services/support/) com as informações coletadas
