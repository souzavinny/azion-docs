...
permalink: /documentacao/secure/connectors/reference/load-balancer/
---
...
Para mais opções de como direcionar o tráfego para o **Load Balancer** baseado em outros critérios, consulte a página [Rules Engine para Applications](/pt-br/documentacao/build/applications/reference/rules-engine/).

## Implementação

| Escopo | Recursos |
| --- | --- |
| Connectors | [Connectors](/pt-br/documentacao/secure/connectors/) |
...
<LinkButton link="/pt-br/documentacao/secure/connectors/reference/origins/#address" label="Saiba mais sobre origin addresses" />
...
Você pode solicitar o aumento dos limites. Contate o [time de suporte técnico](/pt-br/documentacao/services/support/) para fazer a solicitação.
:::
