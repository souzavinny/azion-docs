...
permalink: /documentacao/secure/waf/reference/rule-sets/
---
...
| Escopo | Recurso |
| ----- | ------ |
| Rule set | [Como criar um WAF rule set](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/) |
...
Após configurar as main settings do WAF com a tabela de **Threat Type Configuration**, você deve criar uma regra no [Rules Engine para Firewall](/pt-br/documentacao/secure/firewall/reference/rules-engine/) para executar o comportamento que você configurou.
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/trabalhar-com-rules-engine/" label="consulte o guia sobre criar regra" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/observe/real-time-metrics/#waf" label="saiba mais sobre real-time metrics" severity="secondary" />
