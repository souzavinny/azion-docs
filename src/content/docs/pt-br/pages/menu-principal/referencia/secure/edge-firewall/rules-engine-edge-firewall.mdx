...
permalink: /documentacao/secure/firewall/reference/rules-engine/
---
...
<LinkButton link="/pt-br/documentacao/secure/firewall/" label="Saiba mais sobre o Firewall" severity="secondary" />

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/trabalhar-com-rules-engine/" label="Consulte o guia para trabalhar com Rules Engine" severity="secondary" />

## Implementação

| Escopo | Recurso |
| --- | --- |
| Proteja sua aplicação | [Como proteger uma aplicação](/pt-br/documentacao/secure/firewall/guides/proteja-aplicacao/) |
| Configure as main settings | [Como definir as main settings de um firewall](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/) |
| Crie um WAF rule set | [Como criar um WAF rule set](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/) |
| Bloqueie endereços IP de exit nodes Tor | [Como bloquear endereços IP de exit nodes Tor](/pt-br/documentacao/secure/firewall/guides/bloquear-redes-tor/) |
...
Depois disso, você poderá adicionar [Functions Instances](/pt-br/documentacao/secure/firewall/reference/functions-instances/) e regras do **Rules Engine**. Os campos e requisitos para usar o **Rules Engine para Firewall** são explicados nas seções abaixo.
:::
...
:::note 
A disponibilidade de certos critérios depende dos módulos de Firewall ativados. Acesse a [página de conceitos do Firewall](/pt-br/documentacao/secure/firewall/concepts/#como-os-modulos-desbloqueiam-criteria-e-behaviors) para mais detalhes.
:::
...
Associa a Rule Set de WAF que deve ser utilizada na requisição. As políticas de WAF devem ser previamente configuradas no menu **Edge Libraries** > **WAF Rules*. Você também deve definir o **modo WAF**: **Learning** ou **Blocking**. Leia mais sobre [WAF Rule Sets](/pt-br/documentacao/secure/waf/reference/rule-sets/).
...
Você pode [depurar regras criadas com o Rules Engine para Firewall](/pt-br/documentacao/build/applications/guides/debug-regras/) através da GraphQL API, Data Stream ou Real-Time Events.
