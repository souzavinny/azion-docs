...
:::note 
A disponibilidade de certos critérios depende dos módulos de Firewall ativados. Acesse a [referência dos módulos do Firewall](/pt-br/documentacao/secure/firewall/#sobre-os-modulos-do-edge-firewall) para mais detalhes.
:::
