...
:::note[Nota]
Esta página documenta o novo produto Custom Pages. Se sua conta ainda não foi migrada, consulte a [documentação legada de Error Responses](/pt-br/documentacao/secure/custom-pages/reference/error-responses/).
:::
...
| Personalizando página de erro | [Como personalizar uma página de resposta de erro](/pt-br/documentacao/secure/custom-pages/guides/personalizar-pagina-resposta-erro/) |
...
<LinkButton link="/pt-br/documentacao/build/cache/reference/cache-settings/#browser-cache-settings" label="Saiba mais sobre configurações de expiração de cache" />
