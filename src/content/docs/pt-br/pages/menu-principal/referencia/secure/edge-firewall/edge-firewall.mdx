...
| Escopo | Fonte |
| ------ | ----- |
| Main settings | [Como definir as main settings de um firewall](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/) |
| Atualizar Firewall | [Como atualizar o seu Firewall](/pt-br/documentacao/secure/firewall/guides/como-atualizar-seu-firewall/) |
| Saiba mais sobre Network Lists | [Network Lists](/pt-br/documentacao/secure/firewall/reference/network-shield/network-lists/) |
| Saiba mais sobre Rule Sets | [WAF Rule Sets](/pt-br/documentacao/secure/waf/reference/rule-sets/) |
| Saiba mais sobre WAF Custom Allowed Rules | [WAF Custom Allowed Rules](/pt-br/documentacao/secure/waf/reference/custom-allowed-rules/) |
| Saiba mais sobre Functions | [Functions Instances para Firewall](/pt-br/documentacao/secure/firewall/reference/functions-instances/) |
| Saiba mais sobre Rules Engine | [Rules Engine para Firewall](/pt-br/documentacao/secure/firewall/reference/rules-engine/) |
| Saiba mais sobre Certificate Manager | [Certificate Manager para Secure](/pt-br/documentacao/secure/certificate-manager/) |
| Compatibilidade com DNSSEC | [Compatibilidade com DNSSEC](/pt-br/documentacao/secure/edge-dns/reference/compatibilidade-dnssec/) |
| Criar network lists | [Como criar blocklists de IP com Network Shield](/pt-br/documentacao/secure/network-shield/guides/blocklists-enderecos-ip-edge/) |
| Modo do WAF | [Como verificar o seu modo WAF](/pt-br/documentacao/secure/waf/guides/como-verificar-modo-do-seu-waf/) |
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/" label="consulte o guia definir main settings" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/firewall/reference/rules-engine/" label="saiba mais sobre rules engine" severity="secondary" />

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/trabalhar-com-rules-engine/" label="consulte o guia trabalhar com rules engine" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/ddos-protection/" label="saiba mais sobre DDoS Protection" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/firewall/reference/functions/" label="saiba mais sobre Functions para Firewall" severity="secondary" />

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/instanciar-functions/" label="consulte o guia instanciar functions" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/network-shield/" label="saiba mais sobre Network Shield" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/waf/" label="saiba mais sobre Web Application Firewall" severity="secondary" />

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/" label="consulte o guia criar waf rule set" severity="secondary" />
