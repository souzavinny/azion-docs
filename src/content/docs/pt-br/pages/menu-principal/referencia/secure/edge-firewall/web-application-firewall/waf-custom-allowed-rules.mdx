...
permalink: /documentacao/secure/waf/reference/custom-allowed-rules/
...
:::tip[dica]
Saiba mais sobre os [módulos do Firewall](/pt-br/documentacao/secure/firewall/) e o [Web Application Firewall](/pt-br/documentacao/secure/waf/).
:::
...
Para mais informações sobre como o tuning do WAF funciona na prática, [confira nosso guia sobre como fazer a configuração](https://www.azion.com/pt-br/documentacao/secure/firewall/guides/tune-waf/).
...
## Campos das Allowed Rules

As Allowed Rules são compostas pelos seguintes campos:

| Campo | Descrição |
| ----- | --------- |
| `Rule ID` | ID numérico exclusivo da regra WAF. Consulte a [lista de regras internas](#regras-internas-do-waf). |
...
| `match_zone` | string | A parte da requisição para correspondência. Veja as [opções de Match Zone](#opcoes-de-match-zone) |
