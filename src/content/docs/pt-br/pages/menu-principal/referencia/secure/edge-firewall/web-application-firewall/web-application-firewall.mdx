...
O WAF pode operar em dois modos: **Learning** ou **Blocking**. Você pode definir o modo em uma regra no [Rules Engine](/pt-br/documentacao/secure/firewall/reference/rules-engine/) com o comportamento **Set WAF Rule Set** ou via [API da Azion](https://api.azion.com/#ae9cdca8-3949-4b25-b1e6-2e071cd193fc).
...
| Escopo | Fonte |
| ------ | ----- |
| Criar WAF rule set | [Como criar um WAF rule set](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/) |
| Modo WAF | [Como verificar o modo do seu WAF](/pt-br/documentacao/secure/waf/guides/como-verificar-modo-do-seu-waf/) |
| Score WAF | [Como encontrar o score de requisições bloqueadas pelo WAF](/pt-br/documentacao/secure/waf/guides/como-encontrar-score-de-requisicoes-bloqueadas-pelo-waf/) |
| Integrar WAF com SIEMs | [Como integrar WAF com SIEMs](/pt-br/documentacao/secure/firewall/guides/integrar-siems/) |
...
:::tip[dica]
Saiba mais sobre os [módulos do Firewall](/pt-br/documentacao/secure/firewall/) e o [Rules Engine para o Firewall](/pt-br/documentacao/secure/firewall/reference/rules-engine/).
:::

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/" label="consulte o guia configurar firewall" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/waf/reference/rule-sets/#tipos-de-ameacas" label="saiba mais sobre os tipos de ameaça" severity="secondary" /> <br></br>

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/" label="consulte o guia sobre criar rule set" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/secure/waf/reference/rule-sets/#niveis-de-sensibilidade" label="saiba mais sobre níveis de sensibilidade" severity="secondary" />
...
- **Lista completa:** consulte a descrição das famílias de regras e seus `Rule IDs` em [WAF Rule Sets](/pt-br/documentacao/secure/waf/reference/rule-sets/).
...
A descrição detalhada da regra 13 e de seus parâmetros está disponível na página de [WAF Rule Sets](/pt-br/documentacao/secure/waf/reference/rule-sets/).
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/tune-waf/" label="consulte o guia fazer tuning do WAF" severity="secondary" /> 
...
<LinkButton link="/pt-br/documentacao/secure/waf/reference/custom-allowed-rules/" label="saiba mais sobre Custom Allowed Rules do WAF" severity="secondary" />
...
| Campo | Descrição |
| ----- | --------- |
| `Rule ID` | ID numérico exclusivo da regra WAF. Consulte a lista de regras em [WAF Rule Sets](/pt-br/documentacao/secure/waf/reference/rule-sets/). |
...
Para especificações completas da API e exemplos, consulte a [documentação de Exceções do WAF](/pt-br/documentacao/secure/waf/reference/custom-allowed-rules/#gerenciando-excecoes-via-api) e a [referência da API da Azion](https://api.azion.com/v4#/operations/list_waf_exceptions).
