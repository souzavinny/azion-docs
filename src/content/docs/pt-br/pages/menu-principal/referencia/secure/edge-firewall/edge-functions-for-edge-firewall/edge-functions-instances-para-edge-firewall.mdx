...
permalink: /documentacao/secure/firewall/reference/functions-instances/
---
...
Para saber mais sobre como funcionam e como aplicar algumas dessas Functions, acesse [os guias disponíveis](/pt-br/documentacao/guides/).
