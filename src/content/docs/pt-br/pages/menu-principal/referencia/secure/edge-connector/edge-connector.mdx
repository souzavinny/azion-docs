...
permalink: /documentacao/secure/connectors/
---
...
:::note[Nota]
Esta página documenta o novo produto Connectors. Se sua conta ainda não foi migrada, consulte a [documentação legada de Origins](/pt-br/documentacao/build/applications/reference/origins/).
:::
...
| Módulo Load Balancer | [Load Balancer](/pt-br/documentacao/secure/connectors/reference/load-balancer/) |
...
<LinkButton link="/pt-br/documentacao/secure/connectors/reference/load-balancer/" label="Saiba mais sobre Load Balancer" />
...
O nome do bucket é definido ao [criar ou modificar um bucket Object Storage](/pt-br/documentacao/store/object-storage/guides/criar-e-modificar-um-bucket/). Ao criar um connector, o seletor de buckets lista automaticamente os buckets existentes e disponibiliza um campo de busca para facilitar encontrar o bucket desejado.
...
<LinkButton link="/pt-br/documentacao/store/object-storage/" label="Ir para referência Object Storage" />
...
<LinkButton link="/pt-br/documentacao/architectures/live-streaming-delivery/live-streaming-delivery-com-hls/" label="Ir para a solução Live Ingest" />
