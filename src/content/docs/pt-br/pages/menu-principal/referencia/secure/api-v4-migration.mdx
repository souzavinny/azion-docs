...
<LinkButton link="/pt-br/documentacao/build/workloads/" label="Acesse a Referência de Workloads" />
...
<LinkButton link="/pt-br/documentacao/build/connectors/" label="Acesse a Referência de Connectors"/>

---

## Custom Pages

O **Custom Pages** é um recurso da Azion que permite personalizar páginas de erro para os usuários com base no código de status recebido de um [Connectors](/pt-br/documentacao/build/connectors/) ao buscar o conteúdo da sua origem.
