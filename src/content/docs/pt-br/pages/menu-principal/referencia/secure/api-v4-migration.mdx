...
permalink: /documentacao/devtools/api/v4-migration/
...
<LinkButton link="/pt-br/documentacao/secure/workloads/" label="Acesse a Referência de Workloads" />
...
<LinkButton link="/pt-br/documentacao/secure/connectors/" label="Acesse a Referência de Connectors"/>

---

## Custom Pages

O **Custom Pages** é um recurso da Azion que permite personalizar páginas de erro para os usuários com base no código de status recebido de um [Connectors](/pt-br/documentacao/secure/connectors/) ao buscar o conteúdo da sua origem.
...
<LinkButton link="/pt-br/documentacao/secure/custom-pages/" label="Acesse a Referência de Custom Pages"/>
...
Você pode entrar em contato com nossa [equipe de suporte](/pt-br/documentacao/services/support/#canais-de-atendimento) ou perguntar diretamente ao [Azion Copilot](https://console.azion.com/copilot).
