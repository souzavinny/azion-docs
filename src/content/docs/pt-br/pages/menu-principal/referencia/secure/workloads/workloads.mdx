...
permalink: /documentacao/secure/workloads/
---
...
:::note[Nota]
Esta página documenta o novo produto Workloads. Se sua conta ainda não foi migrada, consulte a [documentação legada de Domains](/pt-br/documentacao/build/applications/reference/domains/).
:::
...
Se você já possui um endereço de aplicação com um domínio existente como `www.azion.com`, pode [redirecionar seu tráfego para a Azion](/pt-br/documentacao/secure/workloads/guides/apontar-dominio-para-a-azion/) configurando os registros no seu provedor de DNS e listando seus **domínios personalizados**.
...
| Escopo | Recurso |
| --- | --- |
| Adicionando um domínio personalizado | [Primeiros passos](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/) |
| Sobre Certificados Digitais | [Certificados Digitais](/pt-br/documentacao/secure/certificate-manager/) |
...
Configure o deploy do seu Workload selecionando uma [Applications](/pt-br/documentacao/build/applications/) e um [Firewall](/pt-br/documentacao/secure/firewall/). Você também pode configurar [Custom Pages](/pt-br/documentacao/secure/custom-pages/) para tratar erros e definir configurações de cache time-to-live (TTL) baseadas no código de status HTTP retornado pelos conectores de edge.
...
:::note
Se optar por entregar sua aplicação via HTTP e HTTPS, é necessário configurar um [certificado digital](/pt-br/documentacao/secure/certificate-manager/) ao seu domínio.
:::
...
<LinkButton link="/en/documentation/secure/firewall/guides/ciphers/" label="ir para o guia de configuração de cipher suite TLS" severity="secondary" />
