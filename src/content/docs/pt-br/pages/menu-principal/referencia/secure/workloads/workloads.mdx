...
:::note[Nota]
Esta página documenta o novo produto Workloads. Se sua conta ainda não foi migrada, consulte a [documentação legada de Domains](/pt-br/documentacao/secure/workloads/reference/domains/).
:::
