...
permalink: /documentacao/build/workloads/
---
...
Se você já possui um endereço de aplicação com um domínio existente como `www.azion.com`, pode [redirecionar seu tráfego para a Azion](/pt-br/documentacao/build/workloads/guides/apontar-dominio-para-a-azion/) configurando os registros no seu provedor de DNS e listando seus **domínios personalizados**.
...
| Escopo | Recurso |
| --- | --- |
| Adicionando um domínio personalizado | [Primeiros passos](/pt-br/documentacao/build/workloads/guides/configurar-dominio/) |
