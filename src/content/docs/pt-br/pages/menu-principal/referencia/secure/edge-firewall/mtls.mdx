...
permalink: /documentacao/secure/certificate-manager/reference/mtls/
---
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/mtls/" label="consulte o guia associar um certificado mTLS a um domínio" severity="secondary" /> 
...
> A lista de variáveis aceitas está disponível na página [Rules Engine para Application](/pt-br/documentacao/build/applications/reference/rules-engine/).
