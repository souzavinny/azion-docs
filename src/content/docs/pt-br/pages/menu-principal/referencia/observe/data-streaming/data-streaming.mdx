...
- [Criar um novo data stream](/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/).  
- Conectar seus data streams a [endpoints](/pt-br/documentacao/guides/#observe).  
- [Editar as configurações de um data stream](/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/) diretamente da lista ao selecionar o stream que deseja atualizar.  
- [Visualizar informações detalhadas](/pt-br/documentacao/observe/data-stream/guides/data-stream-monitorar-metricas/) sobre cada stream para garantir que tudo esteja funcionando corretamente.  
- [Excluir ou parar data streams](/pt-br/documentacao/observe/data-stream/guides/deletar-data-stream/) que não são mais necessários para otimizar seu sistema.
...
| Tarefa | Guia |
| ---- | ----- |
| Acessar o Data Stream | [Primeiros passos do Data Stream](/pt-br/documentacao/observe/data-stream/quickstart/) |
| Configurar o Data Stream | [Como configurar as main settings do Data Stream](/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/) |
| Parar ou deletar um data stream | [Como parar ou deletar um data stream](/pt-br/documentacao/observe/data-stream/guides/deletar-data-stream/) |
| Associar domínios | [Como associar domínios no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-associar-dominios/) |
| Criar template personalizado | [Como criar um template personalizado no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-template-personalizado/) |
...
Você pode [criar um novo data stream](/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/) através do [Azion Console](https://console.azion.com/data-stream):
...
Para [editar qualquer stream](/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/), acesse a página do Data Stream e selecione o stream com o qual deseja trabalhar. Edite as configurações conforme desejado e salve as alterações.

Se você deseja [parar um data stream](/pt-br/documentacao/observe/data-stream/guides/deletar-data-stream/) em sua conta Azion, siga estas etapas:
...
Para [excluir um stream](/pt-br/documentacao/observe/data-stream/guides/deletar-data-stream/): acesse a página Data Stream, navegue até o lado direito da linha e clique no ícone de lixeira para o stream que deseja excluir.
