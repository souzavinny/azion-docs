...
**Edge Pulse** é um produto de [Observe](/pt-br/documentacao/observe/overview/) baseado na solução de mercado *Real User Monitoring (RUM)*. Com ele, você pode, em tempo real:
...
| Escopo | Recurso |
| ------ | ------ |
| Primeiros passos | [Primeiros passos do Edge Pulse](/pt-br/documentacao/observe/edge-pulse/quickstart/) |
...
<LinkButton link="/pt-br/documentacao/observe/real-time-events/" label="explorar via Real-Time Events" />
