...
permalink: /documentacao/observe/real-time-metrics-historico/
---

O **Real-Time Metrics** possui duas versões: **Histórico** e **Novo**. Se você deseja ter acesso a dados de até 2 anos anteriores a data 15 de outubro de 2022, [contate o time de Suporte](/pt-br/documentacao/services/support/#canais-de-atendimento) e solicite acesso ao **Real-Time Metrics Histórico**. Esta versão ficará disponível até o fim de 2024, quando será descontinuada.

Você já pode e poderá continuar usando o [Novo Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/).
...
Você encontra informações detalhadas sobre cada aba e subabas e sobre cada um dos gráficos disponíveis na [documentação do Novo Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/).
