...
O data source **Functions** exibe os dados referentes às solicitações feitas para suas [functions](/pt-br/documentacao/build/applications/functions/) na Azion.
