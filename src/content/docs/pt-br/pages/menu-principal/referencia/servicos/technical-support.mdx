...
permalink: /documentacao/services/support/
---
...
:::tip
Se você deseja abrir um ticket, consulte o guia [Como abrir um Ticket de Suporte](/pt-br/documentacao/services/support/guides/open-ticket/).
:::
...
<Tabs client:visible>
  ...
  | **CNAMEs already in use** | Você encontrou o erro *CNAMEs already in use* ao listar um CNAME em seu [domínio Azion](/pt-br/documentacao/build/applications/reference/domains/). |
  | **Integration Services** | Você deseja solicitar [Integration Services](/pt-br/documentacao/services/solutions-lab/integration-services/) para realizar uma nova integração com a Azion. |
  | **Template (Preview)** | Você precisa que um [Template](/pt-br/documentacao/marketplace/reference/templates/) seja adicionado ao Azion Marketplace. |
  ...
  | **Rules Engine** | Você tem dúvidas sobre como configurar um comportamento usando [Rules Engine para Applications](/pt-br/documentacao/build/applications/reference/rules-engine/) ou [Rules Engine para Firewall](/pt-br/documentacao/secure/firewall/reference/rules-engine/). |
