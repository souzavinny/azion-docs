...
<Tabs client:visible>
  ...
  | **CNAMEs already in use** | Você encontrou o erro *CNAMEs already in use* ao listar um CNAME em seu [domínio Azion](/pt-br/documentacao/secure/workloads/reference/domains/). |
