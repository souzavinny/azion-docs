...
permalink: /documentacao/build/applications/image-processor/
---
...
:::tip
Acompanhe por meio do [Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/) o gráfico de *Bandwidth Saving* para monitorar a economia de tráfego resultante do processamento de imagens.
:::
...
| Escopo | Recurso |
| --- | --- |
| Primeiros passos | [Primeiros passos do Image Processor](/pt-br/documentacao/build/applications/image-processor/first-steps/) |
