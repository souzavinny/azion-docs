...
permalink: /documentacao/build/applications/reference/error-responses/
menu_namespace: applicationsMenu
---
import LinkButton from 'azion-webkit/linkbutton';

:::caution[importante]
A Funcionalidade Error Responses foi substituída por **Custom Pages**. Para mais informações sobre o novo produto, acesse a [Referência de Custom Pages](/pt-br/documentacao/secure/custom-pages/).
:::
...
| Personalizar página de erro | [Como personalizar uma página de resposta de erro](/pt-br/documentacao/build/applications/guides/personalizar-pagina-resposta-erro/) |
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/origins/" label="Saiba mais sobre Origins" />
