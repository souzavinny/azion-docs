...
permalink: /documentacao/build/applications/reference/origins/
---
...
:::caution[importante]
A funcionalidade Origins foi substituída por **Connectors**. Para mais informações sobre o novo produto, acesse a [referência do Connectors](/pt-br/documentacao/secure/connectors/).
:::
...
O nome do bucket é definido quando você [cria ou modifica um bucket de Object Storage](/pt-br/documentacao/store/object-storage/guides/criar-e-modificar-um-bucket/).
...
<LinkButton link="/pt-br/documentacao/store/object-storage/" label="Saiba mais sobre Object Storage" />
