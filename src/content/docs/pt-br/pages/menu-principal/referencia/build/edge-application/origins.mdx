...
:::caution[importante]
A funcionalidade Origins foi substituída por **Connectors**. Para mais informações sobre o novo produto, acesse a [referência do Connectors](/pt-br/documentacao/build/connectors/).
:::
