...
permalink: /documentacao/build/applications/guides/image-processor/
---

Para configurar o [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/), siga os passos:

1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Applications**.
2. Selecione a application responsável pelo gerenciamento de suas imagens na lista de aplicações existentes ou adicione uma nova aplicação com a ajuda da página sobre [criar uma aplicação](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/).
3. Na aba **Cache Settings**, adicione ou edite uma política de cache personalizada para suas imagens.
4. Na seção **Cache Expiration Policies**, configure a [política de expiração](/pt-br/documentacao/build/applications/reference/cache-settings/#browser-cache-settings) para suas imagens.
...
Para redimensionar, cortar, otimizar, converter ou aplicar filtros a uma imagem, você precisará adicionar as query strings descritas na página [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/) ao URL da imagem, o que pode ser feito usando uma [function](/pt-br/documentacao/build/applications/reference/functions/). Para ver o arquivo original, você só precisa remover a string de consulta adicionada no URL.
