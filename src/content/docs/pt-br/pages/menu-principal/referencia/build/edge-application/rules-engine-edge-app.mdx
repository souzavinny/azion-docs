...
| Criar uma configuração de cache | [Como configurar políticas de cache para Applications](/pt-br/documentacao/build/cache/guides/cache-settings/) |
...
<LinkButton link="/pt-br/documentacao/secure/certificate-manager/reference/mtls-for-build/" label="Saiba mais sobre suporte para mTLS" severity="secondary" />
...
[<Tag severity="info" client:only="vue">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/application-accelerator/)
...
:::tip
Consulte o guia [Como configurar a políticas de cache para Applications](/pt-br/documentacao/build/cache/guides/cache-settings/#bypass-cache) para mais informações sobre o uso de Bypass Cache.
:::
...
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Cache</Tag>](/pt-br/documentacao/build/cache/)
...
Ao ativar esta funcionalidade, a Azion irá requisitar os objetos para sua origem via range requests e os mesmos serão cacheados na Azion com [Advanced Cache Key](/pt-br/documentacao/build/cache/reference/cache-settings/#advanced-cache-key).
...
<LinkButton link="/pt-br/documentacao/build/cache/guides/implementar-cache-hls/" label="consulte o guia para implementar cache HLS" severity="secondary" />
...
Para evitar que um usuário receba o cabeçalho `Set-Cookie` da sessão de outro usuário, consulte o [guia sobre políticas de cache](/pt-br/documentacao/build/cache/guides/cache-settings/#criando-uma-regra-para-enviar-cookies-da-origem-ao-usuario).
...
### Optimize Images 
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Image Processor</Tag>](/pt-br/documentacao/build/image-processor/)
...
<Tag severity="info" client:only="vue">Request Phase</Tag> <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/application-accelerator/)
[<Tag severity="info" client:only="vue">Requer Functions</Tag>](/pt-br/documentacao/build/functions/)
...
Atribui a política de cache que deve ser utilizada para a requisição. As políticas de cache devem ser previamente configuradas na [Cache Settings](/pt-br/documentacao/build/cache/reference/cache-settings/).

Na política de cache você configura o tempo que o objeto deve ser armazenado em cache e as regras para variação dos objetos em cache com a [Advanced Cache Key](/pt-br/documentacao/build/cache/reference/cache-settings/#advanced-cache-key).
...
As origens devem ser previamente configuradas usando [Origins](/pt-br/documentacao/secure/connectors/reference/origins/).
