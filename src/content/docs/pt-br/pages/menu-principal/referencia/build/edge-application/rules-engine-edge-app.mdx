...
permalink: /documentacao/build/applications/reference/rules-engine/
---
...
| Criar uma regra | [Como criar regras de Request e Response usando o Rules Engine para Applications](/pt-br/documentacao/build/applications/guides/rules-engine/) |
| Criar uma configuração de cache | [Como configurar políticas de cache para Applications](/pt-br/documentacao/build/applications/guides/cache-settings/) |
| Mitigar HTTPoxy usando rules | [Como mitigar a vulnerabilidade HTTPoxy](/pt-br/documentacao/build/applications/guides/como-mitigar-vulnerabilidade-httpoxy/) |
...
| `${device_group}` | Nome do device group. Você pode criar [device groups](/pt-br/documentacao/build/applications/reference/device-groups/) na aba **Device Groups** de sua aplicação no Azion Console | `Mobile` | Request <br />Response |
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/domains/mtls/" label="Saiba mais sobre suporte para mTLS" severity="secondary" />
...
[<Tag severity="info" client:only="vue">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/applications/reference/application-accelerator/)
...
:::tip
Consulte o guia [Como configurar a políticas de cache para Applications](/pt-br/documentacao/build/applications/guides/cache-settings/#bypass-cache) para mais informações sobre o uso de Bypass Cache.
:::
...
Ativa a compressão de dados em gzip, caso suportada pelo browser do usuário. Consulte o guia de [Como habilitar compressão gzip](/pt-br/documentacao/build/applications/guides/gzip-compression/) para mais informações.

### Enable Large File Optimization
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Cache</Tag>](/pt-br/documentacao/build/applications/reference/cache/)
...
Ao ativar esta funcionalidade, a Azion irá requisitar os objetos para sua origem via range requests e os mesmos serão cacheados na Azion com [Advanced Cache Key](/pt-br/documentacao/build/applications/reference/cache-settings/#advanced-cache-key).
...
<LinkButton link="/pt-br/documentacao/build/applications/guides/implementar-cache-hls/" label="consulte o guia para implementar cache HLS" severity="secondary" />
...
Para evitar que um usuário receba o cabeçalho `Set-Cookie` da sessão de outro usuário, consulte o [guia sobre políticas de cache](/pt-br/documentacao/build/applications/guides/cache-settings/#criando-uma-regra-para-enviar-cookies-da-origem-ao-usuario).
...
### Optimize Images 
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Image Processor</Tag>](/pt-br/documentacao/build/applications/reference/image-processor/)

Ativa a otimização de imagens.

### Redirect HTTP to HTTPS
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer aplicação HTTPS</Tag>](/pt-br/documentacao/build/applications/reference/main-settings/)
...
<Tag severity="info" client:only="vue">Request Phase</Tag> <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/applications/reference/application-accelerator/)
[<Tag severity="info" client:only="vue">Requer Functions</Tag>](/pt-br/documentacao/build/applications/reference/functions/)

Executa uma função criada no **Functions** e instanciada pela aba **Functions** da application. Consulte o guia de [Como executar funções serverless](/pt-br/documentacao/build/functions/guides/funcoes-serverless/) para mais informações.

### Set Cache Policy
<Tag severity="info" client:only="vue">Request Phase</Tag>

Atribui a política de cache que deve ser utilizada para a requisição. As políticas de cache devem ser previamente configuradas na [Cache Settings](/pt-br/documentacao/build/applications/reference/cache-settings/).

Na política de cache você configura o tempo que o objeto deve ser armazenado em cache e as regras para variação dos objetos em cache com a [Advanced Cache Key](/pt-br/documentacao/build/applications/reference/cache-settings/#advanced-cache-key).
...
As origens devem ser previamente configuradas usando [Origins](/pt-br/documentacao/build/applications/reference/origins/).
...
Você pode executar o fazer o [debug de regras criadas com Rules Engine](/pt-br/documentacao/build/applications/guides/debug-regras/) usando **GraphQL API**, **Data Stream** ou **Real-Time Events**.
