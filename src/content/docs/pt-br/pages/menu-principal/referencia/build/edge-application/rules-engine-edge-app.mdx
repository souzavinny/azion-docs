...
| Criar uma configuração de cache | [Como configurar políticas de cache para Applications](/pt-br/documentacao/build/applications/cache/guides/cache-settings/) |
...
[<Tag severity="info" client:only="vue">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/applications/application-accelerator/)
...
:::tip
Consulte o guia [Como configurar a políticas de cache para Applications](/pt-br/documentacao/build/applications/cache/guides/cache-settings/#bypass-cache) para mais informações sobre o uso de Bypass Cache.
:::
...
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Cache</Tag>](/pt-br/documentacao/build/applications/cache/)
...
<LinkButton link="/pt-br/documentacao/build/applications/cache/guides/implementar-cache-hls/" label="consulte o guia para implementar cache HLS" severity="secondary" />
...
Para evitar que um usuário receba o cabeçalho `Set-Cookie` da sessão de outro usuário, consulte o [guia sobre políticas de cache](/pt-br/documentacao/build/applications/cache/guides/cache-settings/#criando-uma-regra-para-enviar-cookies-da-origem-ao-usuario).
...
### Optimize Images 
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Image Processor</Tag>](/pt-br/documentacao/build/applications/image-processor/)
...
<Tag severity="info" client:only="vue">Request Phase</Tag> <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/applications/application-accelerator/)
[<Tag severity="info" client:only="vue">Requer Functions</Tag>](/pt-br/documentacao/build/applications/functions/)
