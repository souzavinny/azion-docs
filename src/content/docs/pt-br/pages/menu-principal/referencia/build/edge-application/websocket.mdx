...
permalink: /documentacao/build/applications/reference/websocket/
---
...
| Functions WebSocket API | [WebSocket API](/pt-br/documentacao/build/functions/runtime-apis/websocket/) |
| Debug Rules | [Debug Rules](/pt-br/documentacao/build/applications/guides/debug-regras/) |
...
<LinkButton link="/pt-br/documentacao/build/functions/runtime-apis/websocket/" label="Ir para referência da WebSocket API" severity="secondary" target="_blank" />
