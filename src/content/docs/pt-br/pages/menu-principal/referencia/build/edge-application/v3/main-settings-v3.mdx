...
permalink: /documentacao/build/applications/reference/v3/main-settings/
---
...
:::caution[importante]
Você está visualizando uma versão anterior desta documentação. Se a sua conta já foi migrada, consulte a [referência de main settings Applications](/pt-br/documentacao/build/applications/reference/main-settings/) atualizada.
:::

Com [Applications](/pt-br/documentacao/build/applications/), você pode escolher o protocolo de entrega e as portas de sua aplicação. Você também pode garantir a segurança da conexão HTTPS entre a aplicação e seus usuários com cifras TLS.
...
:::note
Se você escolher entregar sua aplicação usando HTTP & HTTPS, você deve associar um [digital certificate](/pt-br/documentacao/secure/certificate-manager/) a seu domínio.
:::
...
<LinkButton link="/pt-br/documentacao/secure/firewall/guides/cifras/" label="consulte o guia configurar o conjunto de cifras TLS" severity="secondary" />
