...
- [Cache Settings](/pt-br/documentacao/build/cache/reference/cache-settings/)
- [Functions](/pt-br/documentacao/build/functions/reference/functions-instances/)
...
5. Se você optou por substituir as configurações de cache, adicione o **Maximum TTL** desejado em segundos.
   - Neste ponto, você também pode personalizar outras configurações de cache para conteúdo dinâmico fornecido pelo recurso [Advanced Cache Key](/pt-br/documentacao/build/cache/reference/cache-settings/#advanced-cache-key) .
6. Clique no botão **Save**.
...
Instancie suas funções usando as [Functions](/pt-br/documentacao/build/functions/reference/functions-instances/):
...
Para acessar a [Real-Time Purge](/pt-br/documentacao/build/cache/reference/real-time-purge/), proceda da seguinte forma:
