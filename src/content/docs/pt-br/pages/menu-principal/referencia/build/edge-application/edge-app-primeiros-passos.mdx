...
permalink: /documentacao/build/applications/quickstart/
---

Antes de usar *Applications*, certifique-se que você tem:

- Uma conta no Azion Console. Você pode encontrar mais informações sobre como criar sua conta na [página de documentação](/pt-br/documentacao/account/reference/criar-uma-conta/).
- Uma application. Se você ainda não criou uma application, confira a página sobre [criar uma aplicação](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/).

> Consulte também os guias sobre [como clonar](/pt-br/documentacao/build/applications/guides/clonar-applications/) e [como excluir](/pt-br/documentacao/build/applications/guides/excluir-applications/) uma application.
...
- [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/)
- [Cache](/pt-br/documentacao/build/applications/reference/cache/)
- [Functions](/pt-br/documentacao/build/applications/reference/functions/)
- [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/)
- [Tiered Cache](/pt-br/documentacao/build/applications/reference/cache/tiered-cache/)

Alguns **módulos de Applications** são produtos faturados.Isso pode gerar custos relacionados ao uso,consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
...
- [Device Groups](/pt-br/documentacao/build/applications/reference/device-groups/)
- [Cache Settings](/pt-br/documentacao/build/applications/reference/cache-settings/)
- [Functions](/pt-br/documentacao/build/applications/reference/functions-instances/)
- [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/)
...
Para configurar a origem da sua Applications, você usará o [Connectors](/pt-br/documentacao/build/connectors/).
...
:::note
Para mais detalhes sobre os tipos de conector, acesse a [referência do Connectors](/pt-br/documentacao/build/connectors/).
:::
...
O **Connectors** permite configurar múltiplas origens e distribuir o tráfego entre elas utilizando o [Load Balancer](/pt-br/documentacao/build/connectors/reference/load-balancer/).

:::tip
Você pode usar o [Custom Pages](/pt-br/documentacao/secure/custom-pages/) para configurar páginas de erro personalizadas que são exibidas quando o **Connectors** recebe respostas de erro específicas (como códigos de status HTTP 4xx ou 5xx) da sua origem.
:::

### Device Groups

Para gerenciar grupos de dispositivos usando [Device Groups](/pt-br/documentacao/build/applications/reference/device-groups/):
...
Edite suas configurações de cache na aba [Cache Settings](/pt-br/documentacao/build/applications/reference/cache/):
...
5. Se você optou por substituir as configurações de cache, adicione o **Maximum TTL** desejado em segundos.
   - Neste ponto, você também pode personalizar outras configurações de cache para conteúdo dinâmico fornecido pelo recurso [Advanced Cache Key](/pt-br/documentacao/build/applications/reference/cache-settings/#advanced-cache-key) .
6. Clique no botão **Save**.

#### Tiered Cache

Para usar o módulo [Tiered Cache](/pt-br/documentacao/build/applications/reference/cache/tiered-cache/):
...
Instancie suas funções usando as [Functions](/pt-br/documentacao/build/applications/reference/functions-instances/):
...
Crie regras de negócios condicionais para sua aplicação usando o [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/).
...
Para acessar a [Real-Time Purge](/pt-br/documentacao/build/applications/reference/real-time-purge/), proceda da seguinte forma:
