...
permalink: /documentacao/build/applications/reference/functions/
---
...
| Escopo | Guia |
| - | - |
| API Builder| [Como construir uma API com Functions e ChatGPT](/pt-br/documentacao/build/functions/guides/api-builder/) 
| Exemplos de functions em JavaScript| [Exemplos](/pt-br/documentacao/build/functions/runtime-apis/javascript-examples/)|
...
Ao usar o [Azion Runtime](/pt-br/documentacao/build/functions/runtime-apis/overview/) para desenvolver suas functions, você tem um conjunto de ferramentas que o ajudam a implementar sua lógica.

<LinkButton link="/pt-br/documentacao/build/functions/runtime-apis/overview/" label="saiba mais sobre o Azion Runtime" severity="secondary" target="_blank" />

<br /><LinkButton link="/pt-br/documentacao/build/functions/runtime-apis/compatibility/" label="saiba mais sobre os Web frameworks suportados" severity="secondary" target="_blank" />
<br /><LinkButton link="/pt-br/documentacao/build/functions/runtime-apis/compatibilidade/node/" label="saiba mais sobre o suporte ao Node.js" severity="secondary" target="_blank" />
<br /><LinkButton link="/pt-br/documentacao/build/functions/runtime-apis/javascript/" label="saiba mais sobre as Web APIs suportadas" severity="secondary" target="blank" />
...
Para a lista completa de frameworks suportados e informações detalhadas de compatibilidade, consulte [Compatibilidade de frameworks](/pt-br/documentacao/build/functions/runtime-apis/compatibility/).

### Implicações práticas

Ao fazer o deploy de um projeto com framework, considere:

- **Custos de compute**: Deploys de frameworks geram Functions, que incorrem em cobranças de tempo de compute e invocações. Consulte [Preços](/pt-br/documentacao/platform/pricing/) para detalhes.
- **Debugging**: Use [Preview Deployment](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-api/preview-deployment/), [Data Stream](/pt-br/documentacao/observe/data-stream/guides/debugging-functions-data-stream/) ou [GraphQL API](/pt-br/documentacao/build/functions/guides/debugging-functions-graphql/) para depurar Functions geradas por frameworks.
- **Variáveis de ambiente**: Acesse variáveis de ambiente no código do seu framework usando a [API de variáveis de ambiente da Azion](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime/api-reference/environment-variables/).

<LinkButton link="/pt-br/documentacao/build/functions/runtime-apis/compatibility/" label="Ver todos os frameworks suportados" severity="secondary" target="_blank" />
...
<LinkButton link="/pt-br/documentacao/build/ai-inference/" label="Saiba mais sobre AI Inference" severity="secondary" target="_blank" />
...
Veja [Como criar uma functions usando WebAssembly na Azion Web Platform](/pt-br/documentacao/build/functions/guides/webassembly-na-plataforma-azion/).
...
Saiba mais sobre [Functions Instances](/pt-br/documentacao/build/applications/reference/functions-instances/).
...
Saiba mais sobre [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/).
...
Saiba mais sobre o [Functions Code Editor](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-api/code-editor/).
...
Saiba mais sobre o [Assistente de IA](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-api/ai-integration/).
...
Saiba mais sobre o [Preview Deployment](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-api/preview-deployment/).

---

## Debug

Você pode depurar suas functions em tempo real usando a ferramenta de `inspeção` dentro do [Preview Deployment](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-api/preview-deployment/).

Você também pode depurar usando:

- [Data Stream](/pt-br/documentacao/observe/data-stream/guides/debugging-functions-data-stream/)
- [GraphQL API](/pt-br/documentacao/build/functions/guides/debugging-functions-graphql/)
...
Saiba mais sobre a interface de [Variáveis de Ambiente](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime/api-reference/environment-variables/).
...
Saiba mais sobre o [Comando functions e seus subcomandos](/pt-br/documentacao/devtools/cli/reference/create/#edge-functions).
