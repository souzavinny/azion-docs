...
| Configurar Advanced Cache Key | [Como configurar a Advanced Cache Key para Applications](/pt-br/documentacao/build/application-accelerator/guides/advanced-cache-key/) |
...
**CDN Cache Settings** configura como a Azion armazena o cache na sua rede distribuída. Você pode selecionar dentre as seguintes opções:
...
**Large File Optimization** funciona com o tamanho de fragmentação de *1.024 kB*. Se você deseja modificar o *fragmentation size*, [contate a equipe de Vendas](https://www.azion.com/pt-br/contato/).

<LinkButton link="/pt-br/documentacao/build/cache/#large-file-optimization" label="Saiba mais sobre Large File Optimization" />
...
<LinkButton link="/pt-br/documentacao/build/cache/#stale-cache" label="Saiba mais sobre stale cache" />
