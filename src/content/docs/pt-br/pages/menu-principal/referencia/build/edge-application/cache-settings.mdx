...
permalink: /documentacao/build/applications/reference/cache-settings/
---
...
| Módulo Cache | [Cache](/pt-br/documentacao/build/applications/reference/cache/) |
...
| Configurar Advanced Cache Key | [Como configurar a Advanced Cache Key para Applications](/pt-br/documentacao/build/applications/guides/advanced-cache-key/) |
...
- **Override Cache Settings**: substitui a configuração de cache do seu servidor de origem com o TTL desejado. Para definir o TTL de cache CDN para valores inferiores a 60 segundos, você deve habilitar o módulo [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/).
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/cache/#large-file-optimization" label="Saiba mais sobre Large File Optimization" />
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/cache/tiered-cache/" label="Saiba mais sobre Tiered Cache" />
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/cache/#stale-cache" label="Saiba mais sobre stale cache" />
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/device-groups/" label="Saiba mais sobre Device Groups" />
