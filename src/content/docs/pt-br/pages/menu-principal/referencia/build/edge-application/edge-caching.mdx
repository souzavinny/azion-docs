...
permalink: /documentacao/build/applications/reference/cache/
---
...
| Módulo Tiered Cache | [Tiered Cache](/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) |
| Configurar uma política de cache | [Como configurar políticas de cache para Applications](/pt-br/documentacao/build/applications/guides/cache-settings/) |
...
:::note
Saiba mais sobre como automatizar seu navegador para obter outros dados de cache no guia [Como verificar indicadores de cache usando Modheader para Google Chrome](/pt-br/documentacao/build/applications/guides/verificar-tempo-de-cache-da-pagina/).
:::
...
Quando o [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/) está ativado, além da query string `ims`, variações com formato convertido contêm o formato do arquivo após o separador.
...
Quando a funcionalidade [Advanced Cache Key](/pt-br/documentacao/build/applications/reference/application-accelerator/#advanced-cache-key) estiver configurada, a formação das cache keys também é afetada.
