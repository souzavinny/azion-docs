...
permalink: /documentacao/build/applications/cache/
---
...
| Escopo | Recursos |
| --- | --- |
| Configurações de cache disponíveis | [Cache Settings](/pt-br/documentacao/build/applications/reference/cache-settings/) |
| Módulo Tiered Cache | [Tiered Cache](/pt-br/documentacao/build/applications/cache/tiered-cache/) |
| Configurar uma política de cache | [Como configurar políticas de cache para Applications](/pt-br/documentacao/build/applications/cache/guides/cache-settings/) |
...
:::note
Saiba mais sobre como automatizar seu navegador para obter outros dados de cache no guia [Como verificar indicadores de cache usando Modheader para Google Chrome](/pt-br/documentacao/build/applications/cache/guides/verificar-tempo-de-cache-da-pagina/).
:::
...
| **-** | Se nenhum status for recebido, o conteúdo do request está restrito de permanecer em cache. Por exemplo, se o conteúdo é uma requisição `POST` e [Caching for POST](/pt-br/documentacao/build/applications/reference/cache-settings/#cache-de-metodos-http) está desabilitado, o status não é recebido |
...
Quando o [Image Processor](/pt-br/documentacao/build/applications/image-processor/) está ativado, além da query string `ims`, variações com formato convertido contêm o formato do arquivo após o separador.
...
Se houver uma variação de objetos por [device groups](/pt-br/documentacao/build/applications/reference/device-groups/), o separador `@@` e o nome do device group serão acrescentados ao final. 
...
Quando a funcionalidade [Advanced Cache Key](/pt-br/documentacao/build/applications/application-accelerator/#advanced-cache-key) estiver configurada, a formação das cache keys também é afetada.
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/cache-settings/#browser-cache-settings" label="Saiba mais sobre expiration settings" />
...
**Adaptive Delivery** detecta os grupos de dispositivos que você criou usando o [Device Groups](/pt-br/documentacao/build/applications/reference/device-groups/), permitindo que você configure como a Azion entrega seu conteúdo. Você pode optar por fornecer a mesma versão do conteúdo, independentemente da detecção do dispositivo, ou manter variações de objetos baseadas no dispositivo em cache.

<LinkButton link="/pt-br/documentacao/build/applications/reference/cache-settings/#adaptive-delivery" label="Saiba mais sobre adaptive delivery" />
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/cache-settings/#large-file-optimization" label="Saiba mais sobre configurações de large file optimization" />
...
:::tip
**Aumente limites** <br></br>
Você pode solicitar o aumento dos limites com base no seu plano. Contate o [time de suporte técnico](https://www.azion.com/pt-br/documentacao/services/support/) para fazer a solicitação.
:::
