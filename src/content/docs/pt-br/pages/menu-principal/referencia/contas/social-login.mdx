...
permalink: /documentacao/account/reference/social-login/
...
Para mais informações sobre cadastro na Azion com **Social Login**, visite a página de [criar uma conta](/pt-br/documentacao/account/reference/criar-uma-conta/).
