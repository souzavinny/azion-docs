...
permalink: /documentacao/account/reference/single-sign-on/
...
| Tarefa | Guia |
| ---- | ----- |
| Configurar SAML Microsoft Entra | [Como utilizar Microsoft Entra SAML como um IdP na Azion](/pt-br/documentacao/account/guides/sso-microsoft-entra-saml/) |
| Configurar SAML Google | [Como utilizar Google SAML como IdP para a Azion](/pt-br/documentacao/account/guides/sso-google-saml/) |
| Configurar SAML Okta | [Como utilizar Okta SAML como IdP para a Azion](/pt-br/documentacao/account/guides/sso-okta-saml/) |
| Provisionamento usuários do Microsoft Entra | [Como habilitar o provisionamento automatizado de usuários do Microsoft Entra com SCIM para a Azion](/pt-br/documentacao/account/guides/microsoft-entra-provisionamento-automatizado-de-usuarios/) |
...
Para configurar um certificado X.509 na Azion, consulte [Como configurar um certificado X.509](/pt-br/documentacao/secure/certificate-manager/#como-configurar-um-certificado-x509) na documentação do Certificate Manager.
