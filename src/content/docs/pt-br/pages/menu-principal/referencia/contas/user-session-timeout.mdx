...
permalink: /documentacao/account/reference/user-session-timeout/
...
| Escopo | Recurso |
| ----------- | ----------- |
| Configurar o User Session Timeout | [Como configurar o User Session Timeout](/pt-br/documentacao/account/guides/configurar-user-session-timeout/) |
...
<LinkButton link="/pt-br/documentacao/account/guides/configurar-user-session-timeout/" label="Consulte o guia para configurar o User Session Timeout" severity="secondary" target="_blank" />
