...
permalink: /documentacao/marketplace/templates/nextal/
meta_tags: >-
...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <SectionBasicContent
    ...
    buttons={[
      { label: "Implantar template", link: "/pt-br/documentacao/get-started/frameworks/nextal/", outlined: false, icon: "ai ai-azion", iconPos: "left" }
    ]}
  />
</div>
...
<div style="display: flex; gap: 1rem; align-items: center; flex-direction: row; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 300px;">
    ...
    | Framework | [Next.js](/pt-br/documentacao/build/functions/runtime-apis/compatibility/nextjs/) |
    | Caso de uso | Geral |
  </div>
...
Para mais informações sobre a implementação deste template, visite o [guia do template](/pt-br/documentacao/get-started/frameworks/nextal/).