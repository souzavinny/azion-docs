...
permalink: /documentacao/marketplace/templates/astro-boilerplate/
meta_tags: >-
...
Para mais informações sobre a implementação deste template, visite o [guia do template](/pt-br/documentacao/marketplace/integrations/astro-boilerplate/).
