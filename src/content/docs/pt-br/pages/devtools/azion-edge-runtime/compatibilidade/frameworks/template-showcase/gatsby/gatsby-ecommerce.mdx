...
permalink: /documentacao/marketplace/templates/gatsby-ecommerce/
meta_tags: >-
...
Para mais informações sobre a implementação deste template, visite o [guia do template](/pt-br/documentacao/marketplace/integrations/gatsby-ecommerce-theme/).