...
permalink: /documentacao/marketplace/templates/space-jelly-shop/
meta_tags: >-
...
Para mais informações sobre a implementação deste template, visite o [guia do template](/pt-br/documentacao/marketplace/integrations/next-js-ecommerce-collection/).