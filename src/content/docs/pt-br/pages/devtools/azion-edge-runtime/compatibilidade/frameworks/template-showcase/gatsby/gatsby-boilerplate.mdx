...
permalink: /documentacao/marketplace/templates/gatsby-boilerplate/
meta_tags: >-
...
>
  <Fragment slot="content">
    <div style="flex: 1; min-width: 300px;">
      ...
      | Framework | [Gatsby](/pt-br/documentacao/build/functions/runtime-apis/compatibility/gatsby/) |
...
Para mais informações sobre a implementação deste template, visite o [guia do template](/pt-br/documentacao/marketplace/integrations/gatsby-boilerplate/).