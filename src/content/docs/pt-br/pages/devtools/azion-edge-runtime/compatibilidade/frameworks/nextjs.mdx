...
permalink: /documentacao/build/functions/runtime-apis/compatibility/nextjs/
meta_tags: >-
...
O Next.js também permite a Renderização do Lado do Servidor (SSR) na Azion Web Platform. Para mais informações sobre a compatibilidade do Next.js, [clique aqui](/pt-br/documentacao/build/functions/runtime-apis/frameworks-suportados/nextjs/)

## Templates disponíveis

| Nome do template | Caso de uso | Detalhes |
|:-------------|:---------|:-----|
| Next.js Static Boilerplate | Site estático | <LinkButton link="/pt-br/documentacao/marketplace/templates/nextjs-static-boilerplate/" label="Mais detalhes" severity="secondary" /> |
| Cosmic Next Blog | Blog | <LinkButton link="/pt-br/documentacao/marketplace/templates/cosmic-nextjs-blog/" label="Mais detalhes" severity="secondary" /> |
| Cosmic Agency | E-commerce | <LinkButton link="/pt-br/documentacao/marketplace/templates/cosmic-agency/" label="Mais detalhes" severity="secondary" /> |
| Space Jelly Shop | E-commerce | <LinkButton link="/pt-br/documentacao/marketplace/templates/space-jelly-shop/" label="Mais detalhes" severity="secondary" /> |
| Nextal | Geral | <LinkButton link="/pt-br/documentacao/marketplace/templates/nextal/" label="Mais detalhes" severity="secondary" /> |
