...
og_image: ''
permalink: /documentacao/build/functions/runtime-apis/guides/use-polyfills/
---
...
- Uma conta na [plataforma da Azion](/pt-br/documentacao/account/reference/criar-uma-conta/) com o módulo [Functions](/pt-br/documentacao/build/applications/reference/functions/) habilitado.
...
:::note
Para mais informações sobre como configurar o seu projeto, verifique a [referência do arquivo azion.config.js](/pt-br/documentacao/devtools/cli/reference/azion-config-js/).
:::
