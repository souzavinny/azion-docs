...
- Uma conta na [plataforma da Azion](/pt-br/documentacao/account/reference/criar-uma-conta/) com o módulo [Functions](/pt-br/documentacao/build/functions/) habilitado.
