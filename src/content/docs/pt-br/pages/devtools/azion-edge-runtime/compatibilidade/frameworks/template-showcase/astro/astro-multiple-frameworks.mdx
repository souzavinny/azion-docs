...
permalink: /documentacao/marketplace/templates/astro-multiple-frameworks/
meta_tags: >-
...
Para mais informações sobre a implementação deste template, visite o [guia do template](/en/documentation/marketplace/integrations/astro-ecommerce-collection/).