...
permalink: /documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/readable-default-reader/
...
Em contraste com um [ReadableStreamBYOBReader](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/readable-byob-reader/), que só funciona caso a *stream* tenha uma fonte de bytes, o ReadableStreamDefaultReader pode ser usado para qualquer tipo de fonte de *Readable Stream*.
