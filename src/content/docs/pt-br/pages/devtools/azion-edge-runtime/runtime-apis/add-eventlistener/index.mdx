...
permalink: /documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/add-eventlistener/
menu_namespace: runtimeMenu
---

### Como Funciona

A função *addEventListener* define o gatilho para execução do código JavaScript para receber os dados da requisição. O tipo do event listener é `fetch`, o qual recebe o [fetchEvent](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch-event/).
...
- [Runtime APIs](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch/)
