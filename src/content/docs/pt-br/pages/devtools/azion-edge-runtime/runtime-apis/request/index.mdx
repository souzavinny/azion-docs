...
permalink: /documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/request/
menu_namespace: runtimeMenu
---

A interface `Request` representa uma requisição HTTP e integra a [Fetch API](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch/).

### Como Funciona

O objeto Request pode ser construído e observado como propriedade de um [fetchevent](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/fetch-event/) recebido pela Function.
