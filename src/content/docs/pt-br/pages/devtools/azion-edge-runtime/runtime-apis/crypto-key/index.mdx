...
permalink: /documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/crypto-key/
menu_namespace: runtimeMenu
---

A interface `CryptoKey` representa uma chave criptográfica obtida de um dos [métodos SubtleCrypto](/pt-br/documentacao/build/functions/runtime-apis/functions/runtime-apis/javascript/subtle-crypto/).
