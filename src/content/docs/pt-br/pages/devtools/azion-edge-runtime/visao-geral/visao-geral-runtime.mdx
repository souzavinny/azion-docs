...
**Azion Runtime** é um conjunto de ferramentas de desenvolvimento no **Edge**. O Azion Runtime possibilita a criação de [functions](/pt-br/documentacao/build/applications/functions/) em JavaScript, construídas sobre os padrões da Web.
