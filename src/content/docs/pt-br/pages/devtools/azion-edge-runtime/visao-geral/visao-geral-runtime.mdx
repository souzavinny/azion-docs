...
permalink: /documentacao/build/functions/runtime-apis/overview/
meta_tags: >-
...
**Azion Runtime** é um conjunto de ferramentas de desenvolvimento no **Edge**. O Azion Runtime possibilita a criação de [functions](/pt-br/documentacao/build/applications/reference/functions/) em JavaScript, construídas sobre os padrões da Web.
...
<LinkButton link="/pt-br/documentacao/build/functions/runtime-apis/javascript/" label="Veja todas as Web APIs suportadas" severity="secondary" target="_blank" />
