...
permalink: /documentacao/build/functions/runtime-apis/functions/runtime/api-reference/network-list/
meta_tags: >-
...
Saiba mais sobre [Network Lists na plataforma da Azion](/pt-br/documentacao/secure/firewall/reference/network-shield/network-lists/).
