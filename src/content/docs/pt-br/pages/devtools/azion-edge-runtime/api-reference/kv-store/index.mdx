...
permalink: /documentacao/build/functions/runtime-apis/kv-store/
...
|--------|-----------|------------|
| `put(key, value, options?)` | Armazena um par chave-valor | [Escrever pares chave-valor](/pt-br/documentacao/build/functions/runtime-apis/kv-store/write/) |
| `get(key, type?, options?)` | Recupera um valor pela chave | [Ler pares chave-valor](/pt-br/documentacao/build/functions/runtime-apis/kv-store/read/) |
| `getWithMetadata(key, type?, options?)` | Recupera um valor com seus metadados | [Ler pares chave-valor](/pt-br/documentacao/build/functions/runtime-apis/kv-store/read/) |
| `delete(key)` | Exclui um par chave-valor | [Excluir pares chave-valor](/pt-br/documentacao/build/functions/runtime-apis/kv-store/delete/) |
