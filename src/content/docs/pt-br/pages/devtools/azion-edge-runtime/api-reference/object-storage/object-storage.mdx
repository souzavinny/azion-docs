...
permalink: /documentacao/build/functions/runtime-apis/storage/
meta_tags: >-
...
A [Functions](/pt-br/documentacao/build/applications/reference/functions/) Storage API é uma interface que permite o acesso ao Azion Object Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
