...
permalink: /documentacao/build/functions/runtime-apis/kv-store/read/
...
- [Escrever pares chave-valor](/pt-br/documentacao/build/functions/runtime-apis/kv-store/write/)
- [Excluir pares chave-valor](/pt-br/documentacao/build/functions/runtime-apis/kv-store/delete/)
- [Visão geral da API KV Store](/pt-br/documentacao/build/functions/runtime-apis/kv-store/)
