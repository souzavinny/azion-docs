...
Para depurar códigos, você deve criar uma nova [function](/pt-br/documentacao/build/applications/functions/) que utilizará o método **log**. Esse métodoo imprime no console uma mensagem que foi previamente enviada como parâmetro para a função.
