...
- Interface visual para os argumentos de [Azion Functions](/pt-br/documentacao/build/applications/functions/) por meio de um modo baseado em formulário.
...
1. Acesse [**Functions**](/pt-br/documentacao/build/applications/functions/) → **+ Function**.
