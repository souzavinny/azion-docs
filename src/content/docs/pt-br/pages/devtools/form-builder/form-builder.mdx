...
- Interface visual para os argumentos de [Azion Functions](/pt-br/documentacao/build/applications/reference/functions/) por meio de um modo baseado em formulário.
...
1. Acesse [**Functions**](/pt-br/documentacao/build/applications/reference/functions/) → **+ Function**.
...
As [Functions Instances](/pt-br/documentacao/build/applications/reference/functions-instances/) de [Applications](/pt-br/documentacao/build/applications/) e Firewalls renderizam usando o Form Builder configurado na função criada.

Quando um Form Builder é configurado durante a criação/edição da função, o formulário visual é carregado com um seletor `Form/JSON` ao carregar instâncias em [Applications](/pt-br/documentacao/build/applications/) ou Firewalls.
