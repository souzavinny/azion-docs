...
As [Functions Instances](/pt-br/documentacao/build/functions/reference/functions-instances/) de [Applications](/pt-br/documentacao/build/applications/) e Firewalls renderizam usando o Form Builder configurado na função criada.
