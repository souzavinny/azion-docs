...
permalink: /documentacao/devtools/cli/reference/comando-unlink/
meta_tags: >-
...
- [azion reset](/pt-br/documentacao/devtools/cli/reference/reset/): restaura as configurações salvas da CLI para um estado limpo.
- [azion login](/pt-br/documentacao/devtools/cli/reference/login/): autentica a CLI antes de vincular ou trabalhar em um projeto.
