...
permalink: /documentacao/devtools/cli/reference/azion-config-js/
...
- [Functions](/pt-br/documentacao/build/applications/reference/functions/) - Compute serverless na Azion Platform
- [Applications](/pt-br/documentacao/build/applications/) - Configure e gerencie suas applications
- [Firewall](/pt-br/documentacao/secure/firewall/) - Proteja suas applications
- [WAF](/pt-br/documentacao/secure/waf/) - Web Application Firewall
- [Cache](/pt-br/documentacao/build/applications/reference/cache/) - Configure políticas de cache
