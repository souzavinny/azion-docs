...
A flag `--application-acceleration` especifica se a application tem o módulo [Application Acceleration](/pt-br/documentacao/build/applications/application-accelerator/) ativo.
...
A flag `--edge-functions` especifica se a application tem o módulo [Functions](/pt-br/documentacao/build/applications/functions/) ativo.
...
A flag `--image-optimization` especifica se a application tem o módulo [Image Processor](/pt-br/documentacao/build/applications/image-processor/) ativo.
...
A flag `--l2-caching` especifica se a application tem o módulo [Tiered Cache](/pt-br/documentacao/build/applications/cache/tiered-cache/) ativo.

##### load-balancer

A flag `--load-balancer` especifica se a application tem o módulo [Load Balancer](/pt-br/documentacao/secure/connectors/reference/load-balancer/) ativo.
