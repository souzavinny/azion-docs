...
permalink: /documentacao/devtools/cli/reference/update/
meta_tags: >-
...
A flag `--application-acceleration` especifica se a application tem o módulo [Application Acceleration](/pt-br/documentacao/build/applications/reference/application-accelerator/) ativo.

##### delivery-protocol

A flag `--delivery-protocol` especifica o [protocolo de entrega](/pt-br/documentacao/build/applications/reference/main-settings/) da application.
...
A flag `--edge-firewall` especifica se a application tem um [Firewall](/pt-br/documentacao/secure/firewall/) associado ativado ou não.

##### edge-functions

A flag `--edge-functions` especifica se a application tem o módulo [Functions](/pt-br/documentacao/build/applications/reference/functions/) ativo.
...
A flag `--image-optimization` especifica se a application tem o módulo [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/) ativo.
...
A flag `--l2-caching` especifica se a application tem o módulo [Tiered Cache](/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) ativo.

##### load-balancer

A flag `--load-balancer` especifica se a application tem o módulo [Load Balancer](/pt-br/documentacao/build/connectors/reference/load-balancer/) ativo.
