...
permalink: /documentacao/devtools/graphql/reference/overview/
meta_tags: >-
...
- [API GraphQL do Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/), que fornece métricas agregadas em tempo real.
- [API GraphQL Real-Time Events](/pt-br/documentacao/observe/real-time-events/), que fornece logs brutos em tempo real.

<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/queries/" label="saiba mais sobre dados agregados e brutos" />

Você também pode usar as APIs GraphQL financeiras:

- [API GraphQL de Billing](/pt-br/documentacao/account/reference/billing-and-subscriptions/), que fornece dados relacionados às contas de faturamento, tipos de entradas financeiras e pagamentos.
- [API GraphQL de Accounting](/pt-br/documentacao/devtools/graphql/reference/campos-gql-accounting/), que fornece dados relacionados a produtos e suas métricas sendo contabilizadas na conta do cliente.
- [API GraphQL de Consumption](/pt-br/documentacao/devtools/graphql/reference/campos-gql-consumption/), que fornece dados relacionados ao uso dos produtos e suas métricas que estão sendo contabilizadas na conta do cliente.
