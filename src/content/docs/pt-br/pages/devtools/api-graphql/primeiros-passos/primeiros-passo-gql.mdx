...
permalink: /documentacao/devtools/graphql/reference/first-steps/
meta_tags: >-
...
Para interagir com o playground da GraphQL, você deve estar [logado no Azion Console](https://console.azion.com). Se você ainda não criou uma conta, veja a página de documentação [Criar uma conta na Azion](/pt-br/documentacao/account/reference/criar-uma-conta/).
