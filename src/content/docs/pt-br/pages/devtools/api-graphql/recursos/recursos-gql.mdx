...
permalink: /documentacao/devtools/graphql/reference/recursos/
meta_tags: >-
...
| edgeFunctionsMetrics | Eventos de execução do [Functions](/pt-br/documentacao/build/applications/reference/functions/) |
| httpMetrics | Eventos de requisições registradas pelo [Applications](/pt-br/documentacao/build/applications/) e [Firewall](/pt-br/documentacao/secure/firewall/) |
| httpBreakdownMetrics | Consulte dados agregados, detalhados e em tempo real sobre [eventos de requisições HTTP bloqueadas](/pt-br/documentacao/devtools/graphql/guides/consultar-dados-httpbreakdownmetrics-com-graphql/)  |
| edgeDnsQueriesMetrics | Eventos de consultas realizadas no [Edge DNS](/pt-br/documentacao/secure/edge-dns/) |
| imagesProcessedMetrics |  Eventos de processamento de imagens do [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/) |
| tieredCacheMetrics | Eventos de requisições registradas pelo [Tiered Cache](/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) |
| connectedUsersMetrics | Consulte o número de usuários conectados às suas aplicações, usando [Live Ingest](/pt-br/documentacao/devtools/graphql/guides/query-dados-connected-users-com-graphql/) |
| botManagerMetrics | Consulte o número de requisições avaliadas e as ações realizadas pelo [Azion Bot Manager](/pt-br/documentacao/devtools/graphql/guides/consultar-dados-bot-manager-com-graphql/) (se inscrito) |
| botManagerBreakdownMetrics | Consulte as URLs mais impactadas por bots maliciosos, de acordo com os dados do [Azion Bot Manager](/pt-br/documentacao/devtools/graphql/guides/consultar-dados-bot-manager-breakdown-com-graphql/) (se inscrito) |

<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/campos-gql-real-time-metrics/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Metrics" severity="secondary" />

### Real-Time Events GraphQL API

| Conjunto de dados | Descrição |
| ----------------- | --------- |
| activityHistoryEvents | Logs de eventos de uma conta no Azion Console relacionados às atividades registradas no [Activity History](/pt-br/documentacao/account/reference/activity-history/). Armazena dados por *2 anos* e exibe dados a partir de *22 de setembro de 2023*. |
| functionConsoleEvents | Logs de eventos das aplicações usando o [Azion Runtime](/pt-br/documentacao/build/functions/runtime-apis/overview/) retornados pelo Cells Console. |
...
| functionEvents | Eventos de execução do [Functions](/pt-br/documentacao/build/applications/reference/functions/). |
| workloadEvents | Eventos de requisições registradas pelo [Applications](/pt-br/documentacao/build/applications/) e [Firewall](/pt-br/documentacao/secure/firewall/). |
| idnsQueriesEvents | Eventos de consultas realizadas no [Edge DNS](/pt-br/documentacao/secure/edge-dns/). |
| imagesProcessedEvents | Eventos de processamento de imagens do [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/). |
| l2CacheEvents | Eventos de requisições registradas pelo [Tiered Cache](/pt-br/documentacao/build/applications/reference/cache/tiered-cache/). |
...
<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/campos-gql-real-time-events/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Events" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/campos-gql-billing/" label="veja as descrições dos Campos da API GraphQL de Billing" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/campos-gql-accounting/" label="veja as descrições dos Campos da API GraphQL de Accounting" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/campos-gql-consumption/" label="Veja as descrições dos campos da API GraphQL de Consumption" severity="secondary" />

---

:::tip[dica]
Você também pode rodar uma **Introspection Query** para consultar os metadados dos datasets de Metrics e Events. Os metadados fornecem o que cada dataset das APIs GraphQL permite e informações específicas: nome, descrição e formato. Veja mais no guia [Como consultar metadados com a API GraphQL](/pt-br/documentacao/devtools/graphql/guides/graphql-metadados/).
:::

Você pode solicitar dados *raw* (*brutos*), usando os conjuntos **Events**, ou *aggregated* (*agregados*), usando os conjuntos **Metrics**.

<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/queries/#dados-brutos" label="ir para referência de queries brutas" severity="secondary" /> <br></br>

<LinkButton link="/pt-br/documentacao/devtools/graphql/reference/queries/#dados-agregados" label="ir para referência de queries agregadas" severity="secondary" /> <br></br>

<LinkButton link="/pt-br/documentacao/devtools/graphql/guides/graphql-dados-agregados/" label="ir para guia Como realizar consultas agregando dados com a API GraphQL" severity="secondary" />
