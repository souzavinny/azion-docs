...
| edgeFunctionsMetrics | Eventos de execução do [Functions](/pt-br/documentacao/build/applications/functions/) |
...
| imagesProcessedMetrics |  Eventos de processamento de imagens do [Image Processor](/pt-br/documentacao/build/applications/image-processor/) |
| tieredCacheMetrics | Eventos de requisições registradas pelo [Tiered Cache](/pt-br/documentacao/build/applications/cache/tiered-cache/) |
...
| functionEvents | Eventos de execução do [Functions](/pt-br/documentacao/build/applications/functions/). |
...
| imagesProcessedEvents | Eventos de processamento de imagens do [Image Processor](/pt-br/documentacao/build/applications/image-processor/). |
| l2CacheEvents | Eventos de requisições registradas pelo [Tiered Cache](/pt-br/documentacao/build/applications/cache/tiered-cache/). |
