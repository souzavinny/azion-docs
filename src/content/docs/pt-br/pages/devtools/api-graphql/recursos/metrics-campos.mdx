...
permalink: /documentacao/devtools/graphql/reference/campos-gql-real-time-metrics/
meta_tags: >-
...
:::tip
Você pode usar outros parâmetros para filtrar e consultar dados mais específicos. Leia mais sobre [filtragem da GraphQL API](/pt-br/documentacao/devtools/graphql/reference/recursos/#filtrar).
:::
...
:::tip
Você pode usar outros parâmetros para filtrar e consultar dados mais específicos. Leia mais sobre [filtragem na API GraphQL](/pt-br/documentacao/devtools/graphql/reference/recursos/#filtrar).
:::
...
Os seguintes conjuntos de dados foram descontinuados. Recomenda-se utilizar os [novos conjuntos que substituiram eles](/pt-br/documentacao/devtools/graphql/reference/recursos/).
