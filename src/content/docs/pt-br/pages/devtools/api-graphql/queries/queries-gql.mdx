...
permalink: /documentacao/devtools/graphql/reference/queries/
meta_tags: >-
...
Para cada tipo de dados, você consultará com diferentes [conjuntos de dados da GraphQL](/pt-br/documentacao/devtools/graphql/reference/recursos/#conjuntos-de-dados).

:::tip[dica]
Confira os [limites da API GraphQL](/pt-br/documentacao/devtools/graphql/reference/limites/) para garantir que sua query é válida.
:::
...
Veja mais sobre [Como selecionar Top X queries com a GraphQL API](/pt-br/documentacao/devtools/graphql/guides/graphql-query-top-x/).
:::
...
Veja mais informações e exemplos no guia [Como realizar consultas agregando dados com a API GraphQL](/pt-br/documentacao/devtools/graphql/guides/graphql-dados-agregados/).
...
Dependendo do [tipo de campo de um conjunto de dados](/pt-br/documentacao/devtools/graphql/reference/recursos/#conjuntos-de-dados) que você está consultando, você poderá usar operadores diferentes:
