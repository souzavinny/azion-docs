...
permalink: /documentacao/devtools/mcp/reference/configuracao/
---
...
- [Explorar exemplos MCP](/pt-br/documentacao/devtools/mcp/reference/exemplos/)
- [Guia de solução de problemas](/pt-br/documentacao/devtools/mcp/reference/solucao-de-problemas/)
- [Desenvolvimento Local](/pt-br/documentacao/devtools/mcp/reference/desenvolvimento-local/)
- [Guia de Teste de Cache](/pt-br/documentacao/devtools/mcp/reference/teste-cache/)