...
permalink: /documentacao/devtools/terraform/reference/migration-v3-to-v4/
---
...
- **Token Pessoal**: Um [token pessoal](/pt-br/documentacao/account/reference/personal-tokens/) válido com permissões apropriadas
...
- [Documentação do Terraform Provider v1.x](/pt-br/documentacao/devtools/terraform/v1/) (Descontinuado)
