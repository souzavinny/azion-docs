...
permalink: /documentacao/devtools/terraform/reference/getting-started/
---
...
- Um [Personal Token](/pt-br/documentacao/account/reference/personal-tokens/) com permissões adequadas
...
- [Workloads](/pt-br/documentacao/devtools/terraform/reference/workloads/) - Aprenda sobre workloads
- [Applications](/pt-br/documentacao/devtools/terraform/reference/applications/) - Configure aplicações
- [Security](/pt-br/documentacao/devtools/terraform/reference/security/) - Configure firewall e WAF
- [Best Practices](/pt-br/documentacao/devtools/terraform/reference/best-practices/) - Boas práticas de uso
...
**Solução**: Verifique se o recurso existe na API v4. Alguns recursos da v3 foram removidos ou renomeados. Consulte o [Guia de Migração](/pt-br/documentacao/devtools/terraform/reference/migration-v3-to-v4/).
