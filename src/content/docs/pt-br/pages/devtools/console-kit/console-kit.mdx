...
Para uma configuração mais rápida, gere um [personal token](/pt-br/documentacao/account/guides/personal-tokens/) no [Azion Console](https://console.azion.com) da Azion e salve em um arquivo `.env.development`:
...
2. Configure seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) na CLI:
