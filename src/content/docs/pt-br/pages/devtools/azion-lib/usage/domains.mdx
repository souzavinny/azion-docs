...
permalink: /documentacao/devtools/lib/reference/domains/
meta_tags: >-
...
:::note
Nos exemplos a seguir, os métodos são chamados diretamente sem a criação de um `client`. Para obter mais informações sobre como interagir com serviços e produtos usando um `client`, consulte a documentação do [Azion Lib Client](/pt-br/documentacao/devtools/lib/reference/client/).
:::
