...
permalink: /documentacao/devtools/lib/reference/storage/
meta_tags: >-
...
<LinkButton link="/pt-br/documentacao/devtools/lib/" label="Saiba mais sobre as Azion Libraries" severity="secondary" />
...
:::note
Nos exemplos a seguir, os métodos são chamados diretamente sem a criação de um `client`. Para obter mais informações sobre como interagir com serviços e produtos usando um `client`, verifique a [documentação do cliente da Azion Lib](/pt-br/documentacao/devtools/lib/reference/client/).
:::
