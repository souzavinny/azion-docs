...
permalink: /documentacao/devtools/lib/reference/client/
meta_tags: >-
...
Para mais detalhes sobre operações KV, veja a [documentação da biblioteca KV](/pt-br/documentacao/devtools/lib/reference/kv/).
