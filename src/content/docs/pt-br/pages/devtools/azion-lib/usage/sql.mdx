...
permalink: /documentacao/devtools/lib/reference/sql/
meta_tags: >-
...
:::note
Nos exemplos a seguir, os métodos são chamados diretamente sem a criação de um `client`. Para mais informações sobre como interagir com serviços e produtos usando um `client`, verifique a [documentação do cliente Azion Lib](/pt-br/documentacao/devtools/lib/reference/client/).
:::
