...
permalink: /documentacao/architectures/live-streaming-delivery/live-streaming-delivery-com-hls/
meta_tags: >-
...
- [Applications](/pt-br/documentacao/build/applications/) permite que você construa aplicações na Azion Web Platform e entregue seu conteúdo.
  - [Cache](/pt-br/documentacao/build/applications/cache/) permite que você configure como sua aplicação armazena em cache o conteúdo para reduzir a latência e aumentar as taxas de transferência.
...
2. [Crie um domínio](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/#criar-um-dominio-com-a-azion) e [associe-o à aplicação](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/#vincular-um-dominio-personalizado-a-sua-application).
3. Configure [políticas de cache para HLS](/pt-br/documentacao/build/applications/cache/guides/implementar-cache-hls/) na aplicação.
...
- [Arquitetura de content delivery](/pt-br/documentacao/architectures/applications/content-delivery/)
