...
permalink: /documentacao/platform/compliance/governanca-risco-conformidade/
meta_tags: >-
...
- **Suporte e resposta a incidentes**: o [Security Response Team (SRT)](/pt-br/documentacao/services/security-response-team/) da Azion ajuda os clientes a gerenciar incidentes e monitorar a segurança para manter a conformidade contínua.
...
:::tip
Leia mais sobre o [Modelo de Responsabilidade Compartilhada](/pt-br/documentacao/platform/shared-responsibility/) da Azion.
:::
...
- [Azion Console](/pt-br/documentacao/account/guides/getting-to-know-azion-console/): a interface da Azion onde você pode acessar todos os produtos disponíveis e suas configurações.
- [Firewall](/pt-br/documentacao/secure/firewall/): fornece as principais configurações para configurar sua instância, permitindo associá-la a domínios e ativar módulos para proteger usuários, aplicações e redes.
  ...
  - [Functions for Firewall](/pt-br/documentacao/secure/firewall/reference/functions/): construa aplicações serverless e orientadas a eventos, incluindo funções com seu próprio código-fonte de segurança.
- [Applications](/pt-br/documentacao/build/applications/): permite configurar uma aplicação para definir políticas de entrega e cache.
...
1. [Adicione usuários](/pt-br/documentacao/account/guides/users-management/), [defina permissões de equipe](/pt-br/documentacao/account/guides/teams-permissions/), e configure políticas de conta, como [Single Sign-On (SSO)](/pt-br/documentacao/account/reference/single-sign-on/), [Autenticação Multifator (MFA)](/pt-br/documentacao/account/reference/multi-factor-authentication/), ou [User Session timeout](/pt-br/documentacao/account/reference/user-session-timeout/).
2. [Crie uma aplicação](/pt-br/documentacao/build/applications/).
  ...
  - [Defina as principais configurações da aplicação](/pt-br/documentacao/build/applications/guides/definir-configuracoes-principais/).
3. [Crie um domínio](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/) e vincule à aplicação, e [aponte seu tráfego para a Azion](/pt-br/documentacao/secure/workloads/guides/apontar-dominio-para-a-azion/).
4. [Crie seus certificados digitais](/pt-br/documentacao/secure/workloads/guides/criar-certificado-digital/).
5. [Crie um firewall](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/) e selecione os domínios que você deseja proteger.
  - Defina quaisquer [regras do WAF](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/), [regras do Rules Engine](/pt-br/documentacao/secure/firewall/reference/rules-engine/), ou [functions](/pt-br/documentacao/secure/firewall/reference/functions/) que você deseja implementar e instanciar no firewall.
6. Monitore suas aplicações através dos [produtos Observe](/pt-br/documentacao/) e da página [Activity History](/pt-br/documentacao/account/reference/activity-history/).
...
- [SOC Compliance](/pt-br/documentacao/platform/compliance/soc/)
- [PCI Compliance](/pt-br/documentacao/platform/compliance/pci-dss-certification/)
- [Azion Security Response Team (SRT)](/pt-br/documentacao/services/security-response-team/)
