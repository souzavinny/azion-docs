...
permalink: /documentacao/architectures/artificial-intelligence/ai-agent-third-party-llm/
---
...
- **[Applications](https://www.azion.com/pt-br/documentacao/build/applications/)**: uma aplicação na Azion que hospeda o agente de IA.
- **[Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/)**: uma função serverless que contém a lógica do agente de IA.
...
Utilize o [LangGraph AI Agent Boilerplate](/pt-br/documentacao/marketplace/integrations/langgraph-ai-agent-boilerplate/) para montar rapidamente um backend em LangGraph e uma base SQL que garante persistência confiável de estado e documentos.
...
:::note
Este template usa [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/), [Functions](/pt-br/documentacao/build/applications/reference/functions/) e [SQL Database](/pt-br/documentacao/store/sql-database/), e pode gerar custos relacionados ao uso. Verifique a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
:::
---

## Guia de Referência

- [Guia de Referência - Como integrar um agente de IA a Third Party LLM](/pt-br/documentacao/marketplace/integrations/langgraph-ai-agent-boilerplate/)

## Documentação Relacionada

- [Object Storage](/pt-br/documentacao/store/object-storage/)
- [SQL Database](/pt-br/documentacao/store/sql-database/)
- [Como configurar um domínio personalizado](/pt-br/documentacao/build/workloads/guides/configurar-dominio/)
- [Azion GitHub App](/pt-br/documentacao/get-started/first-deploy/github/azion-github-app/)
- [Vector Search com SQL Database](/pt-br/documentacao/store/sql-database/guides/edge-sql-vector-search/)