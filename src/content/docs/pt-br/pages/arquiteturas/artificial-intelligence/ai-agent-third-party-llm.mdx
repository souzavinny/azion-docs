...
- **[Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/)**: uma função serverless que contém a lógica do agente de IA.
...
- [Como configurar um domínio personalizado](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/)
