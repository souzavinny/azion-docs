...
permalink: /documentacao/architectures/artificial-intelligence/ai-agent-seguranca-autonoma/
---
...
- **[Firewall](/pt-br/documentacao/secure/firewall/)**  
...
- **[Functions](/pt-br/documentacao/secure/firewall/reference/functions/)**  
...
- **[Applications](/pt-br/documentacao/build/applications/)**  (Opcional)
...
```
**Observação:** Certifique-se de que o modelo selecionado esteja disponível e configurado corretamente no ambiente Azion. Consulte os [modelos disponíveis](/pt-br/documentacao/build/ai-inference/reference/modelos/).
...
- [Implemente um assistente Copilot baseado em um agente de IA ReAct](/pt-br/documentacao/architectures/artificial-intelligence/agente-ai-assistente-copilot/)  
- [Automação da segurança com Edge Computing](/pt-br/documentacao/architectures/automacao-da-seguranca/automacao-da-seguranca-com-edge-computing/)  
...
- [Proteja aplicações web e APIs com WAAP](/pt-br/documentacao/architectures/firewall/web-application-and-api-protection-waap/)  
- [Produtos Observe da Azion](/pt-br/documentacao/observe/overview/)