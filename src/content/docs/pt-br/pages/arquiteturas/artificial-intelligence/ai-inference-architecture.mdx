...
permalink: /documentacao/architectures/artificial-intelligence/ai-inference-architecture/
---
...
Use o template [AI Inference Starter Kit](/pt-br/documentacao/marketplace/integrations/ai-inference-starter-kit/) para acelerar sua jornada e ter uma aplicação pronta com APIs compatíveis com OpenAI, rodando no edge.
...
Observações:
- Acesse a página dos [Modelos do AI Inference da Azion](/pt-br/documentacao/build/ai-inference/reference/modelos/) para ver mais modelos disponíveis.
...
- **[Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/)**: analise os eventos e obtenha insights sobre o desempenho de suas aplicações.
...
- [Guia do AI Inference Starter Kit](/pt-br/documentacao/marketplace/integrations/ai-inference-starter-kit/)
- [Modelos disponíveis](/pt-br/documentacao/build/ai-inference/reference/modelos/)
