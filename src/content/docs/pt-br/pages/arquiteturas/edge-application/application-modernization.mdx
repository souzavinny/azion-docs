...
permalink: /documentacao/architectures/applications/modernizacao-de-aplicacoes/
meta_tags: >-
...
1. Crie um aplicação:
    ...
    - Use [Azion CLI](/pt-br/documentacao/devtools/cli/reference/create/#edge-applications) para criar e implantar uma aplicação.
2. Crie um domínio e associe-o à aplicação: 
    - No Console, [crie um domínio](/pt-br/documentacao/build/workloads/guides/configurar-dominio/) usando o botão **+ Create** na homepage.
