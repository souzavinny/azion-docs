...
3. Configure políticas de cache: [configure uma política de cache](/pt-br/documentacao/build/cache/guides/cache-settings/) para imagens. A configuração recomendada é:
...
- [Primeiros passos com Image Processor](/pt-br/documentacao/build/image-processor/first-steps/).
