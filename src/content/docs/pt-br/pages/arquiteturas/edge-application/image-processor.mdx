...
permalink: /documentacao/architectures/applications/image-processor/
---
...
2. Crie um domínio e o associe à aplicação: 
    - No [Console](https://console.azion.com), [crie um domínio](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/) usando o botão **+ Create** na barra de navegação superior.
...
3. Configure políticas de cache: [configure uma política de cache](/pt-br/documentacao/build/applications/cache/guides/cache-settings/) para imagens. A configuração recomendada é:
...
4. Aplique políticas de cache em cenários específicos: use Rules Engine para [aplicar políticas específicas com base em várias condições](/pt-br/documentacao/build/applications/guides/rules-engine/). Crie e modifique as regras:
...
6. Aponte o domínio para Azion: [atualize suas configurações de DNS](/pt-br/documentacao/secure/workloads/guides/migrar-ns-para-a-azion/) para apontar o registro CNAME do seu domínio para o endpoint Azion fornecido para o seu domínio.
7. Teste e monitore: depois de configurar sua entrega de conteúdo, teste a entrega de conteúdo para garantir que está funcionando conforme esperado e [monitore o acesso de entrada](/pt-br/documentacao/).
...
- [Primeiros passos com Image Processor](/pt-br/documentacao/build/applications/image-processor/first-steps/).
