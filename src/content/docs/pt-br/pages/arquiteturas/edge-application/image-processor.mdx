...
2. Crie um domínio e o associe à aplicação: 
    - No [Console](https://console.azion.com), [crie um domínio](/pt-br/documentacao/build/workloads/guides/configurar-dominio/) usando o botão **+ Create** na barra de navegação superior.
...
3. Configure políticas de cache: [configure uma política de cache](/pt-br/documentacao/build/applications/guides/cache-settings/) para imagens. A configuração recomendada é:
...
6. Aponte o domínio para Azion: [atualize suas configurações de DNS](/pt-br/documentacao/build/workloads/guides/migrar-ns-para-a-azion/) para apontar o registro CNAME do seu domínio para o endpoint Azion fornecido para o seu domínio.
...
- [Primeiros passos com Image Processor](/pt-br/documentacao/build/applications/guides/image-processor/).
