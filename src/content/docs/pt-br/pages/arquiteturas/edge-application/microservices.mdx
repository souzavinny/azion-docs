...
description: >-
  ...
  microsserviços.
permalink: /documentacao/architectures/applications/aplicacoes-microsservicos/
meta_tags: >-
...
1. Crie uma aplicação:
    ...
    - Use a [Azion CLI](/en/documentation/devtools/cli/reference/create/#edge-applications) para criar e implantar uma aplicação.
...
3. Crie um domínio e associe-o à aplicação:
    - No Console, [crie um domínio](/en/documentation/build/workloads/guides/configure-a-domain/) usando o botão **+ Create** na página inicial.
...
- [Compatibilidade com APIs Web no Azion Runtime](/en/documentation/build/functions/runtime-apis/frameworks-compatibility/)
- [Compatibilidade com Node.js no Azion Runtime](/en/documentation/build/functions/runtime-apis/compatibility/node/)
