...
permalink: /documentacao/architectures/applications/content-delivery/
meta_tags: >-
...
- [Applications](/pt-br/documentacao/build/applications/): crie uma aplicação para configurar políticas de entrega e cache, criar regras para automatizar atribuições de políticas de cache com base no tipo de conteúdo e determinar como o conteúdo é armazenado em cache.
    - [Cache](/pt-br/documentacao/build/applications/reference/cache/): add-on global para armazenar conteúdo no edge.
    - [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/): usado para personalizar regras de otimização de cache e chaves e cookies de cache com base em padrões estabelecidos.
    - [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/): uma ferramenta para configurar os cenários em que uma política de cache específica é aplicada.
    - [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/): que permite a manipulação de imagens através da linha de requisição.
