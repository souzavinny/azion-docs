...
description: >-
  ...
  cibernéticos.
permalink: /documentacao/architectures/firewall/web-application-and-api-protection-waap/
meta_tags: >-
...
- [Firewall](/pt-br/documentacao/secure/firewall/): fornece as configurações principais para configurar sua instância e associá-la a domínios e ativar módulos.
    - [DDoS Protection](/pt-br/documentacao/secure/ddos-protection/): detecta e mitiga ataques DDoS e DoS quando ativado.
...
- [Applications](/pt-br/documentacao/build/applications/): executa sua aplicação na Azion Web Platform.
...
- [Crie um firewall](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/) e associe-o ao domínio configurado, para que todas as regras de segurança se apliquem a esse domínio específico.
    - Ative o módulo de DDoS Protection.
    - Ative o módulo de Web Application Firewall.
    - Ative o módulo de Network Shield.
- [Crie um conjunto de regras WAF](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/).
    - Configure os tipos de ameaça e níveis de sensibilidade.
- [Crie uma network list no Network Shield](/pt-br/documentacao/secure/network-shield/guides/blocklists-enderecos-ip-edge/).
...
- [Crie regras no Rules Engine do Firewall](/pt-br/documentacao/secure/firewall/guides/trabalhar-com-rules-engine/).
    - Configure o comportamento **Set WAF Rule Set**.
    - Configure os critérios de rede.
    - Configure os critérios de [Request URI](/pt-br/documentacao/marketplace/integrations/bot-manager-lite/#configure-o-rules-engine).

## Documentação relacionada

- Utilize os produtos [Observe da Azion](/pt-br/documentacao/) para monitorar a entrega de sua aplicação, o tráfego recebido e como suas lógicas de segurança estão sendo aplicadas e com quais requisições.
