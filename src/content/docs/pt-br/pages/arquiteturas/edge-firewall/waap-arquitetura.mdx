...
- Utilize os produtos [Observe da Azion](/pt-br/documentacao/observe/overview/) para monitorar a entrega de sua aplicação, o tráfego recebido e como suas lógicas de segurança estão sendo aplicadas e com quais requisições.
