...
permalink: /documentacao/architectures/firewall/prevencao-fraudes-online/
meta_tags: >-
...
- [Applications](/pt-br/documentacao/build/applications/): permite criar aplicações que executam na Azion Global Infrastructure.
  - [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/): usado para personalizar regras de otimização de cache, chaves de cache e cookies com base em padrões estabelecidos.
  - [Cache](/pt-br/documentacao/build/applications/reference/cache/): add-on global para armazenar conteúdo em cache no edge da rede.
  - [Functions for Applications](/pt-br/documentacao/build/applications/reference/functions/): permite criar aplicações serverless baseadas em eventos, no edge da rede, mais próximas dos usuários.
  - [Rules Engine for Applications](/pt-br/documentacao/build/applications/reference/rules-engine/):  permite configurar cenários onde políticas específicas são aplicadas, proporcionando controle granular sobre a entrega.  
- [Firewall](/pt-br/documentacao/secure/firewall/): fornece configurações principais para configurar sua instância, permitindo associá-la a domínios e ativar módulos para proteger usuários, aplicações e redes.
  - [DDoS Protection](/pt-br/documentacao/secure/ddos-protection/): detecta e mitiga ataques DDoS e DoS.
  ...
  - [Functions no Firewall](/pt-br/documentacao/secure/firewall/reference/functions/): crie aplicações serverless baseadas em eventos no edge da rede, incluindo funções com seu próprio código-fonte de segurança.
  - [Rules Engine para Firewall](/pt-br/documentacao/secure/firewall/reference/rules-engine/): permite configurar cenários onde políticas específicas são aplicadas, proporcionando controle granular sobre a entrega.
- Integrações do [Marketplace da Azion](/pt-br/documentacao/marketplace/reference/marketplace/) e integrações personalizadas:
   - Proteção contra bot.
...
- [Observe suite](/pt-br/documentacao/observe/overview/): monitore e rastreie o tráfego por meio de [Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/), [Real-Time Events](/pt-br/documentacao/observe/real-time-events/) e [Data Stream](/pt-br/documentacao/observe/data-stream/).

---

## Implementação

1. [Crie uma aplicação](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/) e faça o deploy no edge.
2. Configure suas integrações personalizadas com a plataforma da Azion.
  - Por exemplo, IdP para gerenciamento de usuários via protocolo [SAML](/pt-br/documentacao/account/guides/sso-google-saml/) ou [SCIM](/pt-br/documentacao/account/guides/microsoft-entra-provisionamento-automatizado-de-usuarios/).
3. [Configure a aplicação](/pt-br/documentacao/build/applications/guides/definir-configuracoes-principais/), definindo origens, cache e outras configurações essenciais.
  - [Configure um domínio personalizado](/pt-br/documentacao/build/applications/reference/domains/) para sua aplicação.
  - [Defina os critérios e comportamentos](/pt-br/documentacao/build/applications/reference/rules-engine/) das regras do Rules Engine. Por exemplo:
...
4. [Crie e configure um firewall](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/).
  - [Defina os critérios e comportamentos](/pt-br/documentacao/secure/firewall/guides/instanciar-functions/) das regras do Rules Engine. Por exemplo:
  ...
  - [Instancie functions](/pt-br/documentacao/secure/firewall/guides/instanciar-functions/) e [integrações](/pt-br/documentacao/marketplace/reference/integracoes/#edge-firewall-functions).
...
6. [Monitore sua aplicação](/pt-br/documentacao/observe/data-stream/guides/monitorar-aplicacoes/) e refine as regras.

---

## Documentação relacionada

- [Reforce a segurança cibernética com a solução avançada de WAAP da Azion](/pt-br/documentacao/architectures/firewall/web-application-and-api-protection-waap/)
- [Proteja suas aplicações com uma solução de gerenciamento de bots](/pt-br/documentacao/architectures/gerenciamento-de-bots/proteja-edge-applications-com-bot-management/)
- [Proteja sua aplicação](/pt-br/documentacao/secure/firewall/guides/proteja-aplicacao/)
- [Proteja sua infraestrutura](/pt-br/documentacao/secure/firewall/guides/proteja-infraestrutura/)
- [Proteja seu DNS](/pt-br/documentacao/secure/firewall/guides/proteja-dns/)
- [Implemente um perímetro de segurança em torno do seu API Gateway](/pt-br/documentacao/architectures/api-gateways/implementar-seguranca-api-gateways/)
- [Acelere a modernização da segurança com edge computing](/pt-br/documentacao/architectures/modernizacao-da-seguranca/modernizacao-da-seguranca-com-edge-computing/)
- [Simplifique sua jornada e proteja seu negócio com automação de segurança](/pt-br/documentacao/architectures/automacao-da-seguranca/automacao-da-seguranca-com-edge-computing/)
- [Fortaleça a Governança, Risco e Conformidade (GRC) em sua organização](/pt-br/documentacao/platform/compliance/governanca-risco-conformidade/)
