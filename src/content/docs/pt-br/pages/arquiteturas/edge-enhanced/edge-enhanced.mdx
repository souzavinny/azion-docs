...
- [Applications](/pt-br/documentacao/build/applications/): configure uma aplicação para definir políticas de entrega e cache, criar regras para automatizar atribuições de políticas de cache com base no tipo de conteúdo e determinar como o conteúdo é armazenado em cache.
    - [Functions](/pt-br/documentacao/build/applications/functions/): permite criar aplicações serverless orientadas a eventos, no edge da rede, mais próximas dos usuários.
...
2. [Crie uma function](/pt-br/documentacao/build/applications/functions/#implementation) e [instancie](/pt-br/documentacao/build/functions/guides/instanciar-functions/) na aplicação recém-criada.
3. Crie um domínio e associe-o à aplicação:
    - No Console, [crie um domínio](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/) usando o botão **+ Create** na página inicial.
