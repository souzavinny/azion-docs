...
2. [Crie uma function](/pt-br/documentacao/build/functions/#implementation) e [instancie](/pt-br/documentacao/build/functions/guides/instanciar-functions/) na aplicação recém-criada.
