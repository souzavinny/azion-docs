...
Crie um workload no Azion Console e associe seu domínio customizado. Veja [Documentação de Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/).
