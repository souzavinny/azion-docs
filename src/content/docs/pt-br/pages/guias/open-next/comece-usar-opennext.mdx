...
permalink: /documentacao/build/functions/guides/como-comecar/
meta_tags: >-
...
Veja [Problemas Conhecidos](/pt-br/documentacao/build/functions/runtime-apis/frameworks-suportados/nextjs/#problemas-conhecidos) para mais detalhes.
...
Isso executa sua aplicação localmente, simulando a plataforma Azion. Veja [Solução de Problemas](/pt-br/documentacao/build/functions/guides/troubleshooting/) para dicas de depuração e monitoramento de logs.
...
- Veja [Problemas Conhecidos](/pt-br/documentacao/build/functions/runtime-apis/frameworks-suportados/nextjs/#problemas-conhecidos) para acessar notas de configuração importantes.
- Veja [Solução de Problemas](/pt-br/documentacao/build/functions/guides/troubleshooting/) para dicas de desenvolvimento local, logs e depuração.
- Explore [Exemplos](/pt-br/documentacao/build/functions/runtime-apis/frameworks-suportados/nextjs/#exemplos) para projetos iniciais e templates.
