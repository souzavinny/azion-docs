...
permalink: /documentacao/build/functions/guides/troubleshooting/
meta_tags: >-
...
Consulte [a documentação da Azion sobre limites de função](/pt-br/documentacao/build/applications/reference/functions/#limites) para restrições de tamanho atualizadas.
...
Se você estiver usando um framework como o Next.js, assegure-se de que seu processo de build não sobrescreva ou ignore essas variáveis. Para mais informações, veja [o guia da Azion sobre variáveis de ambiente](/pt-br/documentacao/build/functions/runtime-apis/functions/environment-variables/).
