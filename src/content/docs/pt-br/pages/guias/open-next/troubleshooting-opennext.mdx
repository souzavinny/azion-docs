...
Consulte [a documentação da Azion sobre limites de função](/pt-br/documentacao/build/applications/functions/#limites) para restrições de tamanho atualizadas.
