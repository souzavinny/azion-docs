...
permalink: /documentacao/devtools/graphql/guides/consultar-top-attacks-com-graphql/
...
:::tip
Para saber mais sobre os campos disponíveis, consulte a documentação sobre os [Campos da API GraphQL do Real-Time Metrics](/pt-br/documentacao/devtools/graphql/reference/campos-gql-real-time-metrics/#httpmetrics-edge-applications-waf).
:::
