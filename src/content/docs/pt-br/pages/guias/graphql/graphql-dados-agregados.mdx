...
permalink: /documentacao/devtools/graphql/guides/graphql-dados-agregados/
...
Para saber mais sobre como consultar dados agregados com a GraphQL API, visite a [página de documentação](/pt-br/documentacao/devtools/graphql/reference/recursos/#conjuntos-de-dados).
