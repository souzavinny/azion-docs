...
permalink: /documentacao/devtools/graphql/guides/consultar-dados-de-uso-edge-functions-com-graphql/
...
Este guia explica como consultar as métricas de tempo de computação e invocações de Functions usando o [GraphiQL Playground](/pt-br/documentacao/devtools/graphql/reference/playground/).
...
:::tip
Para saber mais sobre os campos disponíveis, consulte a documentação dos [Campos da GraphQL API de Consumption](/pt-br/documentacao/devtools/graphql/reference/campos-gql-consumption/).
:::
