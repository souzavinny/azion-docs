...
permalink: /documentacao/devtools/graphql/guides/query-dados-connected-users-com-graphql/
...
:::note
Para obter esses dados, você deve ter a subscrição do [Live Ingest da Azion](https://www.azion.com/pt-br/solucoes/live-streaming/) e usar a [GraphQL API](/pt-br/documentacao/devtools/graphql/reference/overview/).
:::
