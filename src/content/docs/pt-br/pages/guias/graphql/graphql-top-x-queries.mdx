...
permalink: /documentacao/devtools/graphql/guides/graphql-query-top-x/
...
Para selecionar Top X queries através da [GraphQL API](/pt-br/documentacao/devtools/graphql/reference/overview/), siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/devtools/graphql/guides/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/events/graphql`.
