...
permalink: /documentacao/devtools/graphql/guides/graphql-metadados/
menu_namespace: graphqlMenu
---

Metadados são informações relevantes sobre o escopo de dados da [GraphQL API](/pt-br/documentacao/devtools/graphql/reference/overview/). Eles nos auxiliam a compreender melhor o relacionamento e a sua utilidade no processo de consulta.

Para consultar os metadados da GraphQL API, siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/devtools/graphql/guides/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/metrics/graphql`.
...
Para saber mais sobre os conjuntos de dados disponíveis para consulta com a GraphQL API, visite a [página de documentação](/pt-br/documentacao/devtools/graphql/reference/recursos/#conjuntos-de-dados).
