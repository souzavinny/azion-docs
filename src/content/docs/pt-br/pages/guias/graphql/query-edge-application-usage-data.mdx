...
permalink: /documentacao/devtools/graphql/guides/consultar-dados-de-uso-edge-application-com-graphql/
...
Usando o [GraphiQL Playground](/pt-br/documentacao/devtools/graphql/reference/playground/), você pode consultar dados relacionados a:
...
:::tip
Para saber mais sobre os campos disponíveis, consulte a documentação [Campos da API GraphQL de Consumption](/en/documentation/devtools/graphql/reference/gql-consumption-fields/).
:::
