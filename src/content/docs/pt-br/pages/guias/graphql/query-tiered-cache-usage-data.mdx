...
permalink: /documentacao/devtools/graphql/guides/consultar-dados-de-uso-tiered-cache-com-graphql/
...
Este guia explica como consultar o total de dados transferidos pelo Tiered Cache usando o [GraphiQL Playground](/pt-br/documentacao/devtools/graphql/reference/playground/).
...
:::tip
Para saber mais sobre os campos disponíveis, consulte a documentação [Campos da API GraphQL de Consumption](/pt-br/documentacao/devtools/graphql/reference/campos-gql-consumption/).
:::
