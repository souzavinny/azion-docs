...
permalink: /documentacao/build/applications/guides/live-ingest-boas-praticas/
...
- Conhecimento básico sobre [Applications](/pt-br/documentacao/build/applications/) e [Cache Settings](/pt-br/documentacao/build/applications/reference/cache-settings/).
- Familiaridade com o [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/) para Applications.
...
Consulte a documentação sobre [como consultar dados de usuários conectados com GraphQL API](/pt-br/documentacao/devtools/graphql/guides/query-dados-connected-users-com-graphql/) para implementar dashboards de monitoramento personalizados.
...
Consulte o guia [Implementar cache HLS](/pt-br/documentacao/build/applications/cache/guides/implementar-cache-hls/) para instruções detalhadas.
...
- [Live Streaming Delivery com HLS](/pt-br/documentacao/architectures/live-streaming-delivery/live-streaming-delivery-com-hls/)
- [Implementar cache HLS](/pt-br/documentacao/build/applications/cache/guides/implementar-cache-hls/)
- [Applications](/pt-br/documentacao/build/applications/)
...
- [Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/)
- [Consultar dados de usuários conectados com GraphQL API](/pt-br/documentacao/devtools/graphql/guides/query-dados-connected-users-com-graphql/)