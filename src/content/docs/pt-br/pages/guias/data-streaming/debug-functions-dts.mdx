...
permalink: /documentacao/observe/data-stream/guides/debugging-functions-data-stream/
---
...
Antes de analisar o processo, você deve aplicar o código de debugging. Descubra mais em [Debugging functions](/pt-br/documentacao/build/functions/runtime-apis/debugging/).
...
1. Em **Workloads** > **Options**, selecione **All Current and Future Workloads** ou **Filter Workloads**. Veja mais sobre cada opção em [Como associar workloads no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-associar-workloads/).
...
8. Em **Options**, selecione **Filter Domains** ou **All Domains**. Veja mais sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-associar-dominios/).
