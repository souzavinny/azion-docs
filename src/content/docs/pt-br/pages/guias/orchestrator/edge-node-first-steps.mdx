...
permalink: /documentacao/deploy/orchestrator/guides/edge-node-primeiros-passos/
...
:::tip
Para gerar o personal token necessário para autenticar seus edge nodes, siga os passos da [documentação de Personal Token](/pt-br/documentacao/account/guides/personal-tokens/).
:::
