...
permalink: /documentacao/secure/certificate-manager/guides/mtls/
...
Mais informações sobre requisitos, certificados digitais, Trusted CA e como mTLS funciona na Azion estão disponíveis na página [Suporte para mTLS](/pt-br/documentacao/secure/certificate-manager/reference/mtls/).
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Certificate Manager**, na seção **Edge Libraries**.
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/rules-engine/" label="consulte a lista de variáveis disponíveis" severity="secondary" />
