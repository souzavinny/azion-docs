...
permalink: /documentacao/get-started/migrate/akamai/
---
...
| :------------------------ | :-------- | :---------------- |
| **Ion** | Otimização de performance, confiabilidade e experiência de usuário em escala. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/applications/reference/application-accelerator/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) |
| **API Acceleration** | Otimização de performance e confiabilidade para APIs. | [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/applications/reference/application-accelerator/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) |
| **Adaptive Media Delivery** | Entrega de vídeo online em larga escala. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Download Delivery** | Entrega otimizada de arquivos grandes, softwares, jogos e assets de mídia. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Dedicated Delivery** | Entrega de mídia de alto volume com requisitos de offload de origem. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) |
| **Image & Video Manager** | Otimização de imagens e vídeos para dispositivos e condições de rede. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/reference/image-processor/) |
| **Media Services Live** | Fluxos de ingestão e entrega de vídeo ao vivo. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) |
| **Cloudlets** | Aplicações de política para redirects, load balancing, controle de tráfego, phased releases e tratamento de requisições. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) + [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) + [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) |
| **Cloud Wrapper** | Camada privada de cache para offload de origem e redução de egress. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/build/connectors/reference/origin-shield/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) |
| **EdgeWorkers** | Functions JavaScript para customizar comportamento de request e response. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **Akamai Functions** | Execução serverless distribuída para aplicações e workloads de IA. | [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
...
| **API Gateway** | Registro, roteamento, entrega e proteção de APIs. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Rules Engine](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) + [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) |
| **App Platform** | Deployment gerenciado de aplicações em containers. | [Orchestrator](https://www.azion.com/pt-br/documentacao/deploy/orchestrator/) |
...
| **App & API Protector** | Proteção de aplicações e APIs contra vulnerabilidades, abuso e ameaças distribuídas. | [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) + [Web Application Firewall](https://www.azion.com/pt-br/documentacao/secure/waf/) + [DDoS Protection](https://www.azion.com/pt-br/documentacao/secure/ddos-protection/) + [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) |
| **Firewall for AI** | Proteção para aplicações LLM e aplicações orientadas por IA. | [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) + [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) |
| **API Security** | Descoberta, monitoramento e proteção de APIs. | [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) + [Web Application Firewall](https://www.azion.com/pt-br/documentacao/secure/waf/) + [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
...
| **Account Protector** | Proteção contra abuso de contas e ataques de credenciais. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) + [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) |
| **Content Protector** | Proteção contra scraping e acesso automatizado abusivo. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) + [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) + [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) |
| **Input Validation Cloudlet** | Controles de validação de formulários e requisições. | [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) + [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/rules-engine/) |
| **Request Control Cloudlet** | Controle de acesso e filtragem de requisições. | [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) + [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/rules-engine/) |
| **Cloud Firewall** | Controles de segurança de rede para workloads em cloud. | [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) + [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) |
| **Prolexic Solutions** | Proteção DDoS para ambientes de infraestrutura, cloud, híbridos e on-premises. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/secure/ddos-protection/) + [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) |
| **Forward Rewrite Cloudlet** | Reescrita de URL para URLs limpas e semânticas. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **Phased Release Cloudlet** | Controle de release gradual e rollback. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **API Prioritization Cloudlet** | Priorização de tráfego de API. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/applications/reference/application-accelerator/) |
| **Application Load Balancer Cloudlet** | Load balancing de aplicações para performance e disponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) |
| **Audience Segmentation Cloudlet** | Segmentação por cookies, A/B testing e padrões de afinidade de sessão. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **Edge Redirector Cloudlet** | Gerenciamento centralizado de redirects. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **NodeBalancers** | Load balancing L4 e L7 para instâncias de compute. | [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) |
...
| **Global Traffic Management** | Direcionamento de tráfego para otimização de performance e prevenção de indisponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) + [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/) |
...
| **mPulse** | Real-user monitoring e analytics de experiência digital. | [Edge Pulse](https://www.azion.com/pt-br/documentacao/observe/edge-pulse/) + [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/) |
...
* [Applications](https://www.azion.com/pt-br/documentacao/build/applications/)
* [Applications Main Settings](https://www.azion.com/pt-br/documentacao/build/applications/reference/main-settings/)
...
* [Referência de JavaScript Runtime APIs](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/javascript/)
...
* [Origin Shield](https://www.azion.com/pt-br/documentacao/build/connectors/reference/origin-shield/)
...
* [Advanced Cache Key](https://www.azion.com/pt-br/documentacao/build/applications/guides/advanced-cache-key/)
* [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/)
...
* [Como implementar cache HLS para entrega de streaming ao vivo](https://www.azion.com/pt-br/documentacao/build/applications/guides/implementar-cache-hls/)
...
* [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/applications/reference/application-accelerator/)
...
* [Crie um domínio customizado da Azion](https://www.azion.com/pt-br/documentacao/build/workloads/guides/criar-dominio-personalizado-azion/)
...
* [WAF Rule Sets](https://www.azion.com/pt-br/documentacao/secure/waf/reference/rule-sets/) 
...
* [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/)
* [Como configurar Edge DNS](https://www.azion.com/pt-br/documentacao/secure/firewall/guides/edge-dns-definir-main-settings/)
* [Como adicionar registros em uma DNS](https://www.azion.com/pt-br/documentacao/secure/firewall/guides/adicionar-registros/)
* [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/)
...
* [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/)
* [Como acessar o Object Storage usando o protocolo S3](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/s3-protocol-para-object-storage/)
* [Como criar e modificar um bucket](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/criar-e-modificar-um-bucket/)
* [Como fazer upload e download de objetos](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/)
...
* [Como gerenciar KV Store com Functions](https://www.azion.com/pt-br/documentacao/store/kv-store/guides/gerenciar-com-funcoes/)
* [KV Store API](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/kv-store/)
* [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/)
...
* [Como criar e consultar dados no SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/criar-tabelas-edge-sql/)
* [Importe dados para SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/importar-dados-edge-sql/)
* [Como construir uma API RESTful com Functions e SQL Database](https://www.azion.com/pt-br/documentacao/build/functions/guides/api-restful-edge-functions-edge-sql/)
...
* [Grafana plugin dashboards customizados](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/guides/azion-plugin-grafana/)
...
* [Como configurar as main settings do Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/)
* [Como selecionar variáveis no Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/data-stream-selecionar-variaveis/)
...
* [Primeiros passos do Edge Pulse](https://www.azion.com/pt-br/documentacao/observe/edge-pulse/quickstart/)
* [Como analisar dados de navegação do Edge Pulse](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/analisar-dados-navegacao/)
...
* [Entenda logs do Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/entender-logs/)
...
* Revise [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/) para monitorar performance.
