...
| **API Acceleration** | Otimização de performance e confiabilidade para APIs. | [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/applications/application-accelerator/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) |
| **Adaptive Media Delivery** | Entrega de vídeo online em larga escala. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
...
| **Image & Video Manager** | Otimização de imagens e vídeos para dispositivos e condições de rede. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/image-processor/) |
| **Media Services Live** | Fluxos de ingestão e entrega de vídeo ao vivo. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) |
| **Cloudlets** | Aplicações de política para redirects, load balancing, controle de tráfego, phased releases e tratamento de requisições. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) + [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) + [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) |
| **Cloud Wrapper** | Camada privada de cache para offload de origem e redução de egress. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) |
| **EdgeWorkers** | Functions JavaScript para customizar comportamento de request e response. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
| **Akamai Functions** | Execução serverless distribuída para aplicações e workloads de IA. | [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
...
| **Forward Rewrite Cloudlet** | Reescrita de URL para URLs limpas e semânticas. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
...
| **API Prioritization Cloudlet** | Priorização de tráfego de API. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/applications/application-accelerator/) |
| **Application Load Balancer Cloudlet** | Load balancing de aplicações para performance e disponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) |
...
| **NodeBalancers** | Load balancing L4 e L7 para instâncias de compute. | [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) |
...
| **Global Traffic Management** | Direcionamento de tráfego para otimização de performance e prevenção de indisponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) + [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/) |
...
* [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/)
...
* [Advanced Cache Key](https://www.azion.com/pt-br/documentacao/build/applications/cache/guides/advanced-cache-key/)
* [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/)
...
* [Como implementar cache HLS para entrega de streaming ao vivo](https://www.azion.com/pt-br/documentacao/build/applications/cache/guides/implementar-cache-hls/)
...
* [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/applications/application-accelerator/)
...
* [Crie um domínio customizado da Azion](https://www.azion.com/pt-br/documentacao/secure/workloads/guides/criar-dominio-personalizado-azion/)
