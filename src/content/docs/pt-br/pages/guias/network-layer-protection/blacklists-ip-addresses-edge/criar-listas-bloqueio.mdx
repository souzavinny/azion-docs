...
permalink: /documentacao/secure/network-shield/guides/blocklists-enderecos-ip-edge/
...
<br/>
<LinkButton link="/pt-br/documentacao/secure/network-shield/" label="saiba mais sobre o Network Shield" severity="secondary" />
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Network Lists** na seção **Edge Libraries**, .
