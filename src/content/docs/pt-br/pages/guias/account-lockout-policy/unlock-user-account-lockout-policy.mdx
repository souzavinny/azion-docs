...
permalink: /documentacao/account/guides/desbloquear-account-lockout-policy/
...
<LinkButton link="/pt-br/documentacao/account/reference/account-lockout-policy/" label="Saiba mais sobre Account Lockout Policy" severity="secondary" target="_blank" />
...
Para desbloquear manualmente um usuário, você precisa [obter os logs](/pt-br/documentacao/account/guides/account-lockout-policy-logs/) e confirmar os dados sobre o usuário. Em seguida, execute o desbloqueio. Para isso:
