...
permalink: /documentacao/secure/waf/guides/como-verificar-modo-do-seu-waf/
...
- Um [firewall](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/), com os domínios de suas applications associados.
- Esse firewall deve ter pelo menos um [WAF Rule Set](/pt-br/documentacao/secure/waf/reference/rule-sets/) configurado.

Se você não tiver um WAF Rule Set configurado, leia [este guia]](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/) para mais detalhes.
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Firewall**, na seção **Secure**.
