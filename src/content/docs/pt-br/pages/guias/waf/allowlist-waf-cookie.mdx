...
permalink: /documentacao/secure/waf/guides/waf-rules-para-cookie-especifico/
...
- Um [firewall existente](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/) com o **WAF** ativado.
...
Ainda na página **WAF Rules**, você deve criar um **conjunto de regras WAF** secundário incluindo uma [Custom Allowed Rule](/pt-br/documentacao/secure/waf/reference/custom-allowed-rules/). Para fazer isso:
...
3. No menu suspenso **Rule ID**, selecione uma regra. 
    ...
    - Saiba mais sobre todas as [regras internas disponíveis](/pt-br/documentacao/secure/waf/reference/custom-allowed-rules/). 
...
:::tip
Você pode usar os [produtos Observe da Azion](/pt-br/documentacao/observe/overview/) para monitorar a entrega da sua aplicação, o tráfego de entrada e como suas lógicas de segurança estão sendo aplicadas e com quais requisições.
:::