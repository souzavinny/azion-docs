...
:::tip
Você pode usar os [produtos Observe da Azion](/pt-br/documentacao/) para monitorar a entrega da sua aplicação, o tráfego de entrada e como suas lógicas de segurança estão sendo aplicadas e com quais requisições.
:::