...
permalink: /documentacao/build/applications/guides/cross-origin-resource-sharing-cors/
...
A primeira etapa para permitir o acesso CORS é criar uma regra no [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/):
...
Para ativar o CORS em uma configuração para servidores de origem específicos, você precisará ativar o módulo [Application Accelerator](/pt-br/documentacao/build/applications/application-accelerator/):
