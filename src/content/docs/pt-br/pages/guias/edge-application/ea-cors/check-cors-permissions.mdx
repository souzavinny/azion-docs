...
Para ativar o CORS em uma configuração para servidores de origem específicos, você precisará ativar o módulo [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/):
