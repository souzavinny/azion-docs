...
permalink: /documentacao/build/applications/guides/erros-cors/
...
Para resolver esse tipo de erro, você precisa configurar o browser no **Azion Console** usando o [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/).
...
1. Acesse o [Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Applications**.
