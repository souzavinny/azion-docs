...
2. Garanta que o DNS para tal hostname esteja apontado para Azion (ver [Como apontar seu domínio para a Azion](/pt-br/documentacao/build/workloads/guides/apontar-dominio-para-a-azion/)). Isso deve ser feito no seu serviço provedor de DNS.
