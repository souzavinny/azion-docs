...
permalink: /documentacao/secure/certificate-manager/guides/como-gerar-um-certificado-lets-encrypt-via-api/
...
A API V4 da Azion oferece emissão e renovação de [certificados Let's Encrypt](/pt-br/documentacao/secure/certificate-manager/) utilizando dois métodos de validação:
...
Para mais informações sobre essas atualizações visite a documentação de [Certificate Manager](/pt-br/documentacao/secure/certificate-manager/).
...
3. Crie ou use um Token existente de API (ver [Primeiros passos com a API da Azion](https://www.azion.com/pt-br/documentacao/devtools/api/quickstart/)).
...
2. Garanta que o DNS para tal hostname esteja apontado para Azion (ver [Como apontar seu domínio para a Azion](/pt-br/documentacao/secure/workloads/guides/apontar-dominio-para-a-azion/)). Isso deve ser feito no seu serviço provedor de DNS.
...
3. Uma vez que o DNS responda corretamente, crie ou use um Token existente de API (ver [Primeiros passos com a API da Azion](https://www.azion.com/pt-br/documentacao/devtools/api/quickstart/)).
