...
permalink: /documentacao/build/applications/guides/ip-original-header/
...
Para isolar o IP do cliente, você deve adicioná-lo a um novo cabeçalho usando a [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/) para **Applications**.
