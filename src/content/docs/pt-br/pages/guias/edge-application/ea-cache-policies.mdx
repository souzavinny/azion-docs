...
permalink: /documentacao/build/applications/guides/cache-settings/
...
:::tip
Para configurar políticas de cache para conteúdo dinâmico, consulte o guia [Como configurar a Advanced Cache Key para Applications](/pt-br/documentacao/build/applications/guides/advanced-cache-key/).
:::
...
5. Se você optou por substituir as configurações de cache, adicione o **Maximum TTL** desejado em segundos.
   - Nesse momento, você também pode personalizar configurações de cache para conteúdo dinâmico relacionadas à funcionalidade [Advanced Cache Key](/pt-br/documentacao/build/applications/reference/application-accelerator/#advanced-cache-key).
