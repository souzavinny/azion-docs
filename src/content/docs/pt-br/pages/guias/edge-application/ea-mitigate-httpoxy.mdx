...
permalink: /documentacao/build/applications/guides/como-mitigar-vulnerabilidade-httpoxy/
menu_namespace: applicationsMenu
---

HTTPoxy é uma vulnerabilidade de aplicações web causada por requisições HTTP nocivas. Você pode configurar sua application para mitigar HTTPOxy usando o [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/).
