...
permalink: /documentacao/build/applications/guides/advanced-cache-key/
...
:::tip
Se você quiser definir configurações de cache para conteúdo estático, consulte o guia [Como configurar políticas de cache para Applications](/pt-br/documentacao/build/applications/guides/cache-settings/).
:::
