...
2. Selecione a application que deseja configurar ou [crie uma nova](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/).
3. Na aba **Main settings**, na seção **Modules**, ative a opção **Application Accelerator**.
4. Clique no botão **Save**.

:::tip
Se você quiser definir configurações de cache para conteúdo estático, consulte o guia [Como configurar políticas de cache para Applications](/pt-br/documentacao/build/cache/guides/cache-settings/).
:::
