...
permalink: /documentacao/build/applications/guides/configurar-portas/
...
Existem instruções separadas para API v3 usando configurações de [Origins legados](/pt-br/documentacao/build/applications/reference/origins/) e API v4 usando o novo produto [Connectors](/pt-br/documentacao/secure/connectors/).
...
6. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Workloads**.
...
:::tip
Você também pode usar o **Rules Engine** e [criar uma regra](/pt-br/documentacao/build/applications/guides/trabalhar-com-rules-engine/) utilizando o comportamento **Redirect HTTP to HTTPS** para prevenir que seus usuários acessem a aplicação através do protocolo HTTP dado um cenário específico.
:::
...
5. Em **Address**, digite o nome do host de sua origem. Exemplo: `yourorigin.com`.
6. Clique no botão **Save**.
7. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Workloads**.
...
2. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Connectors**.
