...
Existem instruções separadas para API v3 usando configurações de [Origins legados](/pt-br/documentacao/secure/connectors/reference/origins/) e API v4 usando o novo produto [Connectors](/pt-br/documentacao/secure/connectors/).
