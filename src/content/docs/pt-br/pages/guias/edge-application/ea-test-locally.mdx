...
- Uma application e um [domínio configurado](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/).
- Conexão à internet.
...
:::caution[atenção]
Para que a associação ocorra, você deve primeiro [configurar seu domínio](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/) e adicionar pelo menos um CNAME de domínio personalizado à lista de CNAMEs do domínio.
:::
