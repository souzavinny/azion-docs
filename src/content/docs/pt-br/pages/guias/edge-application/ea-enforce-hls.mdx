...
permalink: /documentacao/build/applications/cache/guides/implementar-cache-hls/
---
...
2. Obtenha os detalhes de uma application existente usando o [comando list](/pt-br/documentacao/devtools/cli/reference/list/): `azion list edge-application --details`
...
- Defina os comportamentos de **Advanced Cache Key** de acordo com suas necessidades. Verifique as flags opcionais para o [comando create](/pt-br/documentacao/devtools/cli/reference/create/#flags-opcionais-3).
...
:::tip
Leia mais sobre a configuração de [cache settings](/pt-br/documentacao/build/applications/reference/cache-settings/) para suas applications.
:::
