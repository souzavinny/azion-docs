...
permalink: /documentacao/build/applications/guides/gzip-compression/
...
Você pode habilitar a compressão gzip para qualquer application usando o [Rules Engine para Applications](/pt-br/documentacao/build/applications/reference/rules-engine/).
