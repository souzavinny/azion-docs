...
permalink: /documentacao/marketplace/integrations/videofront-player/
---
...
2. Selecione na lista a aplicação à qual você deseja adicionar a integração ou [crie uma nova application](/pt-br/documentacao/build/applications/quickstart/).
