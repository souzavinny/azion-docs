...
permalink: /documentacao/marketplace/integrations/bot-manager-lite/
...
:::note
Bot Manager Lite é uma [integração com uma versão lite](/pt-br/documentacao/marketplace/integrations/bot-manager-lite/) disponível no Marketplace.
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Marketplace**.
...
:::caution[Atenção]
Se qualquer produto ou módulo for ativado, pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para obter mais informações.
:::
...
Para saber mais informações e detalhes sobre os argumentos, visite a documentação do [Azion Bot Manager Lite](/pt-br/documentacao/secure/bot-manager/reference/lite/#configure-a-funcao).
...
Para saber mais, visite a documentação do [Azion Bot Manager Lite](/pt-br/documentacao/secure/bot-manager/reference/lite/#configuracao-de-actions).
—--
...
:::caution[Atenção]
Se um produto ou módulo for ativado, poderá gerar custos relacionados ao uso. Verifique a [página de preços](/pt-br/documentacao/platform/pricing/) para obter mais informações.
:::
...
:::tip
Consulte a documentação para dar seus [Primeiros passos do Data Stream](/pt-br/documentacao/observe/data-stream/quickstart/) e [Configurar as main settings do Data Stream](/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/).
:::
...
:::tip
Consulte a documentação para dar seus [Primeiros passos do Real⁠-⁠Time Events](/pt-br/documentacao/observe/real-time-events/quickstart/) e [entender os logs do Real⁠-⁠Time Events](/pt-br/documentacao/observe/data-stream/guides/entender-logs/).
:::
...
:::tip
Consulte o guia [Como fazer debug de regras criadas com o Rules Engine](/pt-br/documentacao/build/applications/guides/debug-regras/) para instruções detalhadas sobre como consultar o `traceback` via Data Stream, Real-Time Events e GraphQL API.
:::

import LinkButton from 'azion-webkit/linkbutton';

<LinkButton link="/pt-br/documentacao/secure/firewall/guides/gerenciar-bots/" label="consulte o guia sobre gerenciar bots" outlined />
