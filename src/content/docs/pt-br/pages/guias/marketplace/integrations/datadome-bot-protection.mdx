...
permalink: /documentacao/marketplace/integrations/datadome-bot-protection/
---
...
:::caution[Aviso]
A ativação de módulos pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais detalhes.
:::
