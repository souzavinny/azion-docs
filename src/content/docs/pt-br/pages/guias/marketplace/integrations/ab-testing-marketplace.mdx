...
permalink: /documentacao/marketplace/integrations/ab-testing-marketplace/
---
...
Para utilizar a integração **A/B Testing** fornecida pelo **Marketplace**, acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) e vá para o **Marketplace**.
...
Sendo uma [Applications function](/pt-br/documentacao/marketplace/reference/integracoes/#edge-application-functions), a **Teste A/B** executa tarefas e serviços no edge, empregando uma application *existente*.

:::tip
Para criar uma nova application, acesse a [seção Build](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/).
:::
