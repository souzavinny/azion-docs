...
permalink: /documentacao/marketplace/integrations/ipqs-phone-validation/
---
...
1. Acesse [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Marketplace**.
...
:::caution[Atenção]
Se um produto ou módulo estiver ativado, pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para obter mais informações.
:::
...
- [Referência de Integrações da Azion](/pt-br/documentacao/marketplace/reference/integracoes/)
- [Como instalar uma integração](/pt-br/documentacao/marketplace/reference/instalar-uma-integracao/)
- [Como atualizar uma integração](/pt-br/documentacao/marketplace/reference/atualizar-uma-integracao/)
