...
permalink: /documentacao/marketplace/integrations/process-request-data-into-headers/
---
...
Para terminar o processo, é preciso configurar o [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/) indicando o *behavior* e o *criteria* necessários para executar a integração.
