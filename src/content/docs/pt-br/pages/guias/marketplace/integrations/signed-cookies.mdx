...
permalink: /documentacao/marketplace/integrations/signed-cookies/
---
...
:::tip
Para criar uma nova application, acesse a [seção Build](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/) para obter mais detalhes sobre este tópico.
:::
