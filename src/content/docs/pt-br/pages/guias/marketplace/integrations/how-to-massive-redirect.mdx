...
permalink: /documentacao/marketplace/integrations/massive-redirect-integration/
---
...
:::tip
Para criar uma nova application, acesse a [seção de Build](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/).
:::
...
:::tip
Você pode obter informações e referências mais detalhadas no artigo [Configure redirecionamento em massa para migração de domínios](/pt-br/documentacao/marketplace/integrations/massive-redirect-integration/).
:::
