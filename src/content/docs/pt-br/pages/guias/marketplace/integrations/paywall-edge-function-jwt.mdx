...
permalink: /documentacao/build/functions/guides/paywall-function-jwt/
...
Para criar uma função JWT, você pode consultar o guia sobre [Como instalar a integração JWT através do Marketplace da Azion](/pt-br/documentacao/marketplace/integrations/jwt/).
