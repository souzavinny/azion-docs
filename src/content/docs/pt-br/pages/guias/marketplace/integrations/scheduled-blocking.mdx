...
permalink: /documentacao/marketplace/integrations/scheduled-blocking/
---
...
Para concluir, você precisa configurar o [Rules Engine](/pt-br/documentacao/secure/firewall/reference/rules-engine/) para determinar o *behavior* (comportamento) e os *criteria* (critérios) para executar a função.
