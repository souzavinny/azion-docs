...
permalink: /documentacao/marketplace/integrations/content-targeting-integration/
---
...
:::tip
Se você ainda na tiver uma aplicação, acesse a [seção Build](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/) para saber como criar uma nova application.
:::
