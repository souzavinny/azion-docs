...
permalink: /documentacao/marketplace/integrations/hello-world/
---
...
:::note
Se você não tiver uma application previamente criada, voce deve [criar uma nova](/pt-br/documentacao/build/applications/). Depois de criar sua primeira application, volte ao **Marketplace** e reinicie o processo de instalação.
:::
...
4. Por último, você pode verificar as [permissões necessárias pelo Marketplace](/pt-br/documentacao/marketplace/reference/permissions-marketplace/) para atualizar a aplicação selecionada.
