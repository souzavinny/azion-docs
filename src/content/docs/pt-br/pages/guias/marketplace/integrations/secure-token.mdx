...
permalink: /documentacao/marketplace/integrations/secure-token/
---
...
Para concluir, você precisa configurar o [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/) para determinar o *behavior* e os *criteria* para executar a função.
