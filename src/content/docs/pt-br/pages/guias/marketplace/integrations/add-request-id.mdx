...
permalink: /documentacao/marketplace/integrations/add-request-id-header/
---
...
:::caution[Atenção]
Se um produto ou módulo estiver ativado, pode gerar custos relacionados ao uso, como a execução de funções. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para obter mais informações.
:::
