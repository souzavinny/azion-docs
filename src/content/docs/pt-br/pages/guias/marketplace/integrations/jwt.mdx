...
permalink: /documentacao/marketplace/integrations/jwt/
---
...
Para colocá-la em uso, você deverá configurar no [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/) tanto o critério (*criteria*) como o comportamento (*behavior*) da sua função.
...
:::tip
Veja exemplos casos de uso para essa integração acessando a página [Configure um paywall com Function JWT](/pt-br/documentacao/build/functions/guides/paywall-function-jwt/).
:::
