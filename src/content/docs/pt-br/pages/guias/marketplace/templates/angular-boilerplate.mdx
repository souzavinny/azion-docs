...
permalink: /documentacao/marketplace/integrations/angular-boilerplate/
---
...
- Uma janela pop-up será aberta para confirmar a instalação da [Azion GitHub App](/pt-br/documentacao/get-started/first-deploy/github/azion-github-app/), uma ferramenta que conecta sua conta do GitHub com a plataforma da Azion.
...
Com a integração do [framework adapter Azion Bundler](/pt-br/documentacao/build/functions/runtime-apis/compatibility/), a aplicação passa por um processo de criação otimizado, enfatizando o melhor desempenho e a eficiência.
