...
permalink: /documentacao/marketplace/integrations/dynamic-static-file-optimization-template/
---
...
- O template usa [Application Accelerator](/pt-br/documentacao/build/application-accelerator/) e [Image Processor](/pt-br/documentacao/build/image-processor/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) e o [Azion Image Processor](/pt-br/documentacao/build/cache/guides/cache-settings/) para obter mais detalhes.
:::
