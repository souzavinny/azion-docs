...
permalink: /documentacao/marketplace/integrations/upstash-rate-limiting/
---
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) para obter mais detalhes. Para perguntas específicas relacionadas ao Upstash, consulte a [documentação do Upstash](https://docs.upstash.com/).
:::
