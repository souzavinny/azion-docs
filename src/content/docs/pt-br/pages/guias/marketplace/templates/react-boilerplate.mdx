...
permalink: /documentacao/marketplace/integrations/react-boilerplate/
---
...
Com a integração do [framework adapter Azion Bundler](/pt-br/documentacao/build/functions/runtime-apis/compatibility/), a aplicação passa por um processo de criação otimizado, enfatizando no melhor desempenho e a eficiência.
