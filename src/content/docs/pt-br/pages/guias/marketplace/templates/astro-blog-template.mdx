...
permalink: /documentacao/marketplace/integrations/astro-blog-starter-kit/
---
...
- O template usa [Functions](/pt-br/documentacao/build/applications/reference/functions/) e [Image Processor](/pt-br/documentacao/build/applications/reference/image-processor/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
