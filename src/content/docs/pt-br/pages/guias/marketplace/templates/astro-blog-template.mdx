...
- O template usa [Functions](/pt-br/documentacao/build/functions/) e [Image Processor](/pt-br/documentacao/build/image-processor/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
