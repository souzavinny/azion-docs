...
permalink: /documentacao/marketplace/integrations/upstash-geolocation-edgedeploy/
---
...
- O template usa [Application Accelerator](/pt-br/documentacao/build/applications/application-accelerator/) e [Functions](/pt-br/documentacao/build/applications/functions/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
...
:::tip[dica]
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) para obter mais detalhes. Para perguntas específicas relacionadas ao Upstash, consulte a [documentação](https://docs.upstash.com/) do Upstash.
:::
