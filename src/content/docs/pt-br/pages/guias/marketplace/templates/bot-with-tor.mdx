...
- O template usa [Functions](/pt-br/documentacao/build/functions/) e [Network Shield](/pt-br/documentacao/secure/network-shield/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
...
<LinkButton link="/pt-br/documentacao/secure/workloads/reference/domains/" label="consulte o guia para configurar domínios" severity="secondary" />
