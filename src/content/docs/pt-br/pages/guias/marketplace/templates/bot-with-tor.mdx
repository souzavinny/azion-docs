...
permalink: /documentacao/marketplace/integrations/bot-manager-lite-and-tor-block-starter-kit/
---
...
- O template usa [Functions](/pt-br/documentacao/build/applications/reference/functions/) e [Network Shield](/pt-br/documentacao/secure/network-shield/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
...
Leia mais sobre [Como observar e calibrar regras](/pt-br/documentacao/secure/firewall/guides/gerenciar-bots/#usar-real-time-events-para-observar-e-calibrar-regras).
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/domains/" label="consulte o guia para configurar domínios" severity="secondary" />
