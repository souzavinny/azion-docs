...
- O template usa [Functions](/pt-br/documentacao/build/applications/reference/functions/), [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/) e [Cache](/pt-br/documentacao/build/applications/reference/cache/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
