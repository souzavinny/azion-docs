...
permalink: /documentacao/marketplace/integrations/edgesql-starter-kit/
---
...
- O template usa [Functions](/pt-br/documentacao/build/functions/), [Application Accelerator](/pt-br/documentacao/build/application-accelerator/) e [Cache](/pt-br/documentacao/build/cache/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
...
1. Conecte a Azion com sua conta do GitHub.
    - Uma janela pop-up será aberta para confirmar a instalação do [Azion GitHub App](/pt-br/documentacao/get-started/first-deploy/github/azion-github-app/), uma ferramenta que conecta sua conta do GitHub com a plataforma da Azion.
...
:::tip
Leia a documentação para mais detalhes sobre [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) e o [gerenciamento de banco de dados EdgeSQL](/pt-br/documentacao/store/sql-database/guides/gerenciar-bancos-dados-edge-sql/).
:::
