...
- O template usa [Functions](/pt-br/documentacao/build/applications/functions/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
- 
---
...
<LinkButton link="/pt-br/documentacao/secure/workloads/guides/configurar-dominio/" label="consulte o guia para configurar domínios" severity="secondary" /> 
