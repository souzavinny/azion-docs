...
permalink: /documentacao/marketplace/integrations/bot-manager-lite-integration-kit/
---
...
- Ter um [firewall](/pt-br/documentacao/secure/firewall/) criada em sua conta.
    - Durante a configuração do template, você deve informar o ID do seu firewall existente para adicionar a instância do Bot Manager Lite. Se o ID não existir, a execução falhará. Verifique [como configurar e editar um firewall](/pt-br/documentacao/secure/firewall/guides/proteja-aplicacao/#passo-1-defina-as-configuracoes-principais).
- Instalar a versão mais recente do **Bot Manager Lite**.
    - Vá no [Marketplace da Azion](https://console.azion.com/marketplace) e clique no botão **Install**. Consulte o guia sobre [Como instalar o Azion Bot Manager Lite](/pt-br/documentacao/marketplace/integrations/bot-manager-lite/) para mais detalhes.
...
- O template usa [Functions](/pt-br/documentacao/build/applications/reference/functions/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
- 
---
...
Você pode calibrar e editar os argumentos para ajustar melhor a integração às suas necessidades. Leia mais sobre [Como gerenciar bots](/pt-br/documentacao/secure/firewall/guides/gerenciar-bots/).
...
Leia mais sobre [Como usar Real-Time Events para observar e calibrar regras](/pt-br/documentacao/secure/firewall/guides/gerenciar-bots/#usar-real-time-events-para-observar-e-calibrar-regras).
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) para obter mais detalhes.
:::
