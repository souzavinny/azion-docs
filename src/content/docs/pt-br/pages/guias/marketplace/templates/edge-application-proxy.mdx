...
- O template usa [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/) e [Functions](/pt-br/documentacao/build/applications/reference/functions/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/platform/pricing/) para mais informações.
...
- **Custom Host Header**: em alguns casos, pode ser necessário adicionar informações do host no cabeçalho da solicitação para recuperar informações da origem. Esta variável é usada para esse propósito.
    - Exemplo: `${host}`. Saiba mais sobre o host header e como customizá-lo no [documentação de Origins](/pt-br/documentacao/build/applications/reference/origins/#host-header).
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) e [como configurar políticas de cache para Applications](/pt-br/documentacao/build/applications/guides/cache-settings/#criando-uma-regra-para-ignorar-o-cache-da-origem) para obter mais detalhes.
:::
