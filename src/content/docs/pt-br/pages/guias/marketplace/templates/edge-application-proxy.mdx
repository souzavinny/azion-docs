...
permalink: /documentacao/marketplace/integrations/edge-application-proxy-template/
---
...
- **Behavior** (comportamento): then [Set Origin](/pt-br/documentacao/build/applications/reference/rules-engine/#set-origin) `Default Origin`, [Bypass Cache](/pt-br/documentacao/build/applications/reference/rules-engine/#bypass-cache) e [Forward Cookies](/pt-br/documentacao/build/applications/reference/rules-engine/#forward-cookies).
...
- **Custom Host Header**: em alguns casos, pode ser necessário adicionar informações do host no cabeçalho da solicitação para recuperar informações da origem. Esta variável é usada para esse propósito.
    - Exemplo: `${host}`. Saiba mais sobre o host header e como customizá-lo no [documentação de Origins](/pt-br/documentacao/secure/connectors/reference/origins/#host-header).
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) e [como configurar políticas de cache para Applications](/pt-br/documentacao/build/cache/guides/cache-settings/#criando-uma-regra-para-ignorar-o-cache-da-origem) para obter mais detalhes.
:::
