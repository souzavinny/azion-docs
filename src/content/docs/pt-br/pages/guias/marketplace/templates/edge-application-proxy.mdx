...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) e [como configurar políticas de cache para Applications](/pt-br/documentacao/build/applications/cache/guides/cache-settings/#criando-uma-regra-para-ignorar-o-cache-da-origem) para obter mais detalhes.
:::
