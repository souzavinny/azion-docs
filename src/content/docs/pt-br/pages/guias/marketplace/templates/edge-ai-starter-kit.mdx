...
:::tip
Leia a documentação sobre [gerenciamento de functions](/pt-br/documentacao/build/applications/functions/) para mais detalhes.
:::
...
<LinkButton link="/pt-br/documentacao/secure/workloads/guides/configurar-dominio/" label="Ir para o guia de configuração de domínio" severity="secondary" />
