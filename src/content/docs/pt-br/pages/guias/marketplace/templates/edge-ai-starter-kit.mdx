...
permalink: /documentacao/marketplace/integrations/ai-inference-starter-kit/
---
...
Este exemplo usa o [modelo Qwen3](/pt-br/documentacao/build/ai-inference/reference/modelos/qwen3-30ba3b/). Você pode alterar o modelo e os parâmetros da requisição de acordo com suas preferências. 
Verifique a [referência de modelos de AI](/pt-br/documentacao/build/ai-inference/reference/modelos/) para obter mais informações sobre os modelos disponíveis e como usá-los em sua aplicação.


:::tip
Leia a documentação sobre [gerenciamento de functions](/pt-br/documentacao/build/applications/reference/functions/) para mais detalhes.
:::
