...
permalink: /documentacao/get-started/first-deploy/github/importar-um-projeto-existente-do-github/
---
...
- Uma conta na Azion.
    - Consulte o guia [Como criar uma conta na Azion](/pt-br/documentacao/account/reference/criar-uma-conta/) para mais informações.
...
Confira [alguns exemplos de código](https://github.com/aziontech/azion-samples/tree/dev/templates) para fazer fork e usar como boilerplate, se desejar. Saiba mais sobre [Compatibilidade com web frameworks](/pt-br/documentacao/build/functions/runtime-apis/compatibility/) na documentação.
...
- Um pop-up será aberto para confirmar a instalação da [Azion GitHub App](/pt-br/documentacao/get-started/first-deploy/github/azion-github-app/), uma ferramenta que conecta sua conta do GitHub com a plataforma da Azion.
...
- Você pode usá-las como variáveis globais e editá-las ou transformá-las em segredos na página de **Variables**. Leia a documentação sobre [Variables](/pt-br/documentacao/build/applications/guides/environment-variables/) para mais detalhes.
...
:::tip
Leia a documentação sobre [gerenciamento de applications](/pt-br/documentacao/build/applications/quickstart/) para mais detalhes.
:::
...
<LinkButton link="/pt-br/documentacao/build/workloads/guides/configurar-dominio/" label="saiba mais sobre domínios" severity="secondary" /> 
