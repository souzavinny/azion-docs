...
permalink: /documentacao/get-started/first-deploy/github/azion-github-app/
---
...
- Ao [implantar um modelo](/pt-br/documentacao/marketplace/reference/templates/) ou [importar um projeto do GitHub](/pt-br/documentacao/get-started/first-deploy/github/importar-um-projeto-existente-do-github/).
...
:::tip
Para mais detalhes, consulte os guias [Como importar um projeto existente para construir uma application](/pt-br/documentacao/get-started/first-deploy/github/importar-um-projeto-existente-do-github/) e [Como criar uma conta na Azion](/pt-br/documentacao/account/reference/criar-uma-conta/).
:::
