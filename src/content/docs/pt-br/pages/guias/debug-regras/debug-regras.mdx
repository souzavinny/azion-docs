...
permalink: /documentacao/build/applications/guides/debug-regras/
---
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/rules-engine/" label="Saiba mais sobre Rules Engine" severity="secondary" />

Existem instruções separadas usando configurações de [Domains legados](/pt-br/documentacao/build/applications/reference/domains/) e usando o novo produto [Workloads](/pt-br/documentacao/produtos/secure/workloads).
...
:::tip
Consulte a [documentação da GraphQL API](/pt-br/documentacao/devtools/graphql/reference/overview/) para mais informações.
:::

Para consultar os dados sobre regras disponibilizados pela **GraphQL API**, siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/devtools/graphql/guides/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/events/graphql`.
...
Para saber mais sobre como consultar dados com a **API GraphQL**, visite a [página de documentação](/pt-br/documentacao/devtools/graphql/reference/recursos/#conjuntos-de-dados).
...
8. Em **Workloads**, selecione entre **Filter Workloads** ou **All Current and Future Workloads**. Veja mais sobre cada opção em [Como associar workloads no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-associar-workloads/).
...
8. Em **Domains**, selecione **Filter Domains** ou **All Current and Future Domains**. Veja mais sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-associar-dominios/).
