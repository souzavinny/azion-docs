...
permalink:  /documentacao/account/guides/sso-microsoft-entra-saml/
...
Alternativamente, você pode habilitar o **Provisionamento Automatizado de Usuários**, usando o protocolo SCIM. Confira o [guia passo a passo](/pt-br/documentacao/account/guides/microsoft-entra-provisionamento-automatizado-de-usuarios/) para obter mais informações.
...
1. [De volta ao Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/), acesse a página SSO Management.
