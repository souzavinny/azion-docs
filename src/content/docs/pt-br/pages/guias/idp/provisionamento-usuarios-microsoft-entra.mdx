...
permalink: /documentacao/account/guides/microsoft-entra-provisionamento-automatizado-de-usuarios/
...
:::note
Você precisa de um token pessoal da Azion para executar as seguintes tarefas. Leia a documentação para [criar um novo token pessoal](/pt-br/documentacao/account/guides/personal-tokens/).

Você também precisa [configurar o Microsoft Entra como um Provedor de Identidade (IdP) para a Azion](/pt-br/documentacao/account/guides/sso-microsoft-entra-saml/) previamente.
:::
...
:::note 
O IdP deve estar ativo e vinculado à aplicação SAML correta no console do Microsoft Entra. Confira o guia sobre como usar [Microsoft Entra custom SAML app as an IdP for Azion](/pt-br/documentacao/account/guides/sso-microsoft-entra-saml/) para mais detalhes sobre essa configuração.
:::
