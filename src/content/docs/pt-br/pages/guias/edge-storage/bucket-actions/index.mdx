...
Para fazer o download de um objeto, execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` por seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/), `<bucket_name>` pelo nome do seu bucket, e `<object_key>` pela chave criada para o objeto:
...
1. Accesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Functions**.
...
:::note
Consulte a referência [Object Storage API](/pt-br/documentacao/build/functions/runtime-apis/storage/) para mais detalhes sobre as funções disponíveis para outros tipos de requisições.
:::
