...
permalink: /documentacao/store/object-storage/guides/criar-e-modificar-um-bucket/
...
<LinkButton link="/pt-br/documentacao/store/object-storage/" label="saiba mais sobre Object Storage" severity="secondary" />

Consulte o guia [Como fazer upload e download de objetos de um bucket](/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/) para realizar operações com objetos.
...
Execute a seguinte requisição `POST` em seu terminal, substituindo `[TOKEN VALUE]` por seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e o valor de `name` pelo nome do bucket para criar um novo bucket de leitura:
...
Agora, você pode utilizar o bucket para [fazer o upload e download de objetos](/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/).

---

## Atribua permissão de leitura-escrita para bucket

Execute a seguinte requisição `PATCH` em seu terminal, substituindo `[TOKEN VALUE]` por seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e `bucket_name` pelo nome do bucket para atribuir a permissão de leitura e escrita:
...
Execute a seguinte requisição `DELETE` em seu terminal, substituindo `[TOKEN VALUE]` por seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e `bucket_name` pelo nome do bucket que você deseja remover:
