...
:::note
Os passos a seguir descrevem a configuração no Azion Console. Para informações detalhadas sobre essas interfaces, consulte a [referência de Functions](/pt-br/documentacao/build/functions/) e a [documentação do Firewall](/pt-br/documentacao/secure/firewall/).
:::
