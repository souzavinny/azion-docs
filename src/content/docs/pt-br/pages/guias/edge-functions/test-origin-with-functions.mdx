...
- Um [domínio](/pt-br/documentacao/build/workloads/guides/configurar-dominio/) associado à sua aplicação
...
:::note
Os passos a seguir descrevem a configuração no Azion Console. Para informações detalhadas sobre essas interfaces, consulte a [referência de Functions](/pt-br/documentacao/build/applications/reference/functions/) e a [documentação do Firewall](/pt-br/documentacao/secure/firewall/).
:::
...
- [Referência de Functions](/pt-br/documentacao/build/applications/reference/functions/)
