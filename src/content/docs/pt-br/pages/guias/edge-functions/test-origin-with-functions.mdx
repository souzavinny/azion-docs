...
permalink: /documentacao/build/functions/guides/test-origin-with-functions/
...
- Uma [application](/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/) com tráfego de produção
- Um [domínio](/pt-br/documentacao/secure/workloads/guides/configurar-dominio/) associado à sua aplicação
- Uma origem de teste (seu novo software) acessível via HTTPS
- Um [Firewall](/pt-br/documentacao/secure/firewall/) associado ao seu domínio
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/getting-to-know-azion-console/) > **Functions**.
...
:::note
Os passos a seguir descrevem a configuração no Azion Console. Para informações detalhadas sobre essas interfaces, consulte a [referência de Functions](/pt-br/documentacao/build/applications/functions/) e a [documentação do Firewall](/pt-br/documentacao/secure/firewall/).
:::

1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/getting-to-know-azion-console/) > **Firewall**.
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/getting-to-know-azion-console/) > **Real-Time Events**.
...
- [Referência de Functions](/pt-br/documentacao/build/applications/functions/)
- [Rules Engine para Firewall](/pt-br/documentacao/secure/firewall/reference/rules-engine/)
