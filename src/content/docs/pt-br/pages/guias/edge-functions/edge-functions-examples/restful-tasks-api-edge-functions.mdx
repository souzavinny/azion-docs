...
permalink: /documentacao/build/functions/guides/api-restful-edge-functions-edge-sql/
...
Para mais detalhes, veja a [documentação do SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/).
...
<LinkButton link="/pt-br/documentacao/store/sql-database/" text="Saiba mais sobre SQL Database" />
<LinkButton link="/pt-br/documentacao/build/applications/functions/" text="Saiba mais sobre Functions" />
