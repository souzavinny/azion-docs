...
permalink: /documentacao/build/functions/guides/aplicacao-browserless-functions/
...
<LinkButton link="/pt-br/documentacao/build/applications/guides/criar-uma-aplicacao/" text="Construa uma aplicação" />
