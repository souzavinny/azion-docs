...
<LinkButton link="/pt-br/documentacao/build/functions/reference/functions-instances/" label="Saiba mais sobre Functions para Applications" severity="secondary" />
