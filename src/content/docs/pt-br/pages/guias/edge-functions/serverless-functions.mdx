...
permalink: /documentacao/build/functions/guides/funcoes-serverless/
...
[Functions](/pt-br/documentacao/build/applications/functions/) é um módulo da Azion Web Platform que permite que você programe e execute funções serverless, sem o uso de servidores.

<LinkButton link="/pt-br/documentacao/build/applications/reference/functions-instances/" label="Saiba mais sobre Functions para Applications" severity="secondary" />
...
- Definir critérios de ativação no [Rules Engine](/pt-br/documentacao/build/applications/reference/rules-engine/).
...
:::tip
Consulte o guia [Como criar uma API com Functions e ChatGPT](/pt-br/documentacao/build/functions/guides/api-builder/) para obter um exemplo de uma função que pode ser executada em sua aplicação.
:::
