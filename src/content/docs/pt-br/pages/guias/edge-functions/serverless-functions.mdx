...
[Functions](/pt-br/documentacao/build/applications/reference/functions/) é um módulo da Azion Web Platform que permite que você programe e execute funções serverless, sem o uso de servidores.
