...
permalink: /documentacao/build/functions/guides/altcha/
...
Para finalizar, você deve configurar o [Rules Engine](/pt-br/documentacao/secure/firewall/reference/rules-engine/) para definir o comportamento e os critérios para executar o ALTCHA, via Bot Manager ou independentemente com Firewall.
...
Para que o fluxo do ALTCHA funcione corretamente, você também precisa criar uma regra no [Rules Engine da Application](/pt-br/documentacao/build/applications/reference/rules-engine/) que redirecione os usuários para o endpoint de verificação quando o desafio ainda não foi resolvido.
