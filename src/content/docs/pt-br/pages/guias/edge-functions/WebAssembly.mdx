...
Saiba mais sobre o processo necessário para a criação de uma [function](/pt-br/documentacao/build/applications/reference/functions/) que utiliza uma função originada de um arquivo [WebAssembly](https://webassembly.org/getting-started/developers-guide/).
