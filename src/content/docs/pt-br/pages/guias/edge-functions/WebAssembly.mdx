...
permalink: /documentacao/build/functions/guides/webassembly-na-plataforma-azion/
menu_namespace: applicationsMenu
og_image: >-
  /assets/docs/images/uploads/use-case_-creating-a-function-using-webassembly.png
---

Saiba mais sobre o processo necessário para a criação de uma [function](/pt-br/documentacao/build/applications/functions/) que utiliza uma função originada de um arquivo [WebAssembly](https://webassembly.org/getting-started/developers-guide/).
...
Agora, a função está pronta para ser instanciada em uma application. Veja como [instanciar e executar as funções em sua application](/pt-br/documentacao/build/applications/reference/functions-instances/).
