...
permalink: /documentacao/store/sql-database/guides/importar-dados-edge-sql/
...
- **SQL Database Shell instalado**: Certifique-se de que o SQL Database Shell está devidamente [instalado em seu sistema](/pt-br/documentacao/store/sql-database/guides/install-edge-sql-shell/).
