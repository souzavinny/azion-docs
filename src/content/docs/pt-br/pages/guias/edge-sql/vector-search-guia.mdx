...
permalink: /documentacao/store/sql-database/guides/edge-sql-vector-search/
...
<LinkButton link="/pt-br/documentacao/store/sql-database/reference/vector-search/" label="Saiba mais sobre o Vector Search" severity="secondary" target="_blank" />
...
- Gere um [personal token da Azion](/pt-br/documentacao/account/guides/personal-tokens/).
...
- Crie uma aplicação TypeScript. 
    - Como no exemplo, você pode usar a [Azion CLI](/pt-br/documentacao/devtools/cli/reference/init/) para criar uma aplicação Simple Typescript Router.
