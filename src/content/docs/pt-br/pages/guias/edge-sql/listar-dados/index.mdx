...
permalink: /documentacao/store/sql-database/guides/listando-dados-edge-functions-edge-sql/
...
- [O módulo de Functions habilitado](/pt-br/documentacao/build/applications/functions/).
- [Um Personal Token configurado e ativo](/pt-br/documentacao/account/guides/personal-tokens/).
...
<LinkButton link="/pt-br/documentacao/build/applications/reference/functions-instances/" label="ir para como instanciar functions na sua aplicação"  severity="secondary" />
