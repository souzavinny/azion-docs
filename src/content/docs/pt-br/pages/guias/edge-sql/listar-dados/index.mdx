...
<LinkButton link="/pt-br/documentacao/build/functions/reference/functions-instances/" label="ir para como instanciar functions na sua aplicação"  severity="secondary" />
