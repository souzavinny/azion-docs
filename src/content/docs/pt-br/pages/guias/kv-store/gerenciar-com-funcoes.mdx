...
permalink: /documentacao/store/kv-store/guides/gerenciar-com-funcoes/
menu_namespace: kvStoreMenu
---
...
<LinkButton link="/pt-br/documentacao/store/kv-store/" label="Ir para referência do KV Store" severity="secondary" />
...
- [Functions habilitadas](/pt-br/documentacao/build/applications/functions/) em sua Application.
...
<LinkButton link="/pt-br/documentacao/build/functions/guides/instanciar-functions/" label="Ir para como instanciar functions em sua aplicação" severity="secondary" />
...
- Explore as [Functions](/pt-br/documentacao/build/applications/functions/)
