...
permalink: /documentacao/devtools/mcp/guides/run-mcp-server/
---
...
Neste guia, criaremos uma [Function](/pt-br/documentacao/build/applications/reference/functions/) para executar o servidor MCP.
