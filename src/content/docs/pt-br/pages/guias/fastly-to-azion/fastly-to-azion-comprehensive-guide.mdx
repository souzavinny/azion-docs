...
| **Serviços Fastly** | Principal recurso de entrega para domínios, origens, caching, tratamento de requisições e versões de serviço. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/) |
| **Domains** | Hostnames associados a serviços Fastly. | [Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/) |
| **Hosts e origens** | Configuração de backend origin para serviços de entrega Fastly. | [Connectors](https://www.azion.com/pt-br/documentacao/secure/connectors/) |
| **Origin Shield / padrões de shielding** | Reduz tráfego na origem roteando cache misses por uma localização intermediária de shield. | [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/) |
...
| **Request settings** | Manipulação, encaminhamento e tratamento de requisições. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
...
| **Compute** | Plataforma de compute serverless que executa código customizado na rede da Fastly. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
| **Compute packages** | Código de aplicação empacotado e publicado no Fastly Compute. | [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) + [Azion CLI](https://www.azion.com/pt-br/documentacao/devtools/cli/) |
...
| **Cache Reservation** | Capacidade reservada de cache para conteúdo na Fastly. | [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/) |
...
| **Streaming Delivery** | Entrega de conteúdo de live streaming e video-on-demand. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Media Shield for Live** | Reduz tráfego na origem em fluxos de vídeo ao vivo. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/) |
| **Media Shield for VOD** | Reduz tráfego na origem em fluxos de video-on-demand. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/) |
| **Image Optimizer** | Serviço de transformação e otimização de imagens em tempo real. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/image-processor/) |
| **WebSockets** | Comunicação bidirecional e persistente para aplicações em tempo real. | [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/build/applications/reference/websocket/) + [WebSocket API](https://www.azion.com/pt-br/documentacao/runtime/api-reference/websocket/) |
| **Fanout** | Padrões de mensagem publish-subscribe na Fastly. | [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) + [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/build/applications/reference/websocket/) |
| **AI Accelerator** | Cache semântico e aceleração de tráfego para APIs de IA generativa. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) |
...
| **TLS Service Options** | Configuração TLS para servir sites e aplicações por HTTPS. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/) + [Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/) |
...
Crie um workload no Azion Console e associe seu domínio customizado. Consulte a [documentação de Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/).
