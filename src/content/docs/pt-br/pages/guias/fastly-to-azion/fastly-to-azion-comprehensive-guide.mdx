...
permalink: /documentacao/get-started/migrate/fastly/
---
...
| :------------------------ | :---------- | :---------------- |
| **Full-Site Delivery** | Entrega de sites, aplicações, APIs e tráfego mobile por meio de serviços Fastly. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **Serviços Fastly** | Principal recurso de entrega para domínios, origens, caching, tratamento de requisições e versões de serviço. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Workloads](https://www.azion.com/pt-br/documentacao/build/workloads/) |
| **Domains** | Hostnames associados a serviços Fastly. | [Workloads](https://www.azion.com/pt-br/documentacao/build/workloads/) |
| **Hosts e origens** | Configuração de backend origin para serviços de entrega Fastly. | [Connectors](https://www.azion.com/pt-br/documentacao/build/connectors/) |
| **Origin Shield / padrões de shielding** | Reduz tráfego na origem roteando cache misses por uma localização intermediária de shield. | [Origin Shield](https://www.azion.com/pt-br/documentacao/build/connectors/reference/origin-shield/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) |
| **Conditions** | Condições de request, cache e response na configuração de serviço Fastly. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) |
| **Request settings** | Manipulação, encaminhamento e tratamento de requisições. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **Response settings** | Comportamento de headers de resposta e entrega. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) |
...
| **Compute** | Plataforma de compute serverless que executa código customizado na rede da Fastly. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **Compute packages** | Código de aplicação empacotado e publicado no Fastly Compute. | [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) + [Azion CLI](https://www.azion.com/pt-br/documentacao/devtools/cli/) |
...
| **Cache Reservation** | Capacidade reservada de cache para conteúdo na Fastly. | [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) |
| **Cache APIs** | Padrões de interação programática com cache para aplicações Compute. | [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) + [Real-Time Purge](https://www.azion.com/pt-br/documentacao/build/applications/reference/real-time-purge/) |
| **Streaming Delivery** | Entrega de conteúdo de live streaming e video-on-demand. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Media Shield for Live** | Reduz tráfego na origem em fluxos de vídeo ao vivo. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/build/connectors/reference/origin-shield/) |
| **Media Shield for VOD** | Reduz tráfego na origem em fluxos de video-on-demand. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/build/connectors/reference/origin-shield/) |
| **Image Optimizer** | Serviço de transformação e otimização de imagens em tempo real. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/reference/image-processor/) |
| **WebSockets** | Comunicação bidirecional e persistente para aplicações em tempo real. | [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/build/applications/reference/websocket/) + [WebSocket API](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/websocket/) |
| **Fanout** | Padrões de mensagem publish-subscribe na Fastly. | [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) + [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/build/applications/reference/websocket/) |
| **AI Accelerator** | Cache semântico e aceleração de tráfego para APIs de IA generativa. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) + [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) |
...
| **Edge Rate Limiting** | Conta requisições e aplica ações quando limites são excedidos. | [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/rules-engine/) + [Functions para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/functions/) |
| **Fastly DDoS Protection** | Visibilidade e mitigação de DDoS. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/secure/ddos-protection/) + [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) |
| **Bot Management** | Detecta e responde a tráfego automatizado. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) + [Bot Manager Lite](https://www.azion.com/pt-br/documentacao/secure/bot-manager/reference/lite/) |
| **Certainly** | Autoridade certificadora da Fastly para certificados TLS. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/) |
| **Platform TLS** | Gerenciamento de certificados TLS e chaves via API. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/) + [Azion API](https://www.azion.com/pt-br/documentacao/devtools/api/quickstart/) |
| **TLS Service Options** | Configuração TLS para servir sites e aplicações por HTTPS. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/) + [Workloads](https://www.azion.com/pt-br/documentacao/build/workloads/) |
...
| **Domain Inspector** | Visibilidade e relatórios de tráfego em nível de domínio. | [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/) |
| **Origin Inspector** | Visibilidade e relatórios de respostas da origem. | [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/) + [Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/) |
...
| **Fastly API** | Gerenciamento programático de recursos Fastly. | [Azion API](https://www.azion.com/pt-br/documentacao/devtools/api/quickstart/) |
...
* [Environment Variables](https://www.azion.com/pt-br/documentacao/build/applications/guides/environment-variables/)
...
* [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/build/applications/reference/websocket/)
* [WebSocket API](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/websocket/)
* [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/)
* [Origin Shield](https://www.azion.com/pt-br/documentacao/build/connectors/reference/origin-shield/)
...
* [Modelos AI Inference](https://www.azion.com/en/documentation/build/ai-inference/reference/models/)
* [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/)
* [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/)
...
Crie um workload no Azion Console e associe seu domínio customizado. Consulte a [documentação de Workloads](https://www.azion.com/pt-br/documentacao/build/workloads/).
...
* [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/)
* [Como acessar Object Storage usando o protocolo S3](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/s3-protocol-para-object-storage/)
...
* [Upload e download de objetos](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/)
...
* [KV Store](https://www.azion.com/pt-br/documentacao/store/kv-store/)
* [Como gerenciar KV Store com Functions](https://www.azion.com/en/documentation/store/kv-store/guides/manage-with-functions/)
...
* [Analisar métricas](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/analisar-metricas/)
* [Dashboards customizados com plugin Grafana](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/guides/azion-plugin-grafana/)
...
* [Como configurar sampling no Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/configurar-sampling/)
...
* Revise [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/) para monitorar performance da aplicação.
