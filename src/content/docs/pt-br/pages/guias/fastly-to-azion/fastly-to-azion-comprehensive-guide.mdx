...
| **Origin Shield / padrões de shielding** | Reduz tráfego na origem roteando cache misses por uma localização intermediária de shield. | [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) |
...
| **Request settings** | Manipulação, encaminhamento e tratamento de requisições. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) |
...
| **Compute packages** | Código de aplicação empacotado e publicado no Fastly Compute. | [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [Azion CLI](https://www.azion.com/pt-br/documentacao/produtos/azion-cli/visao-geral/) |
...
| **Cache APIs** | Padrões de interação programática com cache para aplicações Compute. | [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Real-Time Purge](https://www.azion.com/pt-br/documentacao/build/cache/reference/real-time-purge/) |
| **Streaming Delivery** | Entrega de conteúdo de live streaming e video-on-demand. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Media Shield for Live** | Reduz tráfego na origem em fluxos de vídeo ao vivo. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/) |
| **Media Shield for VOD** | Reduz tráfego na origem em fluxos de video-on-demand. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/origin-shield/) |
...
| **Fanout** | Padrões de mensagem publish-subscribe na Fastly. | [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/build/applications/reference/websocket/) |
