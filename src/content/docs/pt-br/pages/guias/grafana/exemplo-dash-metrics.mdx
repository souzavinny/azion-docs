...
permalink: /documentacao/observe/real-time-metrics/guides/metrics-dash/
menu_namespace: realTimeMetricsMenu
---

Siga os passos descritos em [Como utilizar um dashboard pré-configurado com o plugin da Azion no Grafana](/pt-br/documentacao/observe/real-time-metrics/guides/azion-plugin-grafana-dash-pre-configurado/) e utilize o JSON a seguir com a URL `https://api.azionapi.net/metrics/graphql` para criar um dashboard no Grafana com dados da API GraphQL do Real-Time Metrics, como, por exemplo:
