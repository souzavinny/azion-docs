...
permalink: /documentacao/observe/real-time-metrics/guides/data-transferred-dash/
menu_namespace: realTimeMetricsMenu
---

Para criar um dashboard no Grafana com as métricas de **Data Transferred** do [Real-Time Metrics](/pt-br/documentacao/observe/real-time-metrics/), siga os passos descritos em [Como utilizar um dashboard pré-configurado com o plugin da Azion no Grafana](/pt-br/documentacao/observe/real-time-metrics/guides/azion-plugin-grafana-dash-pre-configurado/) e use o seguinte JSON com a URL `https://api.azionapi.net/metrics/graphql`:
