...
Você pode utilizar o [processo de debugging](/pt-br/documentacao/devtools/debugging/) para identificar erros em suas functions. Uma das opções para debugging é utilizar a [GraphQL⁠ API](/pt-br/documentacao/devtools/graphql/reference/overview/).
