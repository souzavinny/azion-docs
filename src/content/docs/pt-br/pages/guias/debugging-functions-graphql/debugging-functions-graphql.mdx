...
permalink: /documentacao/build/functions/guides/debugging-functions-graphql/
---

Você pode utilizar o [processo de debugging](/pt-br/documentacao/build/functions/runtime-apis/debugging/) para identificar erros em suas functions. Uma das opções para debugging é utilizar a [GraphQL⁠ API](/pt-br/documentacao/devtools/graphql/reference/overview/).

Para isso, siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/devtools/graphql/guides/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/events/graphql`.
