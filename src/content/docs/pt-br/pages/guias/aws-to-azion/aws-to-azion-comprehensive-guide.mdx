...
permalink: /documentacao/get-started/migrate/aws/
---
...
| :---------- | :---------- | :--------------- |
| **Amazon CloudFront** | CDN da AWS para entregar conteúdo estático, conteúdo dinâmico, APIs, aplicações e vídeo globalmente. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **CloudFront Distributions** | Recurso principal de entrega do CloudFront para domínios, origens, comportamento de cache, certificados, segurança e configurações de entrega no edge. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **CloudFront Alternate Domain Names** | Configura domínios customizados para distribuições CloudFront. | [Workloads](https://www.azion.com/pt-br/documentacao/build/workloads/) |
| **CloudFront Cache Behaviors** | Comportamento de entrega baseado em caminho, política de cache, política de requisição à origem, métodos permitidos e associações de edge function. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) |
| **CloudFront Cache Policies** | Controla cache keys, TTLs, cabeçalhos, cookies, query strings e compressão. | [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/) |
| **CloudFront Origin Request Policies** | Controla quais valores da requisição o CloudFront encaminha para a origem. | [Rules Engine](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) |
| **CloudFront Response Headers Policies** | Adiciona ou modifica cabeçalhos de resposta, como cabeçalhos de segurança e CORS. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) |
| **CloudFront Origin Shield** | Camada adicional de cache centralizado para reduzir carga na origem e melhorar cache hit ratio. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/) |
| **CloudFront Invalidation** | Remove conteúdo dos caches de edge do CloudFront antes da expiração. | [Real-Time Purge](https://www.azion.com/pt-br/documentacao/build/applications/reference/real-time-purge/) |
| **CloudFront Functions** | Execução leve de JavaScript no edge para redirects, rewrites, cabeçalhos e normalização de cache key. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **Lambda@Edge** | Funções Node.js ou Python acionadas por eventos do CloudFront para customizar a entrega. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **Lambda@Edge for security logic** | Usa funções acionadas pelo CloudFront para validação de requisições, autenticação ou lógica de bloqueio. | [Functions para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/functions/) |
| **CloudFront Device Detection** | Detecta tipo de dispositivo e encaminha metadados de dispositivo para a origem. | [Device Groups](https://www.azion.com/pt-br/documentacao/build/applications/reference/device-groups/) |
| **AWS Elemental MediaLive** | Codificação de vídeo ao vivo em tempo real. | [Live Ingest](https://www.azion.com/pt-br/documentacao/build/applications/guides/live-ingest-boas-praticas/) |
| **AWS Elemental MediaPackage** | Empacota e origina streams de vídeo ao vivo para HLS, DASH e formatos relacionados. | [Live Ingest](https://www.azion.com/pt-br/documentacao/build/applications/guides/live-ingest-boas-praticas/) + [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **CloudFront for live streaming** | Entrega vídeo ao vivo globalmente usando CloudFront com AWS Media Services. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Live Ingest](https://www.azion.com/pt-br/documentacao/build/applications/guides/live-ingest-boas-praticas/) |
| **AWS Lambda** | Compute serverless de uso geral para execução de código orientada a eventos. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **Amazon API Gateway** | Cria e gerencia APIs REST, HTTP e WebSocket com integrações de backend. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **API Gateway request validation / throttling** | Aplica controles, throttling e regras de validação a requisições de API. | [Rules Engine](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) |
| **AWS Amplify Hosting** | CI/CD baseado em Git e hospedagem para aplicações web estáticas e server-side rendered. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Azion CLI](https://www.azion.com/pt-br/documentacao/devtools/cli/) |
| **AWS App Runner** | Faz deploy de código fonte ou imagens de container para aplicações web gerenciadas. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Orchestrator](https://www.azion.com/pt-br/produtos/orchestrator/) |
...
| **Amazon S3 Static Website Hosting** | Hospeda sites estáticos a partir de buckets S3. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) + [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) |
| **S3 Object Lambda** | Transforma objetos S3 com Lambda antes de retorná-los ao solicitante. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
| **S3 Object Lambda for image transformation** | Redimensiona, aplica marca d'água, redige ou transforma conteúdo recuperado do S3. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/reference/image-processor/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/) |
...
| **AWS WAF** | Web application firewall para proteger aplicações e APIs. | [WAF](https://www.azion.com/pt-br/documentacao/secure/waf/) / [Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/) |
| **AWS Managed Rules for AWS WAF** | Grupos de regras gerenciadas para vulnerabilidades comuns e tráfego indesejado. | [WAF Rule Sets](https://www.azion.com/pt-br/documentacao/secure/waf/reference/rule-sets/) |
| **AWS WAF custom rules** | Cria condições de correspondência e ações customizadas para requisições web. | [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/rules-engine/) |
...
| **AWS WAF Rate-Based Rules** | Limita taxas de requisições com base em IP, cabeçalhos, URI, método ou outras chaves. | [Rules Engine](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/) + [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) |
| **AWS WAF IP Sets** | Listas reutilizáveis de IP/CIDR para regras de allow ou block. | [Network Lists](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/network-shield/network-lists/) |
| **AWS Shield Standard** | Proteção DDoS padrão para recursos AWS. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/secure/ddos-protection/) |
| **AWS Shield Advanced** | Proteção DDoS avançada com visibilidade e opções adicionais de mitigação. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/secure/ddos-protection/) |
...
| **Elastic Load Balancing** | Distribui tráfego entre múltiplos destinos e zonas de disponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) |
| **Application Load Balancer** | Load balancing HTTP/HTTPS de camada 7 com roteamento em nível de aplicação. | [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) |
| **Network Load Balancer** | Load balancing TCP/UDP/TLS de camada 4. | [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) |
| **AWS Global Accelerator** | IPs Anycast globais e roteamento otimizado na rede global da AWS. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/) |
...
| **AWS Certificate Manager** | Provisiona, importa, gerencia, faz deploy e renova certificados SSL/TLS. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/) |
| **Amazon CloudWatch Metrics** | Coleta, consulta, visualiza e cria alarmes para métricas de serviço e aplicação. | [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/) |
...
| **AWS APIs** | Interface programática para operações de serviços AWS. | [Azion API](https://www.azion.com/pt-br/documentacao/devtools/api/quickstart/) |
...
| **AWS SDKs** | SDKs específicos por linguagem para criar integrações com serviços AWS. | [SDK](https://www.azion.com/pt-br/documentacao/devtools/lib/) |
...
| **Lambda runtime environment** | Camada de runtime usada por funções Lambda. | [Azion Runtime](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/overview/) |
...
* [Applications](https://www.azion.com/pt-br/documentacao/build/applications/)
* [Applications primeiros passos](https://www.azion.com/pt-br/documentacao/build/applications/quickstart/)
* [Azion CLI visão geral](https://www.azion.com/pt-br/documentacao/devtools/cli/)
* [Importe um projeto existente do GitHub](https://www.azion.com/pt-br/documentacao/get-started/first-deploy/github/importar-um-projeto-existente-do-github/)
...
* [Azion CLI visão geral](https://www.azion.com/pt-br/documentacao/devtools/cli/)
* [azion.config.js referência](https://www.azion.com/pt-br/documentacao/devtools/cli/reference/azion-config-js/)
* [azion deploy comando](https://www.azion.com/pt-br/documentacao/devtools/cli/reference/deploy/)
...
* [Variáveis de Ambiente](https://www.azion.com/pt-br/documentacao/build/applications/guides/environment-variables/)
* [Trabalhando com variáveis](https://www.azion.com/pt-br/documentacao/deploy/orchestrator/guides/trabalhar-com-variaveis/)
* [Azion referência de variáveis de ambiente de runtime](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/functions/environment-variables/)
...
* [Applications](https://www.azion.com/pt-br/documentacao/build/applications/)
* [Applications configurações principais](https://www.azion.com/pt-br/documentacao/build/applications/guides/definir-configuracoes-principais/)
* [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/)
* [Connectors](https://www.azion.com/pt-br/documentacao/build/connectors/)
...
* [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/)
* [Functions Instances](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions-instances/)
* [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/build/applications/reference/rules-engine/)
...
* [Functions](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions/)
* [Functions Instances](https://www.azion.com/pt-br/documentacao/build/applications/reference/functions-instances/)
* [Runtime APIs](https://www.azion.com/pt-br/documentacao/build/applications/guides/runtime/)
* [JavaScript Runtime APIs referência](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/javascript/)
...
* [Load Balancer](https://www.azion.com/pt-br/documentacao/build/connectors/reference/load-balancer/)
* [Connectors](https://www.azion.com/pt-br/documentacao/build/connectors/)
* [Application configurações principais](https://www.azion.com/pt-br/documentacao/build/applications/guides/definir-configuracoes-principais/)
...
* [Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/)
* [Cache Settings](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache-settings/)
* [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache/tiered-cache/)
* [Real-Time Purge](https://www.azion.com/pt-br/documentacao/build/applications/reference/real-time-purge/)
...
* [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/reference/image-processor/)
* [Como processar imagens](https://www.azion.com/pt-br/documentacao/build/applications/guides/processar-imagens/)
...
* [AI Inference modelos](https://www.azion.com/en/documentation/build/ai-inference/reference/models/)
* [AI Inference Starter Kit](https://www.azion.com/pt-br/documentacao/marketplace/integrations/ai-inference-starter-kit/)
...
Crie um workload no Azion Console e associe seu domínio customizado. Veja a [documentação de Workloads](https://www.azion.com/pt-br/documentacao/build/workloads/).
...
* [Workloads](https://www.azion.com/pt-br/documentacao/build/workloads/)
* [Crie um domínio customizado Azion](https://www.azion.com/pt-br/documentacao/build/workloads/guides/criar-dominio-personalizado-azion/)
* [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/)
* [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/)
...
* [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/)
* [Compatibilidade DNSSEC](https://www.azion.com/pt-br/documentacao/secure/edge-dns/reference/compatibilidade-dnssec/)
* [Execute o comando dig](https://www.azion.com/pt-br/documentacao/secure/edge-dns/guides/executar-o-comando-dig/)
* [Execute o comando traceroute](https://www.azion.com/pt-br/documentacao/secure/edge-dns/guides/executar-o-comando-traceroute/)
...
4. Veja o [guia de configuração mTLS](/pt-br/documentacao/secure/certificate-manager/guides/mtls/) para passos detalhados.
...
* [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/)
* [Crie um certificado digital](https://www.azion.com/pt-br/documentacao/build/workloads/guides/criar-certificado-digital/)
* [mTLS](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/reference/mtls/)
...
* [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/rules-engine/)
* [Functions para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/functions/)
...
* [DDoS Protection](https://www.azion.com/pt-br/documentacao/secure/ddos-protection/)
* [DDoS Mitigation](https://www.azion.com/pt-br/documentacao/secure/ddos-protection/reference/ddos-mitigation/)
...
* [Bot Manager Lite](https://www.azion.com/pt-br/documentacao/secure/bot-manager/reference/lite/)
* [Bot Manager Lite integration kit](https://www.azion.com/pt-br/documentacao/marketplace/integrations/bot-manager-lite-integration-kit/)
* [Radware Bot Manager](https://www.azion.com/pt-br/documentacao/marketplace/integrations/radware-bot-manager/)
...
* [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/rules-engine/)
* [Functions para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/functions/)
* [Functions Instances para Firewall](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/functions-instances/)
...
* [Network Lists](https://www.azion.com/pt-br/documentacao/secure/firewall/reference/network-shield/network-lists/)
...
* [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/)
* [Como acessar Object Storage usando protocolo S3](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/s3-protocol-para-object-storage/)
* [Crie e modifique um bucket](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/criar-e-modificar-um-bucket/)
* [Faça upload e download de objetos](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/upload-e-download-de-objetos-do-bucket/)
* [Use um bucket como origem](https://www.azion.com/pt-br/documentacao/store/object-storage/guides/bucket-como-connector/)
* [Referência da biblioteca Storage](https://www.azion.com/pt-br/documentacao/devtools/lib/reference/storage/)
...
* [Biblioteca KV (azion/kv)](https://www.azion.com/pt-br/documentacao/devtools/lib/reference/kv/)
* [SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/)
* [Crie um banco de dados](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/criar-banco-de-dados/)
* [Instale SQL Shell](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/install-edge-sql-shell/)
* [Importe dados para SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/importar-dados-edge-sql/)
...
* [SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/)
* [Vector Search](https://www.azion.com/pt-br/documentacao/store/sql-database/reference/vector-search/)
* [Crie um banco de dados](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/criar-banco-de-dados/)
* [Instale SQL Shell](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/install-edge-sql-shell/)
* [Comandos SQL Database Shell](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/edge-sql-shell-commands/)
* [Importe dados para SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/guides/importar-dados-edge-sql/)
* [Referência da API SQL Database](https://www.azion.com/pt-br/documentacao/build/functions/runtime-apis/sql-database/)
...
* [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/)
* [Real-Time Metrics primeiros passos](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/quickstart/)
* [Historical Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics-historico/)
* [Analise métricas](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/analisar-metricas/)
* [Dashboards customizados do plugin Grafana](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/guides/azion-plugin-grafana/)
* [Dashboards prontos do plugin Grafana](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/guides/azion-plugin-grafana-dash-pre-configurado/)
...
* [Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/)
* [Real-Time Events primeiros passos](https://www.azion.com/pt-br/documentacao/observe/real-time-events/quickstart/)
* [Investigue requisições com GraphQL API](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/investigar-requisicoes-api-graphql/)
* [Configure sampling](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/configurar-sampling/)
...
* [Data Stream primeiros passos](https://www.azion.com/pt-br/documentacao/observe/data-stream/quickstart/)
* [Use Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/)
...
* Revise [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/observe/real-time-metrics/) para monitorar a performance da aplicação
...
* [Leia a documentação de Applications](https://www.azion.com/pt-br/documentacao/build/applications/)
