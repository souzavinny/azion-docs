...
| **CloudFront Alternate Domain Names** | Configura domínios customizados para distribuições CloudFront. | [Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/) |
...
| **CloudFront Cache Policies** | Controla cache keys, TTLs, cabeçalhos, cookies, query strings e compressão. | [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/) |
...
| **CloudFront Origin Shield** | Camada adicional de cache centralizado para reduzir carga na origem e melhorar cache hit ratio. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/) |
...
| **CloudFront Functions** | Execução leve de JavaScript no edge para redirects, rewrites, cabeçalhos e normalização de cache key. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
| **Lambda@Edge** | Funções Node.js ou Python acionadas por eventos do CloudFront para customizar a entrega. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
...
| **AWS Lambda** | Compute serverless de uso geral para execução de código orientada a eventos. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
| **Amazon API Gateway** | Cria e gerencia APIs REST, HTTP e WebSocket com integrações de backend. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
...
| **S3 Object Lambda** | Transforma objetos S3 com Lambda antes de retorná-los ao solicitante. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
| **S3 Object Lambda for image transformation** | Redimensiona, aplica marca d'água, redige ou transforma conteúdo recuperado do S3. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/image-processor/) + [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/) |
...
| **Elastic Load Balancing** | Distribui tráfego entre múltiplos destinos e zonas de disponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) |
| **Application Load Balancer** | Load balancing HTTP/HTTPS de camada 7 com roteamento em nível de aplicação. | [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) |
| **Network Load Balancer** | Load balancing TCP/UDP/TLS de camada 4. | [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) |
| **AWS Global Accelerator** | IPs Anycast globais e roteamento otimizado na rede global da AWS. | [Applications](https://www.azion.com/pt-br/documentacao/build/applications/) + [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/) |
...
* [Connectors](https://www.azion.com/pt-br/documentacao/secure/connectors/)
...
* [Functions](https://www.azion.com/pt-br/documentacao/build/applications/functions/)
...
* [Load Balancer](https://www.azion.com/pt-br/documentacao/secure/connectors/reference/load-balancer/)
* [Connectors](https://www.azion.com/pt-br/documentacao/secure/connectors/)
...
* [Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/)
* [Cache Settings](https://www.azion.com/pt-br/documentacao/build/applications/reference/cache-settings/)
* [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/applications/cache/tiered-cache/)
...
* [Image Processor](https://www.azion.com/pt-br/documentacao/build/applications/image-processor/)
* [Como processar imagens](https://www.azion.com/pt-br/documentacao/build/applications/image-processor/guides/processar-imagens/)
...
Crie um workload no Azion Console e associe seu domínio customizado. Veja a [documentação de Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/).
...
* [Workloads](https://www.azion.com/pt-br/documentacao/secure/workloads/)
* [Crie um domínio customizado Azion](https://www.azion.com/pt-br/documentacao/secure/workloads/guides/criar-dominio-personalizado-azion/)
...
* [Certificate Manager](https://www.azion.com/pt-br/documentacao/secure/certificate-manager/)
* [Crie um certificado digital](https://www.azion.com/pt-br/documentacao/secure/workloads/guides/criar-certificado-digital/)
