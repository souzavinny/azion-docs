...
permalink: /documentacao/account/guides/configurar-user-session-timeout/
...
<LinkButton link="/pt-br/documentacao/account/reference/user-session-timeout/" label="Saiba mais sobre o User Session Timeout" severity="secondary" target="_blank" />
