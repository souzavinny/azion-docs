...
description: >-
  Como as versões em inglês e em português de uma página se unem pelo
  namespace, com permalinks localizados, links com prefixo de idioma e as
  regras de tradução.
...
As regras estruturais de [Estrutura de frases](/pt-br/documentacao/guia-de-estilo/escrita/estrutura-de-frases/) valem para o português sem mudança. Limite de tamanho de frase, uma instrução por passo, tempos verbais simples, voz ativa e agrupamentos curtos de substantivos: tudo se transfere. As regras de vocabulário não se transferem; o vocabulário do português está em [Terminologia](/pt-br/documentacao/guia-de-estilo/escrita/terminologia/).

## Aplique as regras de tradução

Cinco regras cobrem a maior parte do trabalho em uma página em português:

- Não traduza termos técnicos genéricos: `edge computing`, `edge`, `edge location`, `data center`, `serverless`, `template`, `compliance`, `on-premise`.
- Não traduza nomes de produto: **Applications**, **Functions**, **Firewall**, **Azion Web Platform**, **Azion Marketplace**.
...
As listas completas estão em [Terminologia](/pt-br/documentacao/guia-de-estilo/escrita/terminologia/).
