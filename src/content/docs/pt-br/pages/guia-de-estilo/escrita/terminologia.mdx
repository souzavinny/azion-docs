...
Todo produto tem um nome de documentação, e toda página usa esse nome. A lista canônica de nomes vive na base de conhecimento da empresa, a fonte única para nomes de produto. Este guia não repete a lista, porque uma cópia fica errada no dia em que um nome muda.
