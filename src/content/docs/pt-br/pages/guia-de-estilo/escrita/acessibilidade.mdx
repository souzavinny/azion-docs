...
Escreva cada sigla por extenso no primeiro uso em cada página, porque o leitor chega a qualquer página diretamente. A regra completa, com a diferença para nomes de produto, está em [Escolha de palavras](/pt-br/documentacao/guia-de-estilo/escrita/escolha-de-palavras/).
