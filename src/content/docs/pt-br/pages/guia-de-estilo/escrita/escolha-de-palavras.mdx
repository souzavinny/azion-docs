...
Algumas palavras aparecem em rascunhos como decoração e não carregam significado técnico. Elas também aparecem com muito mais frequência em texto gerado por máquina do que em escrita humana. Apague o enchimento e mantenha a frase: "é importante notar que" e "note que" não adicionam nada. Prefira a forma curta: "para" em vez de "a fim de", "porque" em vez de "devido ao fato de que" e "pode" em vez de "tem a capacidade de".
...
- Depois: `Para armazenar conteúdo em cache, configure os três ajustes abaixo.`
...
- Antes: `O Applications oferece um cache poderoso e flexível, perfeito para o e-commerce moderno.`
