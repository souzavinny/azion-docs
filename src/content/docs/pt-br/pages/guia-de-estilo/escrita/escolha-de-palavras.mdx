...
- "Atualmente", "no momento da escrita", "em breve", "agora disponível", "recentemente" e "novo" como modificador: todas envelhecem mal, e ninguém volta para corrigir. Nenhum mês ou ano aparece fora de um changelog. Diga o que é verdade e deixe o changelog carregar a linha do tempo.
