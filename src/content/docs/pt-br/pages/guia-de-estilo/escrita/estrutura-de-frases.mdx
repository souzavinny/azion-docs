...
O ASD-STE100 define regras mais rígidas para procedimentos do que para descrições. A Azion aplica essa divisão aos quatro tipos de conteúdo.
...
Em um procedimento, cada frase dá exatamente uma instrução. Quando um passo contém duas ações, o leitor muitas vezes completa a primeira e pula a segunda.

- Antes: `Crie o bucket e envie seus arquivos, depois configure as permissões.`
- Depois: `Crie o bucket. Envie seus arquivos. Configure as permissões.`
...
Escreva cada passo na voz ativa. Em texto descritivo, use a passiva apenas quando o agente é desconhecido ou é a própria plataforma. Quando um produto age, prefira nomeá-lo como sujeito. A voz ativa também mantém o registro em segunda pessoa descrito em [Voz](/pt-br/documentacao/guia-de-estilo/escrita/voz/).
