...
Em um procedimento, cada passo carrega exatamente uma ação. Quando um passo contém duas, o leitor muitas vezes completa a primeira e pula a segunda. [Procedimentos](/pt-br/documentacao/guia-de-estilo/escrita/procedimentos/) é o dono desta regra, incluindo o único caso em que dois movimentos pequenos dividem um passo e uma única frase.
...
Em inglês, escreva a forma completa de cada verbo: "do not", não "don't". [Voz da documentação](/pt-br/documentacao/guia-de-estilo/escrita/voz/) é a dona desta regra.
