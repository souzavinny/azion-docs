...
Quando a fonte não mostra output para um comando, declare a mudança de estado resultante, ou marque a lacuna com `[GAP: ...]`. Nunca invente um output que a fonte não mostra.
