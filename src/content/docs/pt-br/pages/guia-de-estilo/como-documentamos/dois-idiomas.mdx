...
meta_tags: 'guia de estilo, bilíngue, tradução, português'
...
As regras de frase servem ao par. Frases curtas com tempos verbais simples traduzem sem reestruturação, e onde não há reestruturação o significado não se perde. O lado do vocabulário é uma tabela de substituição: quais termos ficam em inglês, e quais palavras do português são evitadas.
...
- [Terminologia da documentação](/pt-br/documentacao/guia-de-estilo/escrita/terminologia/) - os termos que ficam em inglês e a tabela de substituição.
