...
meta_tags: 'guia de estilo, componentes, MDX'
...
As páginas de documentação são MDX, e esta página é o vocabulário completo de componentes. Um componente ausente desta página não está disponível: um import inventado falha o build, e os componentes legados que resolvem são banidos abaixo, com os motivos.
