...
- Incorreto: `Consulte [**Configurações de cache**](/pt-br/documentacao/build/applications/reference/cache-settings/).`
- Correto: `Consulte [Configurações de cache](/pt-br/documentacao/build/applications/reference/cache-settings/).`
