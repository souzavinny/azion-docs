...
title: Pontuação
description: >-
  Regras de pontuação da documentação da Azion: vírgula em série, travessões e
  hifens, pontuação de títulos e listas, espaçamento e os símbolos a evitar.
...
Travessões usados para dar ênfase são o padrão a evitar. Um texto que se apoia neles soa gerado por máquina, e [Escolha de palavras](/pt-br/documentacao/guia-de-estilo/escrita/escolha-de-palavras/) cobre essa família. Esta é uma regra de escrita, não um defeito de revisão: ninguém sinaliza um travessão isolado.
...
O ponto de exclamação adiciona volume, não informação. Ele também soa promocional, o que [Voz](/pt-br/documentacao/guia-de-estilo/escrita/voz/) descarta.

A exceção é a saída citada. Quando o Azion Console ou um comando imprime um desses sinais, cite exatamente.
