...
O total fica em torno de 10.400 caracteres. O caso de uso é o único tipo que pode passar do alvo de 8.000 caracteres por página em [Tamanho de página e retrieval](/pt-br/documentacao/guia-de-estilo/conteudo/tamanho-de-pagina/): mire em 11.000 e mantenha o teto rígido de 16.000. Mire o inglês em 10.000 para que o par em português caiba.
...
| --- | --- | --- | --- |
| Catalogue pages served fast under load | Cache identical responses at the edge | Applications | [Cache settings](/en/documentation/build/applications/reference/cache-settings/) |
