...
| --- | --- | --- | --- |
| Catalogue pages served fast under load | Cache identical responses at the edge | Applications | [Cache settings](/en/documentation/build/cache/reference/cache-settings/) |
