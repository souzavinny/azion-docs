...
description: >-
  Como escrever uma página de quickstart: um tutorial cujo objetivo é a primeira
...
O exemplo abaixo, em inglês, mostra a abertura, a cadeia de objetos e os pré-requisitos de uma página de quickstart de **Functions**:
