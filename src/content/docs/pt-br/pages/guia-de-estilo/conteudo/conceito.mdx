...
Descritivo: 25 palavras por frase, voz ativa, passiva apenas quando o agente é genuinamente desconhecido ou é a própria plataforma. [Estrutura de frases](/pt-br/documentacao/guia-de-estilo/escrita/estrutura-de-frases/) tem as regras.
...
- **Abertura**: uma declaração de como o sistema se comporta. Nunca `Esta página explica`.
...
- **Um diagrama**: quando a relação é mais fácil de desenhar do que de descrever. O texto alternativo descreve o que o diagrama mostra.
...
- **Espelhe a frase-roteiro.** Uma seção `##` em frase nominal por mecanismo, na ordem em que a frase-roteiro os nomeia.
...
- **Faça os diagramas carregarem significado.** O texto alternativo descreve o que o diagrama mostra; os assets são absolutos a partir da raiz, sem prefixo de idioma.
...
- **Marque lacunas em vez de inventar.** Um componente obrigatório cujo conteúdo a fonte não fornece recebe um marcador `[GAP: ...]`, nunca omissão silenciosa, nunca invenção.

## Exemplos

O exemplo abaixo, em inglês, mostra a abertura, a frase-roteiro e a primeira seção de mecanismo de uma página de conceito sobre o Tiered Cache:
