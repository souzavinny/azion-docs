...
As seções mantêm essa ordem. A lista de interfaces — Azion Console, API, Azion CLI, Terraform — é opcional: ela vale para quase todo produto da Azion, então inclua só quando uma interface for distintiva, e deixe o roteador carregá-la nos outros casos.
