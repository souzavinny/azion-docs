...
| 5 | Guias | Quando o produto tem tarefas | [Guias how-to](/pt-br/documentacao/guia-de-estilo/conteudo/guias-how-to/) para as tarefas com que o leitor chega |
| 6 | Tutoriais | Opcional | [Tutoriais](/pt-br/documentacao/guia-de-estilo/conteudo/tutoriais/): um objetivo escolhido pelo autor, construído do início ao fim |
| 7 | Exemplos | Opcional | Código funcional que o leitor copia, agrupado por linguagem ou por tarefa |
| 8 | Referência | Quando o produto tem configurações | [Páginas de referência](/pt-br/documentacao/guia-de-estilo/conteudo/referencia/): campos, valores, padrões |
| 9 | Limites | Quando o produto tem limites | A tabela de limites, dimensionada por plano |
| 10 | Best practices | Opcional | Como operar bem o produto, e o raciocínio por trás de cada recomendação |
| 11 | Troubleshooting | Quando o produto tem sintomas conhecidos | [Páginas de troubleshooting](/pt-br/documentacao/guia-de-estilo/conteudo/troubleshooting/): sintoma, causa, correção |
...
- **Cresça dividindo um slot que a seção já tem:** Guias em áreas de tarefa nomeadas, Quickstart por interface, Features e capacidades por superfície.
