...
| 11 | Pricing | Sim | Um link para a seção do produto na página de pricing |
| 12 | Changelog | Sim | Um link para as entradas de changelog do produto |

Dois slots têm uma forma fixa na sidebar, e ela não é um dropdown.
...
**Páginas de referência ficam diretamente na sidebar, uma linha cada.** Um leitor que consulta o nome de um campo deve chegar nele em um clique, então referência nunca se esconde atrás de uma linha pai. Quando um produto tem mais páginas de referência do que a sidebar comporta, o sinal é para unir páginas, não para aninhá-las.
...
- **Os doze nunca aumentam em número.**
