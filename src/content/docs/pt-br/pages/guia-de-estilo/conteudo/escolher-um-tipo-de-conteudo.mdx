...
Um slot é uma posição na seção de produto; um tipo é o formato de uma página. A [arquitetura de informação](/pt-br/documentacao/guia-de-estilo/conteudo/arquitetura-de-informacao/) lista doze slots, e este catálogo tem doze tipos. O tamanho igual é coincidência: as duas listas não se mapeiam uma na outra.
