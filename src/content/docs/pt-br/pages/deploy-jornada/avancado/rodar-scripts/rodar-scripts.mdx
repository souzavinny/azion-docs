...
permalink: /documentacao/build/orchestrator/guides/rodar-scripts/
...
<LinkButton link="/pt-br/documentacao/build/orchestrator/guides/instalar-orchestrator-agent/" label="ir para como instalar o agente de orquestração de borda" severity="secondary" target="_blank" />
<LinkButton link="/pt-br/documentacao/build/orchestrator/guides/autorizar-edge-node/" label="ir para como autorizar um edge node" severity="secondary" target="_blank" />
