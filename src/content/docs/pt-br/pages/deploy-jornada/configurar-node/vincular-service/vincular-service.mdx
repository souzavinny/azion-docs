...
permalink: /documentacao/deploy/orchestrator/guides/vincular-servico/
...
<LinkButton link="/pt-br/documentacao/deploy/orchestrator/guides/criar-edge-service/" label="ir para o guia de como criar um edge service" severity="secondary" target="_blank" />
...
1. Execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) para recuperar o ID do edge node que você deseja vincular a um edge service:
...
2. Execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e recupere o ID do edge service que você deseja vincular a um edge node:
...
Substitua `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/), `:id` pelo ID do edge node e informe as seguintes propriedades no corpo da requisição:
