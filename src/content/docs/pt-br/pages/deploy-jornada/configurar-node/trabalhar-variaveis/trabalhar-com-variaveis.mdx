...
description: >-
  ...
  Orchestrator.
permalink: /documentacao/build/orchestrator/guides/trabalhar-com-variaveis/
...
3. Selecione o [edge service](/pt-br/documentacao/build/orchestrator/guides/criar-edge-service/) ao qual você deseja adicionar uma variável.
...
5. Escolha o [serviço](/pt-br/documentacao/build/orchestrator/guides/criar-edge-service/) ao qual você deseja aplicar a variável.
