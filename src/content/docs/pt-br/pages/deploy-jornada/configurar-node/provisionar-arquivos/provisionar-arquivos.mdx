...
description: >-
  ...
  Computing.
permalink: /documentacao/deploy/orchestrator/guides/provisionar-arquivos/
...
1. Execute a seguinte requisição `GET` no seu terminal, substituindo [TOKEN VALUE] pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e recupere o ID do edge service:
...
<LinkButton link="/pt-br/documentacao/deploy/orchestrator/guides/trabalhar-com-variaveis/" label="ir para o guia de trabalho com variáveis" severity="secondary" target="_blank" />
