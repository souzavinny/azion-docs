...
:::note
Certifique-se de que o name e os SANs listados sejam iguais aos [domínios que você configurou com a Azion](/pt-br/documentacao/build/workloads/guides/configurar-dominio/). Isso evitará que ocorram erros quando você associar o certificado ao domínio.
:::
