...
permalink: /documentacao/secure/firewall/guides/cifras/
...
1. Execute a seguinte requisição `GET` no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [token pessoal](/pt-br/documentacao/account/guides/personal-tokens/) para recuperar seu `<workload_id>`:
...
| `ciphers` | Enum que define o conjunto de cifras suportadas. Veja a lista completa de [lista de cifras suportadas](/pt-br/documentacao/build/applications/reference/main-settings/#cifras) para mais detalhes |
...
6. Verifique o conjunto de cifras suportado inspecionando a página ou [executando o comando DIG](/pt-br/documentacao/secure/edge-dns/guides/executar-o-comando-dig/).
...
1. Execute a seguinte requisição `GET` no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [token pessoal](/pt-br/documentacao/account/guides/personal-tokens/) para recuperar seu `<application_id>`:
...
| `minimum_tls_version` | Enum que estabelece a versão mínima de TLS |
| `supported_ciphers` | Enum que define o conjunto de cifras suportadas. Veja a lista completa de [lista de cifras suportadas](/pt-br/documentacao/build/applications/reference/main-settings/#cifras) para mais detalhes |
