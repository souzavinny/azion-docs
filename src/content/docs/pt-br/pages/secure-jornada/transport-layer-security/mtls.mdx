...
Existem instruções separadas para API v3 usando configurações de [Domains legadas](/pt-br/documentacao/secure/workloads/reference/domains/) e API v4 usando o novo produto [Workloads](/pt-br/documentacao/secure/workloads/).
