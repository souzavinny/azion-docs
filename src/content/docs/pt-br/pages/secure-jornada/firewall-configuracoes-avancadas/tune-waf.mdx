...
permalink: /documentacao/secure/firewall/guides/tune-waf/
...
- <Tag severity="info" client:only="vue">[WAF ativado no firewall](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/)</Tag>
...
2. Selecione o WAF Rule Set que deseja usar ou [crie um novo](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/).
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > selecione **WAF Rules**.
2. Selecione o WAF Rule Set que deseja usar ou [crie um novo](/pt-br/documentacao/secure/firewall/guides/criar-waf-rule-set/).
3. Selecione a aba **Tuning**.
    - Você encontrará as variáveis disponíveis para filtrar.
...
Ao filtrar uma consulta com o WAF Tuning, você pode criar uma [allowed rule](/pt-br/documentacao/secure/waf/reference/custom-allowed-rules/) a partir dos resultados apresentados. Para fazer isso:
