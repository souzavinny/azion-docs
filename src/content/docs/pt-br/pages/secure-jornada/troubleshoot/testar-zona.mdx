...
permalink: /documentacao/secure/firewall/guides/testar-zona/
menu_namespace: firewallMenu
---

import LinkButton from 'azion-webkit/linkbutton'

Depois de configurar a sua [zona de Edge DNS](/pt-br/documentacao/secure/firewall/guides/edge-dns-definir-main-settings/), você pode testá-la para verificar se está processando corretamente as suas informações.
...
<LinkButton link="/pt-br/documentacao/secure/edge-dns/guides/executar-o-comando-dig/" label="consulte o guia do comando DIG" severity="secondary" />
