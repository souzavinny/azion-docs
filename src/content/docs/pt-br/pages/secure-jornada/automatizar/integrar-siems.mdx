...
permalink: /documentacao/secure/firewall/guides/integrar-siems/
...
<LinkButton link="/pt-br/documentacao/observe/data-stream/" label="saiba mais sobre Data Stream" severity="secondary" />
...
- Encontre mais informações sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-associar-dominios/).
...
- Você verá campos diferentes dependendo do tipo de endpoint escolhido. Encontre mais informações sobre cada um deles no guia específico para o endpoint na seção de [Observe](/pt-br/documentacao/guides/#observe) na página de guias.
8. Clique no botão **Save**.
</Fragment>

<Fragment slot="panel.api">
1. Execute a seguinte requisição `POST`, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/):
