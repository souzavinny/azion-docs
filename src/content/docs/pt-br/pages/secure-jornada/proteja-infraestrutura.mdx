...
permalink: /documentacao/secure/firewall/guides/proteja-infraestrutura/
---
...
Após [criar um firewall e proteger sua aplicação](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/), você pode usar o **Origin Shield** para proteger sua infraestrutura bloqueando ameaças.
...
- O [Network Shield](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/#modulos) ativado na sua conta.
...
1. Acesse o [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > selecione **Network Lists**.
2. Selecione **Azion Origin Shield**.
3. No campo **List**, você pode copiar a lista de endereços IP.
</Fragment>

<Fragment slot="panel.api">
1. Execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/):
