...
permalink: /documentacao/secure/firewall/guides/balanceamento-de-carga-dns/
...
2. Escolha a zona na qual deseja adicionar registros na lista ou [crie uma zona](/pt-br/documentacao/secure/firewall/guides/edge-dns-definir-main-settings/#crie-uma-nova-zona).
...
1. Execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) para recuperar seu `<hosted_zone_id>`:
