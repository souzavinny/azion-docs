...
permalink: /documentacao/secure/firewall/guides/trabalhar-com-rules-engine/
...
Implementar regras em seu firewall usando o [Rules Engine](/pt-br/documentacao/secure/firewall/reference/rules-engine/) permitirá que você determine as regras que ele deve executar em cenários específicos.
...
:::note
Existem diferentes critérios que requerem módulos diferentes do Firewall. Certifique-se de ter o [módulo correto](/pt-br/documentacao/secure/firewall/reference/rules-engine/#criteria) ativado para criar suas regras.
:::
---
...
1. [No Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/), vá para **Firewall**.
...
1. Execute a seguinte requisição `POST` para criar uma regra, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e a variável `<edge_firewall_id>` pelo valor do ID do firewall:
