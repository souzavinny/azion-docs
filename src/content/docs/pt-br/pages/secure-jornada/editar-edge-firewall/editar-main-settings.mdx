...
| `edge_functions_enabled` | Valor booleano que ativa (`true`) ou desativa (`false`) o módulo [Functions](/pt-br/documentacao/secure/firewall/reference/functions/) |
...
| `debug_rules` | Valor booleano que ativa (`true`) ou desativa (`false`) o recurso [Debug Rules](/pt-br/documentacao/build/applications/guides/debug-regras/) |
