...
permalink: /documentacao/observe/data-stream/guides/investigar-requisicoes-api-graphql/
...
Depois de identificar um país ao qual você não deseja permitir acesso à sua aplicação, você pode criar uma [network list](/pt-br/documentacao/secure/firewall/reference/network-shield/network-lists/) para bloquear o país.
...
<LinkButton link="/pt-br/documentacao/secure/network-shield/guides/blocklists-enderecos-ip-edge/#associe-a-network-list-a-um-edge-firewall" label="consulte o guia de associar uma network list a uma regra" severity="secondary" target="_blank" />
...
1. [Acesse o Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Firewall**.
2. Selecione um firewall existente ou [crie um novo](/pt-br/documentacao/secure/firewall/guides/firewall-definir-main-settings/).
...
:::tip
Se você notar que há requisições legítimas de outros países sendo bloqueadas pela regra do header `User-Agent`, use [WAF Tuning](/pt-br/documentacao/secure/firewall/guides/tune-waf/) para analisar requisições e criar regras permitidas.
:::
...
Se você não quiser bloquear todas as requisições de um país por meio de uma network list, existem outros recursos dos [produtos de Secure](/pt-br/documentacao/secure/firewall/) da Azion que você pode usar.

- Crie uma regra com o [Set Rate Limit](/pt-br/documentacao/secure/firewall/reference/rules-engine/#behaviors).
