...
Se você não quiser bloquear todas as requisições de um país por meio de uma network list, existem outros recursos dos [produtos de Secure](/pt-br/documentacao/secure/overview/) da Azion que você pode usar.
