...
permalink: /documentacao/observe/data-stream/guides/adicionar-filtros-events/
...
Depois de [entender os logs do Real-Time Events](/pt-br/documentacao/observe/data-stream/guides/entender-logs/) e decidir as variáveis que deseja consultar, você pode utilizar o filtro e realizar uma consulta para obter resultados mais precisos.
