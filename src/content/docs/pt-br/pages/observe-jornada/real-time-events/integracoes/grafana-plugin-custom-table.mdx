...
permalink: /documentacao/observe/real-time-metrics/guides/azion-plugin-grafana-personalizar-tabela-logs/
...
5. Na caixa de código, adicione a query que deseja usar.
    - Veja os [guias da GraphQL API](/pt-br/documentacao/devtools/graphql/reference/overview/) para alguns exemplos de queries.
