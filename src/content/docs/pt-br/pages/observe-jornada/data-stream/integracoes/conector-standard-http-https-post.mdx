...
permalink: /documentacao/observe/data-stream/guides/conector-standard-https-post/
...
Você encontra os passos detalhados para a configuração completa no guia [Como configurar as main settings do Data Stream](/pt-br/documentacao/observe/data-stream/guides/como-usar-data-stream/).
...
1. Execute a seguinte requisição `POST` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) para criar seu data stream.
...
:::tip
Com esse tipo de conector, você também pode [adicionar um payload](/pt-br/documentacao/observe/data-stream/guides/data-stream-adicionar-payload/).
:::
