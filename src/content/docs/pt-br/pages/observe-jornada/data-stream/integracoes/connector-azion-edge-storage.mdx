...
permalink: /documentacao/observe/data-stream/guides/conector-azion-object-storage/
...
- Crie uma [credencial S3 via API](/pt-br/documentacao/store/object-storage/guides/s3-protocol-para-object-storage/#crie-uma-credencial-via-api) e [configure o acesso ao bucket através do s3cmd](/pt-br/documentacao/store/object-storage/guides/s3-protocol-para-object-storage/#configure-o-acesso-ao-bucket-atraves-do-s3cmd).
  - Salve a **Access Key** e a **Secret Key** vinculadas à sua credencial. Você precisará delas mais tarde.
- Crie um [bucket de Object Storage](/pt-br/documentacao/store/object-storage/guides/criar-bucket/), ou use um existente.
