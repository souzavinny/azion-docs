...
permalink: /documentacao/observe/data-stream/guides/como-usar-data-stream/
...
1. [Acesse o Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Data Stream**.
...
5. No campo **Template**, selecione o que desejar usar.
    - Caso escolha usar um template personalizado, na caixa de código **Data Set**, adicione as variáveis que você deseja usar nas análises de seus logs. Veja mais sobre [Criar um template personalizado no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-template-personalizado/).
6. Em **Workloads** > **Options**, selecione **All Current and Future Domains** ou **Filter Domains**.
    - Saiba mais sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/observe/data-stream/guides/data-stream-associar-dominios/).
...
1. Execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) para recuperar seu `<data_streaming_id>`:
