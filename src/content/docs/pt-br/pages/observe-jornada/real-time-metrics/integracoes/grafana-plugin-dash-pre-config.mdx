...
permalink: /documentacao/observe/real-time-metrics/guides/azion-plugin-grafana-dash-pre-configurado/
...
<LinkButton link="/pt-br/documentacao/observe/real-time-metrics/guides/integrar-grafana/" label="saiba mais sobre integrar com grafana" severity="secondary" target="_blank" />
...
2. Em **Personal Token**, adicione o token que você criou na página de [Personal Tokens no Azion Console](/pt-br/documentacao/account/reference/personal-tokens/).
