...
Este guia descreve o processo de configuração de um bucket como origem de uma application usando a [API da Azion](https://api.azion.com/), [Azion CLI](/pt-br/documentacao/devtools/cli/), e [Azion Runtime](/pt-br/documentacao/runtime/api-reference/storage/).


Existem instruções separadas para API v3 usando configurações de [Origin legado](/pt-br/documentacao/build/applications/reference/origins/) e API v4 usando o novo produto [Connectors](/pt-br/documentacao/secure/connectors/).
...
:::tip
Após criar sua aplicação com um bucket do Object Storage como origem, você pode gerenciar e configurar configurações, como [respostas de erro](/pt-br/documentacao/build/applications/reference/error-responses/) e [configurações de cache](/pt-br/documentacao/build/applications/cache/guides/cache-settings/).
:::
