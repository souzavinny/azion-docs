...
permalink: /documentacao/store/object-storage/guides/listar-objetos/
menu_namespace: storeMenu
---

Este guia descreve como listar objetos de um bucket do Object Storage usando o [Console](https://console.azion.com/object-storage), a [API da Azion](https://api.azion.com/), [Azion CLI](/pt-br/documentacao/devtools/cli/), e [Azion Runtime](/pt-br/documentacao/build/functions/runtime-apis/storage/).
...
Para listar os objetos em um bucket, execute a seguinte requisição `GET` no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/account/guides/personal-tokens/) e `<bucket_name>` pelo nome do seu bucket:
...
1. Acesse [Azion Console](/pt-br/documentacao/account/guides/como-acessar-o-azion-console/) > **Funções de Borda**.
...
:::note
Consulte a [referência da API do Object Storage](/pt-br/documentacao/build/functions/runtime-apis/storage/) para obter mais detalhes sobre as funções disponíveis para outros tipos de requisições.
:::
