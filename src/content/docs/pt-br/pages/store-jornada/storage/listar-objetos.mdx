...
Este guia descreve como listar objetos de um bucket do Object Storage usando o [Console](https://console.azion.com/object-storage), a [API da Azion](https://api.azion.com/), [Azion CLI](/pt-br/documentacao/devtools/cli/), e [Azion Runtime](/pt-br/documentacao/runtime/api-reference/storage/).
