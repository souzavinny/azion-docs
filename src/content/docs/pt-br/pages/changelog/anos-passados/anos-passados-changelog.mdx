...
description: >-
  ...
  Computing.
permalink: /documentacao/changelog/archive/
meta_tags: >-
...
* **WAF Self-Calibration:** com a nova opção de **Tuning**, você pode visualizar insights e personalizar quais regras serão permitidas de forma rápida e fácil, com apenas alguns cliques. Leia a [documentação](/pt-br/documentacao/secure/waf/) para mais informações.
...
* Adicionamos uma funcionalidade para acesso [multiportas](/pt-br/documentacao/build/workloads/#portas) às Edge Applications, tornando sua implementação mais flexível.
...
* Também aperfeiçoamos questões de segurança em relação à criação de regras no [Rules Engine](/pt-br/documentacao/secure/firewall/reference/rules-engine/).
...
* Nova funcionalidade [Slice Configuration](/pt-br/documentacao/build/applications/reference/cache/).
...
* Adicionado suporte à ECC - _Elliptic Curve Cryptography_ em [Digital Certificates](/pt-br/documentacao/secure/certificate-manager/).
...
* Bug fix no purge de _subdomain_ quando utilizado [Wildcard Purge](/pt-br/documentacao/build/applications/reference/real-time-purge/).
...
* Nova solução Bot Management integrada à plataforma da Azion, usando [Edge Functions](/pt-br/documentacao/build/applications/reference/functions/) no [Edge Firewall](/pt-br/documentacao/secure/firewall/).
* Adicionado componente de seleção [TLS Minimum Version](/pt-br/documentacao/build/workloads/#minimum-tls-version), na interface da Edge Application.
...
* Novos [tipos de purge](/pt-br/documentacao/build/applications/reference/real-time-purge/#tipos-de-purge): purges agora podem ser feitos por URL, CacheKey ou por Wildcard.
...
* Implementação de [Multi-Factor Authentication](/pt-br/documentacao/account/reference/multi-factor-authentication/).
...
* Integração ao Real-Time Manager da funcionalidade de IP Blocking do [Edge Firewall](/pt-br/documentacao/secure/firewall/).
* Integração à API da funcionalidade de IP Blocking do [Edge Firewall](/pt-br/documentacao/secure/firewall/).
...
* Evolução da Learning Tool do produto [Web Application Firewall](/pt-br/documentacao/secure/waf/).
...
* Melhorias dos textos das opções de [Advanced Cache Key](/pt-br/documentacao/build/applications/reference/application-accelerator/#advanced-cache-key).
...
* Renovação do [Shared Certificate](/pt-br/documentacao/secure/certificate-manager/) da Azion junto a CA, para todos os clientes do produto.
...
* Integração das funcionalidades de Advanced Cache Key (cache key por cookie e cache key por query string) do produto [Application Accelerator](/pt-br/documentacao/build/applications/reference/application-accelerator/) ao Real-Time Manager.
...
* Lançamento de novos gráficos de Image Optimization no [Analytics](/pt-br/documentacao/observe/real-time-metrics/).
...
* Suporte a HTTP/2.
* Atualização da aba Origins no Real-Time Manager para integração de funcionalidades do produto [Load Balancer](/pt-br/documentacao/build/connectors/reference/load-balancer/).
* Atualização do Real-Time Manager para inclusão da nova interface para criação de rule sets do [Web Application Firewall](/pt-br/documentacao/secure/waf/).
...
* Atualização da plataforma de [Image Optimization](/pt-br/documentacao/build/applications/reference/image-processor/), com ganhos superiores na otimização de imagens.

---

**mai/2016**

* Lançamento da nova interface para upload de [Digital Certificates](/pt-br/documentacao/secure/certificate-manager/) no Real-Time Manager.
...
* Atualização da interface do [Edge Firewall](/pt-br/documentacao/secure/firewall/) para suporte a reuso de rule sets.
