...
* Adicionamos uma funcionalidade para acesso [multiportas](/pt-br/documentacao/secure/workloads/#portas) às Edge Applications, tornando sua implementação mais flexível.
...
* Nova funcionalidade [Slice Configuration](/pt-br/documentacao/build/applications/cache/).
...
* Nova solução Bot Management integrada à plataforma da Azion, usando [Edge Functions](/pt-br/documentacao/build/applications/functions/) no [Edge Firewall](/pt-br/documentacao/secure/firewall/).
* Adicionado componente de seleção [TLS Minimum Version](/pt-br/documentacao/secure/workloads/#minimum-tls-version), na interface da Edge Application.
...
* Melhorias dos textos das opções de [Advanced Cache Key](/pt-br/documentacao/build/applications/application-accelerator/#advanced-cache-key).
...
* Integração das funcionalidades de Advanced Cache Key (cache key por cookie e cache key por query string) do produto [Application Accelerator](/pt-br/documentacao/build/applications/application-accelerator/) ao Real-Time Manager.
...
* Suporte a HTTP/2.
* Atualização da aba Origins no Real-Time Manager para integração de funcionalidades do produto [Load Balancer](/pt-br/documentacao/secure/connectors/reference/load-balancer/).
...
* Atualização da plataforma de [Image Optimization](/pt-br/documentacao/build/applications/image-processor/), com ganhos superiores na otimização de imagens.
