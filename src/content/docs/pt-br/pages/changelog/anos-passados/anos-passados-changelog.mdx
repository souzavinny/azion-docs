...
* Nova funcionalidade [Slice Configuration](/pt-br/documentacao/build/cache/).
...
* Bug fix no purge de _subdomain_ quando utilizado [Wildcard Purge](/pt-br/documentacao/build/cache/reference/real-time-purge/).
...
* Nova solução Bot Management integrada à plataforma da Azion, usando [Edge Functions](/pt-br/documentacao/build/functions/) no [Edge Firewall](/pt-br/documentacao/secure/firewall/).
...
* Novos [tipos de purge](/pt-br/documentacao/build/cache/reference/real-time-purge/#tipos-de-purge): purges agora podem ser feitos por URL, CacheKey ou por Wildcard.
...
* Melhorias dos textos das opções de [Advanced Cache Key](/pt-br/documentacao/build/application-accelerator/#advanced-cache-key).
...
* Integração das funcionalidades de Advanced Cache Key (cache key por cookie e cache key por query string) do produto [Application Accelerator](/pt-br/documentacao/build/application-accelerator/) ao Real-Time Manager.
...
* Atualização da plataforma de [Image Optimization](/pt-br/documentacao/build/image-processor/), com ganhos superiores na otimização de imagens.
