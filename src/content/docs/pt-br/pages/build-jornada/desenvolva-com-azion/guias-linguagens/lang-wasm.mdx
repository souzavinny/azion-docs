...
Agora, a função está pronta para ser instanciada em uma application. Veja como [instanciar e executar as funções em sua application](/pt-br/documentacao/build/functions/guides/instanciar-functions/).
