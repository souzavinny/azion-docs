...
permalink: /documentacao/build/applications/guides/wasm/
meta_tags: >-
...
Agora, a função está pronta para ser instanciada em uma application. Veja como [instanciar e executar as funções em sua application](/pt-br/documentacao/build/applications/guides/instanciar-functions/).
