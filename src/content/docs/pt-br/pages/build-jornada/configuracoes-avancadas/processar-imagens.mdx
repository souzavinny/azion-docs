...
permalink: /documentacao/build/applications/image-processor/guides/processar-imagens/
...
1. Na seção **Advanced Cache Key**, escolha uma das seguintes opções:
    ...
    - **O conteúdo varia por todos os campos de Query String**: se você não sabe ou não tem certeza sobre quais campos listar na query string porque não é responsável por todo o conteúdo no cache ou não tem [Application Accelerator](/pt-br/documentacao/build/applications/application-accelerator/) ativado.
...
:::note
Para mais informações sobre o endpoint de configurações de cache, consulte o guia sobre [como ajustar suas configurações de cache](/pt-br/documentacao/build/applications/cache/guides/ajustar-cache-settings/).
:::
