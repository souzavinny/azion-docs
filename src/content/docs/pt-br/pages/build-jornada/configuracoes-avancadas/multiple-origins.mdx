...
description: >-
  ...
  Robin.
permalink: /documentacao/build/applications/guides/configure-multiplas-origens/
...
Existem instruções separadas para API v3 usando configurações legadas de [Origin](/pt-br/documentacao/build/applications/reference/origins/) e API v4 usando o novo produto [Connector](/pt-br/documentacao/secure/connectors/).
