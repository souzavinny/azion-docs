...
permalink: /documentacao/build/applications/guides/criar-device-groups/
...
Agora você pode desativar a regra ou [criar uma regra diferente](/pt-br/documentacao/build/applications/guides/trabalhar-com-rules-engine/) para ajustar as configurações da aplicação às suas necessidades.
