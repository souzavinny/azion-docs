...
permalink: /documentacao/secure/connectors/guides/definir-origens/
...
Existem instruções separadas para API v3 usando as configurações legadas de [Origem](/pt-br/documentacao/secure/workloads/reference/domains/) e API v4 usando o novo produto [Connectors](/pt-br/documentacao/secure/connectors/).
...
:::tip
Para implementar algoritmos de balanceamento de carga para múltiplas origens, confira o [guia sobre múltiplas origens com Load Balancer](/pt-br/documentacao/secure/connectors/guides/configure-multiplas-origens/).
:::
...
| `type` | Define o novo tipo de Connector como `http`. Para mais informações sobre balanceamento de carga, confira [como configurar múltiplas origens](/pt-br/documentacao/secure/connectors/guides/configure-multiplas-origens/). |
...
| --- | --- |
| `name` | Define a string como o nome da origem. |
| `origin_type` | Define o novo tipo de origem para `single_origin`. Para mais informações sobre balanceamento de carga, confira [como configurar múltiplas origens com Load Balancer](/pt-br/documentacao/secure/connectors/guides/configure-multiplas-origens/). |
| `addresses` | Recebe uma lista de objetos para cada endereço da origem. Como esta é uma entrada do tipo origem única, você pode enviar apenas um objeto com o valor de `address` dentro do array. |
