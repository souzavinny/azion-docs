  ...
  - title: ''
    cards:
      ...
      - icon: /assets/docs/images/uploads/icon-limits.svg
        ...
        link: /pt-br/documentacao/devtools/graphql/reference/limites/
      - icon: /assets/docs/images/uploads/icon-error.svg
        ...
        link: /pt-br/documentacao/devtools/graphql/reference/mensagens-erro/
---
